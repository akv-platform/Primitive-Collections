...
public interface Double2BooleanMap extends Map<Double, Boolean>, Double2BooleanFunction
{
	...
	public default Boolean computeIfAbsent(Double key, Function<? super Double, ? extends Boolean> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return Boolean.valueOf(computeBooleanIfAbsent(key.doubleValue(), mappingFunction instanceof Double2BooleanFunction ? (Double2BooleanFunction)mappingFunction : K -> mappingFunction.apply(Double.valueOf(K)).booleanValue()));
	}
