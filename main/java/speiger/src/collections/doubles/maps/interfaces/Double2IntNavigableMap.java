 ...
 */
public interface Double2IntNavigableMap extends Double2IntSortedMap, NavigableMap<Double, Integer>
{
	@Override
	public Double2IntNavigableMap copy();
	 ...
	 */
	public default Double2IntNavigableMap synchronize() { return Double2IntMaps.synchronize(this); }
	 ...
	 * @see Double2IntMaps#synchronize
	 */
	public default Double2IntNavigableMap synchronize(Object mutex) { return Double2IntMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Double2IntNavigableMap unmodifiable() { return Double2IntMaps.unmodifiable(this); }
	...
	@Override
	public default Double2IntNavigableMap subMap(double fromKey, double toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Double2IntNavigableMap headMap(double toKey) { return headMap(toKey, false); }
	@Override
	public default Double2IntNavigableMap tailMap(double fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Double2IntMap.Entry lowerEntry(Double key) { return lowerEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2IntMap.Entry floorEntry(Double key) { return floorEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2IntMap.Entry ceilingEntry(Double key) { return ceilingEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2IntMap.Entry higherEntry(Double key) { return higherEntry(key.doubleValue()); }
	
	@Override
	@Deprecated
	default Double2IntNavigableMap subMap(Double fromKey, boolean fromInclusive, Double toKey, boolean toInclusive) { return subMap(fromKey.doubleValue(), fromInclusive, toKey.doubleValue(), toInclusive); }
	@Override
	@Deprecated
	default Double2IntNavigableMap headMap(Double toKey, boolean inclusive) { return headMap(toKey.doubleValue(), inclusive); }
	@Override
	@Deprecated
	default Double2IntNavigableMap tailMap(Double fromKey, boolean inclusive) { return tailMap(fromKey.doubleValue(), inclusive); }
	@Override
	@Deprecated
	default Double2IntNavigableMap subMap(Double fromKey, Double toKey) { return subMap(fromKey.doubleValue(), true, toKey.doubleValue(), false); }
	@Override
	@Deprecated
	default Double2IntNavigableMap headMap(Double toKey) { return headMap(toKey.doubleValue(), false); }
	@Override
	@Deprecated
	default Double2IntNavigableMap tailMap(Double fromKey) { return tailMap(fromKey.doubleValue(), true); }
}