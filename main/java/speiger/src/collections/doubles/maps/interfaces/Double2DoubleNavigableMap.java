 ...
 */
public interface Double2DoubleNavigableMap extends Double2DoubleSortedMap, NavigableMap<Double, Double>
{
	@Override
	 ...
	 */
	public default Double2DoubleNavigableMap synchronize() { return Double2DoubleMaps.synchronize(this); }
	 ...
	 * @see Double2DoubleMaps#synchronize
	 */
	public default Double2DoubleNavigableMap synchronize(Object mutex) { return Double2DoubleMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Double2DoubleNavigableMap unmodifiable() { return Double2DoubleMaps.unmodifiable(this); }
	...
	@Override
	public default Double2DoubleNavigableMap subMap(double fromKey, double toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Double2DoubleNavigableMap headMap(double toKey) { return headMap(toKey, false); }
	@Override
	public default Double2DoubleNavigableMap tailMap(double fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Double2DoubleMap.Entry lowerEntry(Double key) { return lowerEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2DoubleMap.Entry floorEntry(Double key) { return floorEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2DoubleMap.Entry ceilingEntry(Double key) { return ceilingEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2DoubleMap.Entry higherEntry(Double key) { return higherEntry(key.doubleValue()); }
	
	@Override
	@Deprecated
	default Double2DoubleNavigableMap subMap(Double fromKey, boolean fromInclusive, Double toKey, boolean toInclusive) { return subMap(fromKey.doubleValue(), fromInclusive, toKey.doubleValue(), toInclusive); }
	@Override
	@Deprecated
	default Double2DoubleNavigableMap headMap(Double toKey, boolean inclusive) { return headMap(toKey.doubleValue(), inclusive); }
	@Override
	@Deprecated
	default Double2DoubleNavigableMap tailMap(Double fromKey, boolean inclusive) { return tailMap(fromKey.doubleValue(), inclusive); }
	@Override
	@Deprecated
	default Double2DoubleNavigableMap subMap(Double fromKey, Double toKey) { return subMap(fromKey.doubleValue(), true, toKey.doubleValue(), false); }
	@Override
	@Deprecated
	default Double2DoubleNavigableMap headMap(Double toKey) { return headMap(toKey.doubleValue(), false); }
	@Override
	@Deprecated
	default Double2DoubleNavigableMap tailMap(Double fromKey) { return tailMap(fromKey.doubleValue(), true); }
}