 ...
 */
public class Double2ShortLinkedOpenHashMap extends Double2ShortOpenHashMap implements Double2ShortOrderedMap
{
	 ...
	 */
	public Double2ShortLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Double2ShortLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2ShortLinkedOpenHashMap(Double[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ShortLinkedOpenHashMap(Double[] keys, Short[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ShortLinkedOpenHashMap(Map<? extends Double, ? extends Short> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2ShortLinkedOpenHashMap(Double2ShortMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2ShortLinkedOpenHashMap(Double2ShortMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Double2ShortLinkedOpenHashMap copy() {
		Double2ShortLinkedOpenHashMap map = new Double2ShortLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2ShortMap.Entry> implements Double2ShortOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Double2ShortMap.Entry o) {
			return Double2ShortLinkedOpenHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2ShortMap.Entry o) {
			return Double2ShortLinkedOpenHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ShortMap.Entry) {
					...
					int index = Double2ShortLinkedOpenHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return entry.getShortValue() == Double2ShortLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Double2ShortLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Double2ShortLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ShortMap.Entry) {
					Double2ShortMap.Entry entry = (Double2ShortMap.Entry)o;
					return Double2ShortLinkedOpenHashMap.this.remove(entry.getDoubleKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2ShortLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2ShortLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2ShortLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2ShortLinkedOpenHashMap.this.moveToLast(o);
		}
