...
import speiger.src.collections.doubles.maps.interfaces.Double2BooleanConcurrentMap;
 ...
 * 
 */
public class Double2BooleanConcurrentOpenHashMap extends AbstractDouble2BooleanMap implements Double2BooleanConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Double2BooleanConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Double2BooleanConcurrentOpenHashMap() {
	 ...
	 */
	public Double2BooleanConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Double2BooleanConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2BooleanConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2BooleanConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2BooleanConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Double2BooleanConcurrentOpenHashMap(Double[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2BooleanConcurrentOpenHashMap(Double[] keys, Boolean[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2BooleanConcurrentOpenHashMap(Double[] keys, Boolean[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2BooleanConcurrentOpenHashMap(Double[] keys, Boolean[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Double2BooleanConcurrentOpenHashMap(Map<? extends Double, ? extends Boolean> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2BooleanConcurrentOpenHashMap(Map<? extends Double, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2BooleanConcurrentOpenHashMap(Map<? extends Double, ? extends Boolean> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2BooleanConcurrentOpenHashMap(Map<? extends Double, ? extends Boolean> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2BooleanConcurrentOpenHashMap(Double2BooleanMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2BooleanConcurrentOpenHashMap(Double2BooleanMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2BooleanConcurrentOpenHashMap(Double2BooleanMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2BooleanConcurrentOpenHashMap(Double2BooleanMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Double2BooleanConcurrentOpenHashMap copy() {
		Double2BooleanConcurrentOpenHashMap copy = new Double2BooleanConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2BooleanMap.Entry) {
					Double2BooleanMap.Entry entry = (Double2BooleanMap.Entry)o;
					return Double2BooleanConcurrentOpenHashMap.this.remove(entry.getDoubleKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2BooleanConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Double2BooleanConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Double2BooleanConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleSet {
		...
		public boolean remove(double o) {
			int oldSize = size();
			Double2BooleanConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2BooleanMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2BooleanMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Double2BooleanMap.Entry, Map.Entry<Double, Boolean> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Double2BooleanMap.Entry) {
					...
					return Double.doubleToLongBits(getDoubleKey()) == Double.doubleToLongBits(entry.getDoubleKey()) && getBooleanValue() == entry.getBooleanValue();
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Double && value instanceof Boolean && Double.doubleToLongBits(getDoubleKey()) == Double.doubleToLongBits(((Double)key).doubleValue()) && getBooleanValue() == ((Boolean)value).booleanValue();
			}
			return false;
		}
		...
		@Override
		public int hashCode() {
			return Double.hashCode(getDoubleKey()) ^ Boolean.hashCode(getBooleanValue());
		}
		
		@Override
		public String toString() {
			return Double.toString(getDoubleKey()) + "=" + Boolean.toString(getBooleanValue());
		}
	}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Double2BooleanConcurrentOpenHashMap map;
		...
		protected Segment(Double2BooleanConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Double2BooleanConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Double2BooleanConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected boolean put(int hash, double key, boolean value) {
		...
		protected boolean putIfAbsent(int hash, double key, boolean value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected boolean get(int hash, double key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean getOrDefault(int hash, double key, boolean defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(DoubleBooleanConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected boolean remove(int hash, double key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean removeOrDefault(int hash, double key, boolean defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, double key, boolean value) {
			long stamp = writeLock();
			try {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				double current = keys[pos];
				if(Double.doubleToLongBits(current) == 0) return false;
				if(Objects.equals(key, Double.valueOf(current)) && Objects.equals(value, Boolean.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if(Double.doubleToLongBits((current = keys[pos = (++pos & mask)])) == 0) return false;
					else if(Objects.equals(key, Double.valueOf(current)) && Objects.equals(value, Boolean.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, double key, boolean oldValue, boolean newValue) {
			long stamp = writeLock();
			try {
		...
		protected boolean replace(int hash, double key, boolean value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected boolean compute(int hash, double key, DoubleBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean computeIfAbsent(int hash, double key, Double2BooleanFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean supplyIfAbsent(int hash, double key, BooleanSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean computeIfPresent(int hash, double key, DoubleBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected boolean merge(int hash, double key, boolean value, BooleanBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected void insert(int slot, double key, boolean value) {
