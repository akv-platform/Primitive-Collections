...
import speiger.src.collections.doubles.maps.interfaces.Double2LongConcurrentMap;
 ...
 * 
 */
public class Double2LongConcurrentOpenHashMap extends AbstractDouble2LongMap implements Double2LongConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Double2LongConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Double2LongConcurrentOpenHashMap() {
	 ...
	 */
	public Double2LongConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Double2LongConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2LongConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2LongConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2LongConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Double2LongConcurrentOpenHashMap(Double[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2LongConcurrentOpenHashMap(Double[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2LongConcurrentOpenHashMap(Double[] keys, Long[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2LongConcurrentOpenHashMap(Double[] keys, Long[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Double2LongConcurrentOpenHashMap(Map<? extends Double, ? extends Long> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2LongConcurrentOpenHashMap(Map<? extends Double, ? extends Long> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2LongConcurrentOpenHashMap(Map<? extends Double, ? extends Long> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2LongConcurrentOpenHashMap(Map<? extends Double, ? extends Long> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2LongConcurrentOpenHashMap(Double2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2LongConcurrentOpenHashMap(Double2LongMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2LongConcurrentOpenHashMap(Double2LongMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2LongConcurrentOpenHashMap(Double2LongMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Double2LongConcurrentOpenHashMap copy() {
		Double2LongConcurrentOpenHashMap copy = new Double2LongConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2LongMap.Entry) {
					Double2LongMap.Entry entry = (Double2LongMap.Entry)o;
					return Double2LongConcurrentOpenHashMap.this.remove(entry.getDoubleKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2LongConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Double2LongConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Double2LongConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleSet {
		...
		public boolean remove(double o) {
			int oldSize = size();
			Double2LongConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2LongMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2LongMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Double2LongMap.Entry, Map.Entry<Double, Long> {
		...
		@Override
		public int hashCode() {
			return Double.hashCode(getDoubleKey()) ^ Long.hashCode(getLongValue());
		}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Double2LongConcurrentOpenHashMap map;
		...
		protected Segment(Double2LongConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Double2LongConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Double2LongConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected long put(int hash, double key, long value) {
		...
		protected long putIfAbsent(int hash, double key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected long addTo(int hash, double key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected long subFrom(int hash, double key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected long get(int hash, double key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected long getOrDefault(int hash, double key, long defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(DoubleLongConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected long remove(int hash, double key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected long removeOrDefault(int hash, double key, long defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, double key, long value) {
			long stamp = writeLock();
			try {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				double current = keys[pos];
				if(Double.doubleToLongBits(current) == 0) return false;
				if(Objects.equals(key, Double.valueOf(current)) && Objects.equals(value, Long.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if(Double.doubleToLongBits((current = keys[pos = (++pos & mask)])) == 0) return false;
					else if(Objects.equals(key, Double.valueOf(current)) && Objects.equals(value, Long.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, double key, long oldValue, long newValue) {
			long stamp = writeLock();
			try {
		...
		protected long replace(int hash, double key, long value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected long compute(int hash, double key, DoubleLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long computeIfAbsent(int hash, double key, Double2LongFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long supplyIfAbsent(int hash, double key, LongSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long computeIfPresent(int hash, double key, DoubleLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected long merge(int hash, double key, long value, LongLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
