...
public abstract class AbstractDouble2ByteMap extends AbstractMap<Double, Byte> implements Double2ByteMap
{
	...
	public void putAll(Double2ByteMap m) {
		for(ObjectIterator<Double2ByteMap.Entry> iter = Double2ByteMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBytes(DoubleByteUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Double2ByteMap.Entry> iter = Double2ByteMaps.fastIterator(this);iter.hasNext();) {
			Double2ByteMap.Entry entry = iter.next();
		...
		return new AbstractDoubleSet() {
			...
			public DoubleIterator iterator() {
				return new DoubleIterator() {
					ObjectIterator<Double2ByteMap.Entry> iter = Double2ByteMaps.fastIterator(AbstractDouble2ByteMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Double2ByteMap.Entry> iter = Double2ByteMaps.fastIterator(this);
