...
public abstract class AbstractDouble2ObjectMap<V> extends AbstractMap<Double, V> implements Double2ObjectMap<V>
{
	...
	public void putAll(Double2ObjectMap<V> m) {
		for(ObjectIterator<Double2ObjectMap.Entry<V>> iter = Double2ObjectMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceObjects(DoubleObjectUnaryOperator<V> mappingFunction) {
		...
		for(ObjectIterator<Double2ObjectMap.Entry<V>> iter = Double2ObjectMaps.fastIterator(this);iter.hasNext();) {
			Double2ObjectMap.Entry<V> entry = iter.next();
		...
		return new AbstractDoubleSet() {
			...
			public DoubleIterator iterator() {
				return new DoubleIterator() {
					ObjectIterator<Double2ObjectMap.Entry<V>> iter = Double2ObjectMaps.fastIterator(AbstractDouble2ObjectMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Double2ObjectMap.Entry<V>> iter = Double2ObjectMaps.fastIterator(this);
