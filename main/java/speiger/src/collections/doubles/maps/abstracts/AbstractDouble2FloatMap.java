...
public abstract class AbstractDouble2FloatMap extends AbstractMap<Double, Float> implements Double2FloatMap
{
	...
	public void putAll(Double2FloatMap m) {
		for(ObjectIterator<Double2FloatMap.Entry> iter = Double2FloatMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceFloats(DoubleFloatUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Double2FloatMap.Entry> iter = Double2FloatMaps.fastIterator(this);iter.hasNext();) {
			Double2FloatMap.Entry entry = iter.next();
		...
		return new AbstractDoubleSet() {
			...
			public DoubleIterator iterator() {
				return new DoubleIterator() {
					ObjectIterator<Double2FloatMap.Entry> iter = Double2FloatMaps.fastIterator(AbstractDouble2FloatMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Double2FloatMap.Entry> iter = Double2FloatMaps.fastIterator(this);
