...
public class IntAVLTreeSet extends AbstractIntSet implements IntNavigableSet
{
	 ...
	 */
	@Deprecated
	public IntAVLTreeSet(Collection<? extends Integer> collection, IntComparator comp) {
		comparator = comp;
		addAll(collection);
	}
	...
	{
		public AscendingSubSet(IntAVLTreeSet set, boolean fromStart, int lo, boolean loInclusive, boolean toEnd, int hi, boolean hiInclusive)
		{
	...
	static class DescendingSubSet extends SubSet
	{
		...
		public DescendingSubSet(IntAVLTreeSet set, boolean fromStart, int lo, boolean loInclusive, boolean toEnd, int hi, boolean hiInclusive)
		{
			super(set, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	{
		final IntAVLTreeSet set;
		final int lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		IntNavigableSet inverse;
		
		public SubSet(IntAVLTreeSet set, boolean fromStart, int lo, boolean loInclusive, boolean toEnd, int hi, boolean hiInclusive)
		{
			this.set = set;
			this.lo = lo;
			this.hi = hi;
