...
public class IntIterators
{
	 ...
	 */
	public static <E> ObjectIterator<E> map(Iterator<? extends Integer> iterator, Int2ObjectFunction<E> mapper) {
	 ...
	 * @return a iterator that is mapped to a new result
	 */
	public static <E> ObjectIterator<E> map(IntIterator iterator, Int2ObjectFunction<E> mapper) {
	 ...
	 */
	public static <E, V extends Iterable<E>> ObjectIterator<E> flatMap(Iterator<? extends Integer> iterator, Int2ObjectFunction<V> mapper) {
	 ...
	 * @return a iterator that is flatMapped to a new result
	 */
	public static <E, V extends Iterable<E>> ObjectIterator<E> flatMap(IntIterator iterator, Int2ObjectFunction<V> mapper) {
	 ...
	 * @return a iterator that is flatMapped to a new result
	 */
	public static <E> ObjectIterator<E> arrayFlatMap(Iterator<? extends Integer> iterator, Int2ObjectFunction<E[]> mapper) {
	 ...
	 * @return a iterator that is flatMapped to a new result
	 */
	public static <E> ObjectIterator<E> arrayFlatMap(IntIterator iterator, Int2ObjectFunction<E[]> mapper) {
	 ...
	 */
	public static IntIterator filter(Iterator<? extends Integer> iterator, Int2BooleanFunction filter) {
	 ...
	 * @return a filtered iterator
	 */
	public static IntIterator filter(IntIterator iterator, Int2BooleanFunction filter) {
	 ...
	 */
	public static IntList pour(IntIterator iter) {
	 ...
	 */
	public static IntList pour(IntIterator iter, int max) {
	...
	private static class MappedIterator<T> implements ObjectIterator<T>
	{
		...
		MappedIterator(IntIterator iterator, Int2ObjectFunction<T> mapper) {
			this.iterator = iterator;
			this.mapper = mapper;
		}
		...
		@Override
		public T next() {
			return mapper.get(iterator.nextInt());
		}
	...
	private static class FlatMappedIterator<T, V extends Iterable<T>> implements ObjectIterator<T>
	{
		...
		FlatMappedIterator(IntIterator iterator, Int2ObjectFunction<V> mapper) {
			this.iterator = iterator;
			this.mapper = mapper;
		}
		...
		void compute() {
			...
			while(iterator.hasNext()) {
				...
				last = mapper.get(iterator.nextInt()).iterator();
			}
		}
	...
	private static class FlatMappedArrayIterator<T> implements ObjectIterator<T>
	{
		...
		FlatMappedArrayIterator(IntIterator iterator, Int2ObjectFunction<T[]> mapper) {
			this.iterator = iterator;
			this.mapper = mapper;
		}
		...
		void compute() {
			...
			while(iterator.hasNext()) {
				if(last != null && last.hasNext()) return;
				last = ObjectIterators.wrap(mapper.get(iterator.nextInt()));
			}
		}
	...
	private static class SortedIterator implements IntIterator
	{
		...
		public boolean hasNext() {
			if(sortedElements == null) {
				...
				sortedElements = hasNext ? pour(iterator) : IntLists.empty();
	...
	private static class FilteredIterator implements IntIterator
	{
		...
		public FilteredIterator(IntIterator iterator, Int2BooleanFunction filter) {
			this.iterator = iterator;
			this.filter = filter;
		}
