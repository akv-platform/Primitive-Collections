...
public class Int2ShortMaps
{
	 ...
	 */
	public static Int2ShortMap.Entry unmodifiable(Int2ShortMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Int2ShortMap.Entry unmodifiable(Map.Entry<Integer, Short> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Int2ShortNavigableMap {
		...
		@Override
		public Int2ShortNavigableMap descendingMap() { return Int2ShortMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Int2ShortNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Int2ShortOrderedMap {
		...
		@Override
		public Int2ShortOrderedMap copy() { return map.copy(); }
		@Override
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Int2ShortSortedMap {
		...
		public short lastShortValue() { return map.lastShortValue(); }
		@Override
		public Int2ShortSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractInt2ShortMap implements Int2ShortMap {
		...
		public void mergeAllShort(Int2ShortMap m, ShortShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(IntShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(Int2ShortMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Int2ShortMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Int2ShortMap.Entry>
	{
		ObjectOrderedSet<Int2ShortMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Int2ShortMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Int2ShortMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Int2ShortMap.Entry first() { return set.first(); }
		@Override
		public Int2ShortMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Int2ShortMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Int2ShortNavigableMap {
		...
		@Override
		public Int2ShortMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Int2ShortNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Int2ShortOrderedMap {
		...
		@Override
		public Int2ShortOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public IntOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Int2ShortSortedMap {
		...
		public short lastShortValue() { synchronized(mutex) { return map.lastShortValue(); } }
		@Override
		public Int2ShortSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractInt2ShortMap implements Int2ShortMap {
		...
		@Override
		public short supplyShortIfAbsent(int key, ShortSupplier valueProvider) { synchronized(mutex) { return map.supplyShortIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Int2ShortMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public IntSet keySet() {
			if(keys == null) keys = IntSets.synchronize(map.keySet(), mutex);
			return keys;
