...
public abstract class AbstractInt2FloatMap extends AbstractMap<Integer, Float> implements Int2FloatMap
{
	...
	public void putAll(Int2FloatMap m) {
		for(ObjectIterator<Int2FloatMap.Entry> iter = Int2FloatMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceFloats(IntFloatUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Int2FloatMap.Entry> iter = Int2FloatMaps.fastIterator(this);iter.hasNext();) {
			Int2FloatMap.Entry entry = iter.next();
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					ObjectIterator<Int2FloatMap.Entry> iter = Int2FloatMaps.fastIterator(AbstractInt2FloatMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Int2FloatMap.Entry> iter = Int2FloatMaps.fastIterator(this);
