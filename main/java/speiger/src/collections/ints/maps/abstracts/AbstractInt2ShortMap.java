...
public abstract class AbstractInt2ShortMap extends AbstractMap<Integer, Short> implements Int2ShortMap
{
	...
	public void putAll(Int2ShortMap m) {
		for(ObjectIterator<Int2ShortMap.Entry> iter = Int2ShortMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceShorts(IntShortUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Int2ShortMap.Entry> iter = Int2ShortMaps.fastIterator(this);iter.hasNext();) {
			Int2ShortMap.Entry entry = iter.next();
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					ObjectIterator<Int2ShortMap.Entry> iter = Int2ShortMaps.fastIterator(AbstractInt2ShortMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Int2ShortMap.Entry> iter = Int2ShortMaps.fastIterator(this);
