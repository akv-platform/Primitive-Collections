...
public abstract class AbstractInt2ByteMap extends AbstractMap<Integer, Byte> implements Int2ByteMap
{
	...
	public void putAll(Int2ByteMap m) {
		for(ObjectIterator<Int2ByteMap.Entry> iter = Int2ByteMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBytes(IntByteUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Int2ByteMap.Entry> iter = Int2ByteMaps.fastIterator(this);iter.hasNext();) {
			Int2ByteMap.Entry entry = iter.next();
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					ObjectIterator<Int2ByteMap.Entry> iter = Int2ByteMaps.fastIterator(AbstractInt2ByteMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Int2ByteMap.Entry> iter = Int2ByteMaps.fastIterator(this);
