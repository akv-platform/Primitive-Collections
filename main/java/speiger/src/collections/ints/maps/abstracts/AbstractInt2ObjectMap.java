...
public abstract class AbstractInt2ObjectMap<V> extends AbstractMap<Integer, V> implements Int2ObjectMap<V>
{
	...
	public void putAll(Int2ObjectMap<V> m) {
		for(ObjectIterator<Int2ObjectMap.Entry<V>> iter = Int2ObjectMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceObjects(IntObjectUnaryOperator<V> mappingFunction) {
		...
		for(ObjectIterator<Int2ObjectMap.Entry<V>> iter = Int2ObjectMaps.fastIterator(this);iter.hasNext();) {
			Int2ObjectMap.Entry<V> entry = iter.next();
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					ObjectIterator<Int2ObjectMap.Entry<V>> iter = Int2ObjectMaps.fastIterator(AbstractInt2ObjectMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Int2ObjectMap.Entry<V>> iter = Int2ObjectMaps.fastIterator(this);
