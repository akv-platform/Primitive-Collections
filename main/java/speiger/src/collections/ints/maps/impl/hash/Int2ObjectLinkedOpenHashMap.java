 ...
 */
public class Int2ObjectLinkedOpenHashMap<V> extends Int2ObjectOpenHashMap<V> implements Int2ObjectOrderedMap<V>
{
	 ...
	 */
	public Int2ObjectLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Int2ObjectLinkedOpenHashMap(Integer[] keys, V[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ObjectLinkedOpenHashMap(Integer[] keys, V[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2ObjectLinkedOpenHashMap(int[] keys, V[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ObjectLinkedOpenHashMap(int[] keys, V[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ObjectLinkedOpenHashMap(Map<? extends Integer, ? extends V> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Int2ObjectLinkedOpenHashMap(Int2ObjectMap<V> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2ObjectLinkedOpenHashMap(Int2ObjectMap<V> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Int2ObjectLinkedOpenHashMap<V> copy() {
		Int2ObjectLinkedOpenHashMap<V> map = new Int2ObjectLinkedOpenHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectOrderedMap.FastOrderedSet<V> {
		...
		public boolean moveToFirst(Int2ObjectMap.Entry<V> o) {
			return Int2ObjectLinkedOpenHashMap.this.moveToFirst(o.getIntKey());
		}
		
		@Override
		public boolean moveToLast(Int2ObjectMap.Entry<V> o) {
			return Int2ObjectLinkedOpenHashMap.this.moveToLast(o.getIntKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2ObjectMap.Entry) {
					...
					int index = Int2ObjectLinkedOpenHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Int2ObjectLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Int2ObjectLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Int2ObjectLinkedOpenHashMap.this.values[index]);
				}
			}
			return false;
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2ObjectMap.Entry) {
					Int2ObjectMap.Entry<V> entry = (Int2ObjectMap.Entry<V>)o;
					return Int2ObjectLinkedOpenHashMap.this.remove(entry.getIntKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2ObjectLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractIntSet implements IntOrderedSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2ObjectLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(int o) {
			return Int2ObjectLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(int o) {
			return Int2ObjectLinkedOpenHashMap.this.moveToLast(o);
		}
