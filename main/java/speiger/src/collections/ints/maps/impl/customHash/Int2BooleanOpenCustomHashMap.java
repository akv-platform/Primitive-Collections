 ...
 */
public class Int2BooleanOpenCustomHashMap extends AbstractInt2BooleanMap implements ITrimmable
{
	 ...
	 */
	public Int2BooleanOpenCustomHashMap(IntStrategy strategy) {
	 ...
	 */
	public Int2BooleanOpenCustomHashMap(int minCapacity, IntStrategy strategy) {
	 ...
	 */
	public Int2BooleanOpenCustomHashMap(int minCapacity, float loadFactor, IntStrategy strategy) {
	 ...
	 */
	public Int2BooleanOpenCustomHashMap(Integer[] keys, Boolean[] values, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2BooleanOpenCustomHashMap(Integer[] keys, Boolean[] values, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2BooleanOpenCustomHashMap(int[] keys, boolean[] values, IntStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2BooleanOpenCustomHashMap(int[] keys, boolean[] values, float loadFactor, IntStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2BooleanOpenCustomHashMap(Map<? extends Integer, ? extends Boolean> map, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2BooleanOpenCustomHashMap(Map<? extends Integer, ? extends Boolean> map, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2BooleanOpenCustomHashMap(Int2BooleanMap map, IntStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2BooleanOpenCustomHashMap(Int2BooleanMap map, float loadFactor, IntStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(!strategy.equals(keys[i], 0) && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Boolean.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Int2BooleanOpenCustomHashMap copy() {
		Int2BooleanOpenCustomHashMap map = new Int2BooleanOpenCustomHashMap(0, loadFactor, strategy);
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2BooleanMap.Entry> implements Int2BooleanMap.FastEntrySet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2BooleanMap.Entry) {
					...
					int index = Int2BooleanOpenCustomHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getBooleanValue() == Int2BooleanOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Integer)) return false;
					int index = Int2BooleanOpenCustomHashMap.this.findIndex((Integer)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Int2BooleanOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2BooleanMap.Entry) {
					Int2BooleanMap.Entry entry = (Int2BooleanMap.Entry)o;
					return Int2BooleanOpenCustomHashMap.this.remove(entry.getIntKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2BooleanOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractIntSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2BooleanOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Int2BooleanOpenCustomHashMap.this.remove(wrapped.getInt(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
