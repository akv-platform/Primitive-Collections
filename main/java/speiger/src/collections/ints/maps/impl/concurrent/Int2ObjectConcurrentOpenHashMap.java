...
import speiger.src.collections.ints.maps.interfaces.Int2ObjectConcurrentMap;
 ...
 */
public class Int2ObjectConcurrentOpenHashMap<V> extends AbstractInt2ObjectMap<V> implements Int2ObjectConcurrentMap<V>, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Int2ObjectConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Int2ObjectConcurrentOpenHashMap() {
	 ...
	 */
	public Int2ObjectConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Int2ObjectConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Int2ObjectConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ObjectConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ObjectConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Int2ObjectConcurrentOpenHashMap(Integer[] keys, V[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ObjectConcurrentOpenHashMap(Integer[] keys, V[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ObjectConcurrentOpenHashMap(Integer[] keys, V[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ObjectConcurrentOpenHashMap(Integer[] keys, V[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2ObjectConcurrentOpenHashMap(int[] keys, V[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ObjectConcurrentOpenHashMap(int[] keys, V[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ObjectConcurrentOpenHashMap(int[] keys, V[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ObjectConcurrentOpenHashMap(int[] keys, V[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Int2ObjectConcurrentOpenHashMap(Map<? extends Integer, ? extends V> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ObjectConcurrentOpenHashMap(Map<? extends Integer, ? extends V> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ObjectConcurrentOpenHashMap(Map<? extends Integer, ? extends V> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ObjectConcurrentOpenHashMap(Map<? extends Integer, ? extends V> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Int2ObjectConcurrentOpenHashMap(Int2ObjectMap<V> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2ObjectConcurrentOpenHashMap(Int2ObjectMap<V> map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Int2ObjectConcurrentOpenHashMap(Int2ObjectMap<V> map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Int2ObjectConcurrentOpenHashMap(Int2ObjectMap<V> map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Int2ObjectConcurrentOpenHashMap<V> copy() {
		Int2ObjectConcurrentOpenHashMap<V> copy = new Int2ObjectConcurrentOpenHashMap<>(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V> {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2ObjectMap.Entry) {
					Int2ObjectMap.Entry<V> entry = (Int2ObjectMap.Entry<V>)o;
					return Int2ObjectConcurrentOpenHashMap.this.remove(entry.getIntKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2ObjectConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Int2ObjectConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Int2ObjectConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet implements IntSet {
		...
		public boolean remove(int o) {
			int oldSize = size();
			Int2ObjectConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> {
		MapEntry entry;
	...
	protected class MapEntry implements Int2ObjectMap.Entry<V>, Map.Entry<Integer, V> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Int2ObjectMap.Entry) {
					...
					return getIntKey() == entry.getIntKey() && Objects.equals(getValue(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Integer && getIntKey() == ((Integer)key).intValue() && Objects.equals(getValue(), value);
			}
			return false;
		}
		...
		public String toString() {
			return Integer.toString(getIntKey()) + "=" + Objects.toString(getValue());
		}
	}
	...
	protected static class Segment<V> extends StampedLock
	{
		...
		protected final Int2ObjectConcurrentOpenHashMap<V> map;
		...
		protected Segment(Int2ObjectConcurrentOpenHashMap<V> map) {
			this.map = map;
		}
		
		protected Segment(Int2ObjectConcurrentOpenHashMap<V> map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment<V> copy(Int2ObjectConcurrentOpenHashMap<V> newMap) {
			long stamp = readLock();
			try
			{
		...
		protected V put(int hash, int key, V value) {
		...
		protected V putIfAbsent(int hash, int key, V value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected V get(int hash, int key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected V getOrDefault(int hash, int key, V defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(IntObjectConsumer<V> action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected V remove(int hash, int key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected V removeOrDefault(int hash, int key, V defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, int key, V value) {
			long stamp = writeLock();
			try {
				if(key == 0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				int current = keys[pos];
				if(current == 0) return false;
				if(Objects.equals(key, Integer.valueOf(current)) && Objects.equals(value, values[pos])) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == 0) return false;
					else if(Objects.equals(key, Integer.valueOf(current)) && Objects.equals(value, values[pos])){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, int key, V oldValue, V newValue) {
			long stamp = writeLock();
			try {
		...
		protected V replace(int hash, int key, V value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected V compute(int hash, int key, IntObjectUnaryOperator<V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected V computeIfAbsent(int hash, int key, Int2ObjectFunction<V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected V merge(int hash, int key, V value, ObjectObjectUnaryOperator<V, V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
