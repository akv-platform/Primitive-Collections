...
import speiger.src.collections.ints.maps.interfaces.Int2IntConcurrentMap;
 ...
 * 
 */
public class Int2IntConcurrentOpenHashMap extends AbstractInt2IntMap implements Int2IntConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Int2IntConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Int2IntConcurrentOpenHashMap() {
	 ...
	 */
	public Int2IntConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Int2IntConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Int2IntConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2IntConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2IntConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Int2IntConcurrentOpenHashMap(Integer[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2IntConcurrentOpenHashMap(Integer[] keys, Integer[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2IntConcurrentOpenHashMap(Integer[] keys, Integer[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2IntConcurrentOpenHashMap(Integer[] keys, Integer[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2IntConcurrentOpenHashMap(int[] keys, int[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2IntConcurrentOpenHashMap(int[] keys, int[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2IntConcurrentOpenHashMap(int[] keys, int[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2IntConcurrentOpenHashMap(int[] keys, int[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Int2IntConcurrentOpenHashMap(Map<? extends Integer, ? extends Integer> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2IntConcurrentOpenHashMap(Map<? extends Integer, ? extends Integer> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2IntConcurrentOpenHashMap(Map<? extends Integer, ? extends Integer> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2IntConcurrentOpenHashMap(Map<? extends Integer, ? extends Integer> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Int2IntConcurrentOpenHashMap(Int2IntMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2IntConcurrentOpenHashMap(Int2IntMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Int2IntConcurrentOpenHashMap(Int2IntMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Int2IntConcurrentOpenHashMap(Int2IntMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	public Integer get(Object key) {
		int hash = getHashCode(key);
		return Integer.valueOf(getSegment(hash).get(hash, key));
	}
	...
	@Override
	public Int2IntConcurrentOpenHashMap copy() {
		Int2IntConcurrentOpenHashMap copy = new Int2IntConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements Int2IntMap.FastEntrySet {
		@Override
		...
		@Override
		public boolean matchesAny(Object2BooleanFunction<Int2IntMap.Entry> filter) {
		...
		@Override
		public boolean matchesNone(Object2BooleanFunction<Int2IntMap.Entry> filter) {
			Objects.requireNonNull(filter);
			BasicEntry entry = new BasicEntry();
			for(int i = 0,m=segments.length;i<m;i++) {
				Segment seg = segments[i];
		...
		@Override
		public boolean matchesAll(Object2BooleanFunction<Int2IntMap.Entry> filter) {
			Objects.requireNonNull(filter);
			BasicEntry entry = new BasicEntry();
			for(int i = 0,m=segments.length;i<m;i++) {
				Segment seg = segments[i];
		...
		@Override
		public Int2IntMap.Entry findFirst(Object2BooleanFunction<Int2IntMap.Entry> filter) {
			Objects.requireNonNull(filter);
			BasicEntry entry = new BasicEntry();
			for(int i = 0,m=segments.length;i<m;i++) {
				Segment seg = segments[i];
		...
		@Override
		public int count(Object2BooleanFunction<Int2IntMap.Entry> filter) {
			Objects.requireNonNull(filter);
			int result = 0;
			BasicEntry entry = new BasicEntry();
			for(int i = 0,m=segments.length;i<m;i++) {
			...
			if(o instanceof Map.Entry) {
				if(o instanceof Int2IntMap.Entry) {
					...
					try {
						...
						if(index >= 0) return entry.getIntValue() == seg.values[index];
					}
					finally {
						seg.unlockRead(stamp);
					}
					...
					try {
						...
						if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(seg.values[index]));						
					}
					finally {
						seg.unlockRead(stamp);
					}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2IntMap.Entry) {
					Int2IntMap.Entry entry = (Int2IntMap.Entry)o;
					return Int2IntConcurrentOpenHashMap.this.remove(entry.getIntKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2IntConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Int2IntConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Int2IntConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet implements IntSet {
		...
		public boolean remove(int o) {
			int oldSize = size();
			Int2IntConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
		...
		public int reduce(int identity, IntIntUnaryOperator operator) {
			...
			for(int i = 0,m=segments.length;i<m;i++) {
				...
				try {
					int index = seg.firstIndex;
					while(index != -1) {
						state = operator.applyAsInt(state, seg.values[index]);
						index = (int)seg.links[index];
					}
				}
				finally {
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Int2IntMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Int2IntMap.Entry> {
		MapEntry entry;
	...
	private class ValueIterator extends MapIterator implements IntBidirectionalIterator {
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Int2IntConcurrentOpenHashMap map;
		...
		protected Segment(Int2IntConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Int2IntConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Int2IntConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected int getDefaultReturnValue() {
			return map.getDefaultReturnValue();
		}
		
		protected int put(int hash, int key, int value) {
		...
		protected int putIfAbsent(int hash, int key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected int addTo(int hash, int key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected int subFrom(int hash, int key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected int get(int hash, int key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected int get(int hash, Object key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
				return slot < 0 ? getDefaultReturnValue() : values[slot];	
		...
		protected int getOrDefault(int hash, int key, int defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(IntIntConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected int remove(int hash, int key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected int removeOrDefault(int hash, int key, int defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected Integer remove(int hash, Object key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return Integer.valueOf(getDefaultReturnValue());
				return Integer.valueOf(removeIndex(slot));
			}
			finally {
				unlockWrite(stamp);
			}
		...
		protected boolean remove(int hash, int key, int value) {
			long stamp = writeLock();
			try {
				if(key == 0) {
		...
		protected boolean replace(int hash, int key, int oldValue, int newValue) {
			long stamp = writeLock();
			try {
		...
		protected int replace(int hash, int key, int value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected int compute(int hash, int key, IntIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int computeIfAbsent(int hash, int key, Int2IntFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int supplyIfAbsent(int hash, int key, IntSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int computeIfPresent(int hash, int key, IntIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected int merge(int hash, int key, int value, IntIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
