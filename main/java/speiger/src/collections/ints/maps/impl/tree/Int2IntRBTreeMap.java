 ...
 */
public class Int2IntRBTreeMap extends AbstractInt2IntMap implements Int2IntNavigableMap
{
	...
	/** EntrySet Cache */
	protected ObjectSet<Int2IntMap.Entry> entrySet;
	 ...
	 */
	public Int2IntRBTreeMap(IntComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Int2IntRBTreeMap(Integer[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2IntRBTreeMap(Integer[] keys, Integer[] values, IntComparator comp) {
		comparator = comp;
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2IntRBTreeMap(int[] keys, int[] values) {
		this(keys, values, null);
	}
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2IntRBTreeMap(int[] keys, int[] values, IntComparator comp) {
		comparator = comp;
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Int2IntRBTreeMap(Map<? extends Integer, ? extends Integer> map, IntComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Int2IntRBTreeMap(Int2IntMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Int2IntRBTreeMap(Int2IntMap map, IntComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Int2IntRBTreeMap copy() {
		Int2IntRBTreeMap set = new Int2IntRBTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	@Override
	public Int2IntNavigableMap headMap(int toKey, boolean inclusive) {
		return new AscendingNaivgableSubMap(this, true, 0, true, false, toKey, inclusive);
	}
	
	@Override
	public Int2IntNavigableMap tailMap(int fromKey, boolean inclusive) {
	...
	@Override
	public Int2IntMap.Entry lowerEntry(int key) {
		Node node = findLowerNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Int2IntMap.Entry higherEntry(int key) {
		Node node = findHigherNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Int2IntMap.Entry floorEntry(int key) {
		Node node = findFloorNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Int2IntMap.Entry ceilingEntry(int key) {
	...
	static class KeySet extends AbstractIntSet implements IntNavigableSet
	{
		...
		public KeySet(Int2IntNavigableMap map) {
			this.map = map;
		}
		...
		public Integer lower(Integer e) {
			Int2IntMap.Entry node = map.lowerEntry(e.intValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Integer floor(Integer e) {
			Int2IntMap.Entry node = map.floorEntry(e.intValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Integer higher(Integer e) {
			Int2IntMap.Entry node = map.higherEntry(e.intValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Integer ceiling(Integer e) {
			Int2IntMap.Entry node = map.ceilingEntry(e.intValue());
			return node != null ? node.getKey() : null;
		}
		...
		public IntBidirectionalIterator iterator(int fromElement) {
			if(map instanceof Int2IntRBTreeMap) return ((Int2IntRBTreeMap)map).keyIterator(fromElement);
		...
		public IntBidirectionalIterator iterator() {
			if(map instanceof Int2IntRBTreeMap) return ((Int2IntRBTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public IntBidirectionalIterator descendingIterator() {
			if(map instanceof Int2IntRBTreeMap) return ((Int2IntRBTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Int2IntRBTreeMap) return ((Int2IntRBTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Int2IntRBTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Int2IntRBTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Int2IntRBTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Int2IntRBTreeMap map, boolean fromStart, int lo, boolean loInclusive, boolean toEnd, int hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Int2IntRBTreeMap map, boolean fromStart, int lo, boolean loInclusive, boolean toEnd, int hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractInt2IntMap implements Int2IntNavigableMap
	{
		final Int2IntRBTreeMap map;
		final int lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		
		Int2IntNavigableMap inverse;
		IntNavigableSet keySet;
		ObjectSet<Int2IntMap.Entry> entrySet;
		IntCollection values;
		
		NavigableSubMap(Int2IntRBTreeMap map, boolean fromStart, int lo, boolean loInclusive, boolean toEnd, int hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
		...
		@Override
		public Int2IntMap.Entry lowerEntry(int key) { return subLower(key); }
		@Override
		public Int2IntMap.Entry floorEntry(int key) { return subFloor(key); }
		@Override
		public Int2IntMap.Entry ceilingEntry(int key) { return subCeiling(key); }
		@Override
		public Int2IntMap.Entry higherEntry(int key) { return subHigher(key); }
		...
		public Int2IntMap.Entry pollFirstEntry() {
			Node entry = subLowest();
			if(entry != null) {
				Int2IntMap.Entry result = entry.export();
				map.removeNode(entry);
				return result;
			}
			return null;
		...
		abstract class SubEntrySet extends AbstractObjectSet<Int2IntMap.Entry> {
			@Override
			public int size() {
				if (fromStart && toEnd) return map.size();
				int size = 0;
				for(ObjectIterator<Int2IntMap.Entry> iter = iterator();iter.hasNext();iter.next(),size++);
				return size;
			}
		...
		class DecsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Int2IntMap.Entry>
		{
		...
		class AcsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Int2IntMap.Entry>
		{
	...
	class Values extends AbstractIntCollection
	{
		...
		@Override
		public int size() {
			return Int2IntRBTreeMap.this.size;
		}
	...
	class EntrySet extends AbstractObjectSet<Int2IntMap.Entry> {
	...
	class AscendingMapEntryIterator extends MapEntryIterator implements ObjectBidirectionalIterator<Int2IntMap.Entry>
	{
	...
	private static final class Node implements Int2IntMap.Entry
	{
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				...
				return otherKey instanceof Integer && otherValue instanceof Integer && key == ((Integer)otherKey).intValue() && value == ((Integer)otherValue).intValue();
			}
			return false;
		}
