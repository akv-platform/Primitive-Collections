...
{
	@Override
	public Int2CharNavigableMap copy();
	 ...
	 */
	public default Int2CharNavigableMap synchronize() { return Int2CharMaps.synchronize(this); }
	 ...
	 * @see Int2CharMaps#synchronize
	 */
	public default Int2CharNavigableMap synchronize(Object mutex) { return Int2CharMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Int2CharNavigableMap unmodifiable() { return Int2CharMaps.unmodifiable(this); }
	...
	@Override
	public default Int2CharNavigableMap subMap(int fromKey, int toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Int2CharNavigableMap headMap(int toKey) { return headMap(toKey, false); }
	@Override
	public default Int2CharNavigableMap tailMap(int fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Int2CharMap.Entry lowerEntry(Integer key) { return lowerEntry(key.intValue()); }
	@Override
	@Deprecated
	default Int2CharMap.Entry floorEntry(Integer key) { return floorEntry(key.intValue()); }
	@Override
	@Deprecated
	default Int2CharMap.Entry ceilingEntry(Integer key) { return ceilingEntry(key.intValue()); }
	@Override
	@Deprecated
	default Int2CharMap.Entry higherEntry(Integer key) { return higherEntry(key.intValue()); }
	
	@Override
	@Deprecated
	default Int2CharNavigableMap subMap(Integer fromKey, boolean fromInclusive, Integer toKey, boolean toInclusive) { return subMap(fromKey.intValue(), fromInclusive, toKey.intValue(), toInclusive); }
	@Override
	@Deprecated
	default Int2CharNavigableMap headMap(Integer toKey, boolean inclusive) { return headMap(toKey.intValue(), inclusive); }
	@Override
	@Deprecated
	default Int2CharNavigableMap tailMap(Integer fromKey, boolean inclusive) { return tailMap(fromKey.intValue(), inclusive); }
	@Override
	@Deprecated
	default Int2CharNavigableMap subMap(Integer fromKey, Integer toKey) { return subMap(fromKey.intValue(), true, toKey.intValue(), false); }
	@Override
	@Deprecated
	default Int2CharNavigableMap headMap(Integer toKey) { return headMap(toKey.intValue(), false); }
	@Override
	@Deprecated
	default Int2CharNavigableMap tailMap(Integer fromKey) { return tailMap(fromKey.intValue(), true); }
}