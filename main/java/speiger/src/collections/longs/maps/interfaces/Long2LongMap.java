...
public interface Long2LongMap extends Map<Long, Long>, Long2LongFunction
{
	...
	public default Long computeIfAbsent(Long key, Function<? super Long, ? extends Long> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return Long.valueOf(computeLongIfAbsent(key.longValue(), mappingFunction instanceof Long2LongFunction ? (Long2LongFunction)mappingFunction : K -> mappingFunction.apply(Long.valueOf(K)).longValue()));
	}
