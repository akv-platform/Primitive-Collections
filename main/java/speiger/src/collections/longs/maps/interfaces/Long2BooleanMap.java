...
public interface Long2BooleanMap extends Map<Long, Boolean>, Long2BooleanFunction
{
	...
	public default Boolean computeIfAbsent(Long key, Function<? super Long, ? extends Boolean> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return Boolean.valueOf(computeBooleanIfAbsent(key.longValue(), mappingFunction instanceof Long2BooleanFunction ? (Long2BooleanFunction)mappingFunction : K -> mappingFunction.apply(Long.valueOf(K)).booleanValue()));
	}
