 ...
 */
public class Long2FloatAVLTreeMap extends AbstractLong2FloatMap implements Long2FloatNavigableMap
{
	 ...
	 */
	public Long2FloatAVLTreeMap(LongComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Long2FloatAVLTreeMap(Long[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Long2FloatAVLTreeMap(Long[] keys, Float[] values, LongComparator comp) {
		comparator = comp;
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Long2FloatAVLTreeMap(Map<? extends Long, ? extends Float> map, LongComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2FloatAVLTreeMap(Long2FloatMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Long2FloatAVLTreeMap(Long2FloatMap map, LongComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Long2FloatAVLTreeMap copy() {
		Long2FloatAVLTreeMap set = new Long2FloatAVLTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	static class KeySet extends AbstractLongSet implements LongNavigableSet
	{
		...
		public Long lower(Long e) {
			Long2FloatMap.Entry node = map.lowerEntry(e.longValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Long floor(Long e) {
			Long2FloatMap.Entry node = map.floorEntry(e.longValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Long higher(Long e) {
			Long2FloatMap.Entry node = map.higherEntry(e.longValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Long ceiling(Long e) {
			Long2FloatMap.Entry node = map.ceilingEntry(e.longValue());
			return node != null ? node.getKey() : null;
		}
		...
		public LongBidirectionalIterator iterator(long fromElement) {
			if(map instanceof Long2FloatAVLTreeMap) return ((Long2FloatAVLTreeMap)map).keyIterator(fromElement);
		...
		public LongBidirectionalIterator iterator() {
			if(map instanceof Long2FloatAVLTreeMap) return ((Long2FloatAVLTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public LongBidirectionalIterator descendingIterator() {
			if(map instanceof Long2FloatAVLTreeMap) return ((Long2FloatAVLTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Long2FloatAVLTreeMap) return ((Long2FloatAVLTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Long2FloatAVLTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Long2FloatAVLTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Long2FloatAVLTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Long2FloatAVLTreeMap map, boolean fromStart, long lo, boolean loInclusive, boolean toEnd, long hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Long2FloatAVLTreeMap map, boolean fromStart, long lo, boolean loInclusive, boolean toEnd, long hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	{
		final Long2FloatAVLTreeMap map;
		final long lo, hi;
		...
		NavigableSubMap(Long2FloatAVLTreeMap map, boolean fromStart, long lo, boolean loInclusive, boolean toEnd, long hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
	...
	class Values extends AbstractFloatCollection
	{
		...
		@Override
		public int size() {
			return Long2FloatAVLTreeMap.this.size;
		}
