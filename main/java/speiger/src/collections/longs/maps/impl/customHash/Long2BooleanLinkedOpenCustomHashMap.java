 ...
 */
public class Long2BooleanLinkedOpenCustomHashMap extends Long2BooleanOpenCustomHashMap implements Long2BooleanOrderedMap
{
	 ...
	 */
	public Long2BooleanLinkedOpenCustomHashMap(LongStrategy strategy) {
	 ...
	 */
	public Long2BooleanLinkedOpenCustomHashMap(int minCapacity, LongStrategy strategy) {
	 ...
	 */
	public Long2BooleanLinkedOpenCustomHashMap(int minCapacity, float loadFactor, LongStrategy strategy) {
	 ...
	 */
	public Long2BooleanLinkedOpenCustomHashMap(Long[] keys, Boolean[] values, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2BooleanLinkedOpenCustomHashMap(Long[] keys, Boolean[] values, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Long2BooleanLinkedOpenCustomHashMap(Map<? extends Long, ? extends Boolean> map, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2BooleanLinkedOpenCustomHashMap(Map<? extends Long, ? extends Boolean> map, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Long2BooleanLinkedOpenCustomHashMap(Long2BooleanMap map, LongStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2BooleanLinkedOpenCustomHashMap(Long2BooleanMap map, float loadFactor, LongStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Long2BooleanLinkedOpenCustomHashMap copy() {
		Long2BooleanLinkedOpenCustomHashMap map = new Long2BooleanLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2BooleanMap.Entry> implements Long2BooleanOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2BooleanMap.Entry o) {
			return Long2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2BooleanMap.Entry o) {
			return Long2BooleanLinkedOpenCustomHashMap.this.moveToLast(o.getLongKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2BooleanMap.Entry) {
					...
					int index = Long2BooleanLinkedOpenCustomHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getBooleanValue() == Long2BooleanLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Long)) return false;
					int index = Long2BooleanLinkedOpenCustomHashMap.this.findIndex((Long)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Long2BooleanLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2BooleanMap.Entry) {
					Long2BooleanMap.Entry entry = (Long2BooleanMap.Entry)o;
					return Long2BooleanLinkedOpenCustomHashMap.this.remove(entry.getLongKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2BooleanLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2BooleanLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2BooleanLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2BooleanLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2BooleanLinkedOpenCustomHashMap.this.moveToLast(o);
		}
