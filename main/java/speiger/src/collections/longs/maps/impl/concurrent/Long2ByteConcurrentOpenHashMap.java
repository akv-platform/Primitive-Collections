...
import speiger.src.collections.longs.maps.interfaces.Long2ByteConcurrentMap;
 ...
 * 
 */
public class Long2ByteConcurrentOpenHashMap extends AbstractLong2ByteMap implements Long2ByteConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Long2ByteConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Long2ByteConcurrentOpenHashMap() {
	 ...
	 */
	public Long2ByteConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Long2ByteConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2ByteConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2ByteConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2ByteConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Long2ByteConcurrentOpenHashMap(Long[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ByteConcurrentOpenHashMap(Long[] keys, Byte[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2ByteConcurrentOpenHashMap(Long[] keys, Byte[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2ByteConcurrentOpenHashMap(Long[] keys, Byte[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Long2ByteConcurrentOpenHashMap(Map<? extends Long, ? extends Byte> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ByteConcurrentOpenHashMap(Map<? extends Long, ? extends Byte> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2ByteConcurrentOpenHashMap(Map<? extends Long, ? extends Byte> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2ByteConcurrentOpenHashMap(Map<? extends Long, ? extends Byte> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2ByteConcurrentOpenHashMap(Long2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2ByteConcurrentOpenHashMap(Long2ByteMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2ByteConcurrentOpenHashMap(Long2ByteMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2ByteConcurrentOpenHashMap(Long2ByteMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Long2ByteConcurrentOpenHashMap copy() {
		Long2ByteConcurrentOpenHashMap copy = new Long2ByteConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2ByteMap.Entry) {
					Long2ByteMap.Entry entry = (Long2ByteMap.Entry)o;
					return Long2ByteConcurrentOpenHashMap.this.remove(entry.getLongKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2ByteConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2ByteConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2ByteConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongSet {
		...
		public boolean remove(long o) {
			int oldSize = size();
			Long2ByteConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2ByteMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2ByteMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Long2ByteMap.Entry, Map.Entry<Long, Byte> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Long2ByteMap.Entry) {
					...
					return getLongKey() == entry.getLongKey() && getByteValue() == entry.getByteValue();
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Long && value instanceof Byte && getLongKey() == ((Long)key).longValue() && getByteValue() == ((Byte)value).byteValue();
			}
			return false;
		}
		...
		@Override
		public int hashCode() {
			return Long.hashCode(getLongKey()) ^ Byte.hashCode(getByteValue());
		}
		
		@Override
		public String toString() {
			return Long.toString(getLongKey()) + "=" + Byte.toString(getByteValue());
		}
	}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Long2ByteConcurrentOpenHashMap map;
		...
		protected Segment(Long2ByteConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Long2ByteConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Long2ByteConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected byte put(int hash, long key, byte value) {
		...
		protected byte putIfAbsent(int hash, long key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected byte addTo(int hash, long key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected byte subFrom(int hash, long key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected byte get(int hash, long key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected byte getOrDefault(int hash, long key, byte defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(LongByteConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected byte remove(int hash, long key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected byte removeOrDefault(int hash, long key, byte defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, long key, byte value) {
			long stamp = writeLock();
			try {
				if(key == 0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				long current = keys[pos];
				if(current == 0) return false;
				if(Objects.equals(key, Long.valueOf(current)) && Objects.equals(value, Byte.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == 0) return false;
					else if(Objects.equals(key, Long.valueOf(current)) && Objects.equals(value, Byte.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, long key, byte oldValue, byte newValue) {
			long stamp = writeLock();
			try {
		...
		protected byte replace(int hash, long key, byte value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected byte compute(int hash, long key, LongByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected byte computeIfAbsent(int hash, long key, Long2ByteFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected byte supplyIfAbsent(int hash, long key, ByteSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected byte computeIfPresent(int hash, long key, LongByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected byte merge(int hash, long key, byte value, ByteByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
