...
import speiger.src.collections.longs.maps.interfaces.Long2DoubleConcurrentMap;
 ...
 * 
 */
public class Long2DoubleConcurrentOpenHashMap extends AbstractLong2DoubleMap implements Long2DoubleConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Long2DoubleConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Long2DoubleConcurrentOpenHashMap() {
	 ...
	 */
	public Long2DoubleConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Long2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2DoubleConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2DoubleConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Long2DoubleConcurrentOpenHashMap(Long[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2DoubleConcurrentOpenHashMap(Long[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2DoubleConcurrentOpenHashMap(Long[] keys, Double[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2DoubleConcurrentOpenHashMap(Long[] keys, Double[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Long2DoubleConcurrentOpenHashMap(Map<? extends Long, ? extends Double> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2DoubleConcurrentOpenHashMap(Map<? extends Long, ? extends Double> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2DoubleConcurrentOpenHashMap(Map<? extends Long, ? extends Double> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2DoubleConcurrentOpenHashMap(Map<? extends Long, ? extends Double> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2DoubleConcurrentOpenHashMap(Long2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2DoubleConcurrentOpenHashMap(Long2DoubleMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2DoubleConcurrentOpenHashMap(Long2DoubleMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2DoubleConcurrentOpenHashMap(Long2DoubleMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Long2DoubleConcurrentOpenHashMap copy() {
		Long2DoubleConcurrentOpenHashMap copy = new Long2DoubleConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2DoubleMap.Entry> implements Long2DoubleMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2DoubleMap.Entry) {
					Long2DoubleMap.Entry entry = (Long2DoubleMap.Entry)o;
					return Long2DoubleConcurrentOpenHashMap.this.remove(entry.getLongKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2DoubleConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2DoubleConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2DoubleConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongSet {
		...
		public boolean remove(long o) {
			int oldSize = size();
			Long2DoubleConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2DoubleMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2DoubleMap.Entry> {
		MapEntry entry;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Long2DoubleMap.Entry) {
					...
					return getLongKey() == entry.getLongKey() && Double.doubleToLongBits(getDoubleValue()) == Double.doubleToLongBits(entry.getDoubleValue());
				}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Long2DoubleConcurrentOpenHashMap map;
		...
		protected Segment(Long2DoubleConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Long2DoubleConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Long2DoubleConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected double put(int hash, long key, double value) {
		...
		protected double putIfAbsent(int hash, long key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double addTo(int hash, long key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double subFrom(int hash, long key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double get(int hash, long key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double getOrDefault(int hash, long key, double defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(LongDoubleConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected double remove(int hash, long key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected double removeOrDefault(int hash, long key, double defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, long key, double value) {
			long stamp = writeLock();
			try {
				if(key == 0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				long current = keys[pos];
				if(current == 0) return false;
				if(Objects.equals(key, Long.valueOf(current)) && Objects.equals(value, Double.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == 0) return false;
					else if(Objects.equals(key, Long.valueOf(current)) && Objects.equals(value, Double.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, long key, double oldValue, double newValue) {
			long stamp = writeLock();
			try {
		...
		protected double replace(int hash, long key, double value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected double compute(int hash, long key, LongDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected double merge(int hash, long key, double value, DoubleDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
