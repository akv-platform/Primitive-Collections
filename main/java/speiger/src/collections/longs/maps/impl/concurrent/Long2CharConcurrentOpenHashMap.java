...
import speiger.src.collections.longs.maps.interfaces.Long2CharConcurrentMap;
 ...
 * 
 */
public class Long2CharConcurrentOpenHashMap extends AbstractLong2CharMap implements Long2CharConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Long2CharConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Long2CharConcurrentOpenHashMap() {
	 ...
	 */
	public Long2CharConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Long2CharConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2CharConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2CharConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2CharConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Long2CharConcurrentOpenHashMap(Long[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharConcurrentOpenHashMap(Long[] keys, Character[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2CharConcurrentOpenHashMap(Long[] keys, Character[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2CharConcurrentOpenHashMap(Long[] keys, Character[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Long2CharConcurrentOpenHashMap(long[] keys, char[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharConcurrentOpenHashMap(long[] keys, char[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2CharConcurrentOpenHashMap(long[] keys, char[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2CharConcurrentOpenHashMap(long[] keys, char[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Long2CharConcurrentOpenHashMap(Map<? extends Long, ? extends Character> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharConcurrentOpenHashMap(Map<? extends Long, ? extends Character> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2CharConcurrentOpenHashMap(Map<? extends Long, ? extends Character> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2CharConcurrentOpenHashMap(Map<? extends Long, ? extends Character> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2CharConcurrentOpenHashMap(Long2CharMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2CharConcurrentOpenHashMap(Long2CharMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2CharConcurrentOpenHashMap(Long2CharMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2CharConcurrentOpenHashMap(Long2CharMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Long2CharConcurrentOpenHashMap copy() {
		Long2CharConcurrentOpenHashMap copy = new Long2CharConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry> implements Long2CharMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2CharMap.Entry) {
					Long2CharMap.Entry entry = (Long2CharMap.Entry)o;
					return Long2CharConcurrentOpenHashMap.this.remove(entry.getLongKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2CharConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2CharConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2CharConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongSet {
		...
		public boolean remove(long o) {
			int oldSize = size();
			Long2CharConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2CharMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2CharMap.Entry> {
		MapEntry entry;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Long2CharMap.Entry) {
					...
					return getLongKey() == entry.getLongKey() && getCharValue() == entry.getCharValue();
				}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Long2CharConcurrentOpenHashMap map;
		...
		protected Segment(Long2CharConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Long2CharConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Long2CharConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected char put(int hash, long key, char value) {
		...
		protected char putIfAbsent(int hash, long key, char value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected char addTo(int hash, long key, char value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected char subFrom(int hash, long key, char value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected char get(int hash, long key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected char getOrDefault(int hash, long key, char defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(LongCharConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected char remove(int hash, long key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected char removeOrDefault(int hash, long key, char defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, long key, char value) {
			long stamp = writeLock();
			try {
				if(key == 0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				long current = keys[pos];
				if(current == 0) return false;
				if(Objects.equals(key, Long.valueOf(current)) && Objects.equals(value, Character.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == 0) return false;
					else if(Objects.equals(key, Long.valueOf(current)) && Objects.equals(value, Character.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, long key, char oldValue, char newValue) {
			long stamp = writeLock();
			try {
		...
		protected char replace(int hash, long key, char value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected char compute(int hash, long key, LongCharUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected char computeIfAbsent(int hash, long key, Long2CharFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected char supplyIfAbsent(int hash, long key, CharSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected char computeIfPresent(int hash, long key, LongCharUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected char merge(int hash, long key, char value, CharCharUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected void insert(int slot, long key, char value) {
