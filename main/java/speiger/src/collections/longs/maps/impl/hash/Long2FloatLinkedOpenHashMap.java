...
public class Long2FloatLinkedOpenHashMap extends Long2FloatOpenHashMap implements Long2FloatOrderedMap
{
	 ...
	 */
	public Long2FloatLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2FloatLinkedOpenHashMap(Long[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2FloatLinkedOpenHashMap(Long[] keys, Float[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2FloatLinkedOpenHashMap(Map<? extends Long, ? extends Float> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2FloatLinkedOpenHashMap(Long2FloatMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2FloatLinkedOpenHashMap(Long2FloatMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Long2FloatLinkedOpenHashMap copy() {
		Long2FloatLinkedOpenHashMap map = new Long2FloatLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements Long2FloatOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2FloatMap.Entry o) {
			return Long2FloatLinkedOpenHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2FloatMap.Entry o) {
			return Long2FloatLinkedOpenHashMap.this.moveToLast(o.getLongKey());
		}
		...
		@Override
		public Long2FloatMap.Entry pollFirst() {
		...
		@Override
		public Long2FloatMap.Entry pollLast() {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2FloatMap.Entry) {
					...
					int index = Long2FloatLinkedOpenHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return Float.floatToIntBits(entry.getFloatValue()) == Float.floatToIntBits(Long2FloatLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Long2FloatLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float.valueOf(Long2FloatLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2FloatMap.Entry) {
					Long2FloatMap.Entry entry = (Long2FloatMap.Entry)o;
					return Long2FloatLinkedOpenHashMap.this.remove(entry.getLongKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2FloatLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2FloatLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2FloatLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2FloatLinkedOpenHashMap.this.moveToLast(o);
		}
