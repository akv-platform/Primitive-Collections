 ...
 */
public class ImmutableLong2LongOpenHashMap extends AbstractLong2LongMap implements Long2LongOrderedMap
{
	 ...
	 */
	protected ImmutableLong2LongOpenHashMap() {}
	 ...
	 */
	public ImmutableLong2LongOpenHashMap(Long[] keys, Long[] values) {
	 ...
	 */
	public ImmutableLong2LongOpenHashMap(Long[] keys, Long[] values, float loadFactor) {
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
		init(LongArrays.unwrap(keys), LongArrays.unwrap(values), 0, keys.length, loadFactor);
	}
	 ...
	 */
	public ImmutableLong2LongOpenHashMap(Map<? extends Long, ? extends Long> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public ImmutableLong2LongOpenHashMap(Map<? extends Long, ? extends Long> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public ImmutableLong2LongOpenHashMap(Long2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public ImmutableLong2LongOpenHashMap(Long2LongMap map, float loadFactor) {
		long[] keys = new long[map.size()];
		long[] values = new long[keys.length];
		int index = 0;
	...
	protected void init(long[] a, long[] b, int offset, int length, float loadFactor) {
	...
	@Override
	public ImmutableLong2LongOpenHashMap copy() {
		ImmutableLong2LongOpenHashMap map = new ImmutableLong2LongOpenHashMap();
		map.mask = mask;
	...
	@Override
	public boolean replace(long key, long oldValue, long newValue) { throw new UnsupportedOperationException(); }
	
	@Override
	public long replace(long key, long value) { throw new UnsupportedOperationException(); }
	
	@Override
	public long computeLong(long key, LongLongUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
	
	@Override
	public long computeLongIfAbsent(long key, Long2LongFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	protected class MapEntry implements Long2LongMap.Entry, Map.Entry<Long, Long> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Long2LongMap.Entry) {
					...
					return keys[index] == entry.getLongKey() && values[index] == entry.getLongValue();
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				if(!(key instanceof Long)) return false;
				Object value = entry.getValue();
				return key instanceof Long && value instanceof Long && keys[index] == ((Long)key).longValue() && values[index] == ((Long)value).longValue();
			}
			return false;
		}
		...
		@Override
		public int hashCode() {
			return Long.hashCode(keys[index]) ^ Long.hashCode(values[index]);
		}
		
		@Override
		public String toString() {
			return Long.toString(keys[index]) + "=" + Long.toString(values[index]);
		}
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Long2LongMap.Entry> implements Long2LongOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Long2LongMap.Entry o) { throw new UnsupportedOperationException(); }
		
		@Override
		public boolean moveToLast(Long2LongMap.Entry o) { throw new UnsupportedOperationException(); }
		...
		@Override
		public Long2LongMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		
		@Override
		public Long2LongMap.Entry pollLast() { throw new UnsupportedOperationException(); }
		...
		@Override
		public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry fromElement) {
		...
		@Override
		public boolean matchesAny(Object2BooleanFunction<Long2LongMap.Entry> filter) {
		...
		@Override
		public boolean matchesNone(Object2BooleanFunction<Long2LongMap.Entry> filter) {
			Objects.requireNonNull(filter);
		...
		@Override
		public boolean matchesAll(Object2BooleanFunction<Long2LongMap.Entry> filter) {
			Objects.requireNonNull(filter);
			if(size() <= 0) return true;
			BasicEntry entry = new BasicEntry();
			int index = firstIndex;
		...
		@Override
		public Long2LongMap.Entry findFirst(Object2BooleanFunction<Long2LongMap.Entry> filter) {
			Objects.requireNonNull(filter);
		...
		@Override
		public int count(Object2BooleanFunction<Long2LongMap.Entry> filter) {
			Objects.requireNonNull(filter);
			if(size() <= 0) return 0;
			BasicEntry entry = new BasicEntry();
			int result = 0;
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2LongMap.Entry) {
					...
					int index = ImmutableLong2LongOpenHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getLongValue() == ImmutableLong2LongOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = ImmutableLong2LongOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(ImmutableLong2LongOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		@Override
		public int size() {
			return ImmutableLong2LongOpenHashMap.this.size();
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Long2LongMap.Entry> {
		...
		@Override
		public void set(Long2LongMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Long2LongMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
