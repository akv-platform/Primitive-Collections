...
public abstract class AbstractLong2ObjectMap<V> extends AbstractMap<Long, V> implements Long2ObjectMap<V>
{
	...
	public void putAll(Long2ObjectMap<V> m) {
		for(ObjectIterator<Long2ObjectMap.Entry<V>> iter = Long2ObjectMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceObjects(LongObjectUnaryOperator<V> mappingFunction) {
		...
		for(ObjectIterator<Long2ObjectMap.Entry<V>> iter = Long2ObjectMaps.fastIterator(this);iter.hasNext();) {
			Long2ObjectMap.Entry<V> entry = iter.next();
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					ObjectIterator<Long2ObjectMap.Entry<V>> iter = Long2ObjectMaps.fastIterator(AbstractLong2ObjectMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Long2ObjectMap.Entry<V>> iter = Long2ObjectMaps.fastIterator(this);
