...
public abstract class AbstractLong2IntMap extends AbstractMap<Long, Integer> implements Long2IntMap
{
	...
	public void putAll(Long2IntMap m) {
		for(ObjectIterator<Long2IntMap.Entry> iter = Long2IntMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceInts(LongIntUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Long2IntMap.Entry> iter = Long2IntMaps.fastIterator(this);iter.hasNext();) {
			Long2IntMap.Entry entry = iter.next();
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					ObjectIterator<Long2IntMap.Entry> iter = Long2IntMaps.fastIterator(AbstractLong2IntMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Long2IntMap.Entry> iter = Long2IntMaps.fastIterator(this);
