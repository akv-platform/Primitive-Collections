...
public abstract class AbstractLong2LongMap extends AbstractMap<Long, Long> implements Long2LongMap
{
	...
	public void putAll(Long2LongMap m) {
		for(ObjectIterator<Long2LongMap.Entry> iter = Long2LongMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceLongs(LongLongUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Long2LongMap.Entry> iter = Long2LongMaps.fastIterator(this);iter.hasNext();) {
			Long2LongMap.Entry entry = iter.next();
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					ObjectIterator<Long2LongMap.Entry> iter = Long2LongMaps.fastIterator(AbstractLong2LongMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Long2LongMap.Entry> iter = Long2LongMaps.fastIterator(this);
