...
public class Long2FloatMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Long2FloatMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Long2FloatMap.Entry unmodifiable(Long2FloatMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Long2FloatMap.Entry unmodifiable(Map.Entry<Long, Float> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Long2FloatNavigableMap {
		...
		@Override
		public Long2FloatNavigableMap descendingMap() { return Long2FloatMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Long2FloatNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Long2FloatOrderedMap {
		...
		@Override
		public Long2FloatOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.long2FloatEntrySet());
			return (ObjectOrderedSet<Long2FloatMap.Entry>)entrySet;
		}
	}
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Long2FloatSortedMap {
		...
		public float lastFloatValue() { return map.lastFloatValue(); }
		@Override
		public Long2FloatSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractLong2FloatMap implements Long2FloatMap {
		...
		public void mergeAllFloat(Long2FloatMap m, FloatFloatUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceFloats(LongFloatUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceFloats(Long2FloatMap m) { throw new UnsupportedOperationException(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2FloatMap.Entry>
	{
		ObjectOrderedSet<Long2FloatMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Long2FloatMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public boolean moveToFirst(Long2FloatMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public boolean moveToLast(Long2FloatMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public ObjectOrderedSet<Long2FloatMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Long2FloatMap.Entry first() { return set.first(); }
		@Override
		public Long2FloatMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2FloatMap.Entry last() { return set.last(); }
		@Override
		public Long2FloatMap.Entry pollLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Long2FloatNavigableMap {
		...
		@Override
		public Long2FloatNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Long2FloatNavigableMap subMap(Long fromKey, boolean fromInclusive, Long toKey, boolean toInclusive) { synchronized(mutex) { return Long2FloatMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Long2FloatOrderedMap {
		...
		@Override
		public Long2FloatOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public LongOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Long2FloatSortedMap {
		...
		public float lastFloatValue() { synchronized(mutex) { return map.lastFloatValue(); } }
		@Override
		public Long2FloatSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractLong2FloatMap implements Long2FloatMap {
		...
		@Override
		public float supplyFloatIfAbsent(long key, FloatSupplier valueProvider) { synchronized(mutex) { return map.supplyFloatIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Long2FloatMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public LongSet keySet() {
			if(keys == null) keys = LongSets.synchronize(map.keySet(), mutex);
			return keys;
