...
public class Float2ShortMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Float2ShortMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Float2ShortMap.Entry unmodifiable(Float2ShortMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Float2ShortMap.Entry unmodifiable(Map.Entry<Float, Short> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Float2ShortNavigableMap {
		...
		@Override
		public Float2ShortNavigableMap descendingMap() { return Float2ShortMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Float2ShortNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Float2ShortOrderedMap {
		...
		@Override
		public Float2ShortOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.float2ShortEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Float2ShortSortedMap {
		...
		public short lastShortValue() { return map.lastShortValue(); }
		@Override
		public Float2ShortSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractFloat2ShortMap implements Float2ShortMap {
		...
		public void mergeAllShort(Float2ShortMap m, ShortShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(FloatShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(Float2ShortMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Float2ShortMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Float2ShortMap.Entry>
	{
		ObjectOrderedSet<Float2ShortMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Float2ShortMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public boolean moveToFirst(Float2ShortMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public boolean moveToLast(Float2ShortMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public ObjectOrderedSet<Float2ShortMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator(Float2ShortMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Float2ShortMap.Entry first() { return set.first(); }
		@Override
		public Float2ShortMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Float2ShortMap.Entry last() { return set.last(); }
		@Override
		public Float2ShortMap.Entry pollLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Float2ShortNavigableMap {
		...
		@Override
		public Float2ShortMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Float2ShortNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Float2ShortNavigableMap subMap(Float fromKey, boolean fromInclusive, Float toKey, boolean toInclusive) { synchronized(mutex) { return Float2ShortMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Float2ShortOrderedMap {
		...
		@Override
		public Float2ShortOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public FloatOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Float2ShortSortedMap {
		...
		public short lastShortValue() { synchronized(mutex) { return map.lastShortValue(); } }
		@Override
		public Float2ShortSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractFloat2ShortMap implements Float2ShortMap {
		...
		@Override
		public Float2ShortMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public FloatSet keySet() {
			if(keys == null) keys = FloatSets.synchronize(map.keySet(), mutex);
			return keys;
