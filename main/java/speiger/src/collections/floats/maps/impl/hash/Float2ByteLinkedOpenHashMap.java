 ...
 */
public class Float2ByteLinkedOpenHashMap extends Float2ByteOpenHashMap implements Float2ByteOrderedMap
{
	 ...
	 */
	public Float2ByteLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Float2ByteLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2ByteLinkedOpenHashMap(Float[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ByteLinkedOpenHashMap(Float[] keys, Byte[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ByteLinkedOpenHashMap(Map<? extends Float, ? extends Byte> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2ByteLinkedOpenHashMap(Float2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2ByteLinkedOpenHashMap(Float2ByteMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Float2ByteLinkedOpenHashMap copy() {
		Float2ByteLinkedOpenHashMap map = new Float2ByteLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2ByteMap.Entry o) {
			return Float2ByteLinkedOpenHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2ByteMap.Entry o) {
			return Float2ByteLinkedOpenHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ByteMap.Entry) {
					...
					int index = Float2ByteLinkedOpenHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getByteValue() == Float2ByteLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Float2ByteLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Float2ByteLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ByteMap.Entry) {
					Float2ByteMap.Entry entry = (Float2ByteMap.Entry)o;
					return Float2ByteLinkedOpenHashMap.this.remove(entry.getFloatKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2ByteLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2ByteLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2ByteLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2ByteLinkedOpenHashMap.this.moveToLast(o);
		}
