 ...
 */
public class Float2CharLinkedOpenCustomHashMap extends Float2CharOpenCustomHashMap implements Float2CharOrderedMap
{
	 ...
	 */
	public Float2CharLinkedOpenCustomHashMap(FloatStrategy strategy) {
	 ...
	 */
	public Float2CharLinkedOpenCustomHashMap(int minCapacity, FloatStrategy strategy) {
	 ...
	 */
	public Float2CharLinkedOpenCustomHashMap(int minCapacity, float loadFactor, FloatStrategy strategy) {
	 ...
	 */
	public Float2CharLinkedOpenCustomHashMap(Float[] keys, Character[] values, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2CharLinkedOpenCustomHashMap(Float[] keys, Character[] values, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Float2CharLinkedOpenCustomHashMap(float[] keys, char[] values, FloatStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2CharLinkedOpenCustomHashMap(float[] keys, char[] values, float loadFactor, FloatStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Float2CharLinkedOpenCustomHashMap(Map<? extends Float, ? extends Character> map, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2CharLinkedOpenCustomHashMap(Map<? extends Float, ? extends Character> map, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Float2CharLinkedOpenCustomHashMap(Float2CharMap map, FloatStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2CharLinkedOpenCustomHashMap(Float2CharMap map, float loadFactor, FloatStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Float2CharLinkedOpenCustomHashMap copy() {
		Float2CharLinkedOpenCustomHashMap map = new Float2CharLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements Float2CharOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2CharMap.Entry o) {
			return Float2CharLinkedOpenCustomHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2CharMap.Entry o) {
			return Float2CharLinkedOpenCustomHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2CharMap.Entry) {
					...
					int index = Float2CharLinkedOpenCustomHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getCharValue() == Float2CharLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Float)) return false;
					int index = Float2CharLinkedOpenCustomHashMap.this.findIndex((Float)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Float2CharLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2CharMap.Entry) {
					Float2CharMap.Entry entry = (Float2CharMap.Entry)o;
					return Float2CharLinkedOpenCustomHashMap.this.remove(entry.getFloatKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2CharLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Float2CharLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Float2CharLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2CharLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2CharLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2CharLinkedOpenCustomHashMap.this.moveToLast(o);
		}
