 ...
 */
public class Float2ByteOpenCustomHashMap extends AbstractFloat2ByteMap implements ITrimmable
{
	 ...
	 */
	public Float2ByteOpenCustomHashMap(FloatStrategy strategy) {
	 ...
	 */
	public Float2ByteOpenCustomHashMap(int minCapacity, FloatStrategy strategy) {
	 ...
	 */
	public Float2ByteOpenCustomHashMap(int minCapacity, float loadFactor, FloatStrategy strategy) {
	 ...
	 */
	public Float2ByteOpenCustomHashMap(Float[] keys, Byte[] values, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ByteOpenCustomHashMap(Float[] keys, Byte[] values, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Float2ByteOpenCustomHashMap(Map<? extends Float, ? extends Byte> map, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ByteOpenCustomHashMap(Map<? extends Float, ? extends Byte> map, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Float2ByteOpenCustomHashMap(Float2ByteMap map, FloatStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2ByteOpenCustomHashMap(Float2ByteMap map, float loadFactor, FloatStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(!strategy.equals(keys[i], 0F) && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Byte.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Float2ByteOpenCustomHashMap copy() {
		Float2ByteOpenCustomHashMap map = new Float2ByteOpenCustomHashMap(0, loadFactor, strategy);
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteMap.FastEntrySet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ByteMap.Entry) {
					...
					int index = Float2ByteOpenCustomHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getByteValue() == Float2ByteOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Float)) return false;
					int index = Float2ByteOpenCustomHashMap.this.findIndex((Float)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Float2ByteOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ByteMap.Entry) {
					Float2ByteMap.Entry entry = (Float2ByteMap.Entry)o;
					return Float2ByteOpenCustomHashMap.this.remove(entry.getFloatKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2ByteOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractFloatSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2ByteOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Float2ByteOpenCustomHashMap.this.remove(wrapped.getFloat(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
