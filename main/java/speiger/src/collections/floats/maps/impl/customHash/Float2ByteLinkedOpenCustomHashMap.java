 ...
 */
public class Float2ByteLinkedOpenCustomHashMap extends Float2ByteOpenCustomHashMap implements Float2ByteOrderedMap
{
	 ...
	 */
	public Float2ByteLinkedOpenCustomHashMap(FloatStrategy strategy) {
	 ...
	 */
	public Float2ByteLinkedOpenCustomHashMap(int minCapacity, FloatStrategy strategy) {
	 ...
	 */
	public Float2ByteLinkedOpenCustomHashMap(int minCapacity, float loadFactor, FloatStrategy strategy) {
	 ...
	 */
	public Float2ByteLinkedOpenCustomHashMap(Float[] keys, Byte[] values, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ByteLinkedOpenCustomHashMap(Float[] keys, Byte[] values, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Float2ByteLinkedOpenCustomHashMap(Map<? extends Float, ? extends Byte> map, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ByteLinkedOpenCustomHashMap(Map<? extends Float, ? extends Byte> map, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Float2ByteLinkedOpenCustomHashMap(Float2ByteMap map, FloatStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2ByteLinkedOpenCustomHashMap(Float2ByteMap map, float loadFactor, FloatStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Float2ByteLinkedOpenCustomHashMap copy() {
		Float2ByteLinkedOpenCustomHashMap map = new Float2ByteLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2ByteMap.Entry o) {
			return Float2ByteLinkedOpenCustomHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2ByteMap.Entry o) {
			return Float2ByteLinkedOpenCustomHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ByteMap.Entry) {
					...
					int index = Float2ByteLinkedOpenCustomHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getByteValue() == Float2ByteLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Float)) return false;
					int index = Float2ByteLinkedOpenCustomHashMap.this.findIndex((Float)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Float2ByteLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ByteMap.Entry) {
					Float2ByteMap.Entry entry = (Float2ByteMap.Entry)o;
					return Float2ByteLinkedOpenCustomHashMap.this.remove(entry.getFloatKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2ByteLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Float2ByteLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Float2ByteLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2ByteLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2ByteLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2ByteLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Float2ByteMap.Entry> {
		...
		@Override
		public void set(Float2ByteMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Float2ByteMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
