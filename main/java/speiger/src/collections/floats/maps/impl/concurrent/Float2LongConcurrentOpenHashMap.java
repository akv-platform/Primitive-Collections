...
import speiger.src.collections.floats.maps.interfaces.Float2LongConcurrentMap;
 ...
 * 
 */
public class Float2LongConcurrentOpenHashMap extends AbstractFloat2LongMap implements Float2LongConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Float2LongConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Float2LongConcurrentOpenHashMap() {
	 ...
	 */
	public Float2LongConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Float2LongConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2LongConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2LongConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2LongConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Float2LongConcurrentOpenHashMap(Float[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2LongConcurrentOpenHashMap(Float[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2LongConcurrentOpenHashMap(Float[] keys, Long[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2LongConcurrentOpenHashMap(Float[] keys, Long[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Float2LongConcurrentOpenHashMap(Map<? extends Float, ? extends Long> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2LongConcurrentOpenHashMap(Map<? extends Float, ? extends Long> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2LongConcurrentOpenHashMap(Map<? extends Float, ? extends Long> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2LongConcurrentOpenHashMap(Map<? extends Float, ? extends Long> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2LongConcurrentOpenHashMap(Float2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2LongConcurrentOpenHashMap(Float2LongMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Float2LongConcurrentOpenHashMap(Float2LongMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Float2LongConcurrentOpenHashMap(Float2LongMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Float2LongConcurrentOpenHashMap copy() {
		Float2LongConcurrentOpenHashMap copy = new Float2LongConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2LongMap.Entry> implements Float2LongMap.FastEntrySet {
		@Override
		...
		@Override
		public boolean matchesAny(Object2BooleanFunction<Float2LongMap.Entry> filter) {
		...
		@Override
		public boolean matchesNone(Object2BooleanFunction<Float2LongMap.Entry> filter) {
			Objects.requireNonNull(filter);
			BasicEntry entry = new BasicEntry();
			for(int i = 0,m=segments.length;i<m;i++) {
				Segment seg = segments[i];
		...
		@Override
		public boolean matchesAll(Object2BooleanFunction<Float2LongMap.Entry> filter) {
			Objects.requireNonNull(filter);
			BasicEntry entry = new BasicEntry();
			for(int i = 0,m=segments.length;i<m;i++) {
				Segment seg = segments[i];
		...
		@Override
		public Float2LongMap.Entry findFirst(Object2BooleanFunction<Float2LongMap.Entry> filter) {
			Objects.requireNonNull(filter);
			BasicEntry entry = new BasicEntry();
			for(int i = 0,m=segments.length;i<m;i++) {
				Segment seg = segments[i];
		...
		@Override
		public int count(Object2BooleanFunction<Float2LongMap.Entry> filter) {
			Objects.requireNonNull(filter);
			int result = 0;
			BasicEntry entry = new BasicEntry();
			for(int i = 0,m=segments.length;i<m;i++) {
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2LongMap.Entry) {
					Float2LongMap.Entry entry = (Float2LongMap.Entry)o;
					return Float2LongConcurrentOpenHashMap.this.remove(entry.getFloatKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2LongConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Float2LongConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Float2LongConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractFloatSet implements FloatSet {
		...
		public boolean remove(float o) {
			int oldSize = size();
			Float2LongConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Float2LongMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Float2LongMap.Entry> {
		MapEntry entry;
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Float2LongConcurrentOpenHashMap map;
		...
		protected Segment(Float2LongConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Float2LongConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Float2LongConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected long put(int hash, float key, long value) {
		...
		protected long putIfAbsent(int hash, float key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected long addTo(int hash, float key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected long subFrom(int hash, float key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected long get(int hash, float key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected long getOrDefault(int hash, float key, long defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(FloatLongConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected long remove(int hash, float key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected long removeOrDefault(int hash, float key, long defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, float key, long value) {
			long stamp = writeLock();
			try {
		...
		protected boolean replace(int hash, float key, long oldValue, long newValue) {
			long stamp = writeLock();
			try {
		...
		protected long replace(int hash, float key, long value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected long compute(int hash, float key, FloatLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long computeIfAbsent(int hash, float key, Float2LongFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long supplyIfAbsent(int hash, float key, LongSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long computeIfPresent(int hash, float key, FloatLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected long merge(int hash, float key, long value, LongLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
