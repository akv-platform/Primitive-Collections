...
public class Float2FloatLinkedOpenCustomHashMap extends Float2FloatOpenCustomHashMap implements Float2FloatOrderedMap
{
	 ...
	 */
	public Float2FloatLinkedOpenCustomHashMap(FloatStrategy strategy) {
	 ...
	 */
	public Float2FloatLinkedOpenCustomHashMap(int minCapacity, FloatStrategy strategy) {
	 ...
	 */
	public Float2FloatLinkedOpenCustomHashMap(int minCapacity, float loadFactor, FloatStrategy strategy) {
	 ...
	 */
	public Float2FloatLinkedOpenCustomHashMap(Float[] keys, Float[] values, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2FloatLinkedOpenCustomHashMap(Float[] keys, Float[] values, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Float2FloatLinkedOpenCustomHashMap(Map<? extends Float, ? extends Float> map, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2FloatLinkedOpenCustomHashMap(Map<? extends Float, ? extends Float> map, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Float2FloatLinkedOpenCustomHashMap(Float2FloatMap map, FloatStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2FloatLinkedOpenCustomHashMap(Float2FloatMap map, float loadFactor, FloatStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Float2FloatLinkedOpenCustomHashMap copy() {
		Float2FloatLinkedOpenCustomHashMap map = new Float2FloatLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements Float2FloatOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2FloatMap.Entry o) {
			return Float2FloatLinkedOpenCustomHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2FloatMap.Entry o) {
			return Float2FloatLinkedOpenCustomHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2FloatMap.Entry) {
					...
					int index = Float2FloatLinkedOpenCustomHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return Float.floatToIntBits(entry.getFloatValue()) == Float.floatToIntBits(Float2FloatLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Float)) return false;
					int index = Float2FloatLinkedOpenCustomHashMap.this.findIndex((Float)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float.valueOf(Float2FloatLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2FloatMap.Entry) {
					Float2FloatMap.Entry entry = (Float2FloatMap.Entry)o;
					return Float2FloatLinkedOpenCustomHashMap.this.remove(entry.getFloatKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2FloatLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2FloatLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2FloatLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2FloatLinkedOpenCustomHashMap.this.moveToLast(o);
		}
