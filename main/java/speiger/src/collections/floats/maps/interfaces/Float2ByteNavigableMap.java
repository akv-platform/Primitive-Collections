 ...
 */
public interface Float2ByteNavigableMap extends Float2ByteSortedMap, NavigableMap<Float, Byte>
{
	@Override
	public Float2ByteNavigableMap copy();
	 ...
	 */
	public default Float2ByteNavigableMap synchronize() { return Float2ByteMaps.synchronize(this); }
	 ...
	 * @see Float2ByteMaps#synchronize
	 */
	public default Float2ByteNavigableMap synchronize(Object mutex) { return Float2ByteMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Float2ByteNavigableMap unmodifiable() { return Float2ByteMaps.unmodifiable(this); }
	...
	@Override
	public default Float2ByteNavigableMap subMap(float fromKey, float toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Float2ByteNavigableMap headMap(float toKey) { return headMap(toKey, false); }
	@Override
	public default Float2ByteNavigableMap tailMap(float fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Float2ByteMap.Entry lowerEntry(Float key) { return lowerEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2ByteMap.Entry floorEntry(Float key) { return floorEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2ByteMap.Entry ceilingEntry(Float key) { return ceilingEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2ByteMap.Entry higherEntry(Float key) { return higherEntry(key.floatValue()); }
	
	@Override
	@Deprecated
	default Float2ByteNavigableMap subMap(Float fromKey, boolean fromInclusive, Float toKey, boolean toInclusive) { return subMap(fromKey.floatValue(), fromInclusive, toKey.floatValue(), toInclusive); }
	@Override
	@Deprecated
	default Float2ByteNavigableMap headMap(Float toKey, boolean inclusive) { return headMap(toKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2ByteNavigableMap tailMap(Float fromKey, boolean inclusive) { return tailMap(fromKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2ByteNavigableMap subMap(Float fromKey, Float toKey) { return subMap(fromKey.floatValue(), true, toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2ByteNavigableMap headMap(Float toKey) { return headMap(toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2ByteNavigableMap tailMap(Float fromKey) { return tailMap(fromKey.floatValue(), true); }
}