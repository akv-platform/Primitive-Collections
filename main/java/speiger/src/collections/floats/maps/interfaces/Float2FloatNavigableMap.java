...
{
	@Override
	public Float2FloatNavigableMap copy();
	 ...
	 */
	public default Float2FloatNavigableMap synchronize() { return Float2FloatMaps.synchronize(this); }
	 ...
	 * @see Float2FloatMaps#synchronize
	 */
	public default Float2FloatNavigableMap synchronize(Object mutex) { return Float2FloatMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Float2FloatNavigableMap unmodifiable() { return Float2FloatMaps.unmodifiable(this); }
	...
	@Override
	public default Float2FloatNavigableMap subMap(float fromKey, float toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Float2FloatNavigableMap headMap(float toKey) { return headMap(toKey, false); }
	@Override
	public default Float2FloatNavigableMap tailMap(float fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Float2FloatMap.Entry lowerEntry(Float key) { return lowerEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2FloatMap.Entry floorEntry(Float key) { return floorEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2FloatMap.Entry ceilingEntry(Float key) { return ceilingEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2FloatMap.Entry higherEntry(Float key) { return higherEntry(key.floatValue()); }
	
	@Override
	@Deprecated
	default Float2FloatNavigableMap subMap(Float fromKey, boolean fromInclusive, Float toKey, boolean toInclusive) { return subMap(fromKey.floatValue(), fromInclusive, toKey.floatValue(), toInclusive); }
	@Override
	@Deprecated
	default Float2FloatNavigableMap headMap(Float toKey, boolean inclusive) { return headMap(toKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2FloatNavigableMap tailMap(Float fromKey, boolean inclusive) { return tailMap(fromKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2FloatNavigableMap subMap(Float fromKey, Float toKey) { return subMap(fromKey.floatValue(), true, toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2FloatNavigableMap headMap(Float toKey) { return headMap(toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2FloatNavigableMap tailMap(Float fromKey) { return tailMap(fromKey.floatValue(), true); }
}