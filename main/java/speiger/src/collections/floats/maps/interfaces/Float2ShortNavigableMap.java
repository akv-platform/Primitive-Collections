 ...
 */
public interface Float2ShortNavigableMap extends Float2ShortSortedMap, NavigableMap<Float, Short>
{
	@Override
	 ...
	 */
	public default Float2ShortNavigableMap synchronize() { return Float2ShortMaps.synchronize(this); }
	 ...
	 * @see Float2ShortMaps#synchronize
	 */
	public default Float2ShortNavigableMap synchronize(Object mutex) { return Float2ShortMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Float2ShortNavigableMap unmodifiable() { return Float2ShortMaps.unmodifiable(this); }
	...
	@Override
	public default Float2ShortNavigableMap subMap(float fromKey, float toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Float2ShortNavigableMap headMap(float toKey) { return headMap(toKey, false); }
	@Override
	public default Float2ShortNavigableMap tailMap(float fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Float2ShortMap.Entry lowerEntry(Float key) { return lowerEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2ShortMap.Entry floorEntry(Float key) { return floorEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2ShortMap.Entry ceilingEntry(Float key) { return ceilingEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2ShortMap.Entry higherEntry(Float key) { return higherEntry(key.floatValue()); }
	
	@Override
	@Deprecated
	default Float2ShortNavigableMap subMap(Float fromKey, boolean fromInclusive, Float toKey, boolean toInclusive) { return subMap(fromKey.floatValue(), fromInclusive, toKey.floatValue(), toInclusive); }
	@Override
	@Deprecated
	default Float2ShortNavigableMap headMap(Float toKey, boolean inclusive) { return headMap(toKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2ShortNavigableMap tailMap(Float fromKey, boolean inclusive) { return tailMap(fromKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2ShortNavigableMap subMap(Float fromKey, Float toKey) { return subMap(fromKey.floatValue(), true, toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2ShortNavigableMap headMap(Float toKey) { return headMap(toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2ShortNavigableMap tailMap(Float fromKey) { return tailMap(fromKey.floatValue(), true); }
}