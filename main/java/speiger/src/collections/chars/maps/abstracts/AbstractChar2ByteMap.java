...
public abstract class AbstractChar2ByteMap extends AbstractMap<Character, Byte> implements Char2ByteMap
{
	...
	public void putAll(Char2ByteMap m) {
		for(ObjectIterator<Char2ByteMap.Entry> iter = Char2ByteMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBytes(CharByteUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Char2ByteMap.Entry> iter = Char2ByteMaps.fastIterator(this);iter.hasNext();) {
			Char2ByteMap.Entry entry = iter.next();
		...
		return new AbstractCharSet() {
			...
			public CharIterator iterator() {
				return new CharIterator() {
					ObjectIterator<Char2ByteMap.Entry> iter = Char2ByteMaps.fastIterator(AbstractChar2ByteMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Char2ByteMap.Entry> iter = Char2ByteMaps.fastIterator(this);
