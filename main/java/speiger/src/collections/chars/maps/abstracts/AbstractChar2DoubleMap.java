...
public abstract class AbstractChar2DoubleMap extends AbstractMap<Character, Double> implements Char2DoubleMap
{
	...
	public void putAll(Char2DoubleMap m) {
		for(ObjectIterator<Char2DoubleMap.Entry> iter = Char2DoubleMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceDoubles(CharDoubleUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Char2DoubleMap.Entry> iter = Char2DoubleMaps.fastIterator(this);iter.hasNext();) {
			Char2DoubleMap.Entry entry = iter.next();
		...
		return new AbstractCharSet() {
			...
			public CharIterator iterator() {
				return new CharIterator() {
					ObjectIterator<Char2DoubleMap.Entry> iter = Char2DoubleMaps.fastIterator(AbstractChar2DoubleMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Char2DoubleMap.Entry> iter = Char2DoubleMaps.fastIterator(this);
