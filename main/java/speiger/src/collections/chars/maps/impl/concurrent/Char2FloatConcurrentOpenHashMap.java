...
import speiger.src.collections.chars.maps.interfaces.Char2FloatConcurrentMap;
 ...
 * 
 */
public class Char2FloatConcurrentOpenHashMap extends AbstractChar2FloatMap implements Char2FloatConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Char2FloatConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Char2FloatConcurrentOpenHashMap() {
	 ...
	 */
	public Char2FloatConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Char2FloatConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2FloatConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2FloatConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2FloatConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Char2FloatConcurrentOpenHashMap(Character[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2FloatConcurrentOpenHashMap(Character[] keys, Float[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2FloatConcurrentOpenHashMap(Character[] keys, Float[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2FloatConcurrentOpenHashMap(Character[] keys, Float[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
		for(int i = 0,m=keys.length;i<m;i++) put(keys[i].charValue(), values[i].floatValue());
	}
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2FloatConcurrentOpenHashMap(char[] keys, float[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2FloatConcurrentOpenHashMap(char[] keys, float[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2FloatConcurrentOpenHashMap(char[] keys, float[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2FloatConcurrentOpenHashMap(char[] keys, float[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Char2FloatConcurrentOpenHashMap(Map<? extends Character, ? extends Float> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2FloatConcurrentOpenHashMap(Map<? extends Character, ? extends Float> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2FloatConcurrentOpenHashMap(Map<? extends Character, ? extends Float> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2FloatConcurrentOpenHashMap(Map<? extends Character, ? extends Float> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2FloatConcurrentOpenHashMap(Char2FloatMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2FloatConcurrentOpenHashMap(Char2FloatMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2FloatConcurrentOpenHashMap(Char2FloatMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2FloatConcurrentOpenHashMap(Char2FloatMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Char2FloatConcurrentOpenHashMap copy() {
		Char2FloatConcurrentOpenHashMap copy = new Char2FloatConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2FloatMap.Entry> implements Char2FloatMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2FloatMap.Entry) {
					Char2FloatMap.Entry entry = (Char2FloatMap.Entry)o;
					return Char2FloatConcurrentOpenHashMap.this.remove(entry.getCharKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2FloatConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2FloatConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2FloatConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharSet {
		...
		public boolean remove(char o) {
			int oldSize = size();
			Char2FloatConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2FloatMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2FloatMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Char2FloatMap.Entry, Map.Entry<Character, Float> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Char2FloatMap.Entry) {
					...
					return getCharKey() == entry.getCharKey() && Float.floatToIntBits(getFloatValue()) == Float.floatToIntBits(entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Character && value instanceof Float && getCharKey() == ((Character)key).charValue() && Float.floatToIntBits(getFloatValue()) == Float.floatToIntBits(((Float)value).floatValue());
			}
			return false;
		}
		...
		@Override
		public int hashCode() {
			return Character.hashCode(getCharKey()) ^ Float.hashCode(getFloatValue());
		}
		
		@Override
		public String toString() {
			return Character.toString(getCharKey()) + "=" + Float.toString(getFloatValue());
		}
	}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Char2FloatConcurrentOpenHashMap map;
		...
		protected Segment(Char2FloatConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Char2FloatConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Char2FloatConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected float put(int hash, char key, float value) {
		...
		protected float putIfAbsent(int hash, char key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected float addTo(int hash, char key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected float subFrom(int hash, char key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected float get(int hash, char key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected float getOrDefault(int hash, char key, float defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(CharFloatConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected float remove(int hash, char key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected float removeOrDefault(int hash, char key, float defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, char key, float value) {
			long stamp = writeLock();
			try {
				if(key == (char)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				char current = keys[pos];
				if(current == (char)0) return false;
				if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, Float.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (char)0) return false;
					else if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, Float.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, char key, float oldValue, float newValue) {
			long stamp = writeLock();
			try {
		...
		protected float replace(int hash, char key, float value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected float compute(int hash, char key, CharFloatUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected float merge(int hash, char key, float value, FloatFloatUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected void insert(int slot, char key, float value) {
