...
public interface Char2CharMap extends Map<Character, Character>, Char2CharFunction
{
	...
	public default Character computeIfAbsent(Character key, Function<? super Character, ? extends Character> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return Character.valueOf(computeCharIfAbsent(key.charValue(), mappingFunction instanceof Char2CharFunction ? (Char2CharFunction)mappingFunction : K -> mappingFunction.apply(Character.valueOf(K)).charValue()));
	}
