...
public interface Char2ObjectOrderedMap<V> extends Char2ObjectMap<V>
{
	 ...
	 */
	@Override
	public default Char2ObjectOrderedMap<V> synchronize() { return Char2ObjectMaps.synchronize(this); }
	 ...
	 */
	@Override
	public default Char2ObjectOrderedMap<V> synchronize(Object mutex) { return Char2ObjectMaps.synchronize(this, mutex); }
	 ...
	 */
	@Override
	public default Char2ObjectOrderedMap<V> unmodifiable() { return Char2ObjectMaps.unmodifiable(this); }
	
	/**
	 * Fast Ordered Entry Set that allows for a faster Entry Iterator by recycling the Entry Object and just exchanging 1 internal value
	 * @param <V> the type of elements maintained by this Collection
	 */
	interface FastOrderedSet<V> extends Char2ObjectMap.FastEntrySet<V>, ObjectOrderedSet<Char2ObjectMap.Entry<V>> {
		@Override
