 ...
 */
public interface Char2ByteNavigableMap extends Char2ByteSortedMap, NavigableMap<Character, Byte>
{
	@Override
	public Char2ByteNavigableMap copy();
	 ...
	 */
	public default Char2ByteNavigableMap synchronize() { return Char2ByteMaps.synchronize(this); }
	 ...
	 * @see Char2ByteMaps#synchronize
	 */
	public default Char2ByteNavigableMap synchronize(Object mutex) { return Char2ByteMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Char2ByteNavigableMap unmodifiable() { return Char2ByteMaps.unmodifiable(this); }
	...
	@Override
	public default Char2ByteNavigableMap subMap(char fromKey, char toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Char2ByteNavigableMap headMap(char toKey) { return headMap(toKey, false); }
	@Override
	public default Char2ByteNavigableMap tailMap(char fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Char2ByteMap.Entry lowerEntry(Character key) { return lowerEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2ByteMap.Entry floorEntry(Character key) { return floorEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2ByteMap.Entry ceilingEntry(Character key) { return ceilingEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2ByteMap.Entry higherEntry(Character key) { return higherEntry(key.charValue()); }
	
	@Override
	@Deprecated
	default Char2ByteNavigableMap subMap(Character fromKey, boolean fromInclusive, Character toKey, boolean toInclusive) { return subMap(fromKey.charValue(), fromInclusive, toKey.charValue(), toInclusive); }
	@Override
	@Deprecated
	default Char2ByteNavigableMap headMap(Character toKey, boolean inclusive) { return headMap(toKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2ByteNavigableMap tailMap(Character fromKey, boolean inclusive) { return tailMap(fromKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2ByteNavigableMap subMap(Character fromKey, Character toKey) { return subMap(fromKey.charValue(), true, toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2ByteNavigableMap headMap(Character toKey) { return headMap(toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2ByteNavigableMap tailMap(Character fromKey) { return tailMap(fromKey.charValue(), true); }
}