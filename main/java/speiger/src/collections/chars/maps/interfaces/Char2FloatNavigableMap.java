 ...
 */
public interface Char2FloatNavigableMap extends Char2FloatSortedMap, NavigableMap<Character, Float>
{
	@Override
	public Char2FloatNavigableMap copy();
	 ...
	 */
	public default Char2FloatNavigableMap synchronize() { return Char2FloatMaps.synchronize(this); }
	 ...
	 * @see Char2FloatMaps#synchronize
	 */
	public default Char2FloatNavigableMap synchronize(Object mutex) { return Char2FloatMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Char2FloatNavigableMap unmodifiable() { return Char2FloatMaps.unmodifiable(this); }
	...
	@Override
	public default Char2FloatNavigableMap subMap(char fromKey, char toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Char2FloatNavigableMap headMap(char toKey) { return headMap(toKey, false); }
	@Override
	public default Char2FloatNavigableMap tailMap(char fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Char2FloatMap.Entry lowerEntry(Character key) { return lowerEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2FloatMap.Entry floorEntry(Character key) { return floorEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2FloatMap.Entry ceilingEntry(Character key) { return ceilingEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2FloatMap.Entry higherEntry(Character key) { return higherEntry(key.charValue()); }
	
	@Override
	@Deprecated
	default Char2FloatNavigableMap subMap(Character fromKey, boolean fromInclusive, Character toKey, boolean toInclusive) { return subMap(fromKey.charValue(), fromInclusive, toKey.charValue(), toInclusive); }
	@Override
	@Deprecated
	default Char2FloatNavigableMap headMap(Character toKey, boolean inclusive) { return headMap(toKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2FloatNavigableMap tailMap(Character fromKey, boolean inclusive) { return tailMap(fromKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2FloatNavigableMap subMap(Character fromKey, Character toKey) { return subMap(fromKey.charValue(), true, toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2FloatNavigableMap headMap(Character toKey) { return headMap(toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2FloatNavigableMap tailMap(Character fromKey) { return tailMap(fromKey.charValue(), true); }
}