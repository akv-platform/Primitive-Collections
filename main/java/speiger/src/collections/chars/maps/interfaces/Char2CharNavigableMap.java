 ...
 */
public interface Char2CharNavigableMap extends Char2CharSortedMap, NavigableMap<Character, Character>
{
	@Override
	public Char2CharNavigableMap copy();
	 ...
	 */
	public default Char2CharNavigableMap synchronize() { return Char2CharMaps.synchronize(this); }
	 ...
	 * @see Char2CharMaps#synchronize
	 */
	public default Char2CharNavigableMap synchronize(Object mutex) { return Char2CharMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Char2CharNavigableMap unmodifiable() { return Char2CharMaps.unmodifiable(this); }
	...
	@Override
	public default Char2CharNavigableMap subMap(char fromKey, char toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Char2CharNavigableMap headMap(char toKey) { return headMap(toKey, false); }
	@Override
	public default Char2CharNavigableMap tailMap(char fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Char2CharMap.Entry lowerEntry(Character key) { return lowerEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2CharMap.Entry floorEntry(Character key) { return floorEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2CharMap.Entry ceilingEntry(Character key) { return ceilingEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2CharMap.Entry higherEntry(Character key) { return higherEntry(key.charValue()); }
	
	@Override
	@Deprecated
	default Char2CharNavigableMap subMap(Character fromKey, boolean fromInclusive, Character toKey, boolean toInclusive) { return subMap(fromKey.charValue(), fromInclusive, toKey.charValue(), toInclusive); }
	@Override
	@Deprecated
	default Char2CharNavigableMap headMap(Character toKey, boolean inclusive) { return headMap(toKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2CharNavigableMap tailMap(Character fromKey, boolean inclusive) { return tailMap(fromKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2CharNavigableMap subMap(Character fromKey, Character toKey) { return subMap(fromKey.charValue(), true, toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2CharNavigableMap headMap(Character toKey) { return headMap(toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2CharNavigableMap tailMap(Character fromKey) { return tailMap(fromKey.charValue(), true); }
}