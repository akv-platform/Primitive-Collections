...
public class Char2FloatMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Char2FloatMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Char2FloatMap.Entry unmodifiable(Char2FloatMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Char2FloatMap.Entry unmodifiable(Map.Entry<Character, Float> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Char2FloatNavigableMap {
		...
		@Override
		public Char2FloatNavigableMap descendingMap() { return Char2FloatMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Char2FloatNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Char2FloatOrderedMap {
		...
		public ObjectOrderedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.char2FloatEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Char2FloatSortedMap {
		...
		public float lastFloatValue() { return map.lastFloatValue(); }
		@Override
		public Char2FloatSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractChar2FloatMap implements Char2FloatMap {
		...
		public void mergeAllFloat(Char2FloatMap m, FloatFloatUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceFloats(CharFloatUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceFloats(Char2FloatMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Char2FloatMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Char2FloatMap.Entry>
	{
		ObjectOrderedSet<Char2FloatMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Char2FloatMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Char2FloatMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Char2FloatMap.Entry first() { return set.first(); }
		@Override
		public Char2FloatMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Char2FloatMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Char2FloatNavigableMap {
		...
		@Override
		public Char2FloatMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Char2FloatNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Char2FloatSortedMap {
		...
		public float lastFloatValue() { synchronized(mutex) { return map.lastFloatValue(); } }
		@Override
		public Char2FloatSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractChar2FloatMap implements Char2FloatMap {
		...
		@Override
		public float supplyFloatIfAbsent(char key, FloatSupplier valueProvider) { synchronized(mutex) { return map.supplyFloatIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Char2FloatMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public CharSet keySet() {
			if(keys == null) keys = CharSets.synchronize(map.keySet(), mutex);
			return keys;
