 ...
 */
public interface Short2DoubleNavigableMap extends Short2DoubleSortedMap, NavigableMap<Short, Double>
{
	@Override
	 ...
	 */
	public default Short2DoubleNavigableMap synchronize() { return Short2DoubleMaps.synchronize(this); }
	 ...
	 * @see Short2DoubleMaps#synchronize
	 */
	public default Short2DoubleNavigableMap synchronize(Object mutex) { return Short2DoubleMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Short2DoubleNavigableMap unmodifiable() { return Short2DoubleMaps.unmodifiable(this); }
	...
	@Override
	public default Short2DoubleNavigableMap subMap(short fromKey, short toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Short2DoubleNavigableMap headMap(short toKey) { return headMap(toKey, false); }
	@Override
	public default Short2DoubleNavigableMap tailMap(short fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Short2DoubleMap.Entry lowerEntry(Short key) { return lowerEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2DoubleMap.Entry floorEntry(Short key) { return floorEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2DoubleMap.Entry ceilingEntry(Short key) { return ceilingEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2DoubleMap.Entry higherEntry(Short key) { return higherEntry(key.shortValue()); }
	
	@Override
	@Deprecated
	default Short2DoubleNavigableMap subMap(Short fromKey, boolean fromInclusive, Short toKey, boolean toInclusive) { return subMap(fromKey.shortValue(), fromInclusive, toKey.shortValue(), toInclusive); }
	@Override
	@Deprecated
	default Short2DoubleNavigableMap headMap(Short toKey, boolean inclusive) { return headMap(toKey.shortValue(), inclusive); }
	@Override
	@Deprecated
	default Short2DoubleNavigableMap tailMap(Short fromKey, boolean inclusive) { return tailMap(fromKey.shortValue(), inclusive); }
	@Override
	@Deprecated
	default Short2DoubleNavigableMap subMap(Short fromKey, Short toKey) { return subMap(fromKey.shortValue(), true, toKey.shortValue(), false); }
	@Override
	@Deprecated
	default Short2DoubleNavigableMap headMap(Short toKey) { return headMap(toKey.shortValue(), false); }
	@Override
	@Deprecated
	default Short2DoubleNavigableMap tailMap(Short fromKey) { return tailMap(fromKey.shortValue(), true); }
}