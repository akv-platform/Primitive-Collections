...
public interface Short2ObjectMap<V> extends Map<Short, V>, Short2ObjectFunction<V>
{
	...
	public default V computeIfAbsent(Short key, Function<? super Short, ? extends V> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return computeIfAbsent(key.shortValue(), mappingFunction instanceof Short2ObjectFunction ? (Short2ObjectFunction<V>)mappingFunction : K -> mappingFunction.apply(Short.valueOf(K)));
	}
