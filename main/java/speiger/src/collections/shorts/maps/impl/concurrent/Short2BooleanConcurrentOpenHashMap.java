 ...
 * 
 */
public class Short2BooleanConcurrentOpenHashMap extends AbstractShort2BooleanMap implements Short2BooleanConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Short2BooleanConcurrentOpenHashMap(boolean unused) {}
	 ...
	 */
	public Short2BooleanConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Short2BooleanConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2BooleanConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2BooleanConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2BooleanConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Short2BooleanConcurrentOpenHashMap(Short[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2BooleanConcurrentOpenHashMap(Short[] keys, Boolean[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2BooleanConcurrentOpenHashMap(Short[] keys, Boolean[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2BooleanConcurrentOpenHashMap(Short[] keys, Boolean[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2BooleanConcurrentOpenHashMap(Map<? extends Short, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2BooleanConcurrentOpenHashMap(Map<? extends Short, ? extends Boolean> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2BooleanConcurrentOpenHashMap(Map<? extends Short, ? extends Boolean> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2BooleanConcurrentOpenHashMap(Short2BooleanMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2BooleanConcurrentOpenHashMap(Short2BooleanMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2BooleanConcurrentOpenHashMap(Short2BooleanMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2BooleanConcurrentOpenHashMap(Short2BooleanMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	public Short2BooleanConcurrentOpenHashMap copy() {
		Short2BooleanConcurrentOpenHashMap copy = new Short2BooleanConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanMap.FastEntrySet {
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				...
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2BooleanConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractShortSet implements ShortSet {
		...
		public boolean remove(short o) {
			int oldSize = size();
			Short2BooleanConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2BooleanMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2BooleanMap.Entry> {
		MapEntry entry;
	...
	protected static class Segment extends StampedLock
	{
		...
		protected Segment(Short2BooleanConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Short2BooleanConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Short2BooleanConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected boolean put(int hash, short key, boolean value) {
		...
		protected boolean putIfAbsent(int hash, short key, boolean value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected boolean get(int hash, short key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean getOrDefault(int hash, short key, boolean defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ShortBooleanConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected boolean remove(int hash, short key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean removeOrDefault(int hash, short key, boolean defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, short key, boolean value) {
			long stamp = writeLock();
			try {
				if(key == (short)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				short current = keys[pos];
				if(current == (short)0) return false;
				if(Objects.equals(key, Short.valueOf(current)) && Objects.equals(value, Boolean.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (short)0) return false;
					else if(Objects.equals(key, Short.valueOf(current)) && Objects.equals(value, Boolean.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, short key, boolean oldValue, boolean newValue) {
			long stamp = writeLock();
			try {
		...
		protected boolean replace(int hash, short key, boolean value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected boolean compute(int hash, short key, ShortBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean computeIfAbsent(int hash, short key, Short2BooleanFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean supplyIfAbsent(int hash, short key, BooleanSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean computeIfPresent(int hash, short key, ShortBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected boolean merge(int hash, short key, boolean value, BooleanBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
