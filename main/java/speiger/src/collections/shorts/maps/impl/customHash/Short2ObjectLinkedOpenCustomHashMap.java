 ...
 */
public class Short2ObjectLinkedOpenCustomHashMap<V> extends Short2ObjectOpenCustomHashMap<V> implements Short2ObjectOrderedMap<V>
{
	 ...
	 */
	public Short2ObjectLinkedOpenCustomHashMap(ShortStrategy strategy) {
	 ...
	 */
	public Short2ObjectLinkedOpenCustomHashMap(int minCapacity, ShortStrategy strategy) {
	 ...
	 */
	public Short2ObjectLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ShortStrategy strategy) {
	 ...
	 */
	public Short2ObjectLinkedOpenCustomHashMap(Short[] keys, V[] values, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ObjectLinkedOpenCustomHashMap(Short[] keys, V[] values, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Short2ObjectLinkedOpenCustomHashMap(Map<? extends Short, ? extends V> map, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ObjectLinkedOpenCustomHashMap(Map<? extends Short, ? extends V> map, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Short2ObjectLinkedOpenCustomHashMap(Short2ObjectMap<V> map, ShortStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2ObjectLinkedOpenCustomHashMap(Short2ObjectMap<V> map, float loadFactor, ShortStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Short2ObjectLinkedOpenCustomHashMap<V> copy() {
		Short2ObjectLinkedOpenCustomHashMap<V> map = new Short2ObjectLinkedOpenCustomHashMap<>(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectOrderedMap.FastOrderedSet<V> {
		...
		public boolean moveToFirst(Short2ObjectMap.Entry<V> o) {
			return Short2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2ObjectMap.Entry<V> o) {
			return Short2ObjectLinkedOpenCustomHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ObjectMap.Entry) {
					...
					int index = Short2ObjectLinkedOpenCustomHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Short)) return false;
					int index = Short2ObjectLinkedOpenCustomHashMap.this.findIndex((Short)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
			}
			return false;
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ObjectMap.Entry) {
					Short2ObjectMap.Entry<V> entry = (Short2ObjectMap.Entry<V>)o;
					return Short2ObjectLinkedOpenCustomHashMap.this.remove(entry.getShortKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2ObjectLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2ObjectLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2ObjectLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2ObjectLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2ObjectLinkedOpenCustomHashMap.this.moveToLast(o);
		}
