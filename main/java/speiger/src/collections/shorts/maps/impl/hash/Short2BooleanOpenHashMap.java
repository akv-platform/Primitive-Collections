 ...
 */
public class Short2BooleanOpenHashMap extends AbstractShort2BooleanMap implements ITrimmable
{
	 ...
	 */
	public Short2BooleanOpenHashMap(int minCapacity) {
	 ...
	 */
	public Short2BooleanOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2BooleanOpenHashMap(Short[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2BooleanOpenHashMap(Short[] keys, Boolean[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2BooleanOpenHashMap(Map<? extends Short, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2BooleanOpenHashMap(Short2BooleanMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2BooleanOpenHashMap(Short2BooleanMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(keys[i] != (short)0 && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Boolean.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Short2BooleanOpenHashMap copy() {
		Short2BooleanOpenHashMap map = new Short2BooleanOpenHashMap(0, loadFactor);
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanMap.FastEntrySet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2BooleanMap.Entry) {
					...
					int index = Short2BooleanOpenHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getBooleanValue() == Short2BooleanOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Short2BooleanOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Short2BooleanOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2BooleanMap.Entry) {
					Short2BooleanMap.Entry entry = (Short2BooleanMap.Entry)o;
					return Short2BooleanOpenHashMap.this.remove(entry.getShortKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2BooleanOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractShortSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2BooleanOpenHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Short2BooleanOpenHashMap.this.remove(wrapped.getShort(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
