 ...
 */
public class Short2ByteLinkedOpenCustomHashMap extends Short2ByteOpenCustomHashMap implements Short2ByteOrderedMap
{
	 ...
	 */
	public Short2ByteLinkedOpenCustomHashMap(ShortStrategy strategy) {
	 ...
	 */
	public Short2ByteLinkedOpenCustomHashMap(int minCapacity, ShortStrategy strategy) {
	 ...
	 */
	public Short2ByteLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ShortStrategy strategy) {
	 ...
	 */
	public Short2ByteLinkedOpenCustomHashMap(Short[] keys, Byte[] values, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ByteLinkedOpenCustomHashMap(Short[] keys, Byte[] values, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Short2ByteLinkedOpenCustomHashMap(Map<? extends Short, ? extends Byte> map, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ByteLinkedOpenCustomHashMap(Map<? extends Short, ? extends Byte> map, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Short2ByteLinkedOpenCustomHashMap(Short2ByteMap map, ShortStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2ByteLinkedOpenCustomHashMap(Short2ByteMap map, float loadFactor, ShortStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Short2ByteLinkedOpenCustomHashMap copy() {
		Short2ByteLinkedOpenCustomHashMap map = new Short2ByteLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ByteMap.Entry> implements Short2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2ByteMap.Entry o) {
			return Short2ByteLinkedOpenCustomHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2ByteMap.Entry o) {
			return Short2ByteLinkedOpenCustomHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ByteMap.Entry) {
					...
					int index = Short2ByteLinkedOpenCustomHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getByteValue() == Short2ByteLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Short)) return false;
					int index = Short2ByteLinkedOpenCustomHashMap.this.findIndex((Short)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Short2ByteLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ByteMap.Entry) {
					Short2ByteMap.Entry entry = (Short2ByteMap.Entry)o;
					return Short2ByteLinkedOpenCustomHashMap.this.remove(entry.getShortKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2ByteLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2ByteLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2ByteLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2ByteLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2ByteLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2ByteLinkedOpenCustomHashMap.this.moveToLast(o);
		}
