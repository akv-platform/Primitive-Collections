...
public class Short2ObjectMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Short2ObjectMap<?> EMPTY = new EmptyMap<>();
	 ...
	 */
	public static <V> Short2ObjectMap.Entry<V> unmodifiable(Short2ObjectMap.Entry<V> entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @param <V> the type of elements maintained by this Collection
	 * @return a Unmodifyable Entry
	 */
	public static <V> Short2ObjectMap.Entry<V> unmodifiable(Map.Entry<Short, V> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry<V>)entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	...
	public static class UnmodifyableNavigableMap<V> extends UnmodifyableSortedMap<V> implements Short2ObjectNavigableMap<V> {
		...
		@Override
		public Short2ObjectNavigableMap<V> descendingMap() { return Short2ObjectMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Short2ObjectNavigableMap<V> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap<V> extends UnmodifyableMap<V> implements Short2ObjectOrderedMap<V> {
		...
		@Override
		public Short2ObjectOrderedMap<V> copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet<>(map.short2ObjectEntrySet());
			return (ObjectOrderedSet<Short2ObjectMap.Entry<V>>)entrySet;
		}
	}
	...
	public static class UnmodifyableSortedMap<V> extends UnmodifyableMap<V> implements Short2ObjectSortedMap<V> {
		...
		public V lastValue() { return map.lastValue(); }
		@Override
		public Short2ObjectSortedMap<V> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap<V> extends AbstractShort2ObjectMap<V> implements Short2ObjectMap<V> {
		...
		public void mergeAll(Short2ObjectMap<V> m, ObjectObjectUnaryOperator<V, V> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceObjects(ShortObjectUnaryOperator<V> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceObjects(Short2ObjectMap<V> m) { throw new UnsupportedOperationException(); }
		@Override
		public Short2ObjectMap<V> copy() { return map.copy(); }
		@Override
	 ...
	 * @param <V> the type of elements maintained by this Collection
	 */
	public static class UnmodifyableOrderedEntrySet<V> extends UnmodifyableEntrySet<V> implements ObjectOrderedSet<Short2ObjectMap.Entry<V>>
	{
		ObjectOrderedSet<Short2ObjectMap.Entry<V>> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Short2ObjectMap.Entry<V>> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Short2ObjectMap.Entry<V>> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator(Short2ObjectMap.Entry<V> fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Short2ObjectMap.Entry<V> first() { return set.first(); }
		@Override
		public Short2ObjectMap.Entry<V> pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Short2ObjectMap.Entry<V> last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap<V> extends SynchronizedSortedMap<V> implements Short2ObjectNavigableMap<V> {
		...
		@Override
		public Short2ObjectMap.Entry<V> lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Short2ObjectNavigableMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Short2ObjectNavigableMap<V> subMap(Short fromKey, boolean fromInclusive, Short toKey, boolean toInclusive) { synchronized(mutex) { return Short2ObjectMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap<V> extends SynchronizedMap<V> implements Short2ObjectOrderedMap<V> {
		...
		@Override
		public Short2ObjectOrderedMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ShortOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap<V> extends SynchronizedMap<V> implements Short2ObjectSortedMap<V> {
		...
		public V lastValue() { synchronized(mutex) { return map.lastValue(); } }
		@Override
		public Short2ObjectSortedMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap<V> extends AbstractShort2ObjectMap<V> implements Short2ObjectMap<V> {
		...
		@Override
		public V supplyIfAbsent(short key, ObjectSupplier<V> valueProvider) { synchronized(mutex) { return map.supplyIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Short2ObjectMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ShortSet keySet() {
			if(keys == null) keys = ShortSets.synchronize(map.keySet(), mutex);
			return keys;
