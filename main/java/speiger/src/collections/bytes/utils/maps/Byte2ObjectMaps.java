...
public class Byte2ObjectMaps
{
	 ...
	 */
	public static <V> Byte2ObjectMap.Entry<V> unmodifiable(Byte2ObjectMap.Entry<V> entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @param <V> the type of elements maintained by this Collection
	 * @return a Unmodifyable Entry
	 */
	public static <V> Byte2ObjectMap.Entry<V> unmodifiable(Map.Entry<Byte, V> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry<V>)entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	...
	public static class UnmodifyableNavigableMap<V> extends UnmodifyableSortedMap<V> implements Byte2ObjectNavigableMap<V> {
		...
		@Override
		public Byte2ObjectNavigableMap<V> descendingMap() { return Byte2ObjectMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Byte2ObjectNavigableMap<V> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap<V> extends UnmodifyableMap<V> implements Byte2ObjectOrderedMap<V> {
		...
		@Override
		public Byte2ObjectOrderedMap<V> copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet<>(map.byte2ObjectEntrySet());
	...
	public static class UnmodifyableSortedMap<V> extends UnmodifyableMap<V> implements Byte2ObjectSortedMap<V> {
		...
		public V lastValue() { return map.lastValue(); }
		@Override
		public Byte2ObjectSortedMap<V> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap<V> extends AbstractByte2ObjectMap<V> implements Byte2ObjectMap<V> {
		...
		public void mergeAll(Byte2ObjectMap<V> m, ObjectObjectUnaryOperator<V, V> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceObjects(ByteObjectUnaryOperator<V> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceObjects(Byte2ObjectMap<V> m) { throw new UnsupportedOperationException(); }
		@Override
	 ...
	 * @param <V> the type of elements maintained by this Collection
	 */
	public static class UnmodifyableOrderedEntrySet<V> extends UnmodifyableEntrySet<V> implements ObjectOrderedSet<Byte2ObjectMap.Entry<V>>
	{
		ObjectOrderedSet<Byte2ObjectMap.Entry<V>> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Byte2ObjectMap.Entry<V>> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Byte2ObjectMap.Entry<V>> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Byte2ObjectMap.Entry<V> first() { return set.first(); }
		@Override
		public Byte2ObjectMap.Entry<V> pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Byte2ObjectMap.Entry<V> last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap<V> extends SynchronizedSortedMap<V> implements Byte2ObjectNavigableMap<V> {
		...
		@Override
		public Byte2ObjectNavigableMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Byte2ObjectNavigableMap<V> subMap(Byte fromKey, boolean fromInclusive, Byte toKey, boolean toInclusive) { synchronized(mutex) { return Byte2ObjectMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap<V> extends SynchronizedMap<V> implements Byte2ObjectOrderedMap<V> {
		...
		@Override
		public Byte2ObjectOrderedMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ByteOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap<V> extends SynchronizedMap<V> implements Byte2ObjectSortedMap<V> {
		...
		public V lastValue() { synchronized(mutex) { return map.lastValue(); } }
		@Override
		public Byte2ObjectSortedMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap<V> extends AbstractByte2ObjectMap<V> implements Byte2ObjectMap<V> {
		...
		@Override
		public V supplyIfAbsent(byte key, ObjectSupplier<V> valueProvider) { synchronized(mutex) { return map.supplyIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Byte2ObjectMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ByteSet keySet() {
			if(keys == null) keys = ByteSets.synchronize(map.keySet(), mutex);
			return keys;
