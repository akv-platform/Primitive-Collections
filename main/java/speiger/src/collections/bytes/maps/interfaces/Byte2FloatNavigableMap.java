 ...
 */
public interface Byte2FloatNavigableMap extends Byte2FloatSortedMap, NavigableMap<Byte, Float>
{
	@Override
	public Byte2FloatNavigableMap copy();
	 ...
	 */
	public default Byte2FloatNavigableMap synchronize() { return Byte2FloatMaps.synchronize(this); }
	 ...
	 * @see Byte2FloatMaps#synchronize
	 */
	public default Byte2FloatNavigableMap synchronize(Object mutex) { return Byte2FloatMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Byte2FloatNavigableMap unmodifiable() { return Byte2FloatMaps.unmodifiable(this); }
	...
	@Override
	public default Byte2FloatNavigableMap subMap(byte fromKey, byte toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Byte2FloatNavigableMap headMap(byte toKey) { return headMap(toKey, false); }
	@Override
	public default Byte2FloatNavigableMap tailMap(byte fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Byte2FloatMap.Entry lowerEntry(Byte key) { return lowerEntry(key.byteValue()); }
	@Override
	@Deprecated
	default Byte2FloatMap.Entry floorEntry(Byte key) { return floorEntry(key.byteValue()); }
	@Override
	@Deprecated
	default Byte2FloatMap.Entry ceilingEntry(Byte key) { return ceilingEntry(key.byteValue()); }
	@Override
	@Deprecated
	default Byte2FloatMap.Entry higherEntry(Byte key) { return higherEntry(key.byteValue()); }
	
	@Override
	@Deprecated
	default Byte2FloatNavigableMap subMap(Byte fromKey, boolean fromInclusive, Byte toKey, boolean toInclusive) { return subMap(fromKey.byteValue(), fromInclusive, toKey.byteValue(), toInclusive); }
	@Override
	@Deprecated
	default Byte2FloatNavigableMap headMap(Byte toKey, boolean inclusive) { return headMap(toKey.byteValue(), inclusive); }
	@Override
	@Deprecated
	default Byte2FloatNavigableMap tailMap(Byte fromKey, boolean inclusive) { return tailMap(fromKey.byteValue(), inclusive); }
	@Override
	@Deprecated
	default Byte2FloatNavigableMap subMap(Byte fromKey, Byte toKey) { return subMap(fromKey.byteValue(), true, toKey.byteValue(), false); }
	@Override
	@Deprecated
	default Byte2FloatNavigableMap headMap(Byte toKey) { return headMap(toKey.byteValue(), false); }
	@Override
	@Deprecated
	default Byte2FloatNavigableMap tailMap(Byte fromKey) { return tailMap(fromKey.byteValue(), true); }
}