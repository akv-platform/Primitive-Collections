...
public interface Byte2ByteMap extends Map<Byte, Byte>, Byte2ByteFunction
{
	...
	public default Byte computeIfAbsent(Byte key, Function<? super Byte, ? extends Byte> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return Byte.valueOf(computeByteIfAbsent(key.byteValue(), mappingFunction instanceof Byte2ByteFunction ? (Byte2ByteFunction)mappingFunction : K -> mappingFunction.apply(Byte.valueOf(K)).byteValue()));
	}
