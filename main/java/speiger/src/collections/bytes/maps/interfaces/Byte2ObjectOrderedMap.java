 ...
 */
public interface Byte2ObjectOrderedMap<V> extends Byte2ObjectMap<V>
{
	/**
	 ...
	 */
	@Override
	public default Byte2ObjectOrderedMap<V> synchronize() { return Byte2ObjectMaps.synchronize(this); }
	 ...
	 */
	@Override
	public default Byte2ObjectOrderedMap<V> synchronize(Object mutex) { return Byte2ObjectMaps.synchronize(this, mutex); }
	 ...
	 */
	@Override
	public default Byte2ObjectOrderedMap<V> unmodifiable() { return Byte2ObjectMaps.unmodifiable(this); }
	
	/**
	 * Fast Ordered Entry Set that allows for a faster Entry Iterator by recycling the Entry Object and just exchanging 1 internal value
	 * @param <V> the type of elements maintained by this Collection
	 */
	interface FastOrderedSet<V> extends Byte2ObjectMap.FastEntrySet<V>, ObjectOrderedSet<Byte2ObjectMap.Entry<V>> {
		@Override
