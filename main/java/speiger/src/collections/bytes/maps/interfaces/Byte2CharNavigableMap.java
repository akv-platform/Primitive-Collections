 ...
 */
public interface Byte2CharNavigableMap extends Byte2CharSortedMap, NavigableMap<Byte, Character>
{
	@Override
	 ...
	 */
	public default Byte2CharNavigableMap synchronize() { return Byte2CharMaps.synchronize(this); }
	 ...
	 * @see Byte2CharMaps#synchronize
	 */
	public default Byte2CharNavigableMap synchronize(Object mutex) { return Byte2CharMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Byte2CharNavigableMap unmodifiable() { return Byte2CharMaps.unmodifiable(this); }
	...
	@Override
	public default Byte2CharNavigableMap subMap(byte fromKey, byte toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Byte2CharNavigableMap headMap(byte toKey) { return headMap(toKey, false); }
	@Override
	public default Byte2CharNavigableMap tailMap(byte fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Byte2CharMap.Entry lowerEntry(Byte key) { return lowerEntry(key.byteValue()); }
	@Override
	@Deprecated
	default Byte2CharMap.Entry floorEntry(Byte key) { return floorEntry(key.byteValue()); }
	@Override
	@Deprecated
	default Byte2CharMap.Entry ceilingEntry(Byte key) { return ceilingEntry(key.byteValue()); }
	@Override
	@Deprecated
	default Byte2CharMap.Entry higherEntry(Byte key) { return higherEntry(key.byteValue()); }
	
	@Override
	@Deprecated
	default Byte2CharNavigableMap subMap(Byte fromKey, boolean fromInclusive, Byte toKey, boolean toInclusive) { return subMap(fromKey.byteValue(), fromInclusive, toKey.byteValue(), toInclusive); }
	@Override
	@Deprecated
	default Byte2CharNavigableMap headMap(Byte toKey, boolean inclusive) { return headMap(toKey.byteValue(), inclusive); }
	@Override
	@Deprecated
	default Byte2CharNavigableMap tailMap(Byte fromKey, boolean inclusive) { return tailMap(fromKey.byteValue(), inclusive); }
	@Override
	@Deprecated
	default Byte2CharNavigableMap subMap(Byte fromKey, Byte toKey) { return subMap(fromKey.byteValue(), true, toKey.byteValue(), false); }
	@Override
	@Deprecated
	default Byte2CharNavigableMap headMap(Byte toKey) { return headMap(toKey.byteValue(), false); }
	@Override
	@Deprecated
	default Byte2CharNavigableMap tailMap(Byte fromKey) { return tailMap(fromKey.byteValue(), true); }
}