...
public abstract class AbstractByte2LongMap extends AbstractMap<Byte, Long> implements Byte2LongMap
{
	...
	public void putAll(Byte2LongMap m) {
		for(ObjectIterator<Byte2LongMap.Entry> iter = Byte2LongMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceLongs(ByteLongUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Byte2LongMap.Entry> iter = Byte2LongMaps.fastIterator(this);iter.hasNext();) {
			Byte2LongMap.Entry entry = iter.next();
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					ObjectIterator<Byte2LongMap.Entry> iter = Byte2LongMaps.fastIterator(AbstractByte2LongMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Byte2LongMap.Entry> iter = Byte2LongMaps.fastIterator(this);
