 ...
 */
public class Byte2BooleanLinkedOpenHashMap extends Byte2BooleanOpenHashMap implements Byte2BooleanOrderedMap
{
	 ...
	 */
	public Byte2BooleanLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Byte2BooleanLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2BooleanLinkedOpenHashMap(Byte[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2BooleanLinkedOpenHashMap(Byte[] keys, Boolean[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2BooleanLinkedOpenHashMap(Map<? extends Byte, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2BooleanLinkedOpenHashMap(Byte2BooleanMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2BooleanLinkedOpenHashMap(Byte2BooleanMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Byte2BooleanLinkedOpenHashMap copy() {
		Byte2BooleanLinkedOpenHashMap map = new Byte2BooleanLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> implements Byte2BooleanOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Byte2BooleanMap.Entry o) {
			return Byte2BooleanLinkedOpenHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2BooleanMap.Entry o) {
			return Byte2BooleanLinkedOpenHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2BooleanMap.Entry) {
					...
					int index = Byte2BooleanLinkedOpenHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getBooleanValue() == Byte2BooleanLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Byte2BooleanLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Byte2BooleanLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2BooleanMap.Entry) {
					Byte2BooleanMap.Entry entry = (Byte2BooleanMap.Entry)o;
					return Byte2BooleanLinkedOpenHashMap.this.remove(entry.getByteKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2BooleanLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2BooleanLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2BooleanLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2BooleanLinkedOpenHashMap.this.moveToLast(o);
		}
