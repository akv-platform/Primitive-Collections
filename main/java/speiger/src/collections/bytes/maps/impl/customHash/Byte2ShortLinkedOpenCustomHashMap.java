 ...
 */
public class Byte2ShortLinkedOpenCustomHashMap extends Byte2ShortOpenCustomHashMap implements Byte2ShortOrderedMap
{
	 ...
	 */
	public Byte2ShortLinkedOpenCustomHashMap(ByteStrategy strategy) {
	 ...
	 */
	public Byte2ShortLinkedOpenCustomHashMap(int minCapacity, ByteStrategy strategy) {
	 ...
	 */
	public Byte2ShortLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ByteStrategy strategy) {
	 ...
	 */
	public Byte2ShortLinkedOpenCustomHashMap(Byte[] keys, Short[] values, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ShortLinkedOpenCustomHashMap(Byte[] keys, Short[] values, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Byte2ShortLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Short> map, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ShortLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Short> map, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Byte2ShortLinkedOpenCustomHashMap(Byte2ShortMap map, ByteStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2ShortLinkedOpenCustomHashMap(Byte2ShortMap map, float loadFactor, ByteStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	
	@Override
	public short putAndMoveToFirst(byte key, short value) {
	...
	@Override
	public Byte2ShortLinkedOpenCustomHashMap copy() {
		Byte2ShortLinkedOpenCustomHashMap map = new Byte2ShortLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2ShortMap.Entry> implements Byte2ShortOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Byte2ShortMap.Entry o) {
			return Byte2ShortLinkedOpenCustomHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2ShortMap.Entry o) {
			return Byte2ShortLinkedOpenCustomHashMap.this.moveToLast(o.getByteKey());
		}
		...
		@Override
		public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry fromElement) {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ShortMap.Entry) {
					...
					int index = Byte2ShortLinkedOpenCustomHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getShortValue() == Byte2ShortLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Byte)) return false;
					int index = Byte2ShortLinkedOpenCustomHashMap.this.findIndex((Byte)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Byte2ShortLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ShortMap.Entry) {
					Byte2ShortMap.Entry entry = (Byte2ShortMap.Entry)o;
					return Byte2ShortLinkedOpenCustomHashMap.this.remove(entry.getByteKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2ShortLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2ShortLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2ShortLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2ShortLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Byte2ShortMap.Entry> {
		...
		@Override
		public void set(Byte2ShortMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Byte2ShortMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
