...
import speiger.src.collections.bytes.maps.interfaces.Byte2LongConcurrentMap;
 ...
 * 
 */
public class Byte2LongConcurrentOpenHashMap extends AbstractByte2LongMap implements Byte2LongConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Byte2LongConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Byte2LongConcurrentOpenHashMap() {
	 ...
	 */
	public Byte2LongConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Byte2LongConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2LongConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2LongConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2LongConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Byte2LongConcurrentOpenHashMap(Byte[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2LongConcurrentOpenHashMap(Byte[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2LongConcurrentOpenHashMap(Byte[] keys, Long[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2LongConcurrentOpenHashMap(Byte[] keys, Long[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Byte2LongConcurrentOpenHashMap(Map<? extends Byte, ? extends Long> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2LongConcurrentOpenHashMap(Map<? extends Byte, ? extends Long> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2LongConcurrentOpenHashMap(Map<? extends Byte, ? extends Long> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2LongConcurrentOpenHashMap(Map<? extends Byte, ? extends Long> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2LongConcurrentOpenHashMap(Byte2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2LongConcurrentOpenHashMap(Byte2LongMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Byte2LongConcurrentOpenHashMap(Byte2LongMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Byte2LongConcurrentOpenHashMap(Byte2LongMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Byte2LongConcurrentOpenHashMap copy() {
		Byte2LongConcurrentOpenHashMap copy = new Byte2LongConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2LongMap.Entry> implements Byte2LongMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2LongMap.Entry) {
					Byte2LongMap.Entry entry = (Byte2LongMap.Entry)o;
					return Byte2LongConcurrentOpenHashMap.this.remove(entry.getByteKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2LongConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Byte2LongConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Byte2LongConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractByteSet implements ByteSet {
		...
		public boolean remove(byte o) {
			int oldSize = size();
			Byte2LongConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Byte2LongMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Byte2LongMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Byte2LongMap.Entry, Map.Entry<Byte, Long> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Byte2LongMap.Entry) {
					...
					return getByteKey() == entry.getByteKey() && getLongValue() == entry.getLongValue();
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Byte && value instanceof Long && getByteKey() == ((Byte)key).byteValue() && getLongValue() == ((Long)value).longValue();
			}
			return false;
		}
		...
		public String toString() {
			return Byte.toString(getByteKey()) + "=" + Long.toString(getLongValue());
		}
	}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Byte2LongConcurrentOpenHashMap map;
		...
		protected Segment(Byte2LongConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Byte2LongConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Byte2LongConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected long put(int hash, byte key, long value) {
		...
		protected long putIfAbsent(int hash, byte key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected long addTo(int hash, byte key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected long subFrom(int hash, byte key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected long get(int hash, byte key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected long getOrDefault(int hash, byte key, long defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ByteLongConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected long remove(int hash, byte key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected long removeOrDefault(int hash, byte key, long defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, byte key, long value) {
			long stamp = writeLock();
			try {
				if(key == (byte)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				byte current = keys[pos];
				if(current == (byte)0) return false;
				if(Objects.equals(key, Byte.valueOf(current)) && Objects.equals(value, Long.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (byte)0) return false;
					else if(Objects.equals(key, Byte.valueOf(current)) && Objects.equals(value, Long.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, byte key, long oldValue, long newValue) {
			long stamp = writeLock();
			try {
		...
		protected long replace(int hash, byte key, long value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected long compute(int hash, byte key, ByteLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long merge(int hash, byte key, long value, LongLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected void insert(int slot, byte key, long value) {
