 ...
 */
public class Byte2ObjectLinkedOpenHashMap<V> extends Byte2ObjectOpenHashMap<V> implements Byte2ObjectOrderedMap<V>
{
	 ...
	 */
	public Byte2ObjectLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2ObjectLinkedOpenHashMap(Byte[] keys, V[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ObjectLinkedOpenHashMap(Byte[] keys, V[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ObjectLinkedOpenHashMap(Map<? extends Byte, ? extends V> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2ObjectLinkedOpenHashMap(Byte2ObjectMap<V> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2ObjectLinkedOpenHashMap(Byte2ObjectMap<V> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Byte2ObjectLinkedOpenHashMap<V> copy() {
		Byte2ObjectLinkedOpenHashMap<V> map = new Byte2ObjectLinkedOpenHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry<V>> implements Byte2ObjectOrderedMap.FastOrderedSet<V> {
		...
		public boolean moveToFirst(Byte2ObjectMap.Entry<V> o) {
			return Byte2ObjectLinkedOpenHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2ObjectMap.Entry<V> o) {
			return Byte2ObjectLinkedOpenHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ObjectMap.Entry) {
					...
					int index = Byte2ObjectLinkedOpenHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte2ObjectLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Byte2ObjectLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte2ObjectLinkedOpenHashMap.this.values[index]);
				}
			}
			return false;
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ObjectMap.Entry) {
					Byte2ObjectMap.Entry<V> entry = (Byte2ObjectMap.Entry<V>)o;
					return Byte2ObjectLinkedOpenHashMap.this.remove(entry.getByteKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2ObjectLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2ObjectLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2ObjectLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2ObjectLinkedOpenHashMap.this.moveToLast(o);
		}
