...
public abstract class AbstractObject2BooleanMap<T> extends AbstractMap<T, Boolean> implements Object2BooleanMap<T>
{
	...
	public void putAll(Object2BooleanMap<T> m) {
		for(ObjectIterator<Object2BooleanMap.Entry<T>> iter = Object2BooleanMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBooleans(ObjectBooleanUnaryOperator<T> mappingFunction) {
		...
		for(ObjectIterator<Object2BooleanMap.Entry<T>> iter = Object2BooleanMaps.fastIterator(this);iter.hasNext();) {
			Object2BooleanMap.Entry<T> entry = iter.next();
		...
		return new AbstractObjectSet<T>() {
			...
			public ObjectIterator<T> iterator() {
				return new ObjectIterator<T>() {
					ObjectIterator<Object2BooleanMap.Entry<T>> iter = Object2BooleanMaps.fastIterator(AbstractObject2BooleanMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Object2BooleanMap.Entry<T>> iter = Object2BooleanMaps.fastIterator(this);
