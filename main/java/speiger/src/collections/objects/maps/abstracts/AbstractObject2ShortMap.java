...
public abstract class AbstractObject2ShortMap<T> extends AbstractMap<T, Short> implements Object2ShortMap<T>
{
	...
	public void putAll(Object2ShortMap<T> m) {
		for(ObjectIterator<Object2ShortMap.Entry<T>> iter = Object2ShortMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceShorts(ObjectShortUnaryOperator<T> mappingFunction) {
		...
		for(ObjectIterator<Object2ShortMap.Entry<T>> iter = Object2ShortMaps.fastIterator(this);iter.hasNext();) {
			Object2ShortMap.Entry<T> entry = iter.next();
		...
		return new AbstractObjectSet<T>() {
			...
			public ObjectIterator<T> iterator() {
				return new ObjectIterator<T>() {
					ObjectIterator<Object2ShortMap.Entry<T>> iter = Object2ShortMaps.fastIterator(AbstractObject2ShortMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Object2ShortMap.Entry<T>> iter = Object2ShortMaps.fastIterator(this);
