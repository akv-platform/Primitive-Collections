...
import speiger.src.collections.objects.maps.interfaces.Object2FloatConcurrentMap;
 ...
 */
public class Object2FloatConcurrentOpenHashMap<T> extends AbstractObject2FloatMap<T> implements Object2FloatConcurrentMap<T>, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Object2FloatConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Object2FloatConcurrentOpenHashMap() {
	 ...
	 */
	public Object2FloatConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Object2FloatConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2FloatConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2FloatConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Object2FloatConcurrentOpenHashMap(T[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2FloatConcurrentOpenHashMap(T[] keys, Float[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2FloatConcurrentOpenHashMap(T[] keys, Float[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2FloatConcurrentOpenHashMap(T[] keys, Float[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Object2FloatConcurrentOpenHashMap(Map<? extends T, ? extends Float> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2FloatConcurrentOpenHashMap(Map<? extends T, ? extends Float> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2FloatConcurrentOpenHashMap(Map<? extends T, ? extends Float> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2FloatConcurrentOpenHashMap(Map<? extends T, ? extends Float> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Object2FloatConcurrentOpenHashMap(Object2FloatMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2FloatConcurrentOpenHashMap(Object2FloatMap<T> map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Object2FloatConcurrentOpenHashMap(Object2FloatMap<T> map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Object2FloatConcurrentOpenHashMap(Object2FloatMap<T> map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Object2FloatConcurrentOpenHashMap<T> copy() {
		Object2FloatConcurrentOpenHashMap<T> copy = new Object2FloatConcurrentOpenHashMap<>(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2FloatMap.Entry<T>> implements Object2FloatMap.FastEntrySet<T> {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2FloatMap.Entry) {
					Object2FloatMap.Entry<T> entry = (Object2FloatMap.Entry<T>)o;
					return Object2FloatConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2FloatConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Object2FloatConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Object2FloatConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size();
			Object2FloatConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Object2FloatMap.Entry<T>> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Object2FloatMap.Entry<T>> {
		MapEntry entry;
	...
	protected static class Segment<T> extends StampedLock
	{
		...
		protected final Object2FloatConcurrentOpenHashMap<T> map;
		...
		protected Segment(Object2FloatConcurrentOpenHashMap<T> map) {
			this.map = map;
		}
		
		protected Segment(Object2FloatConcurrentOpenHashMap<T> map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment<T> copy(Object2FloatConcurrentOpenHashMap<T> newMap) {
			long stamp = readLock();
			try
			{
		...
		protected float put(int hash, T key, float value) {
		...
		protected float putIfAbsent(int hash, T key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected float addTo(int hash, T key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected float subFrom(int hash, T key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected float getOrDefault(int hash, T key, float defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ObjectFloatConsumer<T> action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected float removeOrDefault(int hash, T key, float defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, T key, float value) {
			long stamp = writeLock();
			try {
				if(key == null) {
		...
		protected boolean replace(int hash, T key, float oldValue, float newValue) {
			long stamp = writeLock();
			try {
		...
		protected float replace(int hash, T key, float value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected float compute(int hash, T key, ObjectFloatUnaryOperator<T> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected float computeIfAbsent(int hash, T key, Object2FloatFunction<T> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected float supplyIfAbsent(int hash, T key, FloatSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected float computeIfPresent(int hash, T key, ObjectFloatUnaryOperator<T> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected float merge(int hash, T key, float value, FloatFloatUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
