 ...
 */
public class Object2DoubleLinkedOpenHashMap<T> extends Object2DoubleOpenHashMap<T> implements Object2DoubleOrderedMap<T>
{
	 ...
	 */
	public Object2DoubleLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Object2DoubleLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Object2DoubleLinkedOpenHashMap(T[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2DoubleLinkedOpenHashMap(T[] keys, Double[] values, float loadFactor) {
	 ...
	 */
	public Object2DoubleLinkedOpenHashMap(Map<? extends T, ? extends Double> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2DoubleLinkedOpenHashMap(Map<? extends T, ? extends Double> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Object2DoubleLinkedOpenHashMap(Object2DoubleMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2DoubleLinkedOpenHashMap(Object2DoubleMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Object2DoubleLinkedOpenHashMap<T> copy() {
		Object2DoubleLinkedOpenHashMap<T> map = new Object2DoubleLinkedOpenHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry<T>> implements Object2DoubleOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2DoubleMap.Entry<T> o) {
			return Object2DoubleLinkedOpenHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2DoubleMap.Entry<T> o) {
			return Object2DoubleLinkedOpenHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2DoubleMap.Entry) {
					...
					int index = Object2DoubleLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Object2DoubleLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2DoubleLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Object2DoubleLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2DoubleMap.Entry) {
					Object2DoubleMap.Entry<T> entry = (Object2DoubleMap.Entry<T>)o;
					return Object2DoubleLinkedOpenHashMap.this.remove(entry.getKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2DoubleLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2DoubleLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Object2DoubleLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Object2DoubleLinkedOpenHashMap.this.moveToLast(o);
		}
