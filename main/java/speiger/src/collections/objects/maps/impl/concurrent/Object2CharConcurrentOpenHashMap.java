...
import speiger.src.collections.objects.maps.interfaces.Object2CharConcurrentMap;
 ...
 */
public class Object2CharConcurrentOpenHashMap<T> extends AbstractObject2CharMap<T> implements Object2CharConcurrentMap<T>, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Object2CharConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Object2CharConcurrentOpenHashMap() {
	 ...
	 */
	public Object2CharConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Object2CharConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Object2CharConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2CharConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2CharConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Object2CharConcurrentOpenHashMap(T[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2CharConcurrentOpenHashMap(T[] keys, Character[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2CharConcurrentOpenHashMap(T[] keys, Character[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2CharConcurrentOpenHashMap(T[] keys, Character[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Object2CharConcurrentOpenHashMap(T[] keys, char[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2CharConcurrentOpenHashMap(T[] keys, char[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2CharConcurrentOpenHashMap(T[] keys, char[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2CharConcurrentOpenHashMap(T[] keys, char[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Object2CharConcurrentOpenHashMap(Map<? extends T, ? extends Character> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2CharConcurrentOpenHashMap(Map<? extends T, ? extends Character> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2CharConcurrentOpenHashMap(Map<? extends T, ? extends Character> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Object2CharConcurrentOpenHashMap(Map<? extends T, ? extends Character> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Object2CharConcurrentOpenHashMap(Object2CharMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2CharConcurrentOpenHashMap(Object2CharMap<T> map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Object2CharConcurrentOpenHashMap(Object2CharMap<T> map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Object2CharConcurrentOpenHashMap(Object2CharMap<T> map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Object2CharConcurrentOpenHashMap<T> copy() {
		Object2CharConcurrentOpenHashMap<T> copy = new Object2CharConcurrentOpenHashMap<>(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2CharMap.Entry<T>> implements Object2CharMap.FastEntrySet<T> {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2CharMap.Entry) {
					Object2CharMap.Entry<T> entry = (Object2CharMap.Entry<T>)o;
					return Object2CharConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2CharConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Object2CharConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Object2CharConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size();
			Object2CharConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Object2CharMap.Entry<T>> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Object2CharMap.Entry<T>> {
		MapEntry entry;
	...
	protected static class Segment<T> extends StampedLock
	{
		...
		protected final Object2CharConcurrentOpenHashMap<T> map;
		...
		protected Segment(Object2CharConcurrentOpenHashMap<T> map) {
			this.map = map;
		}
		
		protected Segment(Object2CharConcurrentOpenHashMap<T> map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment<T> copy(Object2CharConcurrentOpenHashMap<T> newMap) {
			long stamp = readLock();
			try
			{
		...
		protected char put(int hash, T key, char value) {
		...
		protected char putIfAbsent(int hash, T key, char value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected char addTo(int hash, T key, char value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected char subFrom(int hash, T key, char value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected char getOrDefault(int hash, T key, char defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ObjectCharConsumer<T> action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected char removeOrDefault(int hash, T key, char defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, T key, char value) {
			long stamp = writeLock();
			try {
				if(key == null) {
		...
		protected boolean replace(int hash, T key, char oldValue, char newValue) {
			long stamp = writeLock();
			try {
		...
		protected char replace(int hash, T key, char value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected char compute(int hash, T key, ObjectCharUnaryOperator<T> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected char computeIfAbsent(int hash, T key, Object2CharFunction<T> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
				...
				if(newValue == getDefaultReturnValue()) {
					newValue = mappingFunction.getChar(key);
					if(newValue == getDefaultReturnValue()) return newValue;
					values[index] = newValue;
				}
				return newValue;
		...
		protected char supplyIfAbsent(int hash, T key, CharSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected char computeIfPresent(int hash, T key, ObjectCharUnaryOperator<T> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected char merge(int hash, T key, char value, CharCharUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
