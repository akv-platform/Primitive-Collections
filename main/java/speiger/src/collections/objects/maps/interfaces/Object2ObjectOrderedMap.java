...
public interface Object2ObjectOrderedMap<T, V> extends Object2ObjectMap<T, V>
{
	 ...
	 */
	@Override
	public default Object2ObjectOrderedMap<T, V> synchronize() { return Object2ObjectMaps.synchronize(this); }
	 ...
	 */
	@Override
	public default Object2ObjectOrderedMap<T, V> synchronize(Object mutex) { return Object2ObjectMaps.synchronize(this, mutex); }
	 ...
	 */
	@Override
	public default Object2ObjectOrderedMap<T, V> unmodifiable() { return Object2ObjectMaps.unmodifiable(this); }
	 ...
	 * @param <V> the type of elements maintained by this Collection
	 */
	interface FastOrderedSet<T, V> extends Object2ObjectMap.FastEntrySet<T, V>, ObjectOrderedSet<Object2ObjectMap.Entry<T, V>> {
		@Override
