...
public interface Object2CharMap<T> extends Map<T, Character>, Object2CharFunction<T>
{
	...
	public default Character computeIfAbsent(T key, Function<? super T, ? extends Character> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return Character.valueOf(computeCharIfAbsent(key, mappingFunction instanceof Object2CharFunction ? (Object2CharFunction<T>)mappingFunction : K -> mappingFunction.apply(K).charValue()));
	}
