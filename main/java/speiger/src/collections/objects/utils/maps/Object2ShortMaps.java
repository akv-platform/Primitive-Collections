...
public class Object2ShortMaps
{
	 ...
	 */
	public static <T> Object2ShortMap.Entry<T> unmodifiable(Object2ShortMap.Entry<T> entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @param <T> the type of elements maintained by this Collection
	 * @return a Unmodifyable Entry
	 */
	public static <T> Object2ShortMap.Entry<T> unmodifiable(Map.Entry<T, Short> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry<T>)entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	...
	public static class UnmodifyableNavigableMap<T> extends UnmodifyableSortedMap<T> implements Object2ShortNavigableMap<T> {
		...
		@Override
		public Object2ShortNavigableMap<T> descendingMap() { return Object2ShortMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Object2ShortNavigableMap<T> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap<T> extends UnmodifyableMap<T> implements Object2ShortOrderedMap<T> {
		...
		public ObjectOrderedSet<Object2ShortMap.Entry<T>> object2ShortEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet<>(map.object2ShortEntrySet());
	...
	public static class UnmodifyableSortedMap<T> extends UnmodifyableMap<T> implements Object2ShortSortedMap<T> {
		...
		public short lastShortValue() { return map.lastShortValue(); }
		@Override
		public Object2ShortSortedMap<T> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap<T> extends AbstractObject2ShortMap<T> implements Object2ShortMap<T> {
		...
		public void mergeAllShort(Object2ShortMap<T> m, ShortShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(ObjectShortUnaryOperator<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(Object2ShortMap<T> m) { throw new UnsupportedOperationException(); }
		@Override
		public Object2ShortMap<T> copy() { return map.copy(); }
		@Override
	 ...
	 * @param <T> the type of elements maintained by this Collection
	 */
	public static class UnmodifyableOrderedEntrySet<T> extends UnmodifyableEntrySet<T> implements ObjectOrderedSet<Object2ShortMap.Entry<T>>
	{
		ObjectOrderedSet<Object2ShortMap.Entry<T>> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Object2ShortMap.Entry<T>> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Object2ShortMap.Entry<T>> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Object2ShortMap.Entry<T>> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Object2ShortMap.Entry<T>> iterator(Object2ShortMap.Entry<T> fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Object2ShortMap.Entry<T> first() { return set.first(); }
		@Override
		public Object2ShortMap.Entry<T> pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Object2ShortMap.Entry<T> last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap<T> extends SynchronizedSortedMap<T> implements Object2ShortNavigableMap<T> {
		...
		@Override
		public Object2ShortMap.Entry<T> lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Object2ShortNavigableMap<T> copy() { synchronized(mutex) { return map.copy(); } }
	}
	...
	public static class SynchronizedSortedMap<T> extends SynchronizedMap<T> implements Object2ShortSortedMap<T> {
		...
		public short lastShortValue() { synchronized(mutex) { return map.lastShortValue(); } }
		@Override
		public Object2ShortSortedMap<T> copy() { synchronized(mutex) { return map.copy(); } }
	}
	...
	public static class SynchronizedMap<T> extends AbstractObject2ShortMap<T> implements Object2ShortMap<T> {
		...
		@Override
		public short supplyShortIfAbsent(T key, ShortSupplier valueProvider) { synchronized(mutex) { return map.supplyShortIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Object2ShortMap<T> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ObjectSet<T> keySet() {
			if(keys == null) keys = ObjectSets.synchronize(map.keySet(), mutex);
			return keys;
