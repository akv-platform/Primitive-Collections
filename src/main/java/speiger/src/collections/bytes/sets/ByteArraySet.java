...
//	private class SubSet extends AbstractByteSet implements ByteSortedSet {
//		int offset;
//		int length;
//		
...
//		public byte pollLastByte() {
//			if(length == 0) throw new NoSuchElementException();
//			byte result = data[offset+length];
//			size--;
//			length--;
//			System.arraycopy(data, end()+1, data, end(), size-end());
//#if TYPE_OBJECT
...
//			Object[] obj = new Object[size()];
//			for(int i = 0;i<size();i++)
//				obj[i] = Byte.valueOf(data[offset+i]);
//			return obj;
//		}
//		
//		@Override
...
//			else if(a.length < size()) a = (E[])ObjectArrays.newArray(a.getClass().getComponentType(), size());
//			for(int i = 0;i<size();i++)
//				a[i] = (E)Byte.valueOf(data[offset+i]);
//			return a;
//		}
//		
//#if !TYPE_OBJECT
...
//		protected int findIndex(Object o) {
//			for(int i = length-1;i>=0;i--)
//				if(Objects.equals(o, Byte.valueOf(data[offset+i]))) return i + offset;
//			return -1;
//		}
//		
