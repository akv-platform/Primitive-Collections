...
public class ByteAVLTreeSet extends AbstractByteSet implements ByteNavigableSet
{
	 ...
	 */
	public ByteAVLTreeSet(ByteComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public ByteAVLTreeSet(byte[] array) {
	 ...
	 */
	public ByteAVLTreeSet(byte[] array, int offset, int length) {
	 ...
	 */
	public ByteAVLTreeSet(byte[] array, ByteComparator comp) {
	 ...
	 * @throws IllegalStateException if offset and length causes to step outside of the arrays range
	 */
	public ByteAVLTreeSet(byte[] array, int offset, int length, ByteComparator comp) {
		comparator = comp;
		SanityChecks.checkArrayCapacity(array.length, offset, length);
		for(int i = 0;i<length;i++) add(array[offset+i]);
	}
	 ...
	 */
	public ByteAVLTreeSet(ByteSortedSet sortedSet) {
	 ...
	 */
	@Deprecated
	public ByteAVLTreeSet(Collection<? extends Byte> collection, ByteComparator comp) {
		comparator = comp;
		addAll(collection);
	}
	 ...
	 * @param collection the set the elements should be added to the TreeSet
	 */
	public ByteAVLTreeSet(ByteCollection collection) {
		addAll(collection);
	}
	 ...
	 * @param comp the sorter of the tree, can be null
	 */
	public ByteAVLTreeSet(ByteCollection collection, ByteComparator comp) {
		comparator = comp;
		addAll(collection);
	}
	 ...
	 */
	public ByteAVLTreeSet(Iterator<Byte> iterator) {
	 ...
	 * @param comp the sorter of the tree, can be null
	 */
	public ByteAVLTreeSet(Iterator<Byte> iterator, ByteComparator comp) {
	 ...
	 * @param iterator the elements that should be added to the set
	 */
	public ByteAVLTreeSet(ByteIterator iterator) {
	 ...
	 * @param comp the sorter of the tree, can be null
	 */
	public ByteAVLTreeSet(ByteIterator iterator, ByteComparator comp) {
		comparator = comp;
		while(iterator.hasNext()) add(iterator.nextByte());
	}
	...
	public ByteAVLTreeSet copy() {
		ByteAVLTreeSet set = new ByteAVLTreeSet();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
	...
	{
		public AscendingSubSet(ByteAVLTreeSet set, boolean fromStart, byte lo, boolean loInclusive, boolean toEnd, byte hi, boolean hiInclusive)
		{
	...
	static class DescendingSubSet extends SubSet
	{
		...
		public DescendingSubSet(ByteAVLTreeSet set, boolean fromStart, byte lo, boolean loInclusive, boolean toEnd, byte hi, boolean hiInclusive)
		{
			super(set, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class SubSet extends AbstractByteSet implements ByteNavigableSet
	{
		...
		public SubSet(ByteAVLTreeSet set, boolean fromStart, byte lo, boolean loInclusive, boolean toEnd, byte hi, boolean hiInclusive)
		{
			this.set = set;
			this.lo = lo;
			this.hi = hi;
