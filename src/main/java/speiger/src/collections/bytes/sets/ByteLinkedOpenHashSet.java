...
public class ByteLinkedOpenHashSet extends ByteOpenHashSet implements ByteOrderedSet
{
	 ...
	 */
	public ByteLinkedOpenHashSet(int minCapacity, float loadFactor) {
	 ...
	 */
	public ByteLinkedOpenHashSet(byte[] array) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public ByteLinkedOpenHashSet(byte[] array, float loadFactor) {
	 ...
	 */
	public ByteLinkedOpenHashSet(byte[] array, int offset, int length) {
	 ...
	 * @throws IllegalStateException if offset and length causes to step outside of the arrays range
	 */
	public ByteLinkedOpenHashSet(byte[] array, int offset, int length, float loadFactor) {
		this(length);
	 ...
	 */
	@Deprecated
	public ByteLinkedOpenHashSet(Collection<? extends Byte> collection, float loadFactor) {
	 ...
	 * @param collection the set the elements should be added to the Set
	 */
	public ByteLinkedOpenHashSet(ByteCollection collection) {
		this(collection, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public ByteLinkedOpenHashSet(ByteCollection collection, float loadFactor) {
	 ...
	 */
	public ByteLinkedOpenHashSet(Iterator<Byte> iterator) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public ByteLinkedOpenHashSet(Iterator<Byte> iterator, float loadFactor) {
	 ...
	 * @param iterator the elements that should be added to the set
	 */
	public ByteLinkedOpenHashSet(ByteIterator iterator) {
		this(iterator, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	...
	@Override
	public ByteLinkedOpenHashSet copy() {
		ByteLinkedOpenHashSet set = new ByteLinkedOpenHashSet(0, loadFactor);
