...
public abstract class AbstractByte2CharMap extends AbstractMap<Byte, Character> implements Byte2CharMap
{
	...
	public void putAll(Byte2CharMap m) {
		for(ObjectIterator<Byte2CharMap.Entry> iter = Byte2CharMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceChars(ByteCharUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Byte2CharMap.Entry> iter = Byte2CharMaps.fastIterator(this);iter.hasNext();) {
			Byte2CharMap.Entry entry = iter.next();
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					ObjectIterator<Byte2CharMap.Entry> iter = Byte2CharMaps.fastIterator(AbstractByte2CharMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Byte2CharMap.Entry> iter = Byte2CharMaps.fastIterator(this);
