...
public class Byte2LongLinkedOpenHashMap extends Byte2LongOpenHashMap implements Byte2LongOrderedMap
{
	 ...
	 */
	public Byte2LongLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2LongLinkedOpenHashMap(Byte[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2LongLinkedOpenHashMap(Byte[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2LongLinkedOpenHashMap(Map<? extends Byte, ? extends Long> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2LongLinkedOpenHashMap(Byte2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2LongLinkedOpenHashMap(Byte2LongMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Byte2LongLinkedOpenHashMap copy() {
		Byte2LongLinkedOpenHashMap map = new Byte2LongLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2LongMap.Entry> implements Byte2LongOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Byte2LongMap.Entry o) {
			return Byte2LongLinkedOpenHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2LongMap.Entry o) {
			return Byte2LongLinkedOpenHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2LongMap.Entry) {
					...
					int index = Byte2LongLinkedOpenHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getLongValue() == Byte2LongLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Byte2LongLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Byte2LongLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2LongMap.Entry) {
					Byte2LongMap.Entry entry = (Byte2LongMap.Entry)o;
					return Byte2LongLinkedOpenHashMap.this.remove(entry.getByteKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2LongLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2LongLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2LongLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2LongLinkedOpenHashMap.this.moveToLast(o);
		}
