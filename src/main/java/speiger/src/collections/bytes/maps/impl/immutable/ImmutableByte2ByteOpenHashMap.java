...
public class ImmutableByte2ByteOpenHashMap extends AbstractByte2ByteMap implements Byte2ByteOrderedMap
{
	 ...
	 */
	protected ImmutableByte2ByteOpenHashMap() {}
	 ...
	 */
	public ImmutableByte2ByteOpenHashMap(Byte[] keys, Byte[] values) {
	 ...
	 */
	public ImmutableByte2ByteOpenHashMap(Byte[] keys, Byte[] values, float loadFactor) {
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
		init(ByteArrays.unwrap(keys), ByteArrays.unwrap(values), 0, keys.length, loadFactor);
	}
	 ...
	 */
	public ImmutableByte2ByteOpenHashMap(Map<? extends Byte, ? extends Byte> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public ImmutableByte2ByteOpenHashMap(Map<? extends Byte, ? extends Byte> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public ImmutableByte2ByteOpenHashMap(Byte2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public ImmutableByte2ByteOpenHashMap(Byte2ByteMap map, float loadFactor) {
		byte[] keys = new byte[map.size()];
		byte[] values = new byte[keys.length];
		int index = 0;
		for(Byte2ByteMap.Entry entry : Byte2ByteMaps.fastIterable(map)) {
	...
	protected void init(byte[] a, byte[] b, int offset, int length, float loadFactor) {
	...
	@Override
	public ImmutableByte2ByteOpenHashMap copy() {
		ImmutableByte2ByteOpenHashMap map = new ImmutableByte2ByteOpenHashMap();
		map.mask = mask;
	...
	@Override
	public boolean replace(byte key, byte oldValue, byte newValue) { throw new UnsupportedOperationException(); }
	
	@Override
	public byte replace(byte key, byte value) { throw new UnsupportedOperationException(); }
	
	@Override
	public byte computeByte(byte key, ByteByteUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
	
	@Override
	public byte computeByteIfAbsent(byte key, Byte2ByteFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	@Override
	public void mergeAllByte(Byte2ByteMap m, ByteByteUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Byte2ByteMap.Entry o) { throw new UnsupportedOperationException(); }
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ByteMap.Entry) {
					...
					int index = ImmutableByte2ByteOpenHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getByteValue() == ImmutableByte2ByteOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = ImmutableByte2ByteOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(ImmutableByte2ByteOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
