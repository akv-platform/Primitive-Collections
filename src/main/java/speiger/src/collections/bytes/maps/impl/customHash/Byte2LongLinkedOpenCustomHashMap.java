...
public class Byte2LongLinkedOpenCustomHashMap extends Byte2LongOpenCustomHashMap implements Byte2LongOrderedMap
{
	 ...
	 */
	public Byte2LongLinkedOpenCustomHashMap(ByteStrategy strategy) {
	 ...
	 */
	public Byte2LongLinkedOpenCustomHashMap(int minCapacity, ByteStrategy strategy) {
	 ...
	 */
	public Byte2LongLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ByteStrategy strategy) {
	 ...
	 */
	public Byte2LongLinkedOpenCustomHashMap(Byte[] keys, Long[] values, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2LongLinkedOpenCustomHashMap(Byte[] keys, Long[] values, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Byte2LongLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Long> map, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2LongLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Long> map, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Byte2LongLinkedOpenCustomHashMap(Byte2LongMap map, ByteStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2LongLinkedOpenCustomHashMap(Byte2LongMap map, float loadFactor, ByteStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Byte2LongLinkedOpenCustomHashMap copy() {
		Byte2LongLinkedOpenCustomHashMap map = new Byte2LongLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2LongMap.Entry> implements Byte2LongOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Byte2LongMap.Entry o) {
			return Byte2LongLinkedOpenCustomHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2LongMap.Entry o) {
			return Byte2LongLinkedOpenCustomHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2LongMap.Entry) {
					...
					int index = Byte2LongLinkedOpenCustomHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getLongValue() == Byte2LongLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Byte)) return false;
					int index = Byte2LongLinkedOpenCustomHashMap.this.findIndex((Byte)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Byte2LongLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2LongMap.Entry) {
					Byte2LongMap.Entry entry = (Byte2LongMap.Entry)o;
					return Byte2LongLinkedOpenCustomHashMap.this.remove(entry.getByteKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2LongLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2LongLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2LongLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2LongLinkedOpenCustomHashMap.this.moveToLast(o);
		}
