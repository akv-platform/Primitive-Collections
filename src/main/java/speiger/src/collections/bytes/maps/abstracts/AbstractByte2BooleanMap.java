...
public abstract class AbstractByte2BooleanMap extends AbstractMap<Byte, Boolean> implements Byte2BooleanMap
{
	...
	public void putAll(Byte2BooleanMap m) {
		for(ObjectIterator<Byte2BooleanMap.Entry> iter = Byte2BooleanMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBooleans(ByteBooleanUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Byte2BooleanMap.Entry> iter = Byte2BooleanMaps.fastIterator(this);iter.hasNext();) {
			Byte2BooleanMap.Entry entry = iter.next();
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					ObjectIterator<Byte2BooleanMap.Entry> iter = Byte2BooleanMaps.fastIterator(AbstractByte2BooleanMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Byte2BooleanMap.Entry> iter = Byte2BooleanMaps.fastIterator(this);
