 ...
 */
public class Byte2ByteOpenCustomHashMap extends AbstractByte2ByteMap implements ITrimmable
{
	 ...
	 */
	public Byte2ByteOpenCustomHashMap(ByteStrategy strategy) {
	 ...
	 */
	public Byte2ByteOpenCustomHashMap(int minCapacity, ByteStrategy strategy) {
	 ...
	 */
	public Byte2ByteOpenCustomHashMap(int minCapacity, float loadFactor, ByteStrategy strategy) {
	 ...
	 */
	public Byte2ByteOpenCustomHashMap(Byte[] keys, Byte[] values, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ByteOpenCustomHashMap(Byte[] keys, Byte[] values, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Byte2ByteOpenCustomHashMap(Map<? extends Byte, ? extends Byte> map, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ByteOpenCustomHashMap(Map<? extends Byte, ? extends Byte> map, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Byte2ByteOpenCustomHashMap(Byte2ByteMap map, ByteStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2ByteOpenCustomHashMap(Byte2ByteMap map, float loadFactor, ByteStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(!strategy.equals(keys[i], (byte)0) && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Byte.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Byte2ByteOpenCustomHashMap copy() {
		Byte2ByteOpenCustomHashMap map = new Byte2ByteOpenCustomHashMap(0, loadFactor, strategy);
	...
	private final class MapEntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteMap.FastEntrySet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ByteMap.Entry) {
					...
					int index = Byte2ByteOpenCustomHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getByteValue() == Byte2ByteOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Byte)) return false;
					int index = Byte2ByteOpenCustomHashMap.this.findIndex((Byte)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Byte2ByteOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ByteMap.Entry) {
					Byte2ByteMap.Entry entry = (Byte2ByteMap.Entry)o;
					return Byte2ByteOpenCustomHashMap.this.remove(entry.getByteKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2ByteOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractByteSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2ByteOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Byte2ByteOpenCustomHashMap.this.remove(wrapped.getByte(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
