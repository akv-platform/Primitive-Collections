 ...
 */
public class Byte2BooleanLinkedOpenCustomHashMap extends Byte2BooleanOpenCustomHashMap implements Byte2BooleanOrderedMap
{
	 ...
	 */
	public Byte2BooleanLinkedOpenCustomHashMap(ByteStrategy strategy) {
	 ...
	 */
	public Byte2BooleanLinkedOpenCustomHashMap(int minCapacity, ByteStrategy strategy) {
	 ...
	 */
	public Byte2BooleanLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ByteStrategy strategy) {
	 ...
	 */
	public Byte2BooleanLinkedOpenCustomHashMap(Byte[] keys, Boolean[] values, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2BooleanLinkedOpenCustomHashMap(Byte[] keys, Boolean[] values, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Byte2BooleanLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Boolean> map, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2BooleanLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Boolean> map, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Byte2BooleanLinkedOpenCustomHashMap(Byte2BooleanMap map, ByteStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2BooleanLinkedOpenCustomHashMap(Byte2BooleanMap map, float loadFactor, ByteStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Byte2BooleanLinkedOpenCustomHashMap copy() {
		Byte2BooleanLinkedOpenCustomHashMap map = new Byte2BooleanLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> implements Byte2BooleanOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Byte2BooleanMap.Entry o) {
			return Byte2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2BooleanMap.Entry o) {
			return Byte2BooleanLinkedOpenCustomHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2BooleanMap.Entry) {
					...
					int index = Byte2BooleanLinkedOpenCustomHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getBooleanValue() == Byte2BooleanLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Byte)) return false;
					int index = Byte2BooleanLinkedOpenCustomHashMap.this.findIndex((Byte)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Byte2BooleanLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2BooleanMap.Entry) {
					Byte2BooleanMap.Entry entry = (Byte2BooleanMap.Entry)o;
					return Byte2BooleanLinkedOpenCustomHashMap.this.remove(entry.getByteKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2BooleanLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2BooleanLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2BooleanLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Byte2BooleanMap.Entry> {
		...
		@Override
		public void set(Byte2BooleanMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Byte2BooleanMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
