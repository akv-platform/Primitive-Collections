...
public class Byte2ByteLinkedOpenHashMap extends Byte2ByteOpenHashMap implements Byte2ByteOrderedMap
{
	 ...
	 */
	public Byte2ByteLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2ByteLinkedOpenHashMap(Byte[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ByteLinkedOpenHashMap(Byte[] keys, Byte[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ByteLinkedOpenHashMap(Map<? extends Byte, ? extends Byte> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2ByteLinkedOpenHashMap(Byte2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2ByteLinkedOpenHashMap(Byte2ByteMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Byte2ByteLinkedOpenHashMap copy() {
		Byte2ByteLinkedOpenHashMap map = new Byte2ByteLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Byte2ByteMap.Entry o) {
			return Byte2ByteLinkedOpenHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2ByteMap.Entry o) {
			return Byte2ByteLinkedOpenHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ByteMap.Entry) {
					...
					int index = Byte2ByteLinkedOpenHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getByteValue() == Byte2ByteLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Byte2ByteLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ByteMap.Entry) {
					Byte2ByteMap.Entry entry = (Byte2ByteMap.Entry)o;
					return Byte2ByteLinkedOpenHashMap.this.remove(entry.getByteKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2ByteLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2ByteLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2ByteLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2ByteLinkedOpenHashMap.this.moveToLast(o);
		}
