...
public class Byte2ByteLinkedOpenCustomHashMap extends Byte2ByteOpenCustomHashMap implements Byte2ByteOrderedMap
{
	 ...
	 */
	public Byte2ByteLinkedOpenCustomHashMap(ByteStrategy strategy) {
	 ...
	 */
	public Byte2ByteLinkedOpenCustomHashMap(int minCapacity, ByteStrategy strategy) {
	 ...
	 */
	public Byte2ByteLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ByteStrategy strategy) {
	 ...
	 */
	public Byte2ByteLinkedOpenCustomHashMap(Byte[] keys, Byte[] values, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ByteLinkedOpenCustomHashMap(Byte[] keys, Byte[] values, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Byte2ByteLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Byte> map, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ByteLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Byte> map, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Byte2ByteLinkedOpenCustomHashMap(Byte2ByteMap map, ByteStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2ByteLinkedOpenCustomHashMap(Byte2ByteMap map, float loadFactor, ByteStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Byte2ByteLinkedOpenCustomHashMap copy() {
		Byte2ByteLinkedOpenCustomHashMap map = new Byte2ByteLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Byte2ByteMap.Entry o) {
			return Byte2ByteLinkedOpenCustomHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2ByteMap.Entry o) {
			return Byte2ByteLinkedOpenCustomHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ByteMap.Entry) {
					...
					int index = Byte2ByteLinkedOpenCustomHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getByteValue() == Byte2ByteLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Byte)) return false;
					int index = Byte2ByteLinkedOpenCustomHashMap.this.findIndex((Byte)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Byte2ByteLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ByteMap.Entry) {
					Byte2ByteMap.Entry entry = (Byte2ByteMap.Entry)o;
					return Byte2ByteLinkedOpenCustomHashMap.this.remove(entry.getByteKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2ByteLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2ByteLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2ByteLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2ByteLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Byte2ByteMap.Entry> {
		...
		@Override
		public void set(Byte2ByteMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Byte2ByteMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
