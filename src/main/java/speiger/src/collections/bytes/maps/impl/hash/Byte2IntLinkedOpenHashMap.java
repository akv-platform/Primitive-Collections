 ...
 */
public class Byte2IntLinkedOpenHashMap extends Byte2IntOpenHashMap implements Byte2IntOrderedMap
{
	 ...
	 */
	public Byte2IntLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2IntLinkedOpenHashMap(Byte[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2IntLinkedOpenHashMap(Byte[] keys, Integer[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Byte2IntLinkedOpenHashMap(byte[] keys, int[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2IntLinkedOpenHashMap(byte[] keys, int[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2IntLinkedOpenHashMap(Map<? extends Byte, ? extends Integer> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2IntLinkedOpenHashMap(Byte2IntMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2IntLinkedOpenHashMap(Byte2IntMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Byte2IntLinkedOpenHashMap copy() {
		Byte2IntLinkedOpenHashMap map = new Byte2IntLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2IntMap.Entry> implements Byte2IntOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Byte2IntMap.Entry o) {
			return Byte2IntLinkedOpenHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2IntMap.Entry o) {
			return Byte2IntLinkedOpenHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2IntMap.Entry) {
					...
					int index = Byte2IntLinkedOpenHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getIntValue() == Byte2IntLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Byte2IntLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(Byte2IntLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2IntMap.Entry) {
					Byte2IntMap.Entry entry = (Byte2IntMap.Entry)o;
					return Byte2IntLinkedOpenHashMap.this.remove(entry.getByteKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2IntLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2IntLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2IntLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2IntLinkedOpenHashMap.this.moveToLast(o);
		}
