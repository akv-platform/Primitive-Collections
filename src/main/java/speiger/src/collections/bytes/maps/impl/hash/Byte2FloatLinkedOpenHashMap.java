 ...
 */
public class Byte2FloatLinkedOpenHashMap extends Byte2FloatOpenHashMap implements Byte2FloatOrderedMap
{
	 ...
	 */
	public Byte2FloatLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Byte2FloatLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2FloatLinkedOpenHashMap(Byte[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2FloatLinkedOpenHashMap(Byte[] keys, Float[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2FloatLinkedOpenHashMap(Map<? extends Byte, ? extends Float> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2FloatLinkedOpenHashMap(Byte2FloatMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2FloatLinkedOpenHashMap(Byte2FloatMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Byte2FloatLinkedOpenHashMap copy() {
		Byte2FloatLinkedOpenHashMap map = new Byte2FloatLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2FloatMap.Entry> implements Byte2FloatOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Byte2FloatMap.Entry o) {
			return Byte2FloatLinkedOpenHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2FloatMap.Entry o) {
			return Byte2FloatLinkedOpenHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2FloatMap.Entry) {
					...
					int index = Byte2FloatLinkedOpenHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return Float.floatToIntBits(entry.getFloatValue()) == Float.floatToIntBits(Byte2FloatLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Byte2FloatLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float.valueOf(Byte2FloatLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2FloatMap.Entry) {
					Byte2FloatMap.Entry entry = (Byte2FloatMap.Entry)o;
					return Byte2FloatLinkedOpenHashMap.this.remove(entry.getByteKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2FloatLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2FloatLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2FloatLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2FloatLinkedOpenHashMap.this.moveToLast(o);
		}
