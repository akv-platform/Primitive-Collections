...
import speiger.src.collections.bytes.maps.interfaces.Byte2DoubleConcurrentMap;
 ...
 * 
 */
public class Byte2DoubleConcurrentOpenHashMap extends AbstractByte2DoubleMap implements Byte2DoubleConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Byte2DoubleConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Byte2DoubleConcurrentOpenHashMap() {
	 ...
	 */
	public Byte2DoubleConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Byte2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2DoubleConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2DoubleConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Byte2DoubleConcurrentOpenHashMap(Byte[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2DoubleConcurrentOpenHashMap(Byte[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2DoubleConcurrentOpenHashMap(Byte[] keys, Double[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2DoubleConcurrentOpenHashMap(Byte[] keys, Double[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Byte2DoubleConcurrentOpenHashMap(Map<? extends Byte, ? extends Double> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2DoubleConcurrentOpenHashMap(Map<? extends Byte, ? extends Double> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2DoubleConcurrentOpenHashMap(Map<? extends Byte, ? extends Double> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2DoubleConcurrentOpenHashMap(Map<? extends Byte, ? extends Double> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2DoubleConcurrentOpenHashMap(Byte2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2DoubleConcurrentOpenHashMap(Byte2DoubleMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Byte2DoubleConcurrentOpenHashMap(Byte2DoubleMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Byte2DoubleConcurrentOpenHashMap(Byte2DoubleMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Byte2DoubleConcurrentOpenHashMap copy() {
		Byte2DoubleConcurrentOpenHashMap copy = new Byte2DoubleConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements Byte2DoubleMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2DoubleMap.Entry) {
					Byte2DoubleMap.Entry entry = (Byte2DoubleMap.Entry)o;
					return Byte2DoubleConcurrentOpenHashMap.this.remove(entry.getByteKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2DoubleConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Byte2DoubleConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Byte2DoubleConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractByteSet implements ByteSet {
		...
		public boolean remove(byte o) {
			int oldSize = size();
			Byte2DoubleConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Byte2DoubleMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Byte2DoubleMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Byte2DoubleMap.Entry, Map.Entry<Byte, Double> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Byte2DoubleMap.Entry) {
					...
					return getByteKey() == entry.getByteKey() && Double.doubleToLongBits(getDoubleValue()) == Double.doubleToLongBits(entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Byte && value instanceof Double && getByteKey() == ((Byte)key).byteValue() && Double.doubleToLongBits(getDoubleValue()) == Double.doubleToLongBits(((Double)value).doubleValue());
			}
			return false;
		}
		...
		public String toString() {
			return Byte.toString(getByteKey()) + "=" + Double.toString(getDoubleValue());
		}
	}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Byte2DoubleConcurrentOpenHashMap map;
		...
		protected Segment(Byte2DoubleConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Byte2DoubleConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Byte2DoubleConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected double put(int hash, byte key, double value) {
		...
		protected double putIfAbsent(int hash, byte key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double addTo(int hash, byte key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double subFrom(int hash, byte key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double get(int hash, byte key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double getOrDefault(int hash, byte key, double defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ByteDoubleConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected double remove(int hash, byte key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected double removeOrDefault(int hash, byte key, double defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, byte key, double value) {
			long stamp = writeLock();
			try {
				if(key == (byte)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				byte current = keys[pos];
				if(current == (byte)0) return false;
				if(Objects.equals(key, Byte.valueOf(current)) && Objects.equals(value, Double.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (byte)0) return false;
					else if(Objects.equals(key, Byte.valueOf(current)) && Objects.equals(value, Double.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, byte key, double oldValue, double newValue) {
			long stamp = writeLock();
			try {
		...
		protected double replace(int hash, byte key, double value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected double compute(int hash, byte key, ByteDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected double merge(int hash, byte key, double value, DoubleDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
