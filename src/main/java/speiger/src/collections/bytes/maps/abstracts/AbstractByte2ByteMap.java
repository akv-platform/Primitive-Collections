...
public abstract class AbstractByte2ByteMap extends AbstractMap<Byte, Byte> implements Byte2ByteMap
{
	...
	public void putAll(Byte2ByteMap m) {
		for(ObjectIterator<Byte2ByteMap.Entry> iter = Byte2ByteMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBytes(ByteByteUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Byte2ByteMap.Entry> iter = Byte2ByteMaps.fastIterator(this);iter.hasNext();) {
			Byte2ByteMap.Entry entry = iter.next();
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					ObjectIterator<Byte2ByteMap.Entry> iter = Byte2ByteMaps.fastIterator(AbstractByte2ByteMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Byte2ByteMap.Entry> iter = Byte2ByteMaps.fastIterator(this);
