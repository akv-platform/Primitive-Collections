 ...
 */
public class Byte2IntLinkedOpenCustomHashMap extends Byte2IntOpenCustomHashMap implements Byte2IntOrderedMap
{
	 ...
	 */
	public Byte2IntLinkedOpenCustomHashMap(ByteStrategy strategy) {
	 ...
	 */
	public Byte2IntLinkedOpenCustomHashMap(int minCapacity, ByteStrategy strategy) {
	 ...
	 */
	public Byte2IntLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ByteStrategy strategy) {
	 ...
	 */
	public Byte2IntLinkedOpenCustomHashMap(Byte[] keys, Integer[] values, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2IntLinkedOpenCustomHashMap(Byte[] keys, Integer[] values, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Byte2IntLinkedOpenCustomHashMap(byte[] keys, int[] values, ByteStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2IntLinkedOpenCustomHashMap(byte[] keys, int[] values, float loadFactor, ByteStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Byte2IntLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Integer> map, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2IntLinkedOpenCustomHashMap(Map<? extends Byte, ? extends Integer> map, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Byte2IntLinkedOpenCustomHashMap(Byte2IntMap map, ByteStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2IntLinkedOpenCustomHashMap(Byte2IntMap map, float loadFactor, ByteStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Byte2IntLinkedOpenCustomHashMap copy() {
		Byte2IntLinkedOpenCustomHashMap map = new Byte2IntLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	public ObjectOrderedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
		...
		return (ObjectOrderedSet<Byte2IntMap.Entry>)entrySet;
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2IntMap.Entry> implements Byte2IntOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Byte2IntMap.Entry o) {
			return Byte2IntLinkedOpenCustomHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2IntMap.Entry o) {
			return Byte2IntLinkedOpenCustomHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2IntMap.Entry) {
					...
					int index = Byte2IntLinkedOpenCustomHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getIntValue() == Byte2IntLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Byte)) return false;
					int index = Byte2IntLinkedOpenCustomHashMap.this.findIndex((Byte)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(Byte2IntLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2IntMap.Entry) {
					Byte2IntMap.Entry entry = (Byte2IntMap.Entry)o;
					return Byte2IntLinkedOpenCustomHashMap.this.remove(entry.getByteKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2IntLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2IntLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2IntLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2IntLinkedOpenCustomHashMap.this.moveToLast(o);
		}
