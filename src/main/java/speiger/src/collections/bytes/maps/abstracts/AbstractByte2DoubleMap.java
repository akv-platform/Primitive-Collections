...
public abstract class AbstractByte2DoubleMap extends AbstractMap<Byte, Double> implements Byte2DoubleMap
{
	...
	public void putAll(Byte2DoubleMap m) {
		for(ObjectIterator<Byte2DoubleMap.Entry> iter = Byte2DoubleMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceDoubles(ByteDoubleUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Byte2DoubleMap.Entry> iter = Byte2DoubleMaps.fastIterator(this);iter.hasNext();) {
			Byte2DoubleMap.Entry entry = iter.next();
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					ObjectIterator<Byte2DoubleMap.Entry> iter = Byte2DoubleMaps.fastIterator(AbstractByte2DoubleMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Byte2DoubleMap.Entry> iter = Byte2DoubleMaps.fastIterator(this);
