 ...
 */
public class Byte2FloatAVLTreeMap extends AbstractByte2FloatMap implements Byte2FloatNavigableMap
{
	...
	/** EntrySet Cache */
	protected ObjectSet<Byte2FloatMap.Entry> entrySet;
	 ...
	 */
	public Byte2FloatAVLTreeMap(ByteComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Byte2FloatAVLTreeMap(Byte[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Byte2FloatAVLTreeMap(Byte[] keys, Float[] values, ByteComparator comp) {
		comparator = comp;
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Byte2FloatAVLTreeMap(Map<? extends Byte, ? extends Float> map, ByteComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2FloatAVLTreeMap(Byte2FloatMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Byte2FloatAVLTreeMap(Byte2FloatMap map, ByteComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Byte2FloatAVLTreeMap copy() {
		Byte2FloatAVLTreeMap set = new Byte2FloatAVLTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	@Override
	public Byte2FloatNavigableMap descendingMap() {
	...
	@Override
	public Byte2FloatNavigableMap subMap(byte fromKey, boolean fromInclusive, byte toKey, boolean toInclusive) {
		return new AscendingNaivgableSubMap(this, false, fromKey, fromInclusive, false, toKey, toInclusive);
	}
	
	@Override
	public Byte2FloatNavigableMap headMap(byte toKey, boolean inclusive) {
		return new AscendingNaivgableSubMap(this, true, (byte)0, true, false, toKey, inclusive);
	}
	
	@Override
	public Byte2FloatNavigableMap tailMap(byte fromKey, boolean inclusive) {
	...
	@Override
	public Byte2FloatMap.Entry lowerEntry(byte key) {
		Node node = findLowerNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Byte2FloatMap.Entry higherEntry(byte key) {
		Node node = findHigherNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Byte2FloatMap.Entry floorEntry(byte key) {
		Node node = findFloorNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Byte2FloatMap.Entry ceilingEntry(byte key) {
	...
	static class KeySet extends AbstractByteSet implements ByteNavigableSet
	{
		...
		public KeySet(Byte2FloatNavigableMap map) {
			this.map = map;
		}
		...
		public Byte lower(Byte e) {
			Byte2FloatMap.Entry node = map.lowerEntry(e.byteValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Byte floor(Byte e) {
			Byte2FloatMap.Entry node = map.floorEntry(e.byteValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Byte higher(Byte e) {
			Byte2FloatMap.Entry node = map.higherEntry(e.byteValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Byte ceiling(Byte e) {
			Byte2FloatMap.Entry node = map.ceilingEntry(e.byteValue());
			return node != null ? node.getKey() : null;
		}
		...
		public ByteBidirectionalIterator iterator(byte fromElement) {
			if(map instanceof Byte2FloatAVLTreeMap) return ((Byte2FloatAVLTreeMap)map).keyIterator(fromElement);
		...
		public ByteBidirectionalIterator iterator() {
			if(map instanceof Byte2FloatAVLTreeMap) return ((Byte2FloatAVLTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public ByteBidirectionalIterator descendingIterator() {
			if(map instanceof Byte2FloatAVLTreeMap) return ((Byte2FloatAVLTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Byte2FloatAVLTreeMap) return ((Byte2FloatAVLTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Byte2FloatAVLTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Byte2FloatAVLTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Byte2FloatAVLTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Byte2FloatAVLTreeMap map, boolean fromStart, byte lo, boolean loInclusive, boolean toEnd, byte hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Byte2FloatAVLTreeMap map, boolean fromStart, byte lo, boolean loInclusive, boolean toEnd, byte hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractByte2FloatMap implements Byte2FloatNavigableMap
	{
		final Byte2FloatAVLTreeMap map;
		final byte lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		
		Byte2FloatNavigableMap inverse;
		ByteNavigableSet keySet;
		ObjectSet<Byte2FloatMap.Entry> entrySet;
		FloatCollection values;
		
		NavigableSubMap(Byte2FloatAVLTreeMap map, boolean fromStart, byte lo, boolean loInclusive, boolean toEnd, byte hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
		...
		@Override
		public Byte2FloatMap.Entry lowerEntry(byte key) { return subLower(key); }
		@Override
		public Byte2FloatMap.Entry floorEntry(byte key) { return subFloor(key); }
		@Override
		public Byte2FloatMap.Entry ceilingEntry(byte key) { return subCeiling(key); }
		@Override
		public Byte2FloatMap.Entry higherEntry(byte key) { return subHigher(key); }
		...
		@Override
		public Byte2FloatNavigableMap copy() { throw new UnsupportedOperationException(); }
		...
		public Byte2FloatMap.Entry pollFirstEntry() {
			Node entry = subLowest();
			if(entry != null) {
				Byte2FloatMap.Entry result = entry.export();
				map.removeNode(entry);
				return result;
			}
			return null;
		...
		abstract class SubEntrySet extends AbstractObjectSet<Byte2FloatMap.Entry> {
			@Override
			public int size() {
				if (fromStart && toEnd) return map.size();
				int size = 0;
				for(ObjectIterator<Byte2FloatMap.Entry> iter = iterator();iter.hasNext();iter.next(),size++);
				return size;
			}
		...
		class DecsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Byte2FloatMap.Entry>
		{
		...
		class AcsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Byte2FloatMap.Entry>
		{
	...
	class Values extends AbstractFloatCollection
	{
		...
		@Override
		public int size() {
			return Byte2FloatAVLTreeMap.this.size;
		}
	...
	class EntrySet extends AbstractObjectSet<Byte2FloatMap.Entry> {
	...
	class AscendingMapEntryIterator extends MapEntryIterator implements ObjectBidirectionalIterator<Byte2FloatMap.Entry>
	{
	...
	private static final class Node implements Byte2FloatMap.Entry
	{
		byte key;
		float value;
		int state;
		...
		Node(byte key, float value, Node parent) {
			this.key = key;
			this.value = value;
			this.parent = parent;
		}
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				...
				return otherKey instanceof Byte && otherValue instanceof Float && key == ((Byte)otherKey).byteValue() && Float.floatToIntBits(value) == Float.floatToIntBits(((Float)otherValue).floatValue());
			}
			return false;
		}
