 ...
 */
public class Byte2ObjectLinkedOpenCustomHashMap<V> extends Byte2ObjectOpenCustomHashMap<V> implements Byte2ObjectOrderedMap<V>
{
	 ...
	 */
	public Byte2ObjectLinkedOpenCustomHashMap(ByteStrategy strategy) {
	 ...
	 */
	public Byte2ObjectLinkedOpenCustomHashMap(int minCapacity, ByteStrategy strategy) {
	 ...
	 */
	public Byte2ObjectLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ByteStrategy strategy) {
	 ...
	 */
	public Byte2ObjectLinkedOpenCustomHashMap(Byte[] keys, V[] values, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ObjectLinkedOpenCustomHashMap(Byte[] keys, V[] values, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Byte2ObjectLinkedOpenCustomHashMap(Map<? extends Byte, ? extends V> map, ByteStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ObjectLinkedOpenCustomHashMap(Map<? extends Byte, ? extends V> map, float loadFactor, ByteStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Byte2ObjectLinkedOpenCustomHashMap(Byte2ObjectMap<V> map, ByteStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2ObjectLinkedOpenCustomHashMap(Byte2ObjectMap<V> map, float loadFactor, ByteStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Byte2ObjectLinkedOpenCustomHashMap<V> copy() {
		Byte2ObjectLinkedOpenCustomHashMap<V> map = new Byte2ObjectLinkedOpenCustomHashMap<>(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry<V>> implements Byte2ObjectOrderedMap.FastOrderedSet<V> {
		...
		public boolean moveToFirst(Byte2ObjectMap.Entry<V> o) {
			return Byte2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2ObjectMap.Entry<V> o) {
			return Byte2ObjectLinkedOpenCustomHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ObjectMap.Entry) {
					...
					int index = Byte2ObjectLinkedOpenCustomHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Byte)) return false;
					int index = Byte2ObjectLinkedOpenCustomHashMap.this.findIndex((Byte)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
			}
			return false;
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ObjectMap.Entry) {
					Byte2ObjectMap.Entry<V> entry = (Byte2ObjectMap.Entry<V>)o;
					return Byte2ObjectLinkedOpenCustomHashMap.this.remove(entry.getByteKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2ObjectLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2ObjectLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2ObjectLinkedOpenCustomHashMap.this.moveToLast(o);
		}
