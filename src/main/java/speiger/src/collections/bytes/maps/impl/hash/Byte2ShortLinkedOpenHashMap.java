 ...
 */
public class Byte2ShortLinkedOpenHashMap extends Byte2ShortOpenHashMap implements Byte2ShortOrderedMap
{
	 ...
	 */
	public Byte2ShortLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Byte2ShortLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2ShortLinkedOpenHashMap(Byte[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ShortLinkedOpenHashMap(Byte[] keys, Short[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2ShortLinkedOpenHashMap(Map<? extends Byte, ? extends Short> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2ShortLinkedOpenHashMap(Byte2ShortMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2ShortLinkedOpenHashMap(Byte2ShortMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Byte2ShortLinkedOpenHashMap copy() {
		Byte2ShortLinkedOpenHashMap map = new Byte2ShortLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2ShortMap.Entry> implements Byte2ShortOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Byte2ShortMap.Entry o) {
			return Byte2ShortLinkedOpenHashMap.this.moveToFirst(o.getByteKey());
		}
		
		@Override
		public boolean moveToLast(Byte2ShortMap.Entry o) {
			return Byte2ShortLinkedOpenHashMap.this.moveToLast(o.getByteKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ShortMap.Entry) {
					...
					int index = Byte2ShortLinkedOpenHashMap.this.findIndex(entry.getByteKey());
					if(index >= 0) return entry.getShortValue() == Byte2ShortLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Byte2ShortLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Byte2ShortLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2ShortMap.Entry) {
					Byte2ShortMap.Entry entry = (Byte2ShortMap.Entry)o;
					return Byte2ShortLinkedOpenHashMap.this.remove(entry.getByteKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2ShortLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractByteSet implements ByteOrderedSet {
		...
		public boolean remove(byte o) {
			int oldSize = size;
			Byte2ShortLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(byte o) {
			return Byte2ShortLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(byte o) {
			return Byte2ShortLinkedOpenHashMap.this.moveToLast(o);
		}
