 ...
 */
public class Byte2BooleanRBTreeMap extends AbstractByte2BooleanMap implements Byte2BooleanNavigableMap
{
	...
	/** EntrySet Cache */
	protected ObjectSet<Byte2BooleanMap.Entry> entrySet;
	 ...
	 */
	public Byte2BooleanRBTreeMap(ByteComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Byte2BooleanRBTreeMap(Byte[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Byte2BooleanRBTreeMap(Byte[] keys, Boolean[] values, ByteComparator comp) {
		comparator = comp;
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Byte2BooleanRBTreeMap(Map<? extends Byte, ? extends Boolean> map, ByteComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2BooleanRBTreeMap(Byte2BooleanMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Byte2BooleanRBTreeMap(Byte2BooleanMap map, ByteComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Byte2BooleanRBTreeMap copy() {
		Byte2BooleanRBTreeMap set = new Byte2BooleanRBTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	static class KeySet extends AbstractByteSet implements ByteNavigableSet
	{
		...
		public KeySet(Byte2BooleanNavigableMap map) {
			this.map = map;
		}
		...
		public Byte lower(Byte e) {
			Byte2BooleanMap.Entry node = map.lowerEntry(e.byteValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Byte floor(Byte e) {
			Byte2BooleanMap.Entry node = map.floorEntry(e.byteValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Byte higher(Byte e) {
			Byte2BooleanMap.Entry node = map.higherEntry(e.byteValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Byte ceiling(Byte e) {
			Byte2BooleanMap.Entry node = map.ceilingEntry(e.byteValue());
			return node != null ? node.getKey() : null;
		}
		...
		public ByteBidirectionalIterator iterator(byte fromElement) {
			if(map instanceof Byte2BooleanRBTreeMap) return ((Byte2BooleanRBTreeMap)map).keyIterator(fromElement);
		...
		public ByteBidirectionalIterator iterator() {
			if(map instanceof Byte2BooleanRBTreeMap) return ((Byte2BooleanRBTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public ByteBidirectionalIterator descendingIterator() {
			if(map instanceof Byte2BooleanRBTreeMap) return ((Byte2BooleanRBTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Byte2BooleanRBTreeMap) return ((Byte2BooleanRBTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Byte2BooleanRBTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Byte2BooleanRBTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Byte2BooleanRBTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Byte2BooleanRBTreeMap map, boolean fromStart, byte lo, boolean loInclusive, boolean toEnd, byte hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Byte2BooleanRBTreeMap map, boolean fromStart, byte lo, boolean loInclusive, boolean toEnd, byte hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractByte2BooleanMap implements Byte2BooleanNavigableMap
	{
		final Byte2BooleanRBTreeMap map;
		final byte lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		
		Byte2BooleanNavigableMap inverse;
		ByteNavigableSet keySet;
		ObjectSet<Byte2BooleanMap.Entry> entrySet;
		BooleanCollection values;
		
		NavigableSubMap(Byte2BooleanRBTreeMap map, boolean fromStart, byte lo, boolean loInclusive, boolean toEnd, byte hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
		...
		@Override
		public Byte2BooleanMap.Entry lowerEntry(byte key) { return subLower(key); }
		@Override
		public Byte2BooleanMap.Entry floorEntry(byte key) { return subFloor(key); }
		@Override
		public Byte2BooleanMap.Entry ceilingEntry(byte key) { return subCeiling(key); }
		@Override
		public Byte2BooleanMap.Entry higherEntry(byte key) { return subHigher(key); }
		...
		public Byte2BooleanMap.Entry pollFirstEntry() {
			Node entry = subLowest();
			if(entry != null) {
				Byte2BooleanMap.Entry result = entry.export();
				map.removeNode(entry);
				return result;
			}
			return null;
		...
		abstract class SubEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> {
			@Override
			public int size() {
				if (fromStart && toEnd) return map.size();
				int size = 0;
				for(ObjectIterator<Byte2BooleanMap.Entry> iter = iterator();iter.hasNext();iter.next(),size++);
				return size;
			}
		...
		class DecsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Byte2BooleanMap.Entry>
		{
		...
		class AcsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Byte2BooleanMap.Entry>
		{
	...
	class Values extends AbstractBooleanCollection
	{
		...
		@Override
		public int size() {
			return Byte2BooleanRBTreeMap.this.size;
		}
	...
	class EntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> {
	...
	class AscendingMapEntryIterator extends MapEntryIterator implements ObjectBidirectionalIterator<Byte2BooleanMap.Entry>
	{
	...
	private static final class Node implements Byte2BooleanMap.Entry
	{
		...
		Node(byte key, boolean value, Node parent) {
			this.key = key;
			this.value = value;
			this.parent = parent;
		}
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				...
				return otherKey instanceof Byte && otherValue instanceof Boolean && key == ((Byte)otherKey).byteValue() && value == ((Boolean)otherValue).booleanValue();
			}
			return false;
		}
