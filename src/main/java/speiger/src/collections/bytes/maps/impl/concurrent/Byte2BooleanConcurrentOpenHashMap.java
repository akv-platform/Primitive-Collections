 ...
 * 
 */
public class Byte2BooleanConcurrentOpenHashMap extends AbstractByte2BooleanMap implements Byte2BooleanConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Byte2BooleanConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Byte2BooleanConcurrentOpenHashMap() {
	 ...
	 */
	public Byte2BooleanConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Byte2BooleanConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Byte2BooleanConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2BooleanConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2BooleanConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Byte2BooleanConcurrentOpenHashMap(Byte[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2BooleanConcurrentOpenHashMap(Byte[] keys, Boolean[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2BooleanConcurrentOpenHashMap(Byte[] keys, Boolean[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2BooleanConcurrentOpenHashMap(Byte[] keys, Boolean[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Byte2BooleanConcurrentOpenHashMap(Map<? extends Byte, ? extends Boolean> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Byte2BooleanConcurrentOpenHashMap(Map<? extends Byte, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2BooleanConcurrentOpenHashMap(Map<? extends Byte, ? extends Boolean> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Byte2BooleanConcurrentOpenHashMap(Map<? extends Byte, ? extends Boolean> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Byte2BooleanConcurrentOpenHashMap(Byte2BooleanMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Byte2BooleanConcurrentOpenHashMap(Byte2BooleanMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Byte2BooleanConcurrentOpenHashMap(Byte2BooleanMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Byte2BooleanConcurrentOpenHashMap(Byte2BooleanMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Byte2BooleanConcurrentOpenHashMap copy() {
		Byte2BooleanConcurrentOpenHashMap copy = new Byte2BooleanConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> implements Byte2BooleanMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Byte2BooleanMap.Entry) {
					Byte2BooleanMap.Entry entry = (Byte2BooleanMap.Entry)o;
					return Byte2BooleanConcurrentOpenHashMap.this.remove(entry.getByteKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Byte2BooleanConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Byte2BooleanConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Byte2BooleanConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractByteSet implements ByteSet {
		...
		public boolean remove(byte o) {
			int oldSize = size();
			Byte2BooleanConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Byte2BooleanMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Byte2BooleanMap.Entry> {
		MapEntry entry;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Byte2BooleanMap.Entry) {
					...
					return getByteKey() == entry.getByteKey() && getBooleanValue() == entry.getBooleanValue();
				}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Byte2BooleanConcurrentOpenHashMap map;
		...
		protected Segment(Byte2BooleanConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Byte2BooleanConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Byte2BooleanConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected boolean put(int hash, byte key, boolean value) {
		...
		protected boolean putIfAbsent(int hash, byte key, boolean value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected boolean get(int hash, byte key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean getOrDefault(int hash, byte key, boolean defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ByteBooleanConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected boolean remove(int hash, byte key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean removeOrDefault(int hash, byte key, boolean defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, byte key, boolean value) {
			long stamp = writeLock();
			try {
				if(key == (byte)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				byte current = keys[pos];
				if(current == (byte)0) return false;
				if(Objects.equals(key, Byte.valueOf(current)) && Objects.equals(value, Boolean.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (byte)0) return false;
					else if(Objects.equals(key, Byte.valueOf(current)) && Objects.equals(value, Boolean.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, byte key, boolean oldValue, boolean newValue) {
			long stamp = writeLock();
			try {
		...
		protected boolean replace(int hash, byte key, boolean value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected boolean compute(int hash, byte key, ByteBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean computeIfAbsent(int hash, byte key, Byte2BooleanFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean merge(int hash, byte key, boolean value, BooleanBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
