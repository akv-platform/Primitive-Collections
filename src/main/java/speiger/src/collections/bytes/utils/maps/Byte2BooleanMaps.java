...
public class Byte2BooleanMaps
{
	...
	public static class EmptyMap extends AbstractByte2BooleanMap {
		...
		@Override
		public boolean getOrDefault(byte key, boolean defaultValue) { return false; }
		@Override
	...
	public static class SynchronizedMap extends AbstractByte2BooleanMap implements Byte2BooleanMap {
		...
		@Override
		public boolean computeBooleanIfAbsent(byte key, Byte2BooleanFunction mappingFunction) { synchronized(mutex) { return map.computeBooleanIfAbsent(key, mappingFunction); } }
		@Override
