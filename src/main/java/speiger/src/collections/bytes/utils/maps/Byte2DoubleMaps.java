...
public class Byte2DoubleMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Byte2DoubleMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Byte2DoubleMap.Entry unmodifiable(Byte2DoubleMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Byte2DoubleMap.Entry unmodifiable(Map.Entry<Byte, Double> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class SingletonMap extends AbstractByte2DoubleMap {
		...
		@Override
		public void mergeAllDouble(Byte2DoubleMap m, DoubleDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class EmptyMap extends AbstractByte2DoubleMap {
		...
		@Override
		public double getOrDefault(byte key, double defaultValue) { return defaultValue; }
		@Override
		public double computeDouble(byte key, ByteDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public double computeDoubleIfAbsent(byte key, Byte2DoubleFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Byte2DoubleNavigableMap {
		...
		@Override
		public Byte2DoubleNavigableMap descendingMap() { return Byte2DoubleMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Byte2DoubleNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Byte2DoubleOrderedMap {
		...
		@Override
		public Byte2DoubleOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.byte2DoubleEntrySet());
			return (ObjectOrderedSet<Byte2DoubleMap.Entry>)entrySet;
		}
	}
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Byte2DoubleSortedMap {
		...
		public double lastDoubleValue() { return map.lastDoubleValue(); }
		@Override
		public Byte2DoubleSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractByte2DoubleMap implements Byte2DoubleMap {
		...
		public void mergeAllDouble(Byte2DoubleMap m, DoubleDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceDoubles(ByteDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceDoubles(Byte2DoubleMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Byte2DoubleMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Byte2DoubleMap.Entry>
	{
		ObjectOrderedSet<Byte2DoubleMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Byte2DoubleMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public boolean moveToFirst(Byte2DoubleMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public boolean moveToLast(Byte2DoubleMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public ObjectOrderedSet<Byte2DoubleMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Byte2DoubleMap.Entry first() { return set.first(); }
		@Override
		public Byte2DoubleMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Byte2DoubleMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Byte2DoubleNavigableMap {
		...
		@Override
		public Byte2DoubleMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Byte2DoubleNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Byte2DoubleNavigableMap subMap(Byte fromKey, boolean fromInclusive, Byte toKey, boolean toInclusive) { synchronized(mutex) { return Byte2DoubleMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Byte2DoubleOrderedMap {
		...
		@Override
		public Byte2DoubleOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ByteOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Byte2DoubleSortedMap {
		...
		public double lastDoubleValue() { synchronized(mutex) { return map.lastDoubleValue(); } }
		@Override
		public Byte2DoubleSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractByte2DoubleMap implements Byte2DoubleMap {
		...
		@Override
		public Byte2DoubleMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ByteSet keySet() {
			if(keys == null) keys = ByteSets.synchronize(map.keySet(), mutex);
			return keys;
