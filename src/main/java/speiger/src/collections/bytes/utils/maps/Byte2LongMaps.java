...
public class Byte2LongMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Byte2LongMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Byte2LongMap.Entry unmodifiable(Byte2LongMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Byte2LongMap.Entry unmodifiable(Map.Entry<Byte, Long> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Byte2LongNavigableMap {
		...
		@Override
		public Byte2LongNavigableMap descendingMap() { return Byte2LongMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Byte2LongNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Byte2LongOrderedMap {
		...
		@Override
		public Byte2LongOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.byte2LongEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Byte2LongSortedMap {
		...
		public long lastLongValue() { return map.lastLongValue(); }
		@Override
		public Byte2LongSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractByte2LongMap implements Byte2LongMap {
		...
		public void mergeAllLong(Byte2LongMap m, LongLongUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceLongs(ByteLongUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceLongs(Byte2LongMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Byte2LongMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Byte2LongMap.Entry>
	{
		ObjectOrderedSet<Byte2LongMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Byte2LongMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Byte2LongMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Byte2LongMap.Entry first() { return set.first(); }
		@Override
		public Byte2LongMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Byte2LongMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Byte2LongNavigableMap {
		...
		@Override
		public Byte2LongMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Byte2LongNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Byte2LongNavigableMap subMap(Byte fromKey, boolean fromInclusive, Byte toKey, boolean toInclusive) { synchronized(mutex) { return Byte2LongMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Byte2LongOrderedMap {
		...
		@Override
		public Byte2LongOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ByteOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Byte2LongSortedMap {
		...
		public long lastLongValue() { synchronized(mutex) { return map.lastLongValue(); } }
		@Override
		public Byte2LongSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractByte2LongMap implements Byte2LongMap {
		...
		@Override
		public Byte2LongMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ByteSet keySet() {
			if(keys == null) keys = ByteSets.synchronize(map.keySet(), mutex);
			return keys;
