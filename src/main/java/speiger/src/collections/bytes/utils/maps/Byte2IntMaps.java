...
public class Byte2IntMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Byte2IntMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Byte2IntMap.Entry unmodifiable(Byte2IntMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Byte2IntMap.Entry unmodifiable(Map.Entry<Byte, Integer> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Byte2IntNavigableMap {
		...
		@Override
		public Byte2IntNavigableMap descendingMap() { return Byte2IntMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Byte2IntNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Byte2IntOrderedMap {
		...
		@Override
		public Byte2IntOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.byte2IntEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Byte2IntSortedMap {
		...
		public int lastIntValue() { return map.lastIntValue(); }
		@Override
		public Byte2IntSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractByte2IntMap implements Byte2IntMap {
		...
		public void mergeAllInt(Byte2IntMap m, IntIntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceInts(ByteIntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceInts(Byte2IntMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Byte2IntMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Byte2IntMap.Entry>
	{
		ObjectOrderedSet<Byte2IntMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Byte2IntMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Byte2IntMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Byte2IntMap.Entry first() { return set.first(); }
		@Override
		public Byte2IntMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Byte2IntMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Byte2IntNavigableMap {
		...
		@Override
		public Byte2IntMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Byte2IntNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Byte2IntNavigableMap subMap(Byte fromKey, boolean fromInclusive, Byte toKey, boolean toInclusive) { synchronized(mutex) { return Byte2IntMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Byte2IntOrderedMap {
		...
		@Override
		public Byte2IntOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ByteOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Byte2IntSortedMap {
		...
		public int lastIntValue() { synchronized(mutex) { return map.lastIntValue(); } }
		@Override
		public Byte2IntSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractByte2IntMap implements Byte2IntMap {
		...
		@Override
		public Byte2IntMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ByteSet keySet() {
			if(keys == null) keys = ByteSets.synchronize(map.keySet(), mutex);
			return keys;
