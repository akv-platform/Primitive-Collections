...
public abstract class AbstractObject2IntMap<T> extends AbstractMap<T, Integer> implements Object2IntMap<T>
{
	...
	public void putAll(Object2IntMap<T> m) {
		for(ObjectIterator<Object2IntMap.Entry<T>> iter = Object2IntMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceInts(ObjectIntUnaryOperator<T> mappingFunction) {
		...
		for(ObjectIterator<Object2IntMap.Entry<T>> iter = Object2IntMaps.fastIterator(this);iter.hasNext();) {
			Object2IntMap.Entry<T> entry = iter.next();
		...
		return new AbstractObjectSet<T>() {
			...
			public ObjectIterator<T> iterator() {
				return new ObjectIterator<T>() {
					ObjectIterator<Object2IntMap.Entry<T>> iter = Object2IntMaps.fastIterator(AbstractObject2IntMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Object2IntMap.Entry<T>> iter = Object2IntMaps.fastIterator(this);
