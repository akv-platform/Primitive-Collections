...
public abstract class AbstractObject2ByteMap<T> extends AbstractMap<T, Byte> implements Object2ByteMap<T>
{
	...
	public void putAll(Object2ByteMap<T> m) {
		for(ObjectIterator<Object2ByteMap.Entry<T>> iter = Object2ByteMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBytes(ObjectByteUnaryOperator<T> mappingFunction) {
		...
		for(ObjectIterator<Object2ByteMap.Entry<T>> iter = Object2ByteMaps.fastIterator(this);iter.hasNext();) {
			Object2ByteMap.Entry<T> entry = iter.next();
		...
		return new AbstractObjectSet<T>() {
			...
			public ObjectIterator<T> iterator() {
				return new ObjectIterator<T>() {
					ObjectIterator<Object2ByteMap.Entry<T>> iter = Object2ByteMaps.fastIterator(AbstractObject2ByteMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Object2ByteMap.Entry<T>> iter = Object2ByteMaps.fastIterator(this);
