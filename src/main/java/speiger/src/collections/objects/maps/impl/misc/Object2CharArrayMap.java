...
public class Object2CharArrayMap<T> extends AbstractObject2CharMap<T> implements Object2CharOrderedMap<T>
{
	 ...
	 */
	public Object2CharArrayMap(T[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in length
	 */
	public Object2CharArrayMap(T[] keys, Character[] values, int length) {
		this(length);
	 ...
	 */
	public Object2CharArrayMap(T[] keys, char[] values) {
		this(keys, values, keys.length);
	}
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Object2CharArrayMap(T[] keys, char[] values, int length) {
		this(length);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
		putAll(keys, values, 0, length);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Object2CharArrayMap(Object2CharMap<T> map) {
		this(map.size());
		for(ObjectIterator<Object2CharMap.Entry<T>> iter = Object2CharMaps.fastIterator(map);iter.hasNext();size++) {
	...
	public Object2CharArrayMap<T> copy() {
		Object2CharArrayMap<T> map = new Object2CharArrayMap<>();
		map.size = size;
	...
	protected void insertIndex(int index, T key, char value) {
		grow(size+1);
		if(index != size) {
	...
	protected int findIndex(T key, char value) {
	...
	protected int findIndex(Object key, Object value) {
		for(int i = size-1;i>=0;i--)
			if(Objects.equals(key, keys[i]) && Objects.equals(value, Character.valueOf(values[i]))) return i;
		return -1;		
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Object2CharMap.Entry<T>> implements Object2CharOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2CharMap.Entry<T> o) {
			return Object2CharArrayMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2CharMap.Entry<T> o) {
			return Object2CharArrayMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2CharMap.Entry) {
					...
					int index = Object2CharArrayMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getCharValue() == Object2CharArrayMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2CharArrayMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Object2CharArrayMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2CharMap.Entry) {
					Object2CharMap.Entry<T> entry = (Object2CharMap.Entry<T>)o;
					return Object2CharArrayMap.this.remove(entry.getKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2CharArrayMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2CharArrayMap.this.remove(o);
			return size != oldSize;
		}
		...
		@Override
		public boolean moveToFirst(T o) { return Object2CharArrayMap.this.moveToFirst(o); }
		@Override
		public boolean moveToLast(T o) { return Object2CharArrayMap.this.moveToLast(o); }
		@Override
		...
		@Override
		public int size() { return Object2CharArrayMap.this.size(); }
		@Override
		public void clear() { Object2CharArrayMap.this.clear(); }
		@Override
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Object2CharMap.Entry<T>> {
		...
		@Override
		public void set(Object2CharMap.Entry<T> e) { throw new UnsupportedOperationException(); }
		@Override
		public void add(Object2CharMap.Entry<T> e) { throw new UnsupportedOperationException(); }
	}
	...
	private class MapEntry implements Object2CharMap.Entry<T>, Map.Entry<T, Character> {
		int index = -1;
