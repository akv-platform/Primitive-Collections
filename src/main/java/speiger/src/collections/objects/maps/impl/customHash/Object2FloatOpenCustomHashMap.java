 ...
 */
public class Object2FloatOpenCustomHashMap<T> extends AbstractObject2FloatMap<T> implements ITrimmable
{
	 ...
	 */
	public Object2FloatOpenCustomHashMap(ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2FloatOpenCustomHashMap(int minCapacity, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2FloatOpenCustomHashMap(int minCapacity, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2FloatOpenCustomHashMap(T[] keys, Float[] values, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2FloatOpenCustomHashMap(T[] keys, Float[] values, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Object2FloatOpenCustomHashMap(Map<? extends T, ? extends Float> map, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2FloatOpenCustomHashMap(Map<? extends T, ? extends Float> map, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Object2FloatOpenCustomHashMap(Object2FloatMap<T> map, ObjectStrategy<? super T> strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2FloatOpenCustomHashMap(Object2FloatMap<T> map, float loadFactor, ObjectStrategy<? super T> strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	public boolean containsValue(float value) {
		...
		for(int i = nullIndex;i >= 0;i--)
			if(!strategy.equals(keys[i], null) && Float.floatToIntBits(values[i]) == Float.floatToIntBits(value)) return true;
		return false;
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(!strategy.equals(keys[i], null) && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Float.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Object2FloatOpenCustomHashMap<T> copy() {
		Object2FloatOpenCustomHashMap<T> map = new Object2FloatOpenCustomHashMap<>(0, loadFactor, strategy);
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2FloatMap.Entry<T>> implements Object2FloatMap.FastEntrySet<T> {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2FloatMap.Entry) {
					...
					int index = Object2FloatOpenCustomHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Float.floatToIntBits(entry.getFloatValue()) == Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2FloatOpenCustomHashMap.this.findIndex((T)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float.valueOf(Object2FloatOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2FloatMap.Entry) {
					Object2FloatMap.Entry<T> entry = (Object2FloatMap.Entry<T>)o;
					return Object2FloatOpenCustomHashMap.this.remove(entry.getKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2FloatOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2FloatOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Object2FloatOpenCustomHashMap.this.remove(wrapped.get(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
