...
public abstract class AbstractObject2ObjectMap<T, V> extends AbstractMap<T, V> implements Object2ObjectMap<T, V>
{
	...
	public void putAll(Object2ObjectMap<T, V> m) {
		for(ObjectIterator<Object2ObjectMap.Entry<T, V>> iter = Object2ObjectMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceObjects(ObjectObjectUnaryOperator<T, V> mappingFunction) {
		...
		for(ObjectIterator<Object2ObjectMap.Entry<T, V>> iter = Object2ObjectMaps.fastIterator(this);iter.hasNext();) {
			Object2ObjectMap.Entry<T, V> entry = iter.next();
		...
		return new AbstractObjectSet<T>() {
			...
			public ObjectIterator<T> iterator() {
				return new ObjectIterator<T>() {
					ObjectIterator<Object2ObjectMap.Entry<T, V>> iter = Object2ObjectMaps.fastIterator(AbstractObject2ObjectMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Object2ObjectMap.Entry<T, V>> iter = Object2ObjectMaps.fastIterator(this);
