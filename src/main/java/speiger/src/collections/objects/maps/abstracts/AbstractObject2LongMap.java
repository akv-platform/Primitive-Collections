...
public abstract class AbstractObject2LongMap<T> extends AbstractMap<T, Long> implements Object2LongMap<T>
{
	...
	public void putAll(Object2LongMap<T> m) {
		for(ObjectIterator<Object2LongMap.Entry<T>> iter = Object2LongMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceLongs(ObjectLongUnaryOperator<T> mappingFunction) {
		...
		for(ObjectIterator<Object2LongMap.Entry<T>> iter = Object2LongMaps.fastIterator(this);iter.hasNext();) {
			Object2LongMap.Entry<T> entry = iter.next();
		...
		return new AbstractObjectSet<T>() {
			...
			public ObjectIterator<T> iterator() {
				return new ObjectIterator<T>() {
					ObjectIterator<Object2LongMap.Entry<T>> iter = Object2LongMaps.fastIterator(AbstractObject2LongMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Object2LongMap.Entry<T>> iter = Object2LongMaps.fastIterator(this);
