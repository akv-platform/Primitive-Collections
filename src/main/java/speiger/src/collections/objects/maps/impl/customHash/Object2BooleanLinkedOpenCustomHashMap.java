 ...
 */
public class Object2BooleanLinkedOpenCustomHashMap<T> extends Object2BooleanOpenCustomHashMap<T> implements Object2BooleanOrderedMap<T>
{
	 ...
	 */
	public Object2BooleanLinkedOpenCustomHashMap(ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2BooleanLinkedOpenCustomHashMap(int minCapacity, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2BooleanLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2BooleanLinkedOpenCustomHashMap(T[] keys, Boolean[] values, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2BooleanLinkedOpenCustomHashMap(T[] keys, Boolean[] values, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Object2BooleanLinkedOpenCustomHashMap(Map<? extends T, ? extends Boolean> map, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2BooleanLinkedOpenCustomHashMap(Map<? extends T, ? extends Boolean> map, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Object2BooleanLinkedOpenCustomHashMap(Object2BooleanMap<T> map, ObjectStrategy<? super T> strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2BooleanLinkedOpenCustomHashMap(Object2BooleanMap<T> map, float loadFactor, ObjectStrategy<? super T> strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Object2BooleanLinkedOpenCustomHashMap<T> copy() {
		Object2BooleanLinkedOpenCustomHashMap<T> map = new Object2BooleanLinkedOpenCustomHashMap<>(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2BooleanMap.Entry<T>> implements Object2BooleanOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2BooleanMap.Entry<T> o) {
			return Object2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2BooleanMap.Entry<T> o) {
			return Object2BooleanLinkedOpenCustomHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2BooleanMap.Entry) {
					...
					int index = Object2BooleanLinkedOpenCustomHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getBooleanValue() == Object2BooleanLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2BooleanLinkedOpenCustomHashMap.this.findIndex((T)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Object2BooleanLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2BooleanMap.Entry) {
					Object2BooleanMap.Entry<T> entry = (Object2BooleanMap.Entry<T>)o;
					return Object2BooleanLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2BooleanLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2BooleanLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Object2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Object2BooleanLinkedOpenCustomHashMap.this.moveToLast(o);
		}
