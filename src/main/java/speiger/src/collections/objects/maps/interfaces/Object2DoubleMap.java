...
public interface Object2DoubleMap<T> extends Map<T, Double>, Object2DoubleFunction<T>
{
	...
	public default Double computeIfAbsent(T key, Function<? super T, ? extends Double> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return Double.valueOf(computeDoubleIfAbsent(key, mappingFunction instanceof Object2DoubleFunction ? (Object2DoubleFunction<T>)mappingFunction : K -> mappingFunction.apply(K).doubleValue()));
	}
