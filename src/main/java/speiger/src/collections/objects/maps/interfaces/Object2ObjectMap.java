 ...
 */
public interface Object2ObjectMap<T, V> extends Map<T, V>, Object2ObjectFunction<T, V>
{
	/**
	...
	public default V computeIfAbsent(T key, Function<? super T, ? extends V> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return computeIfAbsent(key, mappingFunction instanceof Object2ObjectFunction ? (Object2ObjectFunction<T, V>)mappingFunction : K -> mappingFunction.apply(K));
	}
