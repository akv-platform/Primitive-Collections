...
public class Object2ObjectLinkedOpenCustomHashMap<T, V> extends Object2ObjectOpenCustomHashMap<T, V> implements Object2ObjectOrderedMap<T, V>
{
	 ...
	 */
	public Object2ObjectLinkedOpenCustomHashMap(ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2ObjectLinkedOpenCustomHashMap(int minCapacity, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2ObjectLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2ObjectLinkedOpenCustomHashMap(T[] keys, V[] values, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2ObjectLinkedOpenCustomHashMap(T[] keys, V[] values, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Object2ObjectLinkedOpenCustomHashMap(Map<? extends T, ? extends V> map, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2ObjectLinkedOpenCustomHashMap(Map<? extends T, ? extends V> map, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Object2ObjectLinkedOpenCustomHashMap(Object2ObjectMap<T, V> map, ObjectStrategy<? super T> strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2ObjectLinkedOpenCustomHashMap(Object2ObjectMap<T, V> map, float loadFactor, ObjectStrategy<? super T> strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	public Object2ObjectLinkedOpenCustomHashMap<T, V> copy() {
		Object2ObjectLinkedOpenCustomHashMap<T, V> map = new Object2ObjectLinkedOpenCustomHashMap<>(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<T, V>> implements Object2ObjectOrderedMap.FastOrderedSet<T, V> {
		...
		public boolean moveToFirst(Object2ObjectMap.Entry<T, V> o) {
			return Object2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2ObjectMap.Entry<T, V> o) {
			return Object2ObjectLinkedOpenCustomHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ObjectMap.Entry) {
					...
					int index = Object2ObjectLinkedOpenCustomHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Object2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2ObjectLinkedOpenCustomHashMap.this.findIndex((T)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Object2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
			}
			return false;
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2ObjectLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Object2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Object2ObjectLinkedOpenCustomHashMap.this.moveToLast(o);
		}
