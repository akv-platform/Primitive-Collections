...
public class Object2BooleanLinkedOpenHashMap<T> extends Object2BooleanOpenHashMap<T> implements Object2BooleanOrderedMap<T>
{
	...
	@Override
	public Object2BooleanLinkedOpenHashMap<T> copy() {
		Object2BooleanLinkedOpenHashMap<T> map = new Object2BooleanLinkedOpenHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2BooleanMap.Entry<T>> implements Object2BooleanOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2BooleanMap.Entry<T> o) {
			return Object2BooleanLinkedOpenHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2BooleanMap.Entry<T> o) {
			return Object2BooleanLinkedOpenHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2BooleanMap.Entry) {
					...
					int index = Object2BooleanLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getBooleanValue() == Object2BooleanLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2BooleanLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2BooleanMap.Entry) {
					Object2BooleanMap.Entry<T> entry = (Object2BooleanMap.Entry<T>)o;
					return Object2BooleanLinkedOpenHashMap.this.remove(entry.getKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2BooleanLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2BooleanLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Object2BooleanLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Object2BooleanLinkedOpenHashMap.this.moveToLast(o);
		}
