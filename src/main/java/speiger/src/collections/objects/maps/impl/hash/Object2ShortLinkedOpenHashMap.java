 ...
 */
public class Object2ShortLinkedOpenHashMap<T> extends Object2ShortOpenHashMap<T> implements Object2ShortOrderedMap<T>
{
	 ...
	 */
	public Object2ShortLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Object2ShortLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Object2ShortLinkedOpenHashMap(T[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2ShortLinkedOpenHashMap(T[] keys, Short[] values, float loadFactor) {
	 ...
	 */
	public Object2ShortLinkedOpenHashMap(Map<? extends T, ? extends Short> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2ShortLinkedOpenHashMap(Map<? extends T, ? extends Short> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Object2ShortLinkedOpenHashMap(Object2ShortMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2ShortLinkedOpenHashMap(Object2ShortMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Object2ShortLinkedOpenHashMap<T> copy() {
		Object2ShortLinkedOpenHashMap<T> map = new Object2ShortLinkedOpenHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<T>> implements Object2ShortOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2ShortMap.Entry<T> o) {
			return Object2ShortLinkedOpenHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2ShortMap.Entry<T> o) {
			return Object2ShortLinkedOpenHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ShortMap.Entry) {
					...
					int index = Object2ShortLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getShortValue() == Object2ShortLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2ShortLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Object2ShortLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ShortMap.Entry) {
					Object2ShortMap.Entry<T> entry = (Object2ShortMap.Entry<T>)o;
					return Object2ShortLinkedOpenHashMap.this.remove(entry.getKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2ShortLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2ShortLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Object2ShortLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Object2ShortLinkedOpenHashMap.this.moveToLast(o);
		}
