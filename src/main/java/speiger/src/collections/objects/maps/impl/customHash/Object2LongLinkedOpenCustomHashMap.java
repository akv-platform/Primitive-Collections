 ...
 */
public class Object2LongLinkedOpenCustomHashMap<T> extends Object2LongOpenCustomHashMap<T> implements Object2LongOrderedMap<T>
{
	 ...
	 */
	public Object2LongLinkedOpenCustomHashMap(ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2LongLinkedOpenCustomHashMap(int minCapacity, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2LongLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2LongLinkedOpenCustomHashMap(T[] keys, Long[] values, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2LongLinkedOpenCustomHashMap(T[] keys, Long[] values, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Object2LongLinkedOpenCustomHashMap(Map<? extends T, ? extends Long> map, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2LongLinkedOpenCustomHashMap(Map<? extends T, ? extends Long> map, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Object2LongLinkedOpenCustomHashMap(Object2LongMap<T> map, ObjectStrategy<? super T> strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2LongLinkedOpenCustomHashMap(Object2LongMap<T> map, float loadFactor, ObjectStrategy<? super T> strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Object2LongLinkedOpenCustomHashMap<T> copy() {
		Object2LongLinkedOpenCustomHashMap<T> map = new Object2LongLinkedOpenCustomHashMap<>(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2LongMap.Entry<T>> implements Object2LongOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2LongMap.Entry<T> o) {
			return Object2LongLinkedOpenCustomHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2LongMap.Entry<T> o) {
			return Object2LongLinkedOpenCustomHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2LongMap.Entry) {
					...
					int index = Object2LongLinkedOpenCustomHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getLongValue() == Object2LongLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2LongLinkedOpenCustomHashMap.this.findIndex((T)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Object2LongLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2LongMap.Entry) {
					Object2LongMap.Entry<T> entry = (Object2LongMap.Entry<T>)o;
					return Object2LongLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2LongLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2LongLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Object2LongLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Object2LongLinkedOpenCustomHashMap.this.moveToLast(o);
		}
