 ...
 */
public class Object2LongLinkedOpenHashMap<T> extends Object2LongOpenHashMap<T> implements Object2LongOrderedMap<T>
{
	 ...
	 */
	public Object2LongLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Object2LongLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Object2LongLinkedOpenHashMap(T[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2LongLinkedOpenHashMap(T[] keys, Long[] values, float loadFactor) {
	 ...
	 */
	public Object2LongLinkedOpenHashMap(Map<? extends T, ? extends Long> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2LongLinkedOpenHashMap(Map<? extends T, ? extends Long> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Object2LongLinkedOpenHashMap(Object2LongMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2LongLinkedOpenHashMap(Object2LongMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Object2LongLinkedOpenHashMap<T> copy() {
		Object2LongLinkedOpenHashMap<T> map = new Object2LongLinkedOpenHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2LongMap.Entry<T>> implements Object2LongOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2LongMap.Entry<T> o) {
			return Object2LongLinkedOpenHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2LongMap.Entry<T> o) {
			return Object2LongLinkedOpenHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2LongMap.Entry) {
					...
					int index = Object2LongLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getLongValue() == Object2LongLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2LongLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Object2LongLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2LongMap.Entry) {
					Object2LongMap.Entry<T> entry = (Object2LongMap.Entry<T>)o;
					return Object2LongLinkedOpenHashMap.this.remove(entry.getKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2LongLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2LongLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Object2LongLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Object2LongLinkedOpenHashMap.this.moveToLast(o);
		}
