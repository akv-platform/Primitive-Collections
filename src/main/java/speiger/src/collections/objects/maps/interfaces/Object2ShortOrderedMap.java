...
public interface Object2ShortOrderedMap<T> extends Object2ShortMap<T>
{
	 ...
	 */
	@Override
	public default Object2ShortOrderedMap<T> synchronize() { return Object2ShortMaps.synchronize(this); }
	 ...
	 */
	@Override
	public default Object2ShortOrderedMap<T> synchronize(Object mutex) { return Object2ShortMaps.synchronize(this, mutex); }
	 ...
	 */
	@Override
	public default Object2ShortOrderedMap<T> unmodifiable() { return Object2ShortMaps.unmodifiable(this); }
	
	/**
	 * Fast Ordered Entry Set that allows for a faster Entry Iterator by recycling the Entry Object and just exchanging 1 internal value
	 * @param <T> the type of elements maintained by this Collection
	 */
	interface FastOrderedSet<T> extends Object2ShortMap.FastEntrySet<T>, ObjectOrderedSet<Object2ShortMap.Entry<T>> {
		@Override
