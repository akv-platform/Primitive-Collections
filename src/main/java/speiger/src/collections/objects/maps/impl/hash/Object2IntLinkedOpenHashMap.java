 ...
 */
public class Object2IntLinkedOpenHashMap<T> extends Object2IntOpenHashMap<T> implements Object2IntOrderedMap<T>
{
	 ...
	 */
	public Object2IntLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Object2IntLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Object2IntLinkedOpenHashMap(T[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2IntLinkedOpenHashMap(T[] keys, Integer[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Object2IntLinkedOpenHashMap(T[] keys, int[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2IntLinkedOpenHashMap(T[] keys, int[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Object2IntLinkedOpenHashMap(Map<? extends T, ? extends Integer> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2IntLinkedOpenHashMap(Map<? extends T, ? extends Integer> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Object2IntLinkedOpenHashMap(Object2IntMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2IntLinkedOpenHashMap(Object2IntMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Object2IntLinkedOpenHashMap<T> copy() {
		Object2IntLinkedOpenHashMap<T> map = new Object2IntLinkedOpenHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry<T>> implements Object2IntOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2IntMap.Entry<T> o) {
			return Object2IntLinkedOpenHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2IntMap.Entry<T> o) {
			return Object2IntLinkedOpenHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2IntMap.Entry) {
					...
					int index = Object2IntLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getIntValue() == Object2IntLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2IntLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(Object2IntLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2IntMap.Entry) {
					Object2IntMap.Entry<T> entry = (Object2IntMap.Entry<T>)o;
					return Object2IntLinkedOpenHashMap.this.remove(entry.getKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2IntLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2IntLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Object2IntLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Object2IntLinkedOpenHashMap.this.moveToLast(o);
		}
