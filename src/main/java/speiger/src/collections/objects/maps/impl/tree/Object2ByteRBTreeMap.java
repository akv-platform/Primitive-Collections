 ...
 */
public class Object2ByteRBTreeMap<T> extends AbstractObject2ByteMap<T> implements Object2ByteNavigableMap<T>
{
	 ...
	 */
	public Object2ByteRBTreeMap(Comparator<T> comp) {
		comparator = comp;
	}
	 ...
	 */
	public Object2ByteRBTreeMap(T[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Object2ByteRBTreeMap(T[] keys, Byte[] values, Comparator<T> comp) {
		comparator = comp;
	 ...
	 */
	public Object2ByteRBTreeMap(Map<? extends T, ? extends Byte> map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Object2ByteRBTreeMap(Map<? extends T, ? extends Byte> map, Comparator<T> comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Object2ByteRBTreeMap(Object2ByteMap<T> map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Object2ByteRBTreeMap(Object2ByteMap<T> map, Comparator<T> comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Object2ByteRBTreeMap<T> copy() {
		Object2ByteRBTreeMap<T> set = new Object2ByteRBTreeMap<>();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
	...
	static class KeySet<T> extends AbstractObjectSet<T> implements ObjectNavigableSet<T>
	{
		...
		public ObjectBidirectionalIterator<T> iterator(T fromElement) {
			if(map instanceof Object2ByteRBTreeMap) return ((Object2ByteRBTreeMap<T>)map).keyIterator(fromElement);
		...
		public ObjectBidirectionalIterator<T> iterator() {
			if(map instanceof Object2ByteRBTreeMap) return ((Object2ByteRBTreeMap<T>)map).keyIterator();
			return ((NavigableSubMap<T>)map).keyIterator();
		}
		
		@Override
		public ObjectBidirectionalIterator<T> descendingIterator() {
			if(map instanceof Object2ByteRBTreeMap) return ((Object2ByteRBTreeMap<T>)map).descendingKeyIterator();
			return ((NavigableSubMap<T>)map).descendingKeyIterator();
		}
		
		protected Node<T> start() {
			if(map instanceof Object2ByteRBTreeMap) return ((Object2ByteRBTreeMap<T>)map).first;
			return ((NavigableSubMap<T>)map).subLowest();
		}
		
		protected Node<T> end() {
			if(map instanceof Object2ByteRBTreeMap) return null;
			return ((NavigableSubMap<T>)map).subHighest();
		}
		
		protected Node<T> next(Node<T> entry) {
			if(map instanceof Object2ByteRBTreeMap) return entry.next();
			return ((NavigableSubMap<T>)map).next(entry);
		}
		
		protected Node<T> previous(Node<T> entry) {
			if(map instanceof Object2ByteRBTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Object2ByteRBTreeMap<T> map, boolean fromStart, T lo, boolean loInclusive, boolean toEnd, T hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap<T> extends NavigableSubMap<T>
	{
		...
		DescendingNaivgableSubMap(Object2ByteRBTreeMap<T> map, boolean fromStart, T lo, boolean loInclusive, boolean toEnd, T hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	{
		final Object2ByteRBTreeMap<T> map;
		final T lo, hi;
		...
		NavigableSubMap(Object2ByteRBTreeMap<T> map, boolean fromStart, T lo, boolean loInclusive, boolean toEnd, T hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
	...
	class Values extends AbstractByteCollection
	{
		...
		@Override
		public int size() {
			return Object2ByteRBTreeMap.this.size;
		}
