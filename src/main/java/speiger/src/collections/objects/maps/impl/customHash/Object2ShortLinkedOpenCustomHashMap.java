 ...
 */
public class Object2ShortLinkedOpenCustomHashMap<T> extends Object2ShortOpenCustomHashMap<T> implements Object2ShortOrderedMap<T>
{
	 ...
	 */
	public Object2ShortLinkedOpenCustomHashMap(ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2ShortLinkedOpenCustomHashMap(int minCapacity, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2ShortLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 */
	public Object2ShortLinkedOpenCustomHashMap(T[] keys, Short[] values, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2ShortLinkedOpenCustomHashMap(T[] keys, Short[] values, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Object2ShortLinkedOpenCustomHashMap(Map<? extends T, ? extends Short> map, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2ShortLinkedOpenCustomHashMap(Map<? extends T, ? extends Short> map, float loadFactor, ObjectStrategy<? super T> strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Object2ShortLinkedOpenCustomHashMap(Object2ShortMap<T> map, ObjectStrategy<? super T> strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2ShortLinkedOpenCustomHashMap(Object2ShortMap<T> map, float loadFactor, ObjectStrategy<? super T> strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Object2ShortLinkedOpenCustomHashMap<T> copy() {
		Object2ShortLinkedOpenCustomHashMap<T> map = new Object2ShortLinkedOpenCustomHashMap<>(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<T>> implements Object2ShortOrderedMap.FastOrderedSet<T> {
		...
		public boolean moveToFirst(Object2ShortMap.Entry<T> o) {
			return Object2ShortLinkedOpenCustomHashMap.this.moveToFirst(o.getKey());
		}
		
		@Override
		public boolean moveToLast(Object2ShortMap.Entry<T> o) {
			return Object2ShortLinkedOpenCustomHashMap.this.moveToLast(o.getKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ShortMap.Entry) {
					...
					int index = Object2ShortLinkedOpenCustomHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getShortValue() == Object2ShortLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2ShortLinkedOpenCustomHashMap.this.findIndex((T)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Object2ShortLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ShortMap.Entry) {
					Object2ShortMap.Entry<T> entry = (Object2ShortMap.Entry<T>)o;
					return Object2ShortLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2ShortLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractObjectSet<T> implements ObjectOrderedSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2ShortLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(T o) {
			return Object2ShortLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(T o) {
			return Object2ShortLinkedOpenCustomHashMap.this.moveToLast(o);
		}
