...
public interface Object2ByteMap<T> extends Map<T, Byte>, Object2ByteFunction<T>
{
	...
	public default Byte computeIfAbsent(T key, Function<? super T, ? extends Byte> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return Byte.valueOf(computeByteIfAbsent(key, mappingFunction instanceof Object2ByteFunction ? (Object2ByteFunction<T>)mappingFunction : K -> mappingFunction.apply(K).byteValue()));
	}
