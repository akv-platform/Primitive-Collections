...
public abstract class AbstractObject2FloatMap<T> extends AbstractMap<T, Float> implements Object2FloatMap<T>
{
	...
	public void putAll(Object2FloatMap<T> m) {
		for(ObjectIterator<Object2FloatMap.Entry<T>> iter = Object2FloatMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceFloats(ObjectFloatUnaryOperator<T> mappingFunction) {
		...
		for(ObjectIterator<Object2FloatMap.Entry<T>> iter = Object2FloatMaps.fastIterator(this);iter.hasNext();) {
			Object2FloatMap.Entry<T> entry = iter.next();
		...
		return new AbstractObjectSet<T>() {
			...
			public ObjectIterator<T> iterator() {
				return new ObjectIterator<T>() {
					ObjectIterator<Object2FloatMap.Entry<T>> iter = Object2FloatMaps.fastIterator(AbstractObject2FloatMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Object2FloatMap.Entry<T>> iter = Object2FloatMaps.fastIterator(this);
