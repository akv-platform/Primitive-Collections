 ...
 */
public class Object2ShortOpenHashMap<T> extends AbstractObject2ShortMap<T> implements ITrimmable
{
	 ...
	 */
	public Object2ShortOpenHashMap(int minCapacity) {
	 ...
	 */
	public Object2ShortOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Object2ShortOpenHashMap(T[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2ShortOpenHashMap(T[] keys, Short[] values, float loadFactor) {
	 ...
	 */
	public Object2ShortOpenHashMap(Map<? extends T, ? extends Short> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Object2ShortOpenHashMap(Map<? extends T, ? extends Short> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Object2ShortOpenHashMap(Object2ShortMap<T> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Object2ShortOpenHashMap(Object2ShortMap<T> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(keys[i] != null && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Short.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Object2ShortOpenHashMap<T> copy() {
		Object2ShortOpenHashMap<T> map = new Object2ShortOpenHashMap<>(0, loadFactor);
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<T>> implements Object2ShortMap.FastEntrySet<T> {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ShortMap.Entry) {
					...
					int index = Object2ShortOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return entry.getShortValue() == Object2ShortOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Object2ShortOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Object2ShortOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Object2ShortMap.Entry) {
					Object2ShortMap.Entry<T> entry = (Object2ShortMap.Entry<T>)o;
					return Object2ShortOpenHashMap.this.remove(entry.getKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Object2ShortOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractObjectSet<T> {
		...
		public boolean remove(Object o) {
			int oldSize = size;
			Object2ShortOpenHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Object2ShortOpenHashMap.this.remove(wrapped.get(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
