...
public class ObjectIterators
{
	 ...
	 */
	public static <T, E> ObjectIterator<E> map(Iterator<? extends T> iterator, Object2ObjectFunction<T, E> mapper) {
	 ...
	 * @return a iterator that is mapped to a new result
	 */
	public static <T, E> ObjectIterator<E> map(ObjectIterator<T> iterator, Object2ObjectFunction<T, E> mapper) {
	 ...
	 */
	public static <T, E, V extends Iterable<E>> ObjectIterator<E> flatMap(Iterator<? extends T> iterator, Object2ObjectFunction<T, V> mapper) {
	 ...
	 * @return a iterator that is flatMapped to a new result
	 */
	public static <T, E, V extends Iterable<E>> ObjectIterator<E> flatMap(ObjectIterator<T> iterator, Object2ObjectFunction<T, V> mapper) {
	 ...
	 * @return a iterator that is flatMapped to a new result
	 */
	public static <T, E> ObjectIterator<E> arrayFlatMap(Iterator<? extends T> iterator, Object2ObjectFunction<T, E[]> mapper) {
	 ...
	 * @return a iterator that is flatMapped to a new result
	 */
	public static <T, E> ObjectIterator<E> arrayFlatMap(ObjectIterator<T> iterator, Object2ObjectFunction<T, E[]> mapper) {
	 ...
	 */
	public static <T> ObjectIterator<T> filter(Iterator<? extends T> iterator, Object2BooleanFunction<T> filter) {
	 ...
	 * @return a filtered iterator
	 */
	public static <T> ObjectIterator<T> filter(ObjectIterator<T> iterator, Object2BooleanFunction<T> filter) {
	...
	private static class MappedIterator<E, T> implements ObjectIterator<T>
	{
		...
		MappedIterator(ObjectIterator<E> iterator, Object2ObjectFunction<E, T> mapper) {
			this.iterator = iterator;
			this.mapper = mapper;
		}
		...
		@Override
		public T next() {
			return mapper.getObject(iterator.next());
		}
	...
	private static class FlatMappedIterator<E, T, V extends Iterable<T>> implements ObjectIterator<T>
	{
		...
		FlatMappedIterator(ObjectIterator<E> iterator, Object2ObjectFunction<E, V> mapper) {
			this.iterator = iterator;
			this.mapper = mapper;
		}
		...
		void compute() {
			...
			while(iterator.hasNext()) {
				...
				last = mapper.getObject(iterator.next()).iterator();
			}
		}
	...
	private static class FlatMappedArrayIterator<E, T> implements ObjectIterator<T>
	{
		...
		FlatMappedArrayIterator(ObjectIterator<E> iterator, Object2ObjectFunction<E, T[]> mapper) {
			this.iterator = iterator;
			this.mapper = mapper;
		}
		...
		void compute() {
			...
			while(iterator.hasNext()) {
				if(last != null && last.hasNext()) return;
				last = ObjectIterators.wrap(mapper.getObject(iterator.next()));
			}
		}
	...
	private static class SortedIterator<T> implements ObjectIterator<T>
	{
		ObjectIterator<T> iterator;
		Comparator<T> sorter;
		ObjectList<T> sortedElements = null;
		int index = 0;
		...
		public boolean hasNext() {
			if(sortedElements == null) {
				...
				sortedElements = hasNext ? pour(iterator) : ObjectLists.empty();
	...
	private static class FilteredIterator<T> implements ObjectIterator<T>
	{
		...
		public FilteredIterator(ObjectIterator<T> iterator, Object2BooleanFunction<T> filter) {
			this.iterator = iterator;
			this.filter = filter;
		}
		...
		void compute() {
			...
			while(iterator.hasNext()) {
				lastFound = iterator.next();
				if(filter.getBoolean(lastFound)) {
					foundNext = true;
					break;
				}
			}
