...
public class Object2FloatMaps
{
	...
	public static class EmptyMap<T> extends AbstractObject2FloatMap<T> {
		...
		@Override
		public float getOrDefault(T key, float defaultValue) { return 0F; }
		@Override
	...
	public static class SynchronizedNavigableMap<T> extends SynchronizedSortedMap<T> implements Object2FloatNavigableMap<T> {
		...
		@Override
		public Object2FloatMap.Entry<T> lastEntry() { synchronized(mutex) { return map.firstEntry(); } }
		@Override
	...
	public static class SynchronizedMap<T> extends AbstractObject2FloatMap<T> implements Object2FloatMap<T> {
		...
		@Override
		public float computeFloatIfAbsent(T key, Object2FloatFunction<T> mappingFunction) { synchronized(mutex) { return map.computeFloatIfAbsent(key, mappingFunction); } }
		@Override
