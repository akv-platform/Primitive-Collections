...
public class Object2DoubleMaps
{
	...
	public static class EmptyMap<T> extends AbstractObject2DoubleMap<T> {
		...
		@Override
		public double getOrDefault(T key, double defaultValue) { return 0D; }
		@Override
	...
	public static class UnmodifyableMap<T> extends AbstractObject2DoubleMap<T> implements Object2DoubleMap<T> {
		...
		@Override
		public double computeDoubleIfAbsent(T key, Object2DoubleFunction<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class SynchronizedNavigableMap<T> extends SynchronizedSortedMap<T> implements Object2DoubleNavigableMap<T> {
		...
		@Override
		public Object2DoubleMap.Entry<T> lastEntry() { synchronized(mutex) { return map.firstEntry(); } }
		@Override
	...
	public static class SynchronizedMap<T> extends AbstractObject2DoubleMap<T> implements Object2DoubleMap<T> {
		...
		@Override
		public double computeDoubleIfAbsent(T key, Object2DoubleFunction<T> mappingFunction) { synchronized(mutex) { return map.computeDoubleIfAbsent(key, mappingFunction); } }
		@Override
