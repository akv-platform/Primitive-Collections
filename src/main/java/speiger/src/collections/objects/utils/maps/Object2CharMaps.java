...
public class Object2CharMaps
{
	...
	public static class EmptyMap<T> extends AbstractObject2CharMap<T> {
		...
		@Override
		public char getOrDefault(T key, char defaultValue) { return (char)0; }
		@Override
	...
	public static class UnmodifyableMap<T> extends AbstractObject2CharMap<T> implements Object2CharMap<T> {
		...
		@Override
		public char computeCharIfAbsent(T key, Object2CharFunction<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class SynchronizedNavigableMap<T> extends SynchronizedSortedMap<T> implements Object2CharNavigableMap<T> {
		...
		@Override
		public Object2CharMap.Entry<T> lastEntry() { synchronized(mutex) { return map.firstEntry(); } }
		@Override
	...
	public static class SynchronizedMap<T> extends AbstractObject2CharMap<T> implements Object2CharMap<T> {
		...
		@Override
		public char computeCharIfAbsent(T key, Object2CharFunction<T> mappingFunction) { synchronized(mutex) { return map.computeCharIfAbsent(key, mappingFunction); } }
		@Override
