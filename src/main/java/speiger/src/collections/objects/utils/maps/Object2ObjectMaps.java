...
public class Object2ObjectMaps
{
	...
	public static class UnmodifyableMap<T, V> extends AbstractObject2ObjectMap<T, V> implements Object2ObjectMap<T, V> {
		...
		@Override
		public V computeIfAbsent(T key, Object2ObjectFunction<T, V> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class SynchronizedMap<T, V> extends AbstractObject2ObjectMap<T, V> implements Object2ObjectMap<T, V> {
		...
		@Override
		public V computeIfAbsent(T key, Object2ObjectFunction<T, V> mappingFunction) { synchronized(mutex) { return map.computeIfAbsent(key, mappingFunction); } }
		@Override
