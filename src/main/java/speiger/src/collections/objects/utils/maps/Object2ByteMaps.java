...
public class Object2ByteMaps
{
	 ...
	 */
	public static <T> Object2ByteMap.Entry<T> unmodifiable(Object2ByteMap.Entry<T> entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @param <T> the type of elements maintained by this Collection
	 * @return a Unmodifyable Entry
	 */
	public static <T> Object2ByteMap.Entry<T> unmodifiable(Map.Entry<T, Byte> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry<T>)entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	...
	public static class SingletonMap<T> extends AbstractObject2ByteMap<T> {
		...
		@Override
		public byte computeByteIfAbsent(T key, Object2ByteFunction<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		...
		@Override
		public void mergeAllByte(Object2ByteMap<T> m, ByteByteUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class EmptyMap<T> extends AbstractObject2ByteMap<T> {
		...
		@Override
		public byte getOrDefault(T key, byte defaultValue) { return defaultValue; }
		@Override
		public byte computeByte(T key, ObjectByteUnaryOperator<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public byte computeByteIfAbsent(T key, Object2ByteFunction<T> mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap<T> extends UnmodifyableSortedMap<T> implements Object2ByteNavigableMap<T> {
		...
		@Override
		public Object2ByteNavigableMap<T> descendingMap() { return Object2ByteMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Object2ByteNavigableMap<T> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap<T> extends UnmodifyableMap<T> implements Object2ByteOrderedMap<T> {
		...
		@Override
		public Object2ByteOrderedMap<T> copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Object2ByteMap.Entry<T>> object2ByteEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet<>(map.object2ByteEntrySet());
	...
	public static class UnmodifyableSortedMap<T> extends UnmodifyableMap<T> implements Object2ByteSortedMap<T> {
		...
		public byte lastByteValue() { return map.lastByteValue(); }
		@Override
		public Object2ByteSortedMap<T> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap<T> extends AbstractObject2ByteMap<T> implements Object2ByteMap<T> {
		...
		public void mergeAllByte(Object2ByteMap<T> m, ByteByteUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceBytes(ObjectByteUnaryOperator<T> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceBytes(Object2ByteMap<T> m) { throw new UnsupportedOperationException(); }
		@Override
		public Object2ByteMap<T> copy() { return map.copy(); }
		@Override
	 ...
	 * @param <T> the type of elements maintained by this Collection
	 */
	public static class UnmodifyableOrderedEntrySet<T> extends UnmodifyableEntrySet<T> implements ObjectOrderedSet<Object2ByteMap.Entry<T>>
	{
		ObjectOrderedSet<Object2ByteMap.Entry<T>> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Object2ByteMap.Entry<T>> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public boolean moveToFirst(Object2ByteMap.Entry<T> o) { throw new UnsupportedOperationException(); }
		@Override
		public boolean moveToLast(Object2ByteMap.Entry<T> o) { throw new UnsupportedOperationException(); }
		@Override
		public ObjectOrderedSet<Object2ByteMap.Entry<T>> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Object2ByteMap.Entry<T>> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Object2ByteMap.Entry<T>> iterator(Object2ByteMap.Entry<T> fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Object2ByteMap.Entry<T> first() { return set.first(); }
		@Override
		public Object2ByteMap.Entry<T> pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Object2ByteMap.Entry<T> last() { return set.last(); }
		@Override
		public Object2ByteMap.Entry<T> pollLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedNavigableMap<T> extends SynchronizedSortedMap<T> implements Object2ByteNavigableMap<T> {
		...
		@Override
		public Object2ByteMap.Entry<T> lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Object2ByteNavigableMap<T> copy() { synchronized(mutex) { return map.copy(); } }
	}
	...
	public static class SynchronizedOrderedMap<T> extends SynchronizedMap<T> implements Object2ByteOrderedMap<T> {
		...
		@Override
		public Object2ByteOrderedMap<T> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ObjectOrderedSet<T> keySet() {
	...
	public static class SynchronizedSortedMap<T> extends SynchronizedMap<T> implements Object2ByteSortedMap<T> {
		...
		public byte lastByteValue() { synchronized(mutex) { return map.lastByteValue(); } }
		@Override
		public Object2ByteSortedMap<T> copy() { synchronized(mutex) { return map.copy(); } }
	}
	...
	public static class SynchronizedMap<T> extends AbstractObject2ByteMap<T> implements Object2ByteMap<T> {
		...
		@Override
		public byte supplyByteIfAbsent(T key, ByteSupplier valueProvider) { synchronized(mutex) { return map.supplyByteIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Object2ByteMap<T> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ObjectSet<T> keySet() {
			if(keys == null) keys = ObjectSets.synchronize(map.keySet(), mutex);
			return keys;
