...
public class Object2BooleanMaps
{
	...
	public static class EmptyMap<T> extends AbstractObject2BooleanMap<T> {
		...
		@Override
		public boolean getOrDefault(T key, boolean defaultValue) { return false; }
		@Override
	...
	public static class SynchronizedMap<T> extends AbstractObject2BooleanMap<T> implements Object2BooleanMap<T> {
		...
		@Override
		public boolean computeBooleanIfAbsent(T key, Object2BooleanFunction<T> mappingFunction) { synchronized(mutex) { return map.computeBooleanIfAbsent(key, mappingFunction); } }
		@Override
