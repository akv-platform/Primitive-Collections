 ...
 */
public class Long2CharLinkedOpenCustomHashMap extends Long2CharOpenCustomHashMap implements Long2CharOrderedMap
{
	 ...
	 */
	public Long2CharLinkedOpenCustomHashMap(LongStrategy strategy) {
	 ...
	 */
	public Long2CharLinkedOpenCustomHashMap(int minCapacity, LongStrategy strategy) {
	 ...
	 */
	public Long2CharLinkedOpenCustomHashMap(int minCapacity, float loadFactor, LongStrategy strategy) {
	 ...
	 */
	public Long2CharLinkedOpenCustomHashMap(Long[] keys, Character[] values, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharLinkedOpenCustomHashMap(Long[] keys, Character[] values, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Long2CharLinkedOpenCustomHashMap(long[] keys, char[] values, LongStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharLinkedOpenCustomHashMap(long[] keys, char[] values, float loadFactor, LongStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Long2CharLinkedOpenCustomHashMap(Map<? extends Long, ? extends Character> map, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharLinkedOpenCustomHashMap(Map<? extends Long, ? extends Character> map, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Long2CharLinkedOpenCustomHashMap(Long2CharMap map, LongStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2CharLinkedOpenCustomHashMap(Long2CharMap map, float loadFactor, LongStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Long2CharLinkedOpenCustomHashMap copy() {
		Long2CharLinkedOpenCustomHashMap map = new Long2CharLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry> implements Long2CharOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2CharMap.Entry o) {
			return Long2CharLinkedOpenCustomHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2CharMap.Entry o) {
			return Long2CharLinkedOpenCustomHashMap.this.moveToLast(o.getLongKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2CharMap.Entry) {
					...
					int index = Long2CharLinkedOpenCustomHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getCharValue() == Long2CharLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Long)) return false;
					int index = Long2CharLinkedOpenCustomHashMap.this.findIndex((Long)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Long2CharLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2CharMap.Entry) {
					Long2CharMap.Entry entry = (Long2CharMap.Entry)o;
					return Long2CharLinkedOpenCustomHashMap.this.remove(entry.getLongKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2CharLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2CharLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2CharLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2CharLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2CharLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2CharLinkedOpenCustomHashMap.this.moveToLast(o);
		}
