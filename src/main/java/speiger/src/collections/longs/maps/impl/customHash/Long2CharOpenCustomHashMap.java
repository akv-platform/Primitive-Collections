 ...
 */
public class Long2CharOpenCustomHashMap extends AbstractLong2CharMap implements ITrimmable
{
	 ...
	 */
	public Long2CharOpenCustomHashMap(LongStrategy strategy) {
	 ...
	 */
	public Long2CharOpenCustomHashMap(int minCapacity, LongStrategy strategy) {
	 ...
	 */
	public Long2CharOpenCustomHashMap(int minCapacity, float loadFactor, LongStrategy strategy) {
	 ...
	 */
	public Long2CharOpenCustomHashMap(Long[] keys, Character[] values, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharOpenCustomHashMap(Long[] keys, Character[] values, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Long2CharOpenCustomHashMap(long[] keys, char[] values, LongStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharOpenCustomHashMap(long[] keys, char[] values, float loadFactor, LongStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Long2CharOpenCustomHashMap(Map<? extends Long, ? extends Character> map, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharOpenCustomHashMap(Map<? extends Long, ? extends Character> map, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Long2CharOpenCustomHashMap(Long2CharMap map, LongStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2CharOpenCustomHashMap(Long2CharMap map, float loadFactor, LongStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(!strategy.equals(keys[i], 0L) && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Character.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Long2CharOpenCustomHashMap copy() {
		Long2CharOpenCustomHashMap map = new Long2CharOpenCustomHashMap(0, loadFactor, strategy);
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry> implements Long2CharMap.FastEntrySet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2CharMap.Entry) {
					...
					int index = Long2CharOpenCustomHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getCharValue() == Long2CharOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Long)) return false;
					int index = Long2CharOpenCustomHashMap.this.findIndex((Long)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Long2CharOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2CharMap.Entry) {
					Long2CharMap.Entry entry = (Long2CharMap.Entry)o;
					return Long2CharOpenCustomHashMap.this.remove(entry.getLongKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2CharOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractLongSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2CharOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Long2CharOpenCustomHashMap.this.remove(wrapped.getLong(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
