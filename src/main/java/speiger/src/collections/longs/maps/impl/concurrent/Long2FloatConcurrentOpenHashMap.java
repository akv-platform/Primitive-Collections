...
import speiger.src.collections.longs.maps.interfaces.Long2FloatConcurrentMap;
 ...
 * 
 */
public class Long2FloatConcurrentOpenHashMap extends AbstractLong2FloatMap implements Long2FloatConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Long2FloatConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Long2FloatConcurrentOpenHashMap() {
	 ...
	 */
	public Long2FloatConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Long2FloatConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2FloatConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2FloatConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2FloatConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Long2FloatConcurrentOpenHashMap(Long[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2FloatConcurrentOpenHashMap(Long[] keys, Float[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2FloatConcurrentOpenHashMap(Long[] keys, Float[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2FloatConcurrentOpenHashMap(Long[] keys, Float[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Long2FloatConcurrentOpenHashMap(Map<? extends Long, ? extends Float> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2FloatConcurrentOpenHashMap(Map<? extends Long, ? extends Float> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2FloatConcurrentOpenHashMap(Map<? extends Long, ? extends Float> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2FloatConcurrentOpenHashMap(Map<? extends Long, ? extends Float> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2FloatConcurrentOpenHashMap(Long2FloatMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2FloatConcurrentOpenHashMap(Long2FloatMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2FloatConcurrentOpenHashMap(Long2FloatMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2FloatConcurrentOpenHashMap(Long2FloatMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Long2FloatConcurrentOpenHashMap copy() {
		Long2FloatConcurrentOpenHashMap copy = new Long2FloatConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements Long2FloatMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2FloatMap.Entry) {
					Long2FloatMap.Entry entry = (Long2FloatMap.Entry)o;
					return Long2FloatConcurrentOpenHashMap.this.remove(entry.getLongKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2FloatConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2FloatConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2FloatConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongSet {
		...
		public boolean remove(long o) {
			int oldSize = size();
			Long2FloatConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2FloatMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2FloatMap.Entry> {
		MapEntry entry;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Long2FloatMap.Entry) {
					...
					return getLongKey() == entry.getLongKey() && Float.floatToIntBits(getFloatValue()) == Float.floatToIntBits(entry.getFloatValue());
				}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Long2FloatConcurrentOpenHashMap map;
		...
		protected Segment(Long2FloatConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Long2FloatConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Long2FloatConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected float put(int hash, long key, float value) {
		...
		protected float putIfAbsent(int hash, long key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected float addTo(int hash, long key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected float subFrom(int hash, long key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected float get(int hash, long key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected float getOrDefault(int hash, long key, float defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(LongFloatConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected float remove(int hash, long key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected float removeOrDefault(int hash, long key, float defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, long key, float value) {
			long stamp = writeLock();
			try {
				if(key == 0) {
		...
		protected boolean replace(int hash, long key, float oldValue, float newValue) {
			long stamp = writeLock();
			try {
		...
		protected float replace(int hash, long key, float value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected float compute(int hash, long key, LongFloatUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected float merge(int hash, long key, float value, FloatFloatUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
