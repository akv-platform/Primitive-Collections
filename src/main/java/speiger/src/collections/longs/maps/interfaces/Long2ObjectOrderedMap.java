...
public interface Long2ObjectOrderedMap<V> extends Long2ObjectMap<V>
{
	...
	@Override
	public Long2ObjectOrderedMap<V> copy();
	@Override
	 ...
	 */
	@Override
	public default Long2ObjectOrderedMap<V> synchronize() { return Long2ObjectMaps.synchronize(this); }
	 ...
	 */
	@Override
	public default Long2ObjectOrderedMap<V> synchronize(Object mutex) { return Long2ObjectMaps.synchronize(this, mutex); }
	 ...
	 */
	@Override
	public default Long2ObjectOrderedMap<V> unmodifiable() { return Long2ObjectMaps.unmodifiable(this); }
	
	/**
	 * Fast Ordered Entry Set that allows for a faster Entry Iterator by recycling the Entry Object and just exchanging 1 internal value
	 * @param <V> the type of elements maintained by this Collection
	 */
	interface FastOrderedSet<V> extends Long2ObjectMap.FastEntrySet<V>, ObjectOrderedSet<Long2ObjectMap.Entry<V>> {
		@Override
