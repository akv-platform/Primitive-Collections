 ...
 */
public class Long2ByteLinkedOpenCustomHashMap extends Long2ByteOpenCustomHashMap implements Long2ByteOrderedMap
{
	 ...
	 */
	public Long2ByteLinkedOpenCustomHashMap(LongStrategy strategy) {
	 ...
	 */
	public Long2ByteLinkedOpenCustomHashMap(int minCapacity, LongStrategy strategy) {
	 ...
	 */
	public Long2ByteLinkedOpenCustomHashMap(int minCapacity, float loadFactor, LongStrategy strategy) {
	 ...
	 */
	public Long2ByteLinkedOpenCustomHashMap(Long[] keys, Byte[] values, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ByteLinkedOpenCustomHashMap(Long[] keys, Byte[] values, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Long2ByteLinkedOpenCustomHashMap(Map<? extends Long, ? extends Byte> map, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ByteLinkedOpenCustomHashMap(Map<? extends Long, ? extends Byte> map, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Long2ByteLinkedOpenCustomHashMap(Long2ByteMap map, LongStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2ByteLinkedOpenCustomHashMap(Long2ByteMap map, float loadFactor, LongStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	
	@Override
	public byte putAndMoveToFirst(long key, byte value) {
	...
	@Override
	public byte putAndMoveToLast(long key, byte value) {
		if(strategy.equals(key, 0L)) {
			if(containsNull) {
				byte lastValue = values[nullIndex];
				values[nullIndex] = value;
	...
	@Override
	public byte getAndMoveToFirst(long key) {
	...
	@Override
	public byte getAndMoveToLast(long key) {
		int index = findIndex(key);
		if(index < 0) return getDefaultReturnValue();
	...
	@Override
	public Long2ByteLinkedOpenCustomHashMap copy() {
		Long2ByteLinkedOpenCustomHashMap map = new Long2ByteLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	public ObjectOrderedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
		...
		return (ObjectOrderedSet<Long2ByteMap.Entry>)entrySet;
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Long2ByteMap.Entry o) {
			return Long2ByteLinkedOpenCustomHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2ByteMap.Entry o) {
			return Long2ByteLinkedOpenCustomHashMap.this.moveToLast(o.getLongKey());
		}
		...
		@Override
		public Long2ByteMap.Entry pollFirst() {
			BasicEntry entry = new BasicEntry(firstLongKey(), firstByteValue());
			pollFirstLongKey();
			return entry;
		}
		
		@Override
		public Long2ByteMap.Entry pollLast() {
			BasicEntry entry = new BasicEntry(lastLongKey(), lastByteValue());
			pollLastLongKey();
			return entry;
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2ByteMap.Entry) {
					...
					int index = Long2ByteLinkedOpenCustomHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getByteValue() == Long2ByteLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Long)) return false;
					int index = Long2ByteLinkedOpenCustomHashMap.this.findIndex((Long)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Long2ByteLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2ByteMap.Entry) {
					Long2ByteMap.Entry entry = (Long2ByteMap.Entry)o;
					return Long2ByteLinkedOpenCustomHashMap.this.remove(entry.getLongKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2ByteLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2ByteLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2ByteLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2ByteLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2ByteLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2ByteLinkedOpenCustomHashMap.this.moveToLast(o);
		}
