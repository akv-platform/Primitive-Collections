 ...
 */
public class Long2DoubleLinkedOpenHashMap extends Long2DoubleOpenHashMap implements Long2DoubleOrderedMap
{
	 ...
	 */
	public Long2DoubleLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2DoubleLinkedOpenHashMap(Long[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2DoubleLinkedOpenHashMap(Long[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2DoubleLinkedOpenHashMap(Map<? extends Long, ? extends Double> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2DoubleLinkedOpenHashMap(Long2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2DoubleLinkedOpenHashMap(Long2DoubleMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Long2DoubleLinkedOpenHashMap copy() {
		Long2DoubleLinkedOpenHashMap map = new Long2DoubleLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2DoubleMap.Entry> implements Long2DoubleOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2DoubleMap.Entry o) {
			return Long2DoubleLinkedOpenHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2DoubleMap.Entry o) {
			return Long2DoubleLinkedOpenHashMap.this.moveToLast(o.getLongKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2DoubleMap.Entry) {
					...
					int index = Long2DoubleLinkedOpenHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Long2DoubleLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Long2DoubleLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Long2DoubleLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2DoubleMap.Entry) {
					Long2DoubleMap.Entry entry = (Long2DoubleMap.Entry)o;
					return Long2DoubleLinkedOpenHashMap.this.remove(entry.getLongKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2DoubleLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2DoubleLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2DoubleLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2DoubleLinkedOpenHashMap.this.moveToLast(o);
		}
