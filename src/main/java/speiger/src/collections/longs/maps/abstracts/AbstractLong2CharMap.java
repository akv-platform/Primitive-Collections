...
public abstract class AbstractLong2CharMap extends AbstractMap<Long, Character> implements Long2CharMap
{
	...
	public void putAll(Long2CharMap m) {
		for(ObjectIterator<Long2CharMap.Entry> iter = Long2CharMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceChars(LongCharUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Long2CharMap.Entry> iter = Long2CharMaps.fastIterator(this);iter.hasNext();) {
			Long2CharMap.Entry entry = iter.next();
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					ObjectIterator<Long2CharMap.Entry> iter = Long2CharMaps.fastIterator(AbstractLong2CharMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Long2CharMap.Entry> iter = Long2CharMaps.fastIterator(this);
