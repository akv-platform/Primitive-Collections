...
import speiger.src.collections.longs.maps.interfaces.Long2BooleanConcurrentMap;
 ...
 * 
 */
public class Long2BooleanConcurrentOpenHashMap extends AbstractLong2BooleanMap implements Long2BooleanConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Long2BooleanConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Long2BooleanConcurrentOpenHashMap() {
	 ...
	 */
	public Long2BooleanConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Long2BooleanConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2BooleanConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2BooleanConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2BooleanConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Long2BooleanConcurrentOpenHashMap(Long[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2BooleanConcurrentOpenHashMap(Long[] keys, Boolean[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2BooleanConcurrentOpenHashMap(Long[] keys, Boolean[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2BooleanConcurrentOpenHashMap(Long[] keys, Boolean[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Long2BooleanConcurrentOpenHashMap(Map<? extends Long, ? extends Boolean> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2BooleanConcurrentOpenHashMap(Map<? extends Long, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2BooleanConcurrentOpenHashMap(Map<? extends Long, ? extends Boolean> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Long2BooleanConcurrentOpenHashMap(Map<? extends Long, ? extends Boolean> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2BooleanConcurrentOpenHashMap(Long2BooleanMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2BooleanConcurrentOpenHashMap(Long2BooleanMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2BooleanConcurrentOpenHashMap(Long2BooleanMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Long2BooleanConcurrentOpenHashMap(Long2BooleanMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Long2BooleanConcurrentOpenHashMap copy() {
		Long2BooleanConcurrentOpenHashMap copy = new Long2BooleanConcurrentOpenHashMap(false);
	...
	@Override
	public boolean computeBooleanIfAbsent(long key, Long2BooleanFunction mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		int hash = getHashCode(key);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2BooleanMap.Entry> implements Long2BooleanMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2BooleanMap.Entry) {
					Long2BooleanMap.Entry entry = (Long2BooleanMap.Entry)o;
					return Long2BooleanConcurrentOpenHashMap.this.remove(entry.getLongKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2BooleanConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2BooleanConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2BooleanConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongSet {
		...
		public boolean remove(long o) {
			int oldSize = size();
			Long2BooleanConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2BooleanMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Long2BooleanMap.Entry> {
		MapEntry entry;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Long2BooleanMap.Entry) {
					...
					return getLongKey() == entry.getLongKey() && getBooleanValue() == entry.getBooleanValue();
				}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Long2BooleanConcurrentOpenHashMap map;
		...
		protected Segment(Long2BooleanConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Long2BooleanConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Long2BooleanConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected boolean put(int hash, long key, boolean value) {
		...
		protected boolean putIfAbsent(int hash, long key, boolean value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected boolean get(int hash, long key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean getOrDefault(int hash, long key, boolean defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(LongBooleanConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected boolean remove(int hash, long key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean removeOrDefault(int hash, long key, boolean defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, long key, boolean value) {
			long stamp = writeLock();
			try {
				if(key == 0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				long current = keys[pos];
				if(current == 0) return false;
				if(Objects.equals(key, Long.valueOf(current)) && Objects.equals(value, Boolean.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == 0) return false;
					else if(Objects.equals(key, Long.valueOf(current)) && Objects.equals(value, Boolean.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, long key, boolean oldValue, boolean newValue) {
			long stamp = writeLock();
			try {
		...
		protected boolean replace(int hash, long key, boolean value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected boolean compute(int hash, long key, LongBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean computeIfAbsent(int hash, long key, Long2BooleanFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected boolean merge(int hash, long key, boolean value, BooleanBooleanUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected void insert(int slot, long key, boolean value) {
