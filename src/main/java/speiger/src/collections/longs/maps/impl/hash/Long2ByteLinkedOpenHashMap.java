 ...
 */
public class Long2ByteLinkedOpenHashMap extends Long2ByteOpenHashMap implements Long2ByteOrderedMap
{
	 ...
	 */
	public Long2ByteLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Long2ByteLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2ByteLinkedOpenHashMap(Long[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ByteLinkedOpenHashMap(Long[] keys, Byte[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ByteLinkedOpenHashMap(Map<? extends Long, ? extends Byte> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2ByteLinkedOpenHashMap(Long2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2ByteLinkedOpenHashMap(Long2ByteMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Long2ByteLinkedOpenHashMap copy() {
		Long2ByteLinkedOpenHashMap map = new Long2ByteLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2ByteMap.Entry o) {
			return Long2ByteLinkedOpenHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2ByteMap.Entry o) {
			return Long2ByteLinkedOpenHashMap.this.moveToLast(o.getLongKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2ByteMap.Entry) {
					...
					int index = Long2ByteLinkedOpenHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getByteValue() == Long2ByteLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Long2ByteLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Long2ByteLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2ByteMap.Entry) {
					Long2ByteMap.Entry entry = (Long2ByteMap.Entry)o;
					return Long2ByteLinkedOpenHashMap.this.remove(entry.getLongKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2ByteLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2ByteLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2ByteLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2ByteLinkedOpenHashMap.this.moveToLast(o);
		}
