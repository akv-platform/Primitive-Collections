 ...
 */
public interface Long2CharNavigableMap extends Long2CharSortedMap, NavigableMap<Long, Character>
{
	@Override
	 ...
	 */
	public default Long2CharNavigableMap synchronize() { return Long2CharMaps.synchronize(this); }
	 ...
	 * @see Long2CharMaps#synchronize
	 */
	public default Long2CharNavigableMap synchronize(Object mutex) { return Long2CharMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Long2CharNavigableMap unmodifiable() { return Long2CharMaps.unmodifiable(this); }
	...
	@Override
	public default Long2CharNavigableMap subMap(long fromKey, long toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Long2CharNavigableMap headMap(long toKey) { return headMap(toKey, false); }
	@Override
	public default Long2CharNavigableMap tailMap(long fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Long2CharMap.Entry lowerEntry(Long key) { return lowerEntry(key.longValue()); }
	@Override
	@Deprecated
	default Long2CharMap.Entry floorEntry(Long key) { return floorEntry(key.longValue()); }
	@Override
	@Deprecated
	default Long2CharMap.Entry ceilingEntry(Long key) { return ceilingEntry(key.longValue()); }
	@Override
	@Deprecated
	default Long2CharMap.Entry higherEntry(Long key) { return higherEntry(key.longValue()); }
	
	@Override
	@Deprecated
	default Long2CharNavigableMap subMap(Long fromKey, boolean fromInclusive, Long toKey, boolean toInclusive) { return subMap(fromKey.longValue(), fromInclusive, toKey.longValue(), toInclusive); }
	@Override
	@Deprecated
	default Long2CharNavigableMap headMap(Long toKey, boolean inclusive) { return headMap(toKey.longValue(), inclusive); }
	@Override
	@Deprecated
	default Long2CharNavigableMap tailMap(Long fromKey, boolean inclusive) { return tailMap(fromKey.longValue(), inclusive); }
	@Override
	@Deprecated
	default Long2CharNavigableMap subMap(Long fromKey, Long toKey) { return subMap(fromKey.longValue(), true, toKey.longValue(), false); }
	@Override
	@Deprecated
	default Long2CharNavigableMap headMap(Long toKey) { return headMap(toKey.longValue(), false); }
	@Override
	@Deprecated
	default Long2CharNavigableMap tailMap(Long fromKey) { return tailMap(fromKey.longValue(), true); }
}