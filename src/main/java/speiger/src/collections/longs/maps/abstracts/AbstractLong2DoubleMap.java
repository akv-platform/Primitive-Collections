...
public abstract class AbstractLong2DoubleMap extends AbstractMap<Long, Double> implements Long2DoubleMap
{
	...
	public void putAll(Long2DoubleMap m) {
		for(ObjectIterator<Long2DoubleMap.Entry> iter = Long2DoubleMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceDoubles(LongDoubleUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Long2DoubleMap.Entry> iter = Long2DoubleMaps.fastIterator(this);iter.hasNext();) {
			Long2DoubleMap.Entry entry = iter.next();
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					ObjectIterator<Long2DoubleMap.Entry> iter = Long2DoubleMaps.fastIterator(AbstractLong2DoubleMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Long2DoubleMap.Entry> iter = Long2DoubleMaps.fastIterator(this);
