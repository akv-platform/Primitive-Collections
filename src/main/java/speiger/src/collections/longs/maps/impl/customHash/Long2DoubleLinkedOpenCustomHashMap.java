...
public class Long2DoubleLinkedOpenCustomHashMap extends Long2DoubleOpenCustomHashMap implements Long2DoubleOrderedMap
{
	 ...
	 */
	public Long2DoubleLinkedOpenCustomHashMap(LongStrategy strategy) {
	 ...
	 */
	public Long2DoubleLinkedOpenCustomHashMap(int minCapacity, LongStrategy strategy) {
	 ...
	 */
	public Long2DoubleLinkedOpenCustomHashMap(int minCapacity, float loadFactor, LongStrategy strategy) {
	 ...
	 */
	public Long2DoubleLinkedOpenCustomHashMap(Long[] keys, Double[] values, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2DoubleLinkedOpenCustomHashMap(Long[] keys, Double[] values, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Long2DoubleLinkedOpenCustomHashMap(Map<? extends Long, ? extends Double> map, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2DoubleLinkedOpenCustomHashMap(Map<? extends Long, ? extends Double> map, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Long2DoubleLinkedOpenCustomHashMap(Long2DoubleMap map, LongStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2DoubleLinkedOpenCustomHashMap(Long2DoubleMap map, float loadFactor, LongStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Long2DoubleLinkedOpenCustomHashMap copy() {
		Long2DoubleLinkedOpenCustomHashMap map = new Long2DoubleLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2DoubleMap.Entry> implements Long2DoubleOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2DoubleMap.Entry o) {
			return Long2DoubleLinkedOpenCustomHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2DoubleMap.Entry o) {
			return Long2DoubleLinkedOpenCustomHashMap.this.moveToLast(o.getLongKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2DoubleMap.Entry) {
					...
					int index = Long2DoubleLinkedOpenCustomHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Long2DoubleLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Long)) return false;
					int index = Long2DoubleLinkedOpenCustomHashMap.this.findIndex((Long)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Long2DoubleLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2DoubleMap.Entry) {
					Long2DoubleMap.Entry entry = (Long2DoubleMap.Entry)o;
					return Long2DoubleLinkedOpenCustomHashMap.this.remove(entry.getLongKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2DoubleLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2DoubleLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2DoubleLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2DoubleLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2DoubleLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2DoubleLinkedOpenCustomHashMap.this.moveToLast(o);
		}
