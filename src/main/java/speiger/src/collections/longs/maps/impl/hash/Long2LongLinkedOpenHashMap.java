 ...
 */
public class Long2LongLinkedOpenHashMap extends Long2LongOpenHashMap implements Long2LongOrderedMap
{
	 ...
	 */
	public Long2LongLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Long2LongLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2LongLinkedOpenHashMap(Long[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2LongLinkedOpenHashMap(Long[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2LongLinkedOpenHashMap(Map<? extends Long, ? extends Long> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2LongLinkedOpenHashMap(Long2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2LongLinkedOpenHashMap(Long2LongMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Long2LongLinkedOpenHashMap copy() {
		Long2LongLinkedOpenHashMap map = new Long2LongLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2LongMap.Entry> implements Long2LongOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2LongMap.Entry o) {
			return Long2LongLinkedOpenHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2LongMap.Entry o) {
			return Long2LongLinkedOpenHashMap.this.moveToLast(o.getLongKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2LongMap.Entry) {
					...
					int index = Long2LongLinkedOpenHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getLongValue() == Long2LongLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Long2LongLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Long2LongLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2LongMap.Entry) {
					Long2LongMap.Entry entry = (Long2LongMap.Entry)o;
					return Long2LongLinkedOpenHashMap.this.remove(entry.getLongKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2LongLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2LongLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2LongLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2LongLinkedOpenHashMap.this.moveToLast(o);
		}
