 ...
 */
public class Long2ShortLinkedOpenCustomHashMap extends Long2ShortOpenCustomHashMap implements Long2ShortOrderedMap
{
	 ...
	 */
	public Long2ShortLinkedOpenCustomHashMap(LongStrategy strategy) {
	 ...
	 */
	public Long2ShortLinkedOpenCustomHashMap(int minCapacity, LongStrategy strategy) {
	 ...
	 */
	public Long2ShortLinkedOpenCustomHashMap(int minCapacity, float loadFactor, LongStrategy strategy) {
	 ...
	 */
	public Long2ShortLinkedOpenCustomHashMap(Long[] keys, Short[] values, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ShortLinkedOpenCustomHashMap(Long[] keys, Short[] values, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Long2ShortLinkedOpenCustomHashMap(Map<? extends Long, ? extends Short> map, LongStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ShortLinkedOpenCustomHashMap(Map<? extends Long, ? extends Short> map, float loadFactor, LongStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Long2ShortLinkedOpenCustomHashMap(Long2ShortMap map, LongStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2ShortLinkedOpenCustomHashMap(Long2ShortMap map, float loadFactor, LongStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Long2ShortLinkedOpenCustomHashMap copy() {
		Long2ShortLinkedOpenCustomHashMap map = new Long2ShortLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2ShortMap.Entry> implements Long2ShortOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2ShortMap.Entry o) {
			return Long2ShortLinkedOpenCustomHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2ShortMap.Entry o) {
			return Long2ShortLinkedOpenCustomHashMap.this.moveToLast(o.getLongKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2ShortMap.Entry) {
					...
					int index = Long2ShortLinkedOpenCustomHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getShortValue() == Long2ShortLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Long)) return false;
					int index = Long2ShortLinkedOpenCustomHashMap.this.findIndex((Long)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Long2ShortLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2ShortMap.Entry) {
					Long2ShortMap.Entry entry = (Long2ShortMap.Entry)o;
					return Long2ShortLinkedOpenCustomHashMap.this.remove(entry.getLongKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2ShortLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Long2ShortLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Long2ShortLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2ShortLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2ShortLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2ShortLinkedOpenCustomHashMap.this.moveToLast(o);
		}
