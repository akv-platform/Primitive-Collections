 ...
 */
public class Long2ShortLinkedOpenHashMap extends Long2ShortOpenHashMap implements Long2ShortOrderedMap
{
	 ...
	 */
	public Long2ShortLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Long2ShortLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2ShortLinkedOpenHashMap(Long[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ShortLinkedOpenHashMap(Long[] keys, Short[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2ShortLinkedOpenHashMap(Map<? extends Long, ? extends Short> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2ShortLinkedOpenHashMap(Long2ShortMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2ShortLinkedOpenHashMap(Long2ShortMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Long2ShortLinkedOpenHashMap copy() {
		Long2ShortLinkedOpenHashMap map = new Long2ShortLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2ShortMap.Entry> implements Long2ShortOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2ShortMap.Entry o) {
			return Long2ShortLinkedOpenHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2ShortMap.Entry o) {
			return Long2ShortLinkedOpenHashMap.this.moveToLast(o.getLongKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2ShortMap.Entry) {
					...
					int index = Long2ShortLinkedOpenHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getShortValue() == Long2ShortLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Long2ShortLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Long2ShortLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2ShortMap.Entry) {
					Long2ShortMap.Entry entry = (Long2ShortMap.Entry)o;
					return Long2ShortLinkedOpenHashMap.this.remove(entry.getLongKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2ShortLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2ShortLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2ShortLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2ShortLinkedOpenHashMap.this.moveToLast(o);
		}
