 ...
 */
public interface Long2FloatNavigableMap extends Long2FloatSortedMap, NavigableMap<Long, Float>
{
	@Override
	public Long2FloatNavigableMap copy();
	 ...
	 */
	public default Long2FloatNavigableMap synchronize() { return Long2FloatMaps.synchronize(this); }
	 ...
	 * @see Long2FloatMaps#synchronize
	 */
	public default Long2FloatNavigableMap synchronize(Object mutex) { return Long2FloatMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Long2FloatNavigableMap unmodifiable() { return Long2FloatMaps.unmodifiable(this); }
	...
	@Override
	public default Long2FloatNavigableMap subMap(long fromKey, long toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Long2FloatNavigableMap headMap(long toKey) { return headMap(toKey, false); }
	@Override
	public default Long2FloatNavigableMap tailMap(long fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Long2FloatMap.Entry lowerEntry(Long key) { return lowerEntry(key.longValue()); }
	@Override
	@Deprecated
	default Long2FloatMap.Entry floorEntry(Long key) { return floorEntry(key.longValue()); }
	@Override
	@Deprecated
	default Long2FloatMap.Entry ceilingEntry(Long key) { return ceilingEntry(key.longValue()); }
	@Override
	@Deprecated
	default Long2FloatMap.Entry higherEntry(Long key) { return higherEntry(key.longValue()); }
	
	@Override
	@Deprecated
	default Long2FloatNavigableMap subMap(Long fromKey, boolean fromInclusive, Long toKey, boolean toInclusive) { return subMap(fromKey.longValue(), fromInclusive, toKey.longValue(), toInclusive); }
	@Override
	@Deprecated
	default Long2FloatNavigableMap headMap(Long toKey, boolean inclusive) { return headMap(toKey.longValue(), inclusive); }
	@Override
	@Deprecated
	default Long2FloatNavigableMap tailMap(Long fromKey, boolean inclusive) { return tailMap(fromKey.longValue(), inclusive); }
	@Override
	@Deprecated
	default Long2FloatNavigableMap subMap(Long fromKey, Long toKey) { return subMap(fromKey.longValue(), true, toKey.longValue(), false); }
	@Override
	@Deprecated
	default Long2FloatNavigableMap headMap(Long toKey) { return headMap(toKey.longValue(), false); }
	@Override
	@Deprecated
	default Long2FloatNavigableMap tailMap(Long fromKey) { return tailMap(fromKey.longValue(), true); }
}