 ...
 */
public class Long2CharLinkedOpenHashMap extends Long2CharOpenHashMap implements Long2CharOrderedMap
{
	 ...
	 */
	public Long2CharLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Long2CharLinkedOpenHashMap(Long[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharLinkedOpenHashMap(Long[] keys, Character[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Long2CharLinkedOpenHashMap(long[] keys, char[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharLinkedOpenHashMap(long[] keys, char[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Long2CharLinkedOpenHashMap(Map<? extends Long, ? extends Character> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Long2CharLinkedOpenHashMap(Long2CharMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Long2CharLinkedOpenHashMap(Long2CharMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Long2CharLinkedOpenHashMap copy() {
		Long2CharLinkedOpenHashMap map = new Long2CharLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry> implements Long2CharOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Long2CharMap.Entry o) {
			return Long2CharLinkedOpenHashMap.this.moveToFirst(o.getLongKey());
		}
		
		@Override
		public boolean moveToLast(Long2CharMap.Entry o) {
			return Long2CharLinkedOpenHashMap.this.moveToLast(o.getLongKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2CharMap.Entry) {
					...
					int index = Long2CharLinkedOpenHashMap.this.findIndex(entry.getLongKey());
					if(index >= 0) return entry.getCharValue() == Long2CharLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Long2CharLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Long2CharLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Long2CharMap.Entry) {
					Long2CharMap.Entry entry = (Long2CharMap.Entry)o;
					return Long2CharLinkedOpenHashMap.this.remove(entry.getLongKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Long2CharLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractLongSet implements LongOrderedSet {
		...
		public boolean remove(long o) {
			int oldSize = size;
			Long2CharLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(long o) {
			return Long2CharLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(long o) {
			return Long2CharLinkedOpenHashMap.this.moveToLast(o);
		}
