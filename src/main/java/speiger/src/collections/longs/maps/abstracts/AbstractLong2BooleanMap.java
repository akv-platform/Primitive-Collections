...
public abstract class AbstractLong2BooleanMap extends AbstractMap<Long, Boolean> implements Long2BooleanMap
{
	...
	public void putAll(Long2BooleanMap m) {
		for(ObjectIterator<Long2BooleanMap.Entry> iter = Long2BooleanMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBooleans(LongBooleanUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Long2BooleanMap.Entry> iter = Long2BooleanMaps.fastIterator(this);iter.hasNext();) {
			Long2BooleanMap.Entry entry = iter.next();
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					ObjectIterator<Long2BooleanMap.Entry> iter = Long2BooleanMaps.fastIterator(AbstractLong2BooleanMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Long2BooleanMap.Entry> iter = Long2BooleanMaps.fastIterator(this);
