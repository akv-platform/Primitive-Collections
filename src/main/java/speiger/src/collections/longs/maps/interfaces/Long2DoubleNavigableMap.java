 ...
 */
public interface Long2DoubleNavigableMap extends Long2DoubleSortedMap, NavigableMap<Long, Double>
{
	@Override
	 ...
	 */
	public default Long2DoubleNavigableMap synchronize() { return Long2DoubleMaps.synchronize(this); }
	 ...
	 * @see Long2DoubleMaps#synchronize
	 */
	public default Long2DoubleNavigableMap synchronize(Object mutex) { return Long2DoubleMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Long2DoubleNavigableMap unmodifiable() { return Long2DoubleMaps.unmodifiable(this); }
	...
	@Override
	public default Long2DoubleNavigableMap subMap(long fromKey, long toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Long2DoubleNavigableMap headMap(long toKey) { return headMap(toKey, false); }
	@Override
	public default Long2DoubleNavigableMap tailMap(long fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Long2DoubleMap.Entry lowerEntry(Long key) { return lowerEntry(key.longValue()); }
	@Override
	@Deprecated
	default Long2DoubleMap.Entry floorEntry(Long key) { return floorEntry(key.longValue()); }
	@Override
	@Deprecated
	default Long2DoubleMap.Entry ceilingEntry(Long key) { return ceilingEntry(key.longValue()); }
	@Override
	@Deprecated
	default Long2DoubleMap.Entry higherEntry(Long key) { return higherEntry(key.longValue()); }
	
	@Override
	@Deprecated
	default Long2DoubleNavigableMap subMap(Long fromKey, boolean fromInclusive, Long toKey, boolean toInclusive) { return subMap(fromKey.longValue(), fromInclusive, toKey.longValue(), toInclusive); }
	@Override
	@Deprecated
	default Long2DoubleNavigableMap headMap(Long toKey, boolean inclusive) { return headMap(toKey.longValue(), inclusive); }
	@Override
	@Deprecated
	default Long2DoubleNavigableMap tailMap(Long fromKey, boolean inclusive) { return tailMap(fromKey.longValue(), inclusive); }
	@Override
	@Deprecated
	default Long2DoubleNavigableMap subMap(Long fromKey, Long toKey) { return subMap(fromKey.longValue(), true, toKey.longValue(), false); }
	@Override
	@Deprecated
	default Long2DoubleNavigableMap headMap(Long toKey) { return headMap(toKey.longValue(), false); }
	@Override
	@Deprecated
	default Long2DoubleNavigableMap tailMap(Long fromKey) { return tailMap(fromKey.longValue(), true); }
}