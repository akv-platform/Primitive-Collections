...
public class Long2ByteMaps
{
	...
	public static class EmptyMap extends AbstractLong2ByteMap {
		...
		@Override
		public byte getOrDefault(long key, byte defaultValue) { return defaultValue; }
		@Override
		public byte computeByte(long key, LongByteUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public byte computeByteIfAbsent(long key, Long2ByteFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Long2ByteOrderedMap {
		...
		public ObjectOrderedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.long2ByteEntrySet());
	...
	public static class UnmodifyableMap extends AbstractLong2ByteMap implements Long2ByteMap {
		...
		public void mergeAllByte(Long2ByteMap m, ByteByteUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceBytes(LongByteUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceBytes(Long2ByteMap m) { throw new UnsupportedOperationException(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2ByteMap.Entry>
	{
		ObjectOrderedSet<Long2ByteMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Long2ByteMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Long2ByteMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Long2ByteMap.Entry first() { return set.first(); }
		@Override
		public Long2ByteMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2ByteMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Long2ByteNavigableMap {
		...
		@Override
		public Long2ByteMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
