...
public class Long2BooleanMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Long2BooleanMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Long2BooleanMap.Entry unmodifiable(Long2BooleanMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Long2BooleanMap.Entry unmodifiable(Map.Entry<Long, Boolean> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Long2BooleanNavigableMap {
		...
		@Override
		public Long2BooleanNavigableMap descendingMap() { return Long2BooleanMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Long2BooleanNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Long2BooleanSortedMap {
		...
		public boolean lastBooleanValue() { return map.lastBooleanValue(); }
		@Override
		public Long2BooleanSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractLong2BooleanMap implements Long2BooleanMap {
		...
		public void mergeAllBoolean(Long2BooleanMap m, BooleanBooleanUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceBooleans(LongBooleanUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceBooleans(Long2BooleanMap m) { throw new UnsupportedOperationException(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2BooleanMap.Entry>
	{
		ObjectOrderedSet<Long2BooleanMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Long2BooleanMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Long2BooleanMap.Entry> copy() { return set.copy(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Long2BooleanNavigableMap {
		...
		@Override
		public Long2BooleanNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Long2BooleanNavigableMap subMap(Long fromKey, boolean fromInclusive, Long toKey, boolean toInclusive) { synchronized(mutex) { return Long2BooleanMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Long2BooleanSortedMap {
		...
		public boolean lastBooleanValue() { synchronized(mutex) { return map.lastBooleanValue(); } }
		@Override
		public Long2BooleanSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractLong2BooleanMap implements Long2BooleanMap {
		...
		@Override
		public Long2BooleanMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public LongSet keySet() {
			if(keys == null) keys = LongSets.synchronize(map.keySet(), mutex);
			return keys;
