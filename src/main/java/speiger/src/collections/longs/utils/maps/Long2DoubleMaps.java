...
public class Long2DoubleMaps
{
	 ...
	 */
	public static Long2DoubleMap.Entry unmodifiable(Long2DoubleMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Long2DoubleMap.Entry unmodifiable(Map.Entry<Long, Double> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class EmptyMap extends AbstractLong2DoubleMap {
		...
		@Override
		public double getOrDefault(long key, double defaultValue) { return defaultValue; }
		@Override
		public double computeDouble(long key, LongDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public double computeDoubleIfAbsent(long key, Long2DoubleFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Long2DoubleNavigableMap {
		...
		@Override
		public Long2DoubleNavigableMap descendingMap() { return Long2DoubleMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Long2DoubleNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Long2DoubleOrderedMap {
		...
		@Override
		public Long2DoubleOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.long2DoubleEntrySet());
			return (ObjectOrderedSet<Long2DoubleMap.Entry>)entrySet;
		}
	}
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Long2DoubleSortedMap {
		...
		public double lastDoubleValue() { return map.lastDoubleValue(); }
		@Override
		public Long2DoubleSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractLong2DoubleMap implements Long2DoubleMap {
		...
		public void mergeAllDouble(Long2DoubleMap m, DoubleDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceDoubles(LongDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceDoubles(Long2DoubleMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Long2DoubleMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2DoubleMap.Entry>
	{
		ObjectOrderedSet<Long2DoubleMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Long2DoubleMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Long2DoubleMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Long2DoubleMap.Entry first() { return set.first(); }
		@Override
		public Long2DoubleMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2DoubleMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Long2DoubleNavigableMap {
		...
		@Override
		public Long2DoubleMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Long2DoubleNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Long2DoubleNavigableMap subMap(Long fromKey, boolean fromInclusive, Long toKey, boolean toInclusive) { synchronized(mutex) { return Long2DoubleMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Long2DoubleOrderedMap {
		...
		@Override
		public Long2DoubleOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public LongOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Long2DoubleSortedMap {
		...
		public double lastDoubleValue() { synchronized(mutex) { return map.lastDoubleValue(); } }
		@Override
		public Long2DoubleSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractLong2DoubleMap implements Long2DoubleMap {
		...
		@Override
		public double supplyDoubleIfAbsent(long key, DoubleSupplier valueProvider) { synchronized(mutex) { return map.supplyDoubleIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Long2DoubleMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public LongSet keySet() {
			if(keys == null) keys = LongSets.synchronize(map.keySet(), mutex);
			return keys;
