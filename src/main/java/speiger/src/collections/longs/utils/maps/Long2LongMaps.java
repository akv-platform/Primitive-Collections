...
public class Long2LongMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Long2LongMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Long2LongMap.Entry unmodifiable(Long2LongMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Long2LongMap.Entry unmodifiable(Map.Entry<Long, Long> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class EmptyMap extends AbstractLong2LongMap {
		...
		@Override
		public long getOrDefault(long key, long defaultValue) { return defaultValue; }
		@Override
		public long computeLong(long key, LongLongUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public long computeLongIfAbsent(long key, Long2LongFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Long2LongNavigableMap {
		...
		@Override
		public Long2LongNavigableMap descendingMap() { return Long2LongMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Long2LongNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Long2LongOrderedMap {
		...
		public ObjectOrderedSet<Long2LongMap.Entry> long2LongEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.long2LongEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Long2LongSortedMap {
		...
		public long lastLongValue() { return map.lastLongValue(); }
		@Override
		public Long2LongSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractLong2LongMap implements Long2LongMap {
		...
		public void mergeAllLong(Long2LongMap m, LongLongUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceLongs(LongLongUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceLongs(Long2LongMap m) { throw new UnsupportedOperationException(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2LongMap.Entry>
	{
		ObjectOrderedSet<Long2LongMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Long2LongMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Long2LongMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Long2LongMap.Entry first() { return set.first(); }
		@Override
		public Long2LongMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2LongMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Long2LongNavigableMap {
		...
		@Override
		public Long2LongNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Long2LongNavigableMap subMap(Long fromKey, boolean fromInclusive, Long toKey, boolean toInclusive) { synchronized(mutex) { return Long2LongMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Long2LongSortedMap {
		...
		public long lastLongValue() { synchronized(mutex) { return map.lastLongValue(); } }
		@Override
		public Long2LongSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractLong2LongMap implements Long2LongMap {
		...
		@Override
		public long supplyLongIfAbsent(long key, LongSupplier valueProvider) { synchronized(mutex) { return map.supplyLongIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Long2LongMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public LongSet keySet() {
			if(keys == null) keys = LongSets.synchronize(map.keySet(), mutex);
			return keys;
