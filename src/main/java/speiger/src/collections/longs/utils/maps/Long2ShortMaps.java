...
public class Long2ShortMaps
{
	 ...
	 */
	public static Long2ShortMap.Entry unmodifiable(Long2ShortMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Long2ShortMap.Entry unmodifiable(Map.Entry<Long, Short> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class EmptyMap extends AbstractLong2ShortMap {
		...
		@Override
		public short getOrDefault(long key, short defaultValue) { return defaultValue; }
		@Override
		public short computeShort(long key, LongShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public short computeShortIfAbsent(long key, Long2ShortFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Long2ShortNavigableMap {
		...
		@Override
		public Long2ShortNavigableMap descendingMap() { return Long2ShortMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Long2ShortNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Long2ShortOrderedMap {
		...
		@Override
		public Long2ShortOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.long2ShortEntrySet());
			return (ObjectOrderedSet<Long2ShortMap.Entry>)entrySet;
		}
	}
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Long2ShortSortedMap {
		...
		public short lastShortValue() { return map.lastShortValue(); }
		@Override
		public Long2ShortSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractLong2ShortMap implements Long2ShortMap {
		...
		public void mergeAllShort(Long2ShortMap m, ShortShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(LongShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(Long2ShortMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Long2ShortMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Long2ShortMap.Entry>
	{
		ObjectOrderedSet<Long2ShortMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Long2ShortMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Long2ShortMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator(Long2ShortMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Long2ShortMap.Entry first() { return set.first(); }
		@Override
		public Long2ShortMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Long2ShortMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Long2ShortNavigableMap {
		...
		@Override
		public Long2ShortMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Long2ShortNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Long2ShortNavigableMap subMap(Long fromKey, boolean fromInclusive, Long toKey, boolean toInclusive) { synchronized(mutex) { return Long2ShortMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Long2ShortOrderedMap {
		...
		@Override
		public Long2ShortOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public LongOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Long2ShortSortedMap {
		...
		public short lastShortValue() { synchronized(mutex) { return map.lastShortValue(); } }
		@Override
		public Long2ShortSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractLong2ShortMap implements Long2ShortMap {
		...
		@Override
		public short supplyShortIfAbsent(long key, ShortSupplier valueProvider) { synchronized(mutex) { return map.supplyShortIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Long2ShortMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public LongSet keySet() {
			if(keys == null) keys = LongSets.synchronize(map.keySet(), mutex);
			return keys;
