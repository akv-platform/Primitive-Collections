...
public class LongAVLTreeSet extends AbstractLongSet implements LongNavigableSet
{
	 ...
	 */
	@Deprecated
	public LongAVLTreeSet(Collection<? extends Long> collection, LongComparator comp) {
		comparator = comp;
		addAll(collection);
	}
	...
	{
		public AscendingSubSet(LongAVLTreeSet set, boolean fromStart, long lo, boolean loInclusive, boolean toEnd, long hi, boolean hiInclusive)
		{
	...
	static class DescendingSubSet extends SubSet
	{
		...
		public DescendingSubSet(LongAVLTreeSet set, boolean fromStart, long lo, boolean loInclusive, boolean toEnd, long hi, boolean hiInclusive)
		{
			super(set, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	{
		final LongAVLTreeSet set;
		final long lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		LongNavigableSet inverse;
		
		public SubSet(LongAVLTreeSet set, boolean fromStart, long lo, boolean loInclusive, boolean toEnd, long hi, boolean hiInclusive)
		{
			this.set = set;
			this.lo = lo;
			this.hi = hi;
