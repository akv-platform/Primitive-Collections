...
public class IntLinkedOpenCustomHashSet extends IntOpenCustomHashSet implements IntOrderedSet
{
	 ...
	 */
	public IntLinkedOpenCustomHashSet(IntStrategy strategy) {
	 ...
	 */
	public IntLinkedOpenCustomHashSet(int minCapacity, IntStrategy strategy) {
	 ...
	 */
	public IntLinkedOpenCustomHashSet(int minCapacity, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public IntLinkedOpenCustomHashSet(int[] array, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public IntLinkedOpenCustomHashSet(int[] array, float loadFactor, IntStrategy strategy) {
	 ...
	 */
	public IntLinkedOpenCustomHashSet(int[] array, int offset, int length, IntStrategy strategy) {
	 ...
	 */
	@Deprecated
	public IntLinkedOpenCustomHashSet(Collection<? extends Integer> collection, IntStrategy strategy) {
	 ...
	 */
	@Deprecated
	public IntLinkedOpenCustomHashSet(Collection<? extends Integer> collection, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public IntLinkedOpenCustomHashSet(IntCollection collection, IntStrategy strategy) {
		this(collection, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public IntLinkedOpenCustomHashSet(IntCollection collection, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public IntLinkedOpenCustomHashSet(Iterator<Integer> iterator, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public IntLinkedOpenCustomHashSet(Iterator<Integer> iterator, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public IntLinkedOpenCustomHashSet(IntIterator iterator, IntStrategy strategy) {
		this(iterator, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public boolean moveToFirst(int o) {
		if(isEmpty() || strategy.equals(firstInt(), o)) return false;
		if(strategy.equals(o, 0)) {
			if(containsNull) {
				moveToFirstIndex(nullIndex);
				return true;
	...
	public boolean moveToLast(int o) {
		if(isEmpty() || strategy.equals(lastInt(), o)) return false;
		if(strategy.equals(o, 0)) {
			if(containsNull) {
				moveToLastIndex(nullIndex);
				return true;
	...
	@Override
	public IntLinkedOpenCustomHashSet copy() {
		IntLinkedOpenCustomHashSet set = new IntLinkedOpenCustomHashSet(0, loadFactor, strategy);
