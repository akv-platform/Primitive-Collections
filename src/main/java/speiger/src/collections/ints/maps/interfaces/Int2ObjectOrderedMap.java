...
public interface Int2ObjectOrderedMap<V> extends Int2ObjectMap<V>
{
	 ...
	 */
	@Override
	public default Int2ObjectOrderedMap<V> synchronize() { return Int2ObjectMaps.synchronize(this); }
	 ...
	 */
	@Override
	public default Int2ObjectOrderedMap<V> synchronize(Object mutex) { return Int2ObjectMaps.synchronize(this, mutex); }
	 ...
	 */
	@Override
	public default Int2ObjectOrderedMap<V> unmodifiable() { return Int2ObjectMaps.unmodifiable(this); }
	
	/**
	 * Fast Ordered Entry Set that allows for a faster Entry Iterator by recycling the Entry Object and just exchanging 1 internal value
	 * @param <V> the type of elements maintained by this Collection
	 */
	interface FastOrderedSet<V> extends Int2ObjectMap.FastEntrySet<V>, ObjectOrderedSet<Int2ObjectMap.Entry<V>> {
		@Override
