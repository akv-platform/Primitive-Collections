 ...
 */
public class Int2FloatLinkedOpenCustomHashMap extends Int2FloatOpenCustomHashMap implements Int2FloatOrderedMap
{
	 ...
	 */
	public Int2FloatLinkedOpenCustomHashMap(IntStrategy strategy) {
	 ...
	 */
	public Int2FloatLinkedOpenCustomHashMap(int minCapacity, IntStrategy strategy) {
	 ...
	 */
	public Int2FloatLinkedOpenCustomHashMap(int minCapacity, float loadFactor, IntStrategy strategy) {
	 ...
	 */
	public Int2FloatLinkedOpenCustomHashMap(Integer[] keys, Float[] values, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2FloatLinkedOpenCustomHashMap(Integer[] keys, Float[] values, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2FloatLinkedOpenCustomHashMap(int[] keys, float[] values, IntStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2FloatLinkedOpenCustomHashMap(int[] keys, float[] values, float loadFactor, IntStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2FloatLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Float> map, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2FloatLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Float> map, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Int2FloatLinkedOpenCustomHashMap(Int2FloatMap map, IntStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2FloatLinkedOpenCustomHashMap(Int2FloatMap map, float loadFactor, IntStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Int2FloatLinkedOpenCustomHashMap copy() {
		Int2FloatLinkedOpenCustomHashMap map = new Int2FloatLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements Int2FloatOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Int2FloatMap.Entry o) {
			return Int2FloatLinkedOpenCustomHashMap.this.moveToFirst(o.getIntKey());
		}
		
		@Override
		public boolean moveToLast(Int2FloatMap.Entry o) {
			return Int2FloatLinkedOpenCustomHashMap.this.moveToLast(o.getIntKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2FloatMap.Entry) {
					...
					int index = Int2FloatLinkedOpenCustomHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return Float.floatToIntBits(entry.getFloatValue()) == Float.floatToIntBits(Int2FloatLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Integer)) return false;
					int index = Int2FloatLinkedOpenCustomHashMap.this.findIndex((Integer)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float.valueOf(Int2FloatLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2FloatMap.Entry) {
					Int2FloatMap.Entry entry = (Int2FloatMap.Entry)o;
					return Int2FloatLinkedOpenCustomHashMap.this.remove(entry.getIntKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2FloatLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Int2FloatLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Int2FloatLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet implements IntOrderedSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2FloatLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(int o) {
			return Int2FloatLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(int o) {
			return Int2FloatLinkedOpenCustomHashMap.this.moveToLast(o);
		}
