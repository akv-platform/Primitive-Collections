 ...
 */
public class Int2BooleanLinkedOpenCustomHashMap extends Int2BooleanOpenCustomHashMap implements Int2BooleanOrderedMap
{
	 ...
	 */
	public Int2BooleanLinkedOpenCustomHashMap(IntStrategy strategy) {
	 ...
	 */
	public Int2BooleanLinkedOpenCustomHashMap(int minCapacity, IntStrategy strategy) {
	 ...
	 */
	public Int2BooleanLinkedOpenCustomHashMap(int minCapacity, float loadFactor, IntStrategy strategy) {
	 ...
	 */
	public Int2BooleanLinkedOpenCustomHashMap(Integer[] keys, Boolean[] values, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2BooleanLinkedOpenCustomHashMap(Integer[] keys, Boolean[] values, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2BooleanLinkedOpenCustomHashMap(int[] keys, boolean[] values, IntStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2BooleanLinkedOpenCustomHashMap(int[] keys, boolean[] values, float loadFactor, IntStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2BooleanLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Boolean> map, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2BooleanLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Boolean> map, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Int2BooleanLinkedOpenCustomHashMap(Int2BooleanMap map, IntStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2BooleanLinkedOpenCustomHashMap(Int2BooleanMap map, float loadFactor, IntStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Int2BooleanLinkedOpenCustomHashMap copy() {
		Int2BooleanLinkedOpenCustomHashMap map = new Int2BooleanLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2BooleanMap.Entry> implements Int2BooleanOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Int2BooleanMap.Entry o) {
			return Int2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o.getIntKey());
		}
		
		@Override
		public boolean moveToLast(Int2BooleanMap.Entry o) {
			return Int2BooleanLinkedOpenCustomHashMap.this.moveToLast(o.getIntKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2BooleanMap.Entry) {
					...
					int index = Int2BooleanLinkedOpenCustomHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getBooleanValue() == Int2BooleanLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Integer)) return false;
					int index = Int2BooleanLinkedOpenCustomHashMap.this.findIndex((Integer)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Int2BooleanLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2BooleanMap.Entry) {
					Int2BooleanMap.Entry entry = (Int2BooleanMap.Entry)o;
					return Int2BooleanLinkedOpenCustomHashMap.this.remove(entry.getIntKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2BooleanLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Int2BooleanLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Int2BooleanLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet implements IntOrderedSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2BooleanLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(int o) {
			return Int2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(int o) {
			return Int2BooleanLinkedOpenCustomHashMap.this.moveToLast(o);
		}
