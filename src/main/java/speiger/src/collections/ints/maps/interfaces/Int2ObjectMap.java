...
public interface Int2ObjectMap<V> extends Map<Integer, V>, Int2ObjectFunction<V>
{
	...
	public default V computeIfAbsent(Integer key, Function<? super Integer, ? extends V> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return computeIfAbsent(key.intValue(), mappingFunction instanceof Int2ObjectFunction ? (Int2ObjectFunction<V>)mappingFunction : K -> mappingFunction.apply(Integer.valueOf(K)));
	}
