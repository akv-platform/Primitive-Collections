 ...
 */
public class Int2LongLinkedOpenHashMap extends Int2LongOpenHashMap implements Int2LongOrderedMap
{
	 ...
	 */
	public Int2LongLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Int2LongLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Int2LongLinkedOpenHashMap(Integer[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2LongLinkedOpenHashMap(Integer[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2LongLinkedOpenHashMap(int[] keys, long[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2LongLinkedOpenHashMap(int[] keys, long[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2LongLinkedOpenHashMap(Map<? extends Integer, ? extends Long> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Int2LongLinkedOpenHashMap(Int2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2LongLinkedOpenHashMap(Int2LongMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Int2LongLinkedOpenHashMap copy() {
		Int2LongLinkedOpenHashMap map = new Int2LongLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry> implements Int2LongOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Int2LongMap.Entry o) {
			return Int2LongLinkedOpenHashMap.this.moveToFirst(o.getIntKey());
		}
		
		@Override
		public boolean moveToLast(Int2LongMap.Entry o) {
			return Int2LongLinkedOpenHashMap.this.moveToLast(o.getIntKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2LongMap.Entry) {
					...
					int index = Int2LongLinkedOpenHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getLongValue() == Int2LongLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Int2LongLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Int2LongLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2LongMap.Entry) {
					Int2LongMap.Entry entry = (Int2LongMap.Entry)o;
					return Int2LongLinkedOpenHashMap.this.remove(entry.getIntKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2LongLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractIntSet implements IntOrderedSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2LongLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(int o) {
			return Int2LongLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(int o) {
			return Int2LongLinkedOpenHashMap.this.moveToLast(o);
		}
