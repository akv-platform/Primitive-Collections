...
public class Int2IntLinkedOpenHashMap extends Int2IntOpenHashMap implements Int2IntOrderedMap
{
	 ...
	 */
	public Int2IntLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Int2IntLinkedOpenHashMap(Integer[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2IntLinkedOpenHashMap(Integer[] keys, Integer[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2IntLinkedOpenHashMap(int[] keys, int[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2IntLinkedOpenHashMap(int[] keys, int[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2IntLinkedOpenHashMap(Map<? extends Integer, ? extends Integer> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Int2IntLinkedOpenHashMap(Int2IntMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2IntLinkedOpenHashMap(Int2IntMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Int2IntLinkedOpenHashMap copy() {
		Int2IntLinkedOpenHashMap map = new Int2IntLinkedOpenHashMap(0, loadFactor);
	...
	public ObjectOrderedSet<Int2IntMap.Entry> int2IntEntrySet() {
		...
		return (ObjectOrderedSet<Int2IntMap.Entry>)entrySet;
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements Int2IntOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Int2IntMap.Entry o) {
			return Int2IntLinkedOpenHashMap.this.moveToFirst(o.getIntKey());
		}
		
		@Override
		public boolean moveToLast(Int2IntMap.Entry o) {
			return Int2IntLinkedOpenHashMap.this.moveToLast(o.getIntKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2IntMap.Entry) {
					...
					int index = Int2IntLinkedOpenHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getIntValue() == Int2IntLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Int2IntLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(Int2IntLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2IntMap.Entry) {
					Int2IntMap.Entry entry = (Int2IntMap.Entry)o;
					return Int2IntLinkedOpenHashMap.this.remove(entry.getIntKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2IntLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractIntSet implements IntOrderedSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2IntLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(int o) {
			return Int2IntLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(int o) {
			return Int2IntLinkedOpenHashMap.this.moveToLast(o);
		}
