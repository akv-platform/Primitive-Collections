...
import speiger.src.collections.ints.maps.interfaces.Int2ByteConcurrentMap;
 ...
 * 
 */
public class Int2ByteConcurrentOpenHashMap extends AbstractInt2ByteMap implements Int2ByteConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Int2ByteConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Int2ByteConcurrentOpenHashMap() {
	 ...
	 */
	public Int2ByteConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Int2ByteConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Int2ByteConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ByteConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ByteConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Int2ByteConcurrentOpenHashMap(Integer[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ByteConcurrentOpenHashMap(Integer[] keys, Byte[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ByteConcurrentOpenHashMap(Integer[] keys, Byte[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ByteConcurrentOpenHashMap(Integer[] keys, Byte[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2ByteConcurrentOpenHashMap(int[] keys, byte[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ByteConcurrentOpenHashMap(int[] keys, byte[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ByteConcurrentOpenHashMap(int[] keys, byte[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ByteConcurrentOpenHashMap(int[] keys, byte[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Int2ByteConcurrentOpenHashMap(Map<? extends Integer, ? extends Byte> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ByteConcurrentOpenHashMap(Map<? extends Integer, ? extends Byte> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ByteConcurrentOpenHashMap(Map<? extends Integer, ? extends Byte> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2ByteConcurrentOpenHashMap(Map<? extends Integer, ? extends Byte> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Int2ByteConcurrentOpenHashMap(Int2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2ByteConcurrentOpenHashMap(Int2ByteMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Int2ByteConcurrentOpenHashMap(Int2ByteMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Int2ByteConcurrentOpenHashMap(Int2ByteMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Int2ByteConcurrentOpenHashMap copy() {
		Int2ByteConcurrentOpenHashMap copy = new Int2ByteConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2ByteMap.Entry> implements Int2ByteMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2ByteMap.Entry) {
					Int2ByteMap.Entry entry = (Int2ByteMap.Entry)o;
					return Int2ByteConcurrentOpenHashMap.this.remove(entry.getIntKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2ByteConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Int2ByteConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Int2ByteConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet implements IntSet {
		...
		public boolean remove(int o) {
			int oldSize = size();
			Int2ByteConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Int2ByteMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Int2ByteMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Int2ByteMap.Entry, Map.Entry<Integer, Byte> {
		int index = -1;
		int segmentIndex = -1;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Int2ByteMap.Entry) {
					...
					return getIntKey() == entry.getIntKey() && getByteValue() == entry.getByteValue();
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Integer && value instanceof Byte && getIntKey() == ((Integer)key).intValue() && getByteValue() == ((Byte)value).byteValue();
			}
			return false;
		}
		...
		public String toString() {
			return Integer.toString(getIntKey()) + "=" + Byte.toString(getByteValue());
		}
	}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Int2ByteConcurrentOpenHashMap map;
		...
		protected Segment(Int2ByteConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Int2ByteConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Int2ByteConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected byte put(int hash, int key, byte value) {
		...
		protected byte putIfAbsent(int hash, int key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected byte addTo(int hash, int key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected byte subFrom(int hash, int key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected byte get(int hash, int key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected byte getOrDefault(int hash, int key, byte defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(IntByteConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected byte remove(int hash, int key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected byte removeOrDefault(int hash, int key, byte defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, int key, byte value) {
			long stamp = writeLock();
			try {
				if(key == 0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				int current = keys[pos];
				if(current == 0) return false;
				if(Objects.equals(key, Integer.valueOf(current)) && Objects.equals(value, Byte.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == 0) return false;
					else if(Objects.equals(key, Integer.valueOf(current)) && Objects.equals(value, Byte.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, int key, byte oldValue, byte newValue) {
			long stamp = writeLock();
			try {
		...
		protected byte replace(int hash, int key, byte value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected byte compute(int hash, int key, IntByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected byte merge(int hash, int key, byte value, ByteByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected void insert(int slot, int key, byte value) {
