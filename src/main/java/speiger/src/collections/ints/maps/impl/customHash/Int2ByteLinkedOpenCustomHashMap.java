...
public class Int2ByteLinkedOpenCustomHashMap extends Int2ByteOpenCustomHashMap implements Int2ByteOrderedMap
{
	 ...
	 */
	public Int2ByteLinkedOpenCustomHashMap(IntStrategy strategy) {
	 ...
	 */
	public Int2ByteLinkedOpenCustomHashMap(int minCapacity, IntStrategy strategy) {
	 ...
	 */
	public Int2ByteLinkedOpenCustomHashMap(int minCapacity, float loadFactor, IntStrategy strategy) {
	 ...
	 */
	public Int2ByteLinkedOpenCustomHashMap(Integer[] keys, Byte[] values, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ByteLinkedOpenCustomHashMap(Integer[] keys, Byte[] values, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2ByteLinkedOpenCustomHashMap(int[] keys, byte[] values, IntStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ByteLinkedOpenCustomHashMap(int[] keys, byte[] values, float loadFactor, IntStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2ByteLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Byte> map, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ByteLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Byte> map, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Int2ByteLinkedOpenCustomHashMap(Int2ByteMap map, IntStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2ByteLinkedOpenCustomHashMap(Int2ByteMap map, float loadFactor, IntStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Int2ByteLinkedOpenCustomHashMap copy() {
		Int2ByteLinkedOpenCustomHashMap map = new Int2ByteLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2ByteMap.Entry> implements Int2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Int2ByteMap.Entry o) {
			return Int2ByteLinkedOpenCustomHashMap.this.moveToFirst(o.getIntKey());
		}
		
		@Override
		public boolean moveToLast(Int2ByteMap.Entry o) {
			return Int2ByteLinkedOpenCustomHashMap.this.moveToLast(o.getIntKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2ByteMap.Entry) {
					...
					int index = Int2ByteLinkedOpenCustomHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getByteValue() == Int2ByteLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Integer)) return false;
					int index = Int2ByteLinkedOpenCustomHashMap.this.findIndex((Integer)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Int2ByteLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2ByteMap.Entry) {
					Int2ByteMap.Entry entry = (Int2ByteMap.Entry)o;
					return Int2ByteLinkedOpenCustomHashMap.this.remove(entry.getIntKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2ByteLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Int2ByteLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Int2ByteLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet implements IntOrderedSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2ByteLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(int o) {
			return Int2ByteLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(int o) {
			return Int2ByteLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Int2ByteMap.Entry> {
		...
		@Override
		public void set(Int2ByteMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Int2ByteMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
