 ...
 */
public class ImmutableInt2IntOpenHashMap extends AbstractInt2IntMap implements Int2IntOrderedMap
{
	 ...
	 */
	protected ImmutableInt2IntOpenHashMap() {}
	 ...
	 */
	public ImmutableInt2IntOpenHashMap(Integer[] keys, Integer[] values) {
	 ...
	 */
	public ImmutableInt2IntOpenHashMap(Integer[] keys, Integer[] values, float loadFactor) {
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
		init(IntArrays.unwrap(keys), IntArrays.unwrap(values), 0, keys.length, loadFactor);
	}
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public ImmutableInt2IntOpenHashMap(int[] keys, int[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public ImmutableInt2IntOpenHashMap(int[] keys, int[] values, float loadFactor) {
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public ImmutableInt2IntOpenHashMap(Map<? extends Integer, ? extends Integer> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public ImmutableInt2IntOpenHashMap(Map<? extends Integer, ? extends Integer> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public ImmutableInt2IntOpenHashMap(Int2IntMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public ImmutableInt2IntOpenHashMap(Int2IntMap map, float loadFactor) {
		int[] keys = new int[map.size()];
		int[] values = new int[keys.length];
		int index = 0;
	...
	protected void init(int[] a, int[] b, int offset, int length, float loadFactor) {
	...
	@Override
	public ImmutableInt2IntOpenHashMap copy() {
		ImmutableInt2IntOpenHashMap map = new ImmutableInt2IntOpenHashMap();
		map.mask = mask;
	...
	@Override
	public boolean replace(int key, int oldValue, int newValue) { throw new UnsupportedOperationException(); }
	
	@Override
	public int replace(int key, int value) { throw new UnsupportedOperationException(); }
	...
	protected class MapEntry implements Int2IntMap.Entry, Map.Entry<Integer, Integer> {
		...
		@Override
		public int hashCode() {
			return Integer.hashCode(keys[index]) ^ Integer.hashCode(values[index]);
		}
	...
	private class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements Int2IntOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Int2IntMap.Entry o) { throw new UnsupportedOperationException(); }
		
		@Override
		public boolean moveToLast(Int2IntMap.Entry o) { throw new UnsupportedOperationException(); }
		...
		@Override
		public Int2IntMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		
		@Override
		public Int2IntMap.Entry pollLast() { throw new UnsupportedOperationException(); }
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2IntMap.Entry) {
					...
					int index = ImmutableInt2IntOpenHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getIntValue() == ImmutableInt2IntOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = ImmutableInt2IntOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(ImmutableInt2IntOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		@Override
		public int size() {
			return ImmutableInt2IntOpenHashMap.this.size();
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Int2IntMap.Entry> {
		...
		@Override
		public void set(Int2IntMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Int2IntMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
