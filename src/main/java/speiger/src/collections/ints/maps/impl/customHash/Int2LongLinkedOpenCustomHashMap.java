 ...
 */
public class Int2LongLinkedOpenCustomHashMap extends Int2LongOpenCustomHashMap implements Int2LongOrderedMap
{
	 ...
	 */
	public Int2LongLinkedOpenCustomHashMap(IntStrategy strategy) {
	 ...
	 */
	public Int2LongLinkedOpenCustomHashMap(int minCapacity, IntStrategy strategy) {
	 ...
	 */
	public Int2LongLinkedOpenCustomHashMap(int minCapacity, float loadFactor, IntStrategy strategy) {
	 ...
	 */
	public Int2LongLinkedOpenCustomHashMap(Integer[] keys, Long[] values, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2LongLinkedOpenCustomHashMap(Integer[] keys, Long[] values, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2LongLinkedOpenCustomHashMap(int[] keys, long[] values, IntStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2LongLinkedOpenCustomHashMap(int[] keys, long[] values, float loadFactor, IntStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2LongLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Long> map, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2LongLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Long> map, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Int2LongLinkedOpenCustomHashMap(Int2LongMap map, IntStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2LongLinkedOpenCustomHashMap(Int2LongMap map, float loadFactor, IntStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Int2LongLinkedOpenCustomHashMap copy() {
		Int2LongLinkedOpenCustomHashMap map = new Int2LongLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry> implements Int2LongOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Int2LongMap.Entry o) {
			return Int2LongLinkedOpenCustomHashMap.this.moveToFirst(o.getIntKey());
		}
		
		@Override
		public boolean moveToLast(Int2LongMap.Entry o) {
			return Int2LongLinkedOpenCustomHashMap.this.moveToLast(o.getIntKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2LongMap.Entry) {
					...
					int index = Int2LongLinkedOpenCustomHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getLongValue() == Int2LongLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Integer)) return false;
					int index = Int2LongLinkedOpenCustomHashMap.this.findIndex((Integer)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Int2LongLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2LongMap.Entry) {
					Int2LongMap.Entry entry = (Int2LongMap.Entry)o;
					return Int2LongLinkedOpenCustomHashMap.this.remove(entry.getIntKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2LongLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Int2LongLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Int2LongLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet implements IntOrderedSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2LongLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(int o) {
			return Int2LongLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(int o) {
			return Int2LongLinkedOpenCustomHashMap.this.moveToLast(o);
		}
