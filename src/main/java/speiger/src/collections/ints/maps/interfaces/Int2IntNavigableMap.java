 ...
 */
public interface Int2IntNavigableMap extends Int2IntSortedMap, NavigableMap<Integer, Integer>
{
	@Override
	 ...
	 */
	public default Int2IntNavigableMap synchronize() { return Int2IntMaps.synchronize(this); }
	 ...
	 * @see Int2IntMaps#synchronize
	 */
	public default Int2IntNavigableMap synchronize(Object mutex) { return Int2IntMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Int2IntNavigableMap unmodifiable() { return Int2IntMaps.unmodifiable(this); }
	...
	@Override
	public default Int2IntNavigableMap subMap(int fromKey, int toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Int2IntNavigableMap headMap(int toKey) { return headMap(toKey, false); }
	@Override
	public default Int2IntNavigableMap tailMap(int fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Int2IntMap.Entry lowerEntry(Integer key) { return lowerEntry(key.intValue()); }
	@Override
	@Deprecated
	default Int2IntMap.Entry floorEntry(Integer key) { return floorEntry(key.intValue()); }
	@Override
	@Deprecated
	default Int2IntMap.Entry ceilingEntry(Integer key) { return ceilingEntry(key.intValue()); }
	@Override
	@Deprecated
	default Int2IntMap.Entry higherEntry(Integer key) { return higherEntry(key.intValue()); }
	
	@Override
	@Deprecated
	default Int2IntNavigableMap subMap(Integer fromKey, boolean fromInclusive, Integer toKey, boolean toInclusive) { return subMap(fromKey.intValue(), fromInclusive, toKey.intValue(), toInclusive); }
	@Override
	@Deprecated
	default Int2IntNavigableMap headMap(Integer toKey, boolean inclusive) { return headMap(toKey.intValue(), inclusive); }
	@Override
	@Deprecated
	default Int2IntNavigableMap tailMap(Integer fromKey, boolean inclusive) { return tailMap(fromKey.intValue(), inclusive); }
	@Override
	@Deprecated
	default Int2IntNavigableMap subMap(Integer fromKey, Integer toKey) { return subMap(fromKey.intValue(), true, toKey.intValue(), false); }
	@Override
	@Deprecated
	default Int2IntNavigableMap headMap(Integer toKey) { return headMap(toKey.intValue(), false); }
	@Override
	@Deprecated
	default Int2IntNavigableMap tailMap(Integer fromKey) { return tailMap(fromKey.intValue(), true); }
}