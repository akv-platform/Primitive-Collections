...
public abstract class AbstractInt2CharMap extends AbstractMap<Integer, Character> implements Int2CharMap
{
	...
	public void putAll(Int2CharMap m) {
		for(ObjectIterator<Int2CharMap.Entry> iter = Int2CharMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceChars(IntCharUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Int2CharMap.Entry> iter = Int2CharMaps.fastIterator(this);iter.hasNext();) {
			Int2CharMap.Entry entry = iter.next();
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					ObjectIterator<Int2CharMap.Entry> iter = Int2CharMaps.fastIterator(AbstractInt2CharMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Int2CharMap.Entry> iter = Int2CharMaps.fastIterator(this);
