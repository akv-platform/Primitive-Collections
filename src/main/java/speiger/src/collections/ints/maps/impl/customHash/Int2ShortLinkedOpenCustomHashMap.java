 ...
 */
public class Int2ShortLinkedOpenCustomHashMap extends Int2ShortOpenCustomHashMap implements Int2ShortOrderedMap
{
	 ...
	 */
	public Int2ShortLinkedOpenCustomHashMap(IntStrategy strategy) {
	 ...
	 */
	public Int2ShortLinkedOpenCustomHashMap(int minCapacity, IntStrategy strategy) {
	 ...
	 */
	public Int2ShortLinkedOpenCustomHashMap(int minCapacity, float loadFactor, IntStrategy strategy) {
	 ...
	 */
	public Int2ShortLinkedOpenCustomHashMap(Integer[] keys, Short[] values, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ShortLinkedOpenCustomHashMap(Integer[] keys, Short[] values, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2ShortLinkedOpenCustomHashMap(int[] keys, short[] values, IntStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ShortLinkedOpenCustomHashMap(int[] keys, short[] values, float loadFactor, IntStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2ShortLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Short> map, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2ShortLinkedOpenCustomHashMap(Map<? extends Integer, ? extends Short> map, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Int2ShortLinkedOpenCustomHashMap(Int2ShortMap map, IntStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2ShortLinkedOpenCustomHashMap(Int2ShortMap map, float loadFactor, IntStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Int2ShortLinkedOpenCustomHashMap copy() {
		Int2ShortLinkedOpenCustomHashMap map = new Int2ShortLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2ShortMap.Entry> implements Int2ShortOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Int2ShortMap.Entry o) {
			return Int2ShortLinkedOpenCustomHashMap.this.moveToFirst(o.getIntKey());
		}
		
		@Override
		public boolean moveToLast(Int2ShortMap.Entry o) {
			return Int2ShortLinkedOpenCustomHashMap.this.moveToLast(o.getIntKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2ShortMap.Entry) {
					...
					int index = Int2ShortLinkedOpenCustomHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getShortValue() == Int2ShortLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Integer)) return false;
					int index = Int2ShortLinkedOpenCustomHashMap.this.findIndex((Integer)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Int2ShortLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2ShortMap.Entry) {
					Int2ShortMap.Entry entry = (Int2ShortMap.Entry)o;
					return Int2ShortLinkedOpenCustomHashMap.this.remove(entry.getIntKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2ShortLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Int2ShortLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Int2ShortLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet implements IntOrderedSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2ShortLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(int o) {
			return Int2ShortLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(int o) {
			return Int2ShortLinkedOpenCustomHashMap.this.moveToLast(o);
		}
