...
public class Int2CharLinkedOpenHashMap extends Int2CharOpenHashMap implements Int2CharOrderedMap
{
	 ...
	 */
	public Int2CharLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Int2CharLinkedOpenHashMap(Integer[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2CharLinkedOpenHashMap(Integer[] keys, Character[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2CharLinkedOpenHashMap(int[] keys, char[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2CharLinkedOpenHashMap(int[] keys, char[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2CharLinkedOpenHashMap(Map<? extends Integer, ? extends Character> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Int2CharLinkedOpenHashMap(Int2CharMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2CharLinkedOpenHashMap(Int2CharMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	public Int2CharLinkedOpenHashMap copy() {
		Int2CharLinkedOpenHashMap map = new Int2CharLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements Int2CharOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Int2CharMap.Entry o) {
			return Int2CharLinkedOpenHashMap.this.moveToFirst(o.getIntKey());
		}
		
		@Override
		public boolean moveToLast(Int2CharMap.Entry o) {
			return Int2CharLinkedOpenHashMap.this.moveToLast(o.getIntKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2CharMap.Entry) {
					...
					int index = Int2CharLinkedOpenHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getCharValue() == Int2CharLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Int2CharLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Int2CharLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				...
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2CharLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractIntSet implements IntOrderedSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2CharLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(int o) {
			return Int2CharLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(int o) {
			return Int2CharLinkedOpenHashMap.this.moveToLast(o);
		}
