...
public interface Int2ShortNavigableMap extends Int2ShortSortedMap, NavigableMap<Integer, Short>
{
	 ...
	 */
	public default Int2ShortNavigableMap synchronize() { return Int2ShortMaps.synchronize(this); }
	 ...
	 * @see Int2ShortMaps#synchronize
	 */
	public default Int2ShortNavigableMap synchronize(Object mutex) { return Int2ShortMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Int2ShortNavigableMap unmodifiable() { return Int2ShortMaps.unmodifiable(this); }
	...
	@Override
	public default Int2ShortNavigableMap subMap(int fromKey, int toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Int2ShortNavigableMap headMap(int toKey) { return headMap(toKey, false); }
	@Override
	public default Int2ShortNavigableMap tailMap(int fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Int2ShortMap.Entry lowerEntry(Integer key) { return lowerEntry(key.intValue()); }
	@Override
	@Deprecated
	default Int2ShortMap.Entry floorEntry(Integer key) { return floorEntry(key.intValue()); }
	@Override
	@Deprecated
	default Int2ShortMap.Entry ceilingEntry(Integer key) { return ceilingEntry(key.intValue()); }
	@Override
	@Deprecated
	default Int2ShortMap.Entry higherEntry(Integer key) { return higherEntry(key.intValue()); }
	
	@Override
	@Deprecated
	default Int2ShortNavigableMap subMap(Integer fromKey, boolean fromInclusive, Integer toKey, boolean toInclusive) { return subMap(fromKey.intValue(), fromInclusive, toKey.intValue(), toInclusive); }
	@Override
	@Deprecated
	default Int2ShortNavigableMap headMap(Integer toKey, boolean inclusive) { return headMap(toKey.intValue(), inclusive); }
	@Override
	@Deprecated
	default Int2ShortNavigableMap tailMap(Integer fromKey, boolean inclusive) { return tailMap(fromKey.intValue(), inclusive); }
	@Override
	@Deprecated
	default Int2ShortNavigableMap subMap(Integer fromKey, Integer toKey) { return subMap(fromKey.intValue(), true, toKey.intValue(), false); }
	@Override
	@Deprecated
	default Int2ShortNavigableMap headMap(Integer toKey) { return headMap(toKey.intValue(), false); }
	@Override
	@Deprecated
	default Int2ShortNavigableMap tailMap(Integer fromKey) { return tailMap(fromKey.intValue(), true); }
}