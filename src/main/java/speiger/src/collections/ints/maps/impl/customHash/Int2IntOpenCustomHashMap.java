 ...
 */
public class Int2IntOpenCustomHashMap extends AbstractInt2IntMap implements ITrimmable
{
	 ...
	 */
	public Int2IntOpenCustomHashMap(IntStrategy strategy) {
	 ...
	 */
	public Int2IntOpenCustomHashMap(int minCapacity, IntStrategy strategy) {
	 ...
	 */
	public Int2IntOpenCustomHashMap(int minCapacity, float loadFactor, IntStrategy strategy) {
	 ...
	 */
	public Int2IntOpenCustomHashMap(Integer[] keys, Integer[] values, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2IntOpenCustomHashMap(Integer[] keys, Integer[] values, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2IntOpenCustomHashMap(int[] keys, int[] values, IntStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2IntOpenCustomHashMap(int[] keys, int[] values, float loadFactor, IntStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2IntOpenCustomHashMap(Map<? extends Integer, ? extends Integer> map, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2IntOpenCustomHashMap(Map<? extends Integer, ? extends Integer> map, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2IntOpenCustomHashMap(Int2IntMap map, IntStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2IntOpenCustomHashMap(Int2IntMap map, float loadFactor, IntStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	public boolean containsValue(int value) {
		...
		for(int i = nullIndex;i >= 0;i--)
			if(!strategy.equals(keys[i], 0) && values[i] == value) return true;
		return false;
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(!strategy.equals(keys[i], 0) && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Integer.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Int2IntOpenCustomHashMap copy() {
		Int2IntOpenCustomHashMap map = new Int2IntOpenCustomHashMap(0, loadFactor, strategy);
	...
	protected class MapEntry implements Int2IntMap.Entry, Map.Entry<Integer, Integer> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Int2IntMap.Entry) {
					...
					return keys[index] == entry.getIntKey() && values[index] == entry.getIntValue();
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Integer && value instanceof Integer && keys[index] == ((Integer)key).intValue() && values[index] == ((Integer)value).intValue();
			}
			return false;
		}
		...
		public String toString() {
			return Integer.toString(keys[index]) + "=" + Integer.toString(values[index]);
		}
	}
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements Int2IntMap.FastEntrySet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2IntMap.Entry) {
					...
					int index = Int2IntOpenCustomHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return entry.getIntValue() == Int2IntOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Integer)) return false;
					int index = Int2IntOpenCustomHashMap.this.findIndex((Integer)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(Int2IntOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2IntMap.Entry) {
					Int2IntMap.Entry entry = (Int2IntMap.Entry)o;
					return Int2IntOpenCustomHashMap.this.remove(entry.getIntKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2IntOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractIntSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2IntOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Int2IntOpenCustomHashMap.this.remove(wrapped.getInt(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
