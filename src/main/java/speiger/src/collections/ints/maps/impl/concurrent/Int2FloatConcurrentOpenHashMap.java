...
import speiger.src.collections.ints.maps.interfaces.Int2FloatConcurrentMap;
 ...
 * 
 */
public class Int2FloatConcurrentOpenHashMap extends AbstractInt2FloatMap implements Int2FloatConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Int2FloatConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Int2FloatConcurrentOpenHashMap() {
	 ...
	 */
	public Int2FloatConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Int2FloatConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Int2FloatConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2FloatConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2FloatConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Int2FloatConcurrentOpenHashMap(Integer[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2FloatConcurrentOpenHashMap(Integer[] keys, Float[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2FloatConcurrentOpenHashMap(Integer[] keys, Float[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2FloatConcurrentOpenHashMap(Integer[] keys, Float[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2FloatConcurrentOpenHashMap(int[] keys, float[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2FloatConcurrentOpenHashMap(int[] keys, float[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2FloatConcurrentOpenHashMap(int[] keys, float[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2FloatConcurrentOpenHashMap(int[] keys, float[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Int2FloatConcurrentOpenHashMap(Map<? extends Integer, ? extends Float> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2FloatConcurrentOpenHashMap(Map<? extends Integer, ? extends Float> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2FloatConcurrentOpenHashMap(Map<? extends Integer, ? extends Float> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Int2FloatConcurrentOpenHashMap(Map<? extends Integer, ? extends Float> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Int2FloatConcurrentOpenHashMap(Int2FloatMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2FloatConcurrentOpenHashMap(Int2FloatMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Int2FloatConcurrentOpenHashMap(Int2FloatMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Int2FloatConcurrentOpenHashMap(Int2FloatMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Int2FloatConcurrentOpenHashMap copy() {
		Int2FloatConcurrentOpenHashMap copy = new Int2FloatConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements Int2FloatMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2FloatMap.Entry) {
					Int2FloatMap.Entry entry = (Int2FloatMap.Entry)o;
					return Int2FloatConcurrentOpenHashMap.this.remove(entry.getIntKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2FloatConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Int2FloatConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Int2FloatConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet implements IntSet {
		...
		public boolean remove(int o) {
			int oldSize = size();
			Int2FloatConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Int2FloatMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Int2FloatMap.Entry> {
		MapEntry entry;
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Int2FloatConcurrentOpenHashMap map;
		...
		protected Segment(Int2FloatConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Int2FloatConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Int2FloatConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected float put(int hash, int key, float value) {
		...
		protected float putIfAbsent(int hash, int key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected float addTo(int hash, int key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected float subFrom(int hash, int key, float value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected float get(int hash, int key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected float getOrDefault(int hash, int key, float defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(IntFloatConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected float remove(int hash, int key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected float removeOrDefault(int hash, int key, float defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, int key, float value) {
			long stamp = writeLock();
			try {
				if(key == 0) {
		...
		protected boolean replace(int hash, int key, float oldValue, float newValue) {
			long stamp = writeLock();
			try {
		...
		protected float replace(int hash, int key, float value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected float compute(int hash, int key, IntFloatUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected float computeIfAbsent(int hash, int key, Int2FloatFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected float supplyIfAbsent(int hash, int key, FloatSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected float computeIfPresent(int hash, int key, IntFloatUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected float merge(int hash, int key, float value, FloatFloatUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
