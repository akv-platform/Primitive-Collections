 ...
 */
public class Int2DoubleOpenCustomHashMap extends AbstractInt2DoubleMap implements ITrimmable
{
	 ...
	 */
	public Int2DoubleOpenCustomHashMap(IntStrategy strategy) {
	 ...
	 */
	public Int2DoubleOpenCustomHashMap(int minCapacity, IntStrategy strategy) {
	 ...
	 */
	public Int2DoubleOpenCustomHashMap(int minCapacity, float loadFactor, IntStrategy strategy) {
	 ...
	 */
	public Int2DoubleOpenCustomHashMap(Integer[] keys, Double[] values, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2DoubleOpenCustomHashMap(Integer[] keys, Double[] values, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Int2DoubleOpenCustomHashMap(int[] keys, double[] values, IntStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2DoubleOpenCustomHashMap(int[] keys, double[] values, float loadFactor, IntStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2DoubleOpenCustomHashMap(Map<? extends Integer, ? extends Double> map, IntStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Int2DoubleOpenCustomHashMap(Map<? extends Integer, ? extends Double> map, float loadFactor, IntStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Int2DoubleOpenCustomHashMap(Int2DoubleMap map, IntStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Int2DoubleOpenCustomHashMap(Int2DoubleMap map, float loadFactor, IntStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	public boolean containsValue(double value) {
		...
		for(int i = nullIndex;i >= 0;i--)
			if(!strategy.equals(keys[i], 0) && Double.doubleToLongBits(values[i]) == Double.doubleToLongBits(value)) return true;
		return false;
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(!strategy.equals(keys[i], 0) && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Double.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Int2DoubleOpenCustomHashMap copy() {
		Int2DoubleOpenCustomHashMap map = new Int2DoubleOpenCustomHashMap(0, loadFactor, strategy);
	...
	protected class MapEntry implements Int2DoubleMap.Entry, Map.Entry<Integer, Double> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Int2DoubleMap.Entry) {
					...
					return keys[index] == entry.getIntKey() && Double.doubleToLongBits(values[index]) == Double.doubleToLongBits(entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Integer && value instanceof Double && keys[index] == ((Integer)key).intValue() && Double.doubleToLongBits(values[index]) == Double.doubleToLongBits(((Double)value).doubleValue());
			}
			return false;
		}
		...
		public String toString() {
			return Integer.toString(keys[index]) + "=" + Double.toString(values[index]);
		}
	}
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2DoubleMap.Entry> implements Int2DoubleMap.FastEntrySet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2DoubleMap.Entry) {
					...
					int index = Int2DoubleOpenCustomHashMap.this.findIndex(entry.getIntKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Int2DoubleOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Integer)) return false;
					int index = Int2DoubleOpenCustomHashMap.this.findIndex((Integer)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Int2DoubleOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Int2DoubleMap.Entry) {
					Int2DoubleMap.Entry entry = (Int2DoubleMap.Entry)o;
					return Int2DoubleOpenCustomHashMap.this.remove(entry.getIntKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Int2DoubleOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractIntSet {
		...
		public boolean remove(int o) {
			int oldSize = size;
			Int2DoubleOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class Values extends AbstractDoubleCollection {
		...
		public boolean matchesAny(Double2BooleanFunction filter) {
			...
			for(int i = nullIndex-1;i>=0;i--) {
				if(!strategy.equals(keys[i], 0) && filter.get(values[i])) return true;
			}
			return false;
		}
		...
		public boolean matchesNone(Double2BooleanFunction filter) {
			...
			for(int i = nullIndex-1;i>=0;i--) {
				if(!strategy.equals(keys[i], 0) && filter.get(values[i])) return false;
			}
			return true;
		}
		...
		public double findFirst(Double2BooleanFunction filter) {
			...
			for(int i = nullIndex-1;i>=0;i--) {
				if(!strategy.equals(keys[i], 0) && filter.get(values[i])) return values[i];
			}
			return 0D;
		}
		...
		public int count(Double2BooleanFunction filter) {
			...
			for(int i = nullIndex-1;i>=0;i--) {
				if(!strategy.equals(keys[i], 0) && filter.get(values[i])) result++;
			}
			return result;
		}
	}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Int2DoubleOpenCustomHashMap.this.remove(wrapped.getInt(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
