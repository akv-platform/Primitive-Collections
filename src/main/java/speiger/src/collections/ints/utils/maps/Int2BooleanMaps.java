...
public class Int2BooleanMaps
{
	 ...
	 */
	public static Int2BooleanMap.Entry unmodifiable(Int2BooleanMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Int2BooleanMap.Entry unmodifiable(Map.Entry<Integer, Boolean> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class SingletonMap extends AbstractInt2BooleanMap {
		...
		@Override
		public boolean computeBooleanIfAbsent(int key, Int2BooleanFunction mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class EmptyMap extends AbstractInt2BooleanMap {
		...
		@Override
		public boolean getOrDefault(int key, boolean defaultValue) { return defaultValue; }
		@Override
		public boolean computeBoolean(int key, IntBooleanUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public boolean computeBooleanIfAbsent(int key, Int2BooleanFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Int2BooleanNavigableMap {
		...
		@Override
		public Int2BooleanNavigableMap descendingMap() { return Int2BooleanMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Int2BooleanNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Int2BooleanOrderedMap {
		...
		public ObjectOrderedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.int2BooleanEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Int2BooleanSortedMap {
		...
		public boolean lastBooleanValue() { return map.lastBooleanValue(); }
		@Override
		public Int2BooleanSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractInt2BooleanMap implements Int2BooleanMap {
		...
		public void mergeAllBoolean(Int2BooleanMap m, BooleanBooleanUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceBooleans(IntBooleanUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceBooleans(Int2BooleanMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Int2BooleanMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Int2BooleanMap.Entry>
	{
		ObjectOrderedSet<Int2BooleanMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Int2BooleanMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Int2BooleanMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Int2BooleanMap.Entry first() { return set.first(); }
		@Override
		public Int2BooleanMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Int2BooleanMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Int2BooleanNavigableMap {
		...
		@Override
		public Int2BooleanMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Int2BooleanNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Int2BooleanSortedMap {
		...
		public boolean lastBooleanValue() { synchronized(mutex) { return map.lastBooleanValue(); } }
		@Override
		public Int2BooleanSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractInt2BooleanMap implements Int2BooleanMap {
		...
		@Override
		public boolean supplyBooleanIfAbsent(int key, BooleanSupplier valueProvider) { synchronized(mutex) { return map.supplyBooleanIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Int2BooleanMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public IntSet keySet() {
			if(keys == null) keys = IntSets.synchronize(map.keySet(), mutex);
			return keys;
