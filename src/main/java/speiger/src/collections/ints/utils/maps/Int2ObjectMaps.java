...
public class Int2ObjectMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Int2ObjectMap<?> EMPTY = new EmptyMap<>();
	 ...
	 */
	public static <V> Int2ObjectMap.Entry<V> unmodifiable(Int2ObjectMap.Entry<V> entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @param <V> the type of elements maintained by this Collection
	 * @return a Unmodifyable Entry
	 */
	public static <V> Int2ObjectMap.Entry<V> unmodifiable(Map.Entry<Integer, V> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry<V>)entry : (entry == null ? null : new UnmodifyableEntry<>(entry)); }
	...
	public static class EmptyMap<V> extends AbstractInt2ObjectMap<V> {
		...
		@Override
		public V getOrDefault(int key, V defaultValue) { return defaultValue; }
		@Override
		public V compute(int key, IntObjectUnaryOperator<V> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public V computeIfAbsent(int key, Int2ObjectFunction<V> mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap<V> extends UnmodifyableSortedMap<V> implements Int2ObjectNavigableMap<V> {
		...
		@Override
		public Int2ObjectNavigableMap<V> descendingMap() { return Int2ObjectMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Int2ObjectNavigableMap<V> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableSortedMap<V> extends UnmodifyableMap<V> implements Int2ObjectSortedMap<V> {
		...
		public V lastValue() { return map.lastValue(); }
		@Override
		public Int2ObjectSortedMap<V> copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap<V> extends AbstractInt2ObjectMap<V> implements Int2ObjectMap<V> {
		...
		public void mergeAll(Int2ObjectMap<V> m, ObjectObjectUnaryOperator<V, V> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceObjects(IntObjectUnaryOperator<V> mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceObjects(Int2ObjectMap<V> m) { throw new UnsupportedOperationException(); }
		@Override
		public Int2ObjectMap<V> copy() { return map.copy(); }
		@Override
	 ...
	 * @param <V> the type of elements maintained by this Collection
	 */
	public static class UnmodifyableOrderedEntrySet<V> extends UnmodifyableEntrySet<V> implements ObjectOrderedSet<Int2ObjectMap.Entry<V>>
	{
		ObjectOrderedSet<Int2ObjectMap.Entry<V>> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Int2ObjectMap.Entry<V>> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Int2ObjectMap.Entry<V>> copy() { return set.copy(); }
		@Override
	...
	public static class SynchronizedNavigableMap<V> extends SynchronizedSortedMap<V> implements Int2ObjectNavigableMap<V> {
		...
		@Override
		public Int2ObjectNavigableMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedSortedMap<V> extends SynchronizedMap<V> implements Int2ObjectSortedMap<V> {
		...
		public V lastValue() { synchronized(mutex) { return map.lastValue(); } }
		@Override
		public Int2ObjectSortedMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap<V> extends AbstractInt2ObjectMap<V> implements Int2ObjectMap<V> {
		...
		@Override
		public V supplyIfAbsent(int key, ObjectSupplier<V> valueProvider) { synchronized(mutex) { return map.supplyIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Int2ObjectMap<V> copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public IntSet keySet() {
			if(keys == null) keys = IntSets.synchronize(map.keySet(), mutex);
			return keys;
