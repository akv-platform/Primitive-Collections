 ...
 */
public interface Float2IntNavigableMap extends Float2IntSortedMap, NavigableMap<Float, Integer>
{
	@Override
	public Float2IntNavigableMap copy();
	 ...
	 */
	public default Float2IntNavigableMap synchronize() { return Float2IntMaps.synchronize(this); }
	 ...
	 * @see Float2IntMaps#synchronize
	 */
	public default Float2IntNavigableMap synchronize(Object mutex) { return Float2IntMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Float2IntNavigableMap unmodifiable() { return Float2IntMaps.unmodifiable(this); }
	...
	@Override
	public default Float2IntNavigableMap subMap(float fromKey, float toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Float2IntNavigableMap headMap(float toKey) { return headMap(toKey, false); }
	@Override
	public default Float2IntNavigableMap tailMap(float fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Float2IntMap.Entry lowerEntry(Float key) { return lowerEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2IntMap.Entry floorEntry(Float key) { return floorEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2IntMap.Entry ceilingEntry(Float key) { return ceilingEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2IntMap.Entry higherEntry(Float key) { return higherEntry(key.floatValue()); }
	
	@Override
	@Deprecated
	default Float2IntNavigableMap subMap(Float fromKey, boolean fromInclusive, Float toKey, boolean toInclusive) { return subMap(fromKey.floatValue(), fromInclusive, toKey.floatValue(), toInclusive); }
	@Override
	@Deprecated
	default Float2IntNavigableMap headMap(Float toKey, boolean inclusive) { return headMap(toKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2IntNavigableMap tailMap(Float fromKey, boolean inclusive) { return tailMap(fromKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2IntNavigableMap subMap(Float fromKey, Float toKey) { return subMap(fromKey.floatValue(), true, toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2IntNavigableMap headMap(Float toKey) { return headMap(toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2IntNavigableMap tailMap(Float fromKey) { return tailMap(fromKey.floatValue(), true); }
}