 ...
 */
public class Float2DoubleAVLTreeMap extends AbstractFloat2DoubleMap implements Float2DoubleNavigableMap
{
	 ...
	 */
	public Float2DoubleAVLTreeMap(FloatComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Float2DoubleAVLTreeMap(Float[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Float2DoubleAVLTreeMap(Float[] keys, Double[] values, FloatComparator comp) {
		comparator = comp;
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Float2DoubleAVLTreeMap(Map<? extends Float, ? extends Double> map, FloatComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2DoubleAVLTreeMap(Float2DoubleMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Float2DoubleAVLTreeMap(Float2DoubleMap map, FloatComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Float2DoubleAVLTreeMap copy() {
		Float2DoubleAVLTreeMap set = new Float2DoubleAVLTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	static class KeySet extends AbstractFloatSet implements FloatNavigableSet
	{
		...
		public Float lower(Float e) {
			Float2DoubleMap.Entry node = map.lowerEntry(e.floatValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Float floor(Float e) {
			Float2DoubleMap.Entry node = map.floorEntry(e.floatValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Float higher(Float e) {
			Float2DoubleMap.Entry node = map.higherEntry(e.floatValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Float ceiling(Float e) {
			Float2DoubleMap.Entry node = map.ceilingEntry(e.floatValue());
			return node != null ? node.getKey() : null;
		}
		...
		public FloatBidirectionalIterator iterator(float fromElement) {
			if(map instanceof Float2DoubleAVLTreeMap) return ((Float2DoubleAVLTreeMap)map).keyIterator(fromElement);
		...
		public FloatBidirectionalIterator iterator() {
			if(map instanceof Float2DoubleAVLTreeMap) return ((Float2DoubleAVLTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public FloatBidirectionalIterator descendingIterator() {
			if(map instanceof Float2DoubleAVLTreeMap) return ((Float2DoubleAVLTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Float2DoubleAVLTreeMap) return ((Float2DoubleAVLTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Float2DoubleAVLTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Float2DoubleAVLTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Float2DoubleAVLTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Float2DoubleAVLTreeMap map, boolean fromStart, float lo, boolean loInclusive, boolean toEnd, float hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Float2DoubleAVLTreeMap map, boolean fromStart, float lo, boolean loInclusive, boolean toEnd, float hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	{
		final Float2DoubleAVLTreeMap map;
		final float lo, hi;
		...
		NavigableSubMap(Float2DoubleAVLTreeMap map, boolean fromStart, float lo, boolean loInclusive, boolean toEnd, float hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
	...
	class Values extends AbstractDoubleCollection
	{
		...
		@Override
		public int size() {
			return Float2DoubleAVLTreeMap.this.size;
		}
