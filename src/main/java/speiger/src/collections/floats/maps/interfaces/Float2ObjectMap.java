...
public interface Float2ObjectMap<V> extends Map<Float, V>, Float2ObjectFunction<V>
{
	...
	public default V computeIfAbsent(Float key, Function<? super Float, ? extends V> mappingFunction) {
		Objects.requireNonNull(mappingFunction);
		return computeIfAbsent(key.floatValue(), mappingFunction instanceof Float2ObjectFunction ? (Float2ObjectFunction<V>)mappingFunction : K -> mappingFunction.apply(Float.valueOf(K)));
	}
