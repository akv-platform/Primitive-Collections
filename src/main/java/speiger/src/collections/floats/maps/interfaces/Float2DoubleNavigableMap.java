 ...
 */
public interface Float2DoubleNavigableMap extends Float2DoubleSortedMap, NavigableMap<Float, Double>
{
	@Override
	public Float2DoubleNavigableMap copy();
	 ...
	 */
	public default Float2DoubleNavigableMap synchronize() { return Float2DoubleMaps.synchronize(this); }
	 ...
	 * @see Float2DoubleMaps#synchronize
	 */
	public default Float2DoubleNavigableMap synchronize(Object mutex) { return Float2DoubleMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Float2DoubleNavigableMap unmodifiable() { return Float2DoubleMaps.unmodifiable(this); }
	...
	@Override
	public default Float2DoubleNavigableMap subMap(float fromKey, float toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Float2DoubleNavigableMap headMap(float toKey) { return headMap(toKey, false); }
	@Override
	public default Float2DoubleNavigableMap tailMap(float fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Float2DoubleMap.Entry lowerEntry(Float key) { return lowerEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2DoubleMap.Entry floorEntry(Float key) { return floorEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2DoubleMap.Entry ceilingEntry(Float key) { return ceilingEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2DoubleMap.Entry higherEntry(Float key) { return higherEntry(key.floatValue()); }
	
	@Override
	@Deprecated
	default Float2DoubleNavigableMap subMap(Float fromKey, boolean fromInclusive, Float toKey, boolean toInclusive) { return subMap(fromKey.floatValue(), fromInclusive, toKey.floatValue(), toInclusive); }
	@Override
	@Deprecated
	default Float2DoubleNavigableMap headMap(Float toKey, boolean inclusive) { return headMap(toKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2DoubleNavigableMap tailMap(Float fromKey, boolean inclusive) { return tailMap(fromKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2DoubleNavigableMap subMap(Float fromKey, Float toKey) { return subMap(fromKey.floatValue(), true, toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2DoubleNavigableMap headMap(Float toKey) { return headMap(toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2DoubleNavigableMap tailMap(Float fromKey) { return tailMap(fromKey.floatValue(), true); }
}