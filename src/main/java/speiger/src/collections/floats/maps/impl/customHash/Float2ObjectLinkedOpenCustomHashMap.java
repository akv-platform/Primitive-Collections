...
public class Float2ObjectLinkedOpenCustomHashMap<V> extends Float2ObjectOpenCustomHashMap<V> implements Float2ObjectOrderedMap<V>
{
	...
	@Override
	public Float2ObjectLinkedOpenCustomHashMap<V> copy() {
		Float2ObjectLinkedOpenCustomHashMap<V> map = new Float2ObjectLinkedOpenCustomHashMap<>(0, loadFactor, strategy);
	...
	public ObjectOrderedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
		...
		return (ObjectOrderedSet<Float2ObjectMap.Entry<V>>)entrySet;
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectOrderedMap.FastOrderedSet<V> {
		...
		public boolean moveToFirst(Float2ObjectMap.Entry<V> o) {
			return Float2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2ObjectMap.Entry<V> o) {
			return Float2ObjectLinkedOpenCustomHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ObjectMap.Entry) {
					...
					int index = Float2ObjectLinkedOpenCustomHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Float)) return false;
					int index = Float2ObjectLinkedOpenCustomHashMap.this.findIndex((Float)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
			}
			return false;
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ObjectMap.Entry) {
					Float2ObjectMap.Entry<V> entry = (Float2ObjectMap.Entry<V>)o;
					return Float2ObjectLinkedOpenCustomHashMap.this.remove(entry.getFloatKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2ObjectLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Float2ObjectLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Float2ObjectLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2ObjectLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2ObjectLinkedOpenCustomHashMap.this.moveToLast(o);
		}
