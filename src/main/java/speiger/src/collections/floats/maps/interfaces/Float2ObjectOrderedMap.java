...
public interface Float2ObjectOrderedMap<V> extends Float2ObjectMap<V>
{
	 ...
	 */
	@Override
	public default Float2ObjectOrderedMap<V> synchronize() { return Float2ObjectMaps.synchronize(this); }
	 ...
	 */
	@Override
	public default Float2ObjectOrderedMap<V> synchronize(Object mutex) { return Float2ObjectMaps.synchronize(this, mutex); }
	 ...
	 */
	@Override
	public default Float2ObjectOrderedMap<V> unmodifiable() { return Float2ObjectMaps.unmodifiable(this); }
	
	/**
	 * Fast Ordered Entry Set that allows for a faster Entry Iterator by recycling the Entry Object and just exchanging 1 internal value
	 * @param <V> the type of elements maintained by this Collection
	 */
	interface FastOrderedSet<V> extends Float2ObjectMap.FastEntrySet<V>, ObjectOrderedSet<Float2ObjectMap.Entry<V>> {
		@Override
