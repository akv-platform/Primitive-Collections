 ...
 */
public class Float2CharLinkedOpenHashMap extends Float2CharOpenHashMap implements Float2CharOrderedMap
{
	 ...
	 */
	public Float2CharLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Float2CharLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2CharLinkedOpenHashMap(Float[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2CharLinkedOpenHashMap(Float[] keys, Character[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Float2CharLinkedOpenHashMap(float[] keys, char[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2CharLinkedOpenHashMap(float[] keys, char[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2CharLinkedOpenHashMap(Map<? extends Float, ? extends Character> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2CharLinkedOpenHashMap(Float2CharMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2CharLinkedOpenHashMap(Float2CharMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Float2CharLinkedOpenHashMap copy() {
		Float2CharLinkedOpenHashMap map = new Float2CharLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements Float2CharOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2CharMap.Entry o) {
			return Float2CharLinkedOpenHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2CharMap.Entry o) {
			return Float2CharLinkedOpenHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2CharMap.Entry) {
					...
					int index = Float2CharLinkedOpenHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getCharValue() == Float2CharLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Float2CharLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Float2CharLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2CharMap.Entry) {
					Float2CharMap.Entry entry = (Float2CharMap.Entry)o;
					return Float2CharLinkedOpenHashMap.this.remove(entry.getFloatKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2CharLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2CharLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2CharLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2CharLinkedOpenHashMap.this.moveToLast(o);
		}
