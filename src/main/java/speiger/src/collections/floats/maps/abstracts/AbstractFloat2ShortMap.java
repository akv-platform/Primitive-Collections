...
public abstract class AbstractFloat2ShortMap extends AbstractMap<Float, Short> implements Float2ShortMap
{
	...
	public void putAll(Float2ShortMap m) {
		for(ObjectIterator<Float2ShortMap.Entry> iter = Float2ShortMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceShorts(FloatShortUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Float2ShortMap.Entry> iter = Float2ShortMaps.fastIterator(this);iter.hasNext();) {
			Float2ShortMap.Entry entry = iter.next();
		...
		return new AbstractFloatSet() {
			...
			public FloatIterator iterator() {
				return new FloatIterator() {
					ObjectIterator<Float2ShortMap.Entry> iter = Float2ShortMaps.fastIterator(AbstractFloat2ShortMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Float2ShortMap.Entry> iter = Float2ShortMaps.fastIterator(this);
