 ...
 */
public class Float2ShortLinkedOpenHashMap extends Float2ShortOpenHashMap implements Float2ShortOrderedMap
{
	 ...
	 */
	public Float2ShortLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2ShortLinkedOpenHashMap(Float[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ShortLinkedOpenHashMap(Float[] keys, Short[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ShortLinkedOpenHashMap(Map<? extends Float, ? extends Short> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2ShortLinkedOpenHashMap(Float2ShortMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2ShortLinkedOpenHashMap(Float2ShortMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Float2ShortLinkedOpenHashMap copy() {
		Float2ShortLinkedOpenHashMap map = new Float2ShortLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2ShortMap.Entry> implements Float2ShortOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2ShortMap.Entry o) {
			return Float2ShortLinkedOpenHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2ShortMap.Entry o) {
			return Float2ShortLinkedOpenHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ShortMap.Entry) {
					...
					int index = Float2ShortLinkedOpenHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getShortValue() == Float2ShortLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Float2ShortLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Float2ShortLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ShortMap.Entry) {
					Float2ShortMap.Entry entry = (Float2ShortMap.Entry)o;
					return Float2ShortLinkedOpenHashMap.this.remove(entry.getFloatKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2ShortLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2ShortLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2ShortLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2ShortLinkedOpenHashMap.this.moveToLast(o);
		}
