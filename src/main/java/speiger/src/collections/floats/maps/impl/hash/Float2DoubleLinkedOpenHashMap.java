 ...
 */
public class Float2DoubleLinkedOpenHashMap extends Float2DoubleOpenHashMap implements Float2DoubleOrderedMap
{
	 ...
	 */
	public Float2DoubleLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2DoubleLinkedOpenHashMap(Float[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2DoubleLinkedOpenHashMap(Float[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2DoubleLinkedOpenHashMap(Map<? extends Float, ? extends Double> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2DoubleLinkedOpenHashMap(Float2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2DoubleLinkedOpenHashMap(Float2DoubleMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Float2DoubleLinkedOpenHashMap copy() {
		Float2DoubleLinkedOpenHashMap map = new Float2DoubleLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry> implements Float2DoubleOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2DoubleMap.Entry o) {
			return Float2DoubleLinkedOpenHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2DoubleMap.Entry o) {
			return Float2DoubleLinkedOpenHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2DoubleMap.Entry) {
					...
					int index = Float2DoubleLinkedOpenHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Float2DoubleLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Float2DoubleLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Float2DoubleLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2DoubleMap.Entry) {
					Float2DoubleMap.Entry entry = (Float2DoubleMap.Entry)o;
					return Float2DoubleLinkedOpenHashMap.this.remove(entry.getFloatKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2DoubleLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2DoubleLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2DoubleLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2DoubleLinkedOpenHashMap.this.moveToLast(o);
		}
