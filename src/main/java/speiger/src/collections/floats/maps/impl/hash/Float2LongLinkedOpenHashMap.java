 ...
 */
public class Float2LongLinkedOpenHashMap extends Float2LongOpenHashMap implements Float2LongOrderedMap
{
	 ...
	 */
	public Float2LongLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Float2LongLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2LongLinkedOpenHashMap(Float[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2LongLinkedOpenHashMap(Float[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2LongLinkedOpenHashMap(Map<? extends Float, ? extends Long> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2LongLinkedOpenHashMap(Float2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2LongLinkedOpenHashMap(Float2LongMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Float2LongLinkedOpenHashMap copy() {
		Float2LongLinkedOpenHashMap map = new Float2LongLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2LongMap.Entry> implements Float2LongOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2LongMap.Entry o) {
			return Float2LongLinkedOpenHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2LongMap.Entry o) {
			return Float2LongLinkedOpenHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2LongMap.Entry) {
					...
					int index = Float2LongLinkedOpenHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getLongValue() == Float2LongLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Float2LongLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Float2LongLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2LongMap.Entry) {
					Float2LongMap.Entry entry = (Float2LongMap.Entry)o;
					return Float2LongLinkedOpenHashMap.this.remove(entry.getFloatKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2LongLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2LongLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2LongLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2LongLinkedOpenHashMap.this.moveToLast(o);
		}
