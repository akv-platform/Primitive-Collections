...
import speiger.src.collections.floats.maps.interfaces.Float2DoubleConcurrentMap;
 ...
 * 
 */
public class Float2DoubleConcurrentOpenHashMap extends AbstractFloat2DoubleMap implements Float2DoubleConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Float2DoubleConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Float2DoubleConcurrentOpenHashMap() {
	 ...
	 */
	public Float2DoubleConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Float2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2DoubleConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2DoubleConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Float2DoubleConcurrentOpenHashMap(Float[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2DoubleConcurrentOpenHashMap(Float[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2DoubleConcurrentOpenHashMap(Float[] keys, Double[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2DoubleConcurrentOpenHashMap(Float[] keys, Double[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Float2DoubleConcurrentOpenHashMap(Map<? extends Float, ? extends Double> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2DoubleConcurrentOpenHashMap(Map<? extends Float, ? extends Double> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2DoubleConcurrentOpenHashMap(Map<? extends Float, ? extends Double> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2DoubleConcurrentOpenHashMap(Map<? extends Float, ? extends Double> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2DoubleConcurrentOpenHashMap(Float2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2DoubleConcurrentOpenHashMap(Float2DoubleMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Float2DoubleConcurrentOpenHashMap(Float2DoubleMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Float2DoubleConcurrentOpenHashMap(Float2DoubleMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Float2DoubleConcurrentOpenHashMap copy() {
		Float2DoubleConcurrentOpenHashMap copy = new Float2DoubleConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry> implements Float2DoubleMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2DoubleMap.Entry) {
					Float2DoubleMap.Entry entry = (Float2DoubleMap.Entry)o;
					return Float2DoubleConcurrentOpenHashMap.this.remove(entry.getFloatKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2DoubleConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Float2DoubleConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Float2DoubleConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractFloatSet implements FloatSet {
		...
		public boolean remove(float o) {
			int oldSize = size();
			Float2DoubleConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Float2DoubleMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Float2DoubleMap.Entry> {
		MapEntry entry;
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Float2DoubleConcurrentOpenHashMap map;
		...
		protected Segment(Float2DoubleConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Float2DoubleConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Float2DoubleConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected double put(int hash, float key, double value) {
		...
		protected double putIfAbsent(int hash, float key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double addTo(int hash, float key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double subFrom(int hash, float key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double get(int hash, float key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double getOrDefault(int hash, float key, double defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(FloatDoubleConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected double remove(int hash, float key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected double removeOrDefault(int hash, float key, double defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, float key, double value) {
			long stamp = writeLock();
			try {
		...
		protected boolean replace(int hash, float key, double oldValue, double newValue) {
			long stamp = writeLock();
			try {
		...
		protected double replace(int hash, float key, double value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected double compute(int hash, float key, FloatDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected double computeIfAbsent(int hash, float key, Float2DoubleFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected double supplyIfAbsent(int hash, float key, DoubleSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected double computeIfPresent(int hash, float key, FloatDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected double merge(int hash, float key, double value, DoubleDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
