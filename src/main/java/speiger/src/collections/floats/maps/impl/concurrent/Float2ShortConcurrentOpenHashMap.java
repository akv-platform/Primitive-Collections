...
import speiger.src.collections.floats.maps.interfaces.Float2ShortConcurrentMap;
 ...
 * 
 */
public class Float2ShortConcurrentOpenHashMap extends AbstractFloat2ShortMap implements Float2ShortConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Float2ShortConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Float2ShortConcurrentOpenHashMap() {
	 ...
	 */
	public Float2ShortConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Float2ShortConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2ShortConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2ShortConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2ShortConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Float2ShortConcurrentOpenHashMap(Float[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ShortConcurrentOpenHashMap(Float[] keys, Short[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2ShortConcurrentOpenHashMap(Float[] keys, Short[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2ShortConcurrentOpenHashMap(Float[] keys, Short[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Float2ShortConcurrentOpenHashMap(Map<? extends Float, ? extends Short> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2ShortConcurrentOpenHashMap(Map<? extends Float, ? extends Short> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2ShortConcurrentOpenHashMap(Map<? extends Float, ? extends Short> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2ShortConcurrentOpenHashMap(Map<? extends Float, ? extends Short> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2ShortConcurrentOpenHashMap(Float2ShortMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2ShortConcurrentOpenHashMap(Float2ShortMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Float2ShortConcurrentOpenHashMap(Float2ShortMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Float2ShortConcurrentOpenHashMap(Float2ShortMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Float2ShortConcurrentOpenHashMap copy() {
		Float2ShortConcurrentOpenHashMap copy = new Float2ShortConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2ShortMap.Entry> implements Float2ShortMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2ShortMap.Entry) {
					Float2ShortMap.Entry entry = (Float2ShortMap.Entry)o;
					return Float2ShortConcurrentOpenHashMap.this.remove(entry.getFloatKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2ShortConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Float2ShortConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Float2ShortConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractFloatSet implements FloatSet {
		...
		public boolean remove(float o) {
			int oldSize = size();
			Float2ShortConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Float2ShortMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Float2ShortMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Float2ShortMap.Entry, Map.Entry<Float, Short> {
		int index = -1;
		int segmentIndex = -1;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Float2ShortMap.Entry) {
					...
					return Float.floatToIntBits(getFloatKey()) == Float.floatToIntBits(entry.getFloatKey()) && getShortValue() == entry.getShortValue();
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Float && value instanceof Short && Float.floatToIntBits(getFloatKey()) == Float.floatToIntBits(((Float)key).floatValue()) && getShortValue() == ((Short)value).shortValue();
			}
			return false;
		}
		...
		@Override
		public int hashCode() {
			return Float.hashCode(getFloatKey()) ^ Short.hashCode(getShortValue());
		}
		
		@Override
		public String toString() {
			return Float.toString(getFloatKey()) + "=" + Short.toString(getShortValue());
		}
	}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Float2ShortConcurrentOpenHashMap map;
		...
		protected Segment(Float2ShortConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Float2ShortConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Float2ShortConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected short put(int hash, float key, short value) {
		...
		protected short putIfAbsent(int hash, float key, short value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected short addTo(int hash, float key, short value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected short subFrom(int hash, float key, short value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected short get(int hash, float key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected short getOrDefault(int hash, float key, short defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(FloatShortConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected short remove(int hash, float key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected short removeOrDefault(int hash, float key, short defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, float key, short value) {
			long stamp = writeLock();
			try {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				float current = keys[pos];
				if(Float.floatToIntBits(current) == 0) return false;
				if(Objects.equals(key, Float.valueOf(current)) && Objects.equals(value, Short.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if(Float.floatToIntBits((current = keys[pos = (++pos & mask)])) == 0) return false;
					else if(Objects.equals(key, Float.valueOf(current)) && Objects.equals(value, Short.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, float key, short oldValue, short newValue) {
			long stamp = writeLock();
			try {
		...
		protected short replace(int hash, float key, short value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected short compute(int hash, float key, FloatShortUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected short computeIfAbsent(int hash, float key, Float2ShortFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected short supplyIfAbsent(int hash, float key, ShortSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected short computeIfPresent(int hash, float key, FloatShortUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected short merge(int hash, float key, short value, ShortShortUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected void insert(int slot, float key, short value) {
