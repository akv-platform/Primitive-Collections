 ...
 */
public interface Float2LongNavigableMap extends Float2LongSortedMap, NavigableMap<Float, Long>
{
	@Override
	 ...
	 */
	public default Float2LongNavigableMap synchronize() { return Float2LongMaps.synchronize(this); }
	 ...
	 * @see Float2LongMaps#synchronize
	 */
	public default Float2LongNavigableMap synchronize(Object mutex) { return Float2LongMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Float2LongNavigableMap unmodifiable() { return Float2LongMaps.unmodifiable(this); }
	...
	@Override
	public default Float2LongNavigableMap subMap(float fromKey, float toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Float2LongNavigableMap headMap(float toKey) { return headMap(toKey, false); }
	@Override
	public default Float2LongNavigableMap tailMap(float fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Float2LongMap.Entry lowerEntry(Float key) { return lowerEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2LongMap.Entry floorEntry(Float key) { return floorEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2LongMap.Entry ceilingEntry(Float key) { return ceilingEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2LongMap.Entry higherEntry(Float key) { return higherEntry(key.floatValue()); }
	
	@Override
	@Deprecated
	default Float2LongNavigableMap subMap(Float fromKey, boolean fromInclusive, Float toKey, boolean toInclusive) { return subMap(fromKey.floatValue(), fromInclusive, toKey.floatValue(), toInclusive); }
	@Override
	@Deprecated
	default Float2LongNavigableMap headMap(Float toKey, boolean inclusive) { return headMap(toKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2LongNavigableMap tailMap(Float fromKey, boolean inclusive) { return tailMap(fromKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2LongNavigableMap subMap(Float fromKey, Float toKey) { return subMap(fromKey.floatValue(), true, toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2LongNavigableMap headMap(Float toKey) { return headMap(toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2LongNavigableMap tailMap(Float fromKey) { return tailMap(fromKey.floatValue(), true); }
}