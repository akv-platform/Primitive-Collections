...
public abstract class AbstractFloat2FloatMap extends AbstractMap<Float, Float> implements Float2FloatMap
{
	...
	public void putAll(Float2FloatMap m) {
		for(ObjectIterator<Float2FloatMap.Entry> iter = Float2FloatMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceFloats(FloatFloatUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Float2FloatMap.Entry> iter = Float2FloatMaps.fastIterator(this);iter.hasNext();) {
			Float2FloatMap.Entry entry = iter.next();
		...
		return new AbstractFloatSet() {
			...
			public FloatIterator iterator() {
				return new FloatIterator() {
					ObjectIterator<Float2FloatMap.Entry> iter = Float2FloatMaps.fastIterator(AbstractFloat2FloatMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Float2FloatMap.Entry> iter = Float2FloatMaps.fastIterator(this);
