...
public class Float2IntLinkedOpenCustomHashMap extends Float2IntOpenCustomHashMap implements Float2IntOrderedMap
{
	 ...
	 */
	public Float2IntLinkedOpenCustomHashMap(FloatStrategy strategy) {
	 ...
	 */
	public Float2IntLinkedOpenCustomHashMap(int minCapacity, FloatStrategy strategy) {
	 ...
	 */
	public Float2IntLinkedOpenCustomHashMap(int minCapacity, float loadFactor, FloatStrategy strategy) {
	 ...
	 */
	public Float2IntLinkedOpenCustomHashMap(Float[] keys, Integer[] values, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2IntLinkedOpenCustomHashMap(Float[] keys, Integer[] values, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Float2IntLinkedOpenCustomHashMap(float[] keys, int[] values, FloatStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2IntLinkedOpenCustomHashMap(float[] keys, int[] values, float loadFactor, FloatStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Float2IntLinkedOpenCustomHashMap(Map<? extends Float, ? extends Integer> map, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2IntLinkedOpenCustomHashMap(Map<? extends Float, ? extends Integer> map, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Float2IntLinkedOpenCustomHashMap(Float2IntMap map, FloatStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2IntLinkedOpenCustomHashMap(Float2IntMap map, float loadFactor, FloatStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	
	@Override
	public int putAndMoveToFirst(float key, int value) {
	...
	@Override
	public int putAndMoveToLast(float key, int value) {
		if(strategy.equals(key, 0F)) {
			if(containsNull) {
				int lastValue = values[nullIndex];
				values[nullIndex] = value;
	...
	@Override
	public int getAndMoveToFirst(float key) {
	...
	@Override
	public int getAndMoveToLast(float key) {
		int index = findIndex(key);
		if(index < 0) return getDefaultReturnValue();
	...
	@Override
	public Float2IntLinkedOpenCustomHashMap copy() {
		Float2IntLinkedOpenCustomHashMap map = new Float2IntLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2IntMap.Entry> implements Float2IntOrderedMap.FastOrderedSet {
		@Override
		...
		@Override
		public boolean moveToFirst(Float2IntMap.Entry o) {
			return Float2IntLinkedOpenCustomHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2IntMap.Entry o) {
			return Float2IntLinkedOpenCustomHashMap.this.moveToLast(o.getFloatKey());
		}
		
		@Override
		public Float2IntMap.Entry first() {
			return new BasicEntry(firstFloatKey(), firstIntValue());
		}
		
		@Override
		public Float2IntMap.Entry last() {
			return new BasicEntry(lastFloatKey(), lastIntValue());
		}
		
		@Override
		public Float2IntMap.Entry pollFirst() {
			BasicEntry entry = new BasicEntry(firstFloatKey(), firstIntValue());
			pollFirstFloatKey();
			return entry;
		}
		...
		public Float2IntMap.Entry pollLast() {
			BasicEntry entry = new BasicEntry(lastFloatKey(), lastIntValue());
			pollLastFloatKey();
			return entry;
		}
		...
		@Override
		public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator(Float2IntMap.Entry fromElement) {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2IntMap.Entry) {
					...
					int index = Float2IntLinkedOpenCustomHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getIntValue() == Float2IntLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Float)) return false;
					int index = Float2IntLinkedOpenCustomHashMap.this.findIndex((Float)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(Float2IntLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2IntMap.Entry) {
					Float2IntMap.Entry entry = (Float2IntMap.Entry)o;
					return Float2IntLinkedOpenCustomHashMap.this.remove(entry.getFloatKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2IntLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Float2IntLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Float2IntLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2IntLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2IntLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2IntLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Float2IntMap.Entry> {
		...
		@Override
		public void set(Float2IntMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Float2IntMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
