...
import speiger.src.collections.floats.maps.interfaces.Float2CharConcurrentMap;
 ...
 * 
 */
public class Float2CharConcurrentOpenHashMap extends AbstractFloat2CharMap implements Float2CharConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Float2CharConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Float2CharConcurrentOpenHashMap() {
	 ...
	 */
	public Float2CharConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Float2CharConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2CharConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2CharConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2CharConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Float2CharConcurrentOpenHashMap(Float[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2CharConcurrentOpenHashMap(Float[] keys, Character[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2CharConcurrentOpenHashMap(Float[] keys, Character[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2CharConcurrentOpenHashMap(Float[] keys, Character[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Float2CharConcurrentOpenHashMap(float[] keys, char[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2CharConcurrentOpenHashMap(float[] keys, char[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2CharConcurrentOpenHashMap(float[] keys, char[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2CharConcurrentOpenHashMap(float[] keys, char[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Float2CharConcurrentOpenHashMap(Map<? extends Float, ? extends Character> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2CharConcurrentOpenHashMap(Map<? extends Float, ? extends Character> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2CharConcurrentOpenHashMap(Map<? extends Float, ? extends Character> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Float2CharConcurrentOpenHashMap(Map<? extends Float, ? extends Character> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2CharConcurrentOpenHashMap(Float2CharMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2CharConcurrentOpenHashMap(Float2CharMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Float2CharConcurrentOpenHashMap(Float2CharMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Float2CharConcurrentOpenHashMap(Float2CharMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Float2CharConcurrentOpenHashMap copy() {
		Float2CharConcurrentOpenHashMap copy = new Float2CharConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements Float2CharMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2CharMap.Entry) {
					Float2CharMap.Entry entry = (Float2CharMap.Entry)o;
					return Float2CharConcurrentOpenHashMap.this.remove(entry.getFloatKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2CharConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Float2CharConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Float2CharConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractFloatSet implements FloatSet {
		...
		public boolean remove(float o) {
			int oldSize = size();
			Float2CharConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Float2CharMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Float2CharMap.Entry> {
		MapEntry entry;
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Float2CharConcurrentOpenHashMap map;
		...
		protected Segment(Float2CharConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Float2CharConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Float2CharConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected char put(int hash, float key, char value) {
		...
		protected char putIfAbsent(int hash, float key, char value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected char addTo(int hash, float key, char value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected char subFrom(int hash, float key, char value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected char get(int hash, float key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected char getOrDefault(int hash, float key, char defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(FloatCharConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected char remove(int hash, float key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected char removeOrDefault(int hash, float key, char defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, float key, char value) {
			long stamp = writeLock();
			try {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				float current = keys[pos];
				if(Float.floatToIntBits(current) == 0) return false;
				if(Objects.equals(key, Float.valueOf(current)) && Objects.equals(value, Character.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if(Float.floatToIntBits((current = keys[pos = (++pos & mask)])) == 0) return false;
					else if(Objects.equals(key, Float.valueOf(current)) && Objects.equals(value, Character.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, float key, char oldValue, char newValue) {
			long stamp = writeLock();
			try {
		...
		protected char replace(int hash, float key, char value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected char compute(int hash, float key, FloatCharUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected char computeIfAbsent(int hash, float key, Float2CharFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected char supplyIfAbsent(int hash, float key, CharSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected char merge(int hash, float key, char value, CharCharUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
