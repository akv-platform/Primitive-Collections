...
public class Float2BooleanLinkedOpenHashMap extends Float2BooleanOpenHashMap implements Float2BooleanOrderedMap
{
	...
	@Override
	public Float2BooleanLinkedOpenHashMap copy() {
		Float2BooleanLinkedOpenHashMap map = new Float2BooleanLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements Float2BooleanOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2BooleanMap.Entry o) {
			return Float2BooleanLinkedOpenHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2BooleanMap.Entry o) {
			return Float2BooleanLinkedOpenHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2BooleanMap.Entry) {
					...
					int index = Float2BooleanLinkedOpenHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getBooleanValue() == Float2BooleanLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Float2BooleanLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Float2BooleanLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2BooleanMap.Entry) {
					Float2BooleanMap.Entry entry = (Float2BooleanMap.Entry)o;
					return Float2BooleanLinkedOpenHashMap.this.remove(entry.getFloatKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2BooleanLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2BooleanLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2BooleanLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2BooleanLinkedOpenHashMap.this.moveToLast(o);
		}
