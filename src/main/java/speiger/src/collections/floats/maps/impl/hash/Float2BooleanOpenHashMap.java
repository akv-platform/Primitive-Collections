 ...
 */
public class Float2BooleanOpenHashMap extends AbstractFloat2BooleanMap implements ITrimmable
{
	 ...
	 */
	public Float2BooleanOpenHashMap(int minCapacity) {
	 ...
	 */
	public Float2BooleanOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2BooleanOpenHashMap(Float[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2BooleanOpenHashMap(Float[] keys, Boolean[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2BooleanOpenHashMap(Map<? extends Float, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2BooleanOpenHashMap(Float2BooleanMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2BooleanOpenHashMap(Float2BooleanMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(Float.floatToIntBits(keys[i]) != 0 && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Boolean.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Float2BooleanOpenHashMap copy() {
		Float2BooleanOpenHashMap map = new Float2BooleanOpenHashMap(0, loadFactor);
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements Float2BooleanMap.FastEntrySet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2BooleanMap.Entry) {
					...
					int index = Float2BooleanOpenHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getBooleanValue() == Float2BooleanOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Float2BooleanOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Float2BooleanOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2BooleanMap.Entry) {
					Float2BooleanMap.Entry entry = (Float2BooleanMap.Entry)o;
					return Float2BooleanOpenHashMap.this.remove(entry.getFloatKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2BooleanOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractFloatSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2BooleanOpenHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Float2BooleanOpenHashMap.this.remove(wrapped.getFloat(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
