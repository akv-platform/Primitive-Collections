...
public abstract class AbstractFloat2ObjectMap<V> extends AbstractMap<Float, V> implements Float2ObjectMap<V>
{
	...
	public void putAll(Float2ObjectMap<V> m) {
		for(ObjectIterator<Float2ObjectMap.Entry<V>> iter = Float2ObjectMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceObjects(FloatObjectUnaryOperator<V> mappingFunction) {
		...
		for(ObjectIterator<Float2ObjectMap.Entry<V>> iter = Float2ObjectMaps.fastIterator(this);iter.hasNext();) {
			Float2ObjectMap.Entry<V> entry = iter.next();
		...
		return new AbstractFloatSet() {
			...
			public FloatIterator iterator() {
				return new FloatIterator() {
					ObjectIterator<Float2ObjectMap.Entry<V>> iter = Float2ObjectMaps.fastIterator(AbstractFloat2ObjectMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Float2ObjectMap.Entry<V>> iter = Float2ObjectMaps.fastIterator(this);
