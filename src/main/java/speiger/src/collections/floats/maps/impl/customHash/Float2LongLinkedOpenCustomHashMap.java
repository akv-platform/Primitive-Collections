 ...
 */
public class Float2LongLinkedOpenCustomHashMap extends Float2LongOpenCustomHashMap implements Float2LongOrderedMap
{
	 ...
	 */
	public Float2LongLinkedOpenCustomHashMap(FloatStrategy strategy) {
	 ...
	 */
	public Float2LongLinkedOpenCustomHashMap(int minCapacity, FloatStrategy strategy) {
	 ...
	 */
	public Float2LongLinkedOpenCustomHashMap(int minCapacity, float loadFactor, FloatStrategy strategy) {
	 ...
	 */
	public Float2LongLinkedOpenCustomHashMap(Float[] keys, Long[] values, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2LongLinkedOpenCustomHashMap(Float[] keys, Long[] values, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Float2LongLinkedOpenCustomHashMap(Map<? extends Float, ? extends Long> map, FloatStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2LongLinkedOpenCustomHashMap(Map<? extends Float, ? extends Long> map, float loadFactor, FloatStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Float2LongLinkedOpenCustomHashMap(Float2LongMap map, FloatStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2LongLinkedOpenCustomHashMap(Float2LongMap map, float loadFactor, FloatStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	
	@Override
	public long putAndMoveToFirst(float key, long value) {
	...
	@Override
	public long putAndMoveToLast(float key, long value) {
		if(strategy.equals(key, 0F)) {
			if(containsNull) {
				long lastValue = values[nullIndex];
				values[nullIndex] = value;
	...
	@Override
	public long getAndMoveToFirst(float key) {
	...
	@Override
	public long getAndMoveToLast(float key) {
		int index = findIndex(key);
		if(index < 0) return getDefaultReturnValue();
	...
	@Override
	public Float2LongLinkedOpenCustomHashMap copy() {
		Float2LongLinkedOpenCustomHashMap map = new Float2LongLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2LongMap.Entry> implements Float2LongOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Float2LongMap.Entry o) {
			return Float2LongLinkedOpenCustomHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2LongMap.Entry o) {
			return Float2LongLinkedOpenCustomHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		@Override
		public Float2LongMap.Entry pollFirst() {
			BasicEntry entry = new BasicEntry(firstFloatKey(), firstLongValue());
			pollFirstFloatKey();
			return entry;
		}
		
		@Override
		public Float2LongMap.Entry pollLast() {
			BasicEntry entry = new BasicEntry(lastFloatKey(), lastLongValue());
			pollLastFloatKey();
			return entry;
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2LongMap.Entry) {
					...
					int index = Float2LongLinkedOpenCustomHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getLongValue() == Float2LongLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Float)) return false;
					int index = Float2LongLinkedOpenCustomHashMap.this.findIndex((Float)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Float2LongLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2LongMap.Entry) {
					Float2LongMap.Entry entry = (Float2LongMap.Entry)o;
					return Float2LongLinkedOpenCustomHashMap.this.remove(entry.getFloatKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2LongLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Float2LongLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Float2LongLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2LongLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2LongLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2LongLinkedOpenCustomHashMap.this.moveToLast(o);
		}
