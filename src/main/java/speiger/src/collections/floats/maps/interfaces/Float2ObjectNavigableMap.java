 ...
 */
public interface Float2ObjectNavigableMap<V> extends Float2ObjectSortedMap<V>, NavigableMap<Float, V>
{
	@Override
	public Float2ObjectNavigableMap<V> copy();
	 ...
	 */
	public default Float2ObjectNavigableMap<V> synchronize() { return Float2ObjectMaps.synchronize(this); }
	 ...
	 * @see Float2ObjectMaps#synchronize
	 */
	public default Float2ObjectNavigableMap<V> synchronize(Object mutex) { return Float2ObjectMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Float2ObjectNavigableMap<V> unmodifiable() { return Float2ObjectMaps.unmodifiable(this); }
	...
	@Override
	public default Float2ObjectNavigableMap<V> subMap(float fromKey, float toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Float2ObjectNavigableMap<V> headMap(float toKey) { return headMap(toKey, false); }
	@Override
	public default Float2ObjectNavigableMap<V> tailMap(float fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Float2ObjectMap.Entry<V> lowerEntry(Float key) { return lowerEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2ObjectMap.Entry<V> floorEntry(Float key) { return floorEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2ObjectMap.Entry<V> ceilingEntry(Float key) { return ceilingEntry(key.floatValue()); }
	@Override
	@Deprecated
	default Float2ObjectMap.Entry<V> higherEntry(Float key) { return higherEntry(key.floatValue()); }
	
	@Override
	@Deprecated
	default Float2ObjectNavigableMap<V> subMap(Float fromKey, boolean fromInclusive, Float toKey, boolean toInclusive) { return subMap(fromKey.floatValue(), fromInclusive, toKey.floatValue(), toInclusive); }
	@Override
	@Deprecated
	default Float2ObjectNavigableMap<V> headMap(Float toKey, boolean inclusive) { return headMap(toKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2ObjectNavigableMap<V> tailMap(Float fromKey, boolean inclusive) { return tailMap(fromKey.floatValue(), inclusive); }
	@Override
	@Deprecated
	default Float2ObjectNavigableMap<V> subMap(Float fromKey, Float toKey) { return subMap(fromKey.floatValue(), true, toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2ObjectNavigableMap<V> headMap(Float toKey) { return headMap(toKey.floatValue(), false); }
	@Override
	@Deprecated
	default Float2ObjectNavigableMap<V> tailMap(Float fromKey) { return tailMap(fromKey.floatValue(), true); }
}