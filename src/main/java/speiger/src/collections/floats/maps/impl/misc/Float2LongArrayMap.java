 ...
 */
public class Float2LongArrayMap extends AbstractFloat2LongMap implements Float2LongOrderedMap
{
	 ...
	 */
	public Float2LongArrayMap(int minCapacity) {
	 ...
	 */
	public Float2LongArrayMap(Float[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in length
	 */
	public Float2LongArrayMap(Float[] keys, Long[] values, int length) {
		this(length);
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2LongArrayMap(Float2LongMap map) {
		this(map.size());
		for(ObjectIterator<Float2LongMap.Entry> iter = Float2LongMaps.fastIterator(map);iter.hasNext();size++) {
	...
	public Float2LongArrayMap copy() {
		Float2LongArrayMap map = new Float2LongArrayMap();
		map.size = size;
	...
	protected void insertIndex(int index, float key, long value) {
		grow(size+1);
		if(index != size) {
	...
	protected int findIndex(float key, long value) {
	...
	protected int findIndex(Object key, Object value) {
		for(int i = size-1;i>=0;i--)
			if(Objects.equals(key, Float.valueOf(keys[i])) && Objects.equals(value, Long.valueOf(values[i]))) return i;
		return -1;		
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Float2LongMap.Entry> implements Float2LongOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2LongMap.Entry o) {
			return Float2LongArrayMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2LongMap.Entry o) {
			return Float2LongArrayMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2LongMap.Entry) {
					...
					int index = Float2LongArrayMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return entry.getLongValue() == Float2LongArrayMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Float2LongArrayMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Float2LongArrayMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2LongMap.Entry) {
					Float2LongMap.Entry entry = (Float2LongMap.Entry)o;
					return Float2LongArrayMap.this.remove(entry.getFloatKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2LongArrayMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2LongArrayMap.this.remove(o);
			return size != oldSize;
		}
		...
		@Override
		public boolean moveToFirst(float o) { return Float2LongArrayMap.this.moveToFirst(o); }
		@Override
		public boolean moveToLast(float o) { return Float2LongArrayMap.this.moveToLast(o); }
		@Override
		...
		@Override
		public int size() { return Float2LongArrayMap.this.size(); }
		@Override
		public void clear() { Float2LongArrayMap.this.clear(); }
		@Override
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Float2LongMap.Entry> {
		...
		@Override
		public void set(Float2LongMap.Entry e) { throw new UnsupportedOperationException(); }
		@Override
		public void add(Float2LongMap.Entry e) { throw new UnsupportedOperationException(); }
	}
	...
	private class MapEntry implements Float2LongMap.Entry, Map.Entry<Float, Long> {
		int index = -1;
