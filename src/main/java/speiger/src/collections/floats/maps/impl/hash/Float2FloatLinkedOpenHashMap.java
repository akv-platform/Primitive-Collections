...
public class Float2FloatLinkedOpenHashMap extends Float2FloatOpenHashMap implements Float2FloatOrderedMap
{
	 ...
	 */
	public Float2FloatLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Float2FloatLinkedOpenHashMap(Float[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2FloatLinkedOpenHashMap(Float[] keys, Float[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Float2FloatLinkedOpenHashMap(Map<? extends Float, ? extends Float> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Float2FloatLinkedOpenHashMap(Float2FloatMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Float2FloatLinkedOpenHashMap(Float2FloatMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Float2FloatLinkedOpenHashMap copy() {
		Float2FloatLinkedOpenHashMap map = new Float2FloatLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements Float2FloatOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Float2FloatMap.Entry o) {
			return Float2FloatLinkedOpenHashMap.this.moveToFirst(o.getFloatKey());
		}
		
		@Override
		public boolean moveToLast(Float2FloatMap.Entry o) {
			return Float2FloatLinkedOpenHashMap.this.moveToLast(o.getFloatKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2FloatMap.Entry) {
					...
					int index = Float2FloatLinkedOpenHashMap.this.findIndex(entry.getFloatKey());
					if(index >= 0) return Float.floatToIntBits(entry.getFloatValue()) == Float.floatToIntBits(Float2FloatLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Float2FloatLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float.valueOf(Float2FloatLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Float2FloatMap.Entry) {
					Float2FloatMap.Entry entry = (Float2FloatMap.Entry)o;
					return Float2FloatLinkedOpenHashMap.this.remove(entry.getFloatKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Float2FloatLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractFloatSet implements FloatOrderedSet {
		...
		public boolean remove(float o) {
			int oldSize = size;
			Float2FloatLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(float o) {
			return Float2FloatLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(float o) {
			return Float2FloatLinkedOpenHashMap.this.moveToLast(o);
		}
