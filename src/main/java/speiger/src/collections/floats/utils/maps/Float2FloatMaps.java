...
public class Float2FloatMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Float2FloatMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Float2FloatMap.Entry unmodifiable(Float2FloatMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Float2FloatMap.Entry unmodifiable(Map.Entry<Float, Float> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class SingletonMap extends AbstractFloat2FloatMap {
		...
		@Override
		public float computeFloatIfAbsent(float key, Float2FloatFunction mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
	...
	public static class EmptyMap extends AbstractFloat2FloatMap {
		...
		@Override
		public float getOrDefault(float key, float defaultValue) { return defaultValue; }
		@Override
		public float computeFloat(float key, FloatFloatUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public float computeFloatIfAbsent(float key, Float2FloatFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Float2FloatNavigableMap {
		...
		@Override
		public Float2FloatNavigableMap descendingMap() { return Float2FloatMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Float2FloatNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Float2FloatOrderedMap {
		...
		@Override
		public Float2FloatOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.float2FloatEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Float2FloatSortedMap {
		...
		public float lastFloatValue() { return map.lastFloatValue(); }
		@Override
		public Float2FloatSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractFloat2FloatMap implements Float2FloatMap {
		...
		public void mergeAllFloat(Float2FloatMap m, FloatFloatUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceFloats(FloatFloatUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceFloats(Float2FloatMap m) { throw new UnsupportedOperationException(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Float2FloatMap.Entry>
	{
		ObjectOrderedSet<Float2FloatMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Float2FloatMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Float2FloatMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator(Float2FloatMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Float2FloatMap.Entry first() { return set.first(); }
		@Override
		public Float2FloatMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Float2FloatMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Float2FloatNavigableMap {
		...
		@Override
		public Float2FloatNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Float2FloatNavigableMap subMap(Float fromKey, boolean fromInclusive, Float toKey, boolean toInclusive) { synchronized(mutex) { return Float2FloatMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Float2FloatOrderedMap {
		...
		@Override
		public Float2FloatOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public FloatOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Float2FloatSortedMap {
		...
		public float lastFloatValue() { synchronized(mutex) { return map.lastFloatValue(); } }
		@Override
		public Float2FloatSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractFloat2FloatMap implements Float2FloatMap {
		...
		@Override
		public float supplyFloatIfAbsent(float key, FloatSupplier valueProvider) { synchronized(mutex) { return map.supplyFloatIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Float2FloatMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public FloatSet keySet() {
			if(keys == null) keys = FloatSets.synchronize(map.keySet(), mutex);
			return keys;
