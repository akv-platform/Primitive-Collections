...
public class Float2BooleanMaps
{
	...
	public static class EmptyMap extends AbstractFloat2BooleanMap {
		...
		@Override
		public boolean getOrDefault(float key, boolean defaultValue) { return false; }
		@Override
	...
	public static class SynchronizedMap extends AbstractFloat2BooleanMap implements Float2BooleanMap {
		...
		@Override
		public boolean computeBooleanIfAbsent(float key, Float2BooleanFunction mappingFunction) { synchronized(mutex) { return map.computeBooleanIfAbsent(key, mappingFunction); } }
		@Override
