...
public class FloatRBTreeSet extends AbstractFloatSet implements FloatNavigableSet
{
	 ...
	 */
	@Deprecated
	public FloatRBTreeSet(Collection<? extends Float> collection, FloatComparator comp) {
		comparator = comp;
		addAll(collection);
	}
	...
	public FloatRBTreeSet copy() {
		FloatRBTreeSet set = new FloatRBTreeSet();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
	...
	{
		public AscendingSubSet(FloatRBTreeSet set, boolean fromStart, float lo, boolean loInclusive, boolean toEnd, float hi, boolean hiInclusive)
		{
	...
	static class DescendingSubSet extends SubSet
	{
		...
		public DescendingSubSet(FloatRBTreeSet set, boolean fromStart, float lo, boolean loInclusive, boolean toEnd, float hi, boolean hiInclusive)
		{
			super(set, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	{
		final FloatRBTreeSet set;
		final float lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		FloatNavigableSet inverse;
		
		public SubSet(FloatRBTreeSet set, boolean fromStart, float lo, boolean loInclusive, boolean toEnd, float hi, boolean hiInclusive)
		{
			this.set = set;
			this.lo = lo;
			this.hi = hi;
