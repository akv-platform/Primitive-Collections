...
public class FloatLinkedOpenCustomHashSet extends FloatOpenCustomHashSet implements FloatOrderedSet
{
	 ...
	 */
	@Deprecated
	public FloatLinkedOpenCustomHashSet(Collection<? extends Float> collection, FloatStrategy strategy) {
	 ...
	 */
	@Deprecated
	public FloatLinkedOpenCustomHashSet(Collection<? extends Float> collection, float loadFactor, FloatStrategy strategy) {
	...
	@Override
	public FloatLinkedOpenCustomHashSet copy() {
		FloatLinkedOpenCustomHashSet set = new FloatLinkedOpenCustomHashSet(0, loadFactor, strategy);
