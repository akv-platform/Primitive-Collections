...
public class FloatLinkedOpenHashSet extends FloatOpenHashSet implements FloatOrderedSet
{
	 ...
	 */
	public FloatLinkedOpenHashSet(int minCapacity, float loadFactor) {
	 ...
	 */
	public FloatLinkedOpenHashSet(float[] array) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public FloatLinkedOpenHashSet(float[] array, float loadFactor) {
	 ...
	 */
	public FloatLinkedOpenHashSet(float[] array, int offset, int length) {
	 ...
	 * @throws IllegalStateException if offset and length causes to step outside of the arrays range
	 */
	public FloatLinkedOpenHashSet(float[] array, int offset, int length, float loadFactor) {
		this(length);
	 ...
	 */
	@Deprecated
	public FloatLinkedOpenHashSet(Collection<? extends Float> collection, float loadFactor) {
	 ...
	 * @param collection the set the elements should be added to the Set
	 */
	public FloatLinkedOpenHashSet(FloatCollection collection) {
		this(collection, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public FloatLinkedOpenHashSet(FloatCollection collection, float loadFactor) {
	 ...
	 */
	public FloatLinkedOpenHashSet(Iterator<Float> iterator) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public FloatLinkedOpenHashSet(Iterator<Float> iterator, float loadFactor) {
	 ...
	 * @param iterator the elements that should be added to the set
	 */
	public FloatLinkedOpenHashSet(FloatIterator iterator) {
		this(iterator, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	...
	public boolean addAndMoveToFirst(float o) {
		if(Float.floatToIntBits(o) == 0) {
			...
			while(Float.floatToIntBits(keys[pos]) != 0) {
				if(Float.floatToIntBits(keys[pos]) == Float.floatToIntBits(o)) {
	...
	@Override
	public FloatLinkedOpenHashSet copy() {
		FloatLinkedOpenHashSet set = new FloatLinkedOpenHashSet(0, loadFactor);
