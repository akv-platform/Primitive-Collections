...
public class ShortAVLTreeSet extends AbstractShortSet implements ShortNavigableSet
{
	 ...
	 */
	@Deprecated
	public ShortAVLTreeSet(Collection<? extends Short> collection, ShortComparator comp) {
		comparator = comp;
		addAll(collection);
	}
	...
	{
		public AscendingSubSet(ShortAVLTreeSet set, boolean fromStart, short lo, boolean loInclusive, boolean toEnd, short hi, boolean hiInclusive)
		{
	...
	static class DescendingSubSet extends SubSet
	{
		...
		public DescendingSubSet(ShortAVLTreeSet set, boolean fromStart, short lo, boolean loInclusive, boolean toEnd, short hi, boolean hiInclusive)
		{
			super(set, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	{
		final ShortAVLTreeSet set;
		final short lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		ShortNavigableSet inverse;
		
		public SubSet(ShortAVLTreeSet set, boolean fromStart, short lo, boolean loInclusive, boolean toEnd, short hi, boolean hiInclusive)
		{
			this.set = set;
			this.lo = lo;
			this.hi = hi;
