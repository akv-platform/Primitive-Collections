...
public class Short2DoubleMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Short2DoubleMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Short2DoubleMap.Entry unmodifiable(Short2DoubleMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Short2DoubleMap.Entry unmodifiable(Map.Entry<Short, Double> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class EmptyMap extends AbstractShort2DoubleMap {
		...
		@Override
		public double getOrDefault(short key, double defaultValue) { return defaultValue; }
		@Override
		public double computeDouble(short key, ShortDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public double computeDoubleIfAbsent(short key, Short2DoubleFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Short2DoubleNavigableMap {
		...
		@Override
		public Short2DoubleNavigableMap descendingMap() { return Short2DoubleMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Short2DoubleNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Short2DoubleOrderedMap {
		...
		@Override
		public Short2DoubleOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.short2DoubleEntrySet());
			return (ObjectOrderedSet<Short2DoubleMap.Entry>)entrySet;
		}
	}
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Short2DoubleSortedMap {
		...
		public double lastDoubleValue() { return map.lastDoubleValue(); }
		@Override
		public Short2DoubleSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractShort2DoubleMap implements Short2DoubleMap {
		...
		public void mergeAllDouble(Short2DoubleMap m, DoubleDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceDoubles(ShortDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceDoubles(Short2DoubleMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Short2DoubleMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Short2DoubleMap.Entry>
	{
		ObjectOrderedSet<Short2DoubleMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Short2DoubleMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Short2DoubleMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Short2DoubleMap.Entry first() { return set.first(); }
		@Override
		public Short2DoubleMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Short2DoubleMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Short2DoubleNavigableMap {
		...
		@Override
		public Short2DoubleMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Short2DoubleNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Short2DoubleNavigableMap subMap(Short fromKey, boolean fromInclusive, Short toKey, boolean toInclusive) { synchronized(mutex) { return Short2DoubleMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Short2DoubleOrderedMap {
		...
		@Override
		public Short2DoubleOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ShortOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Short2DoubleSortedMap {
		...
		public double lastDoubleValue() { synchronized(mutex) { return map.lastDoubleValue(); } }
		@Override
		public Short2DoubleSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractShort2DoubleMap implements Short2DoubleMap {
		...
		@Override
		public double supplyDoubleIfAbsent(short key, DoubleSupplier valueProvider) { synchronized(mutex) { return map.supplyDoubleIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Short2DoubleMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ShortSet keySet() {
			if(keys == null) keys = ShortSets.synchronize(map.keySet(), mutex);
			return keys;
