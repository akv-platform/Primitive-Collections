...
public class Short2BooleanMaps
{
	...
	public static class SynchronizedMap extends AbstractShort2BooleanMap implements Short2BooleanMap {
		...
		@Override
		public boolean computeBooleanIfAbsent(short key, Short2BooleanFunction mappingFunction) { synchronized(mutex) { return map.computeBooleanIfAbsent(key, mappingFunction); } }
		@Override
