...
public class Short2IntMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Short2IntMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Short2IntMap.Entry unmodifiable(Short2IntMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Short2IntMap.Entry unmodifiable(Map.Entry<Short, Integer> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class EmptyMap extends AbstractShort2IntMap {
		...
		@Override
		public int getOrDefault(short key, int defaultValue) { return defaultValue; }
		@Override
		public int computeInt(short key, ShortIntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public int computeIntIfAbsent(short key, Short2IntFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Short2IntNavigableMap {
		...
		@Override
		public Short2IntNavigableMap descendingMap() { return Short2IntMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Short2IntNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Short2IntOrderedMap {
		...
		public ObjectOrderedSet<Short2IntMap.Entry> short2IntEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.short2IntEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Short2IntSortedMap {
		...
		public int lastIntValue() { return map.lastIntValue(); }
		@Override
		public Short2IntSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractShort2IntMap implements Short2IntMap {
		...
		public void mergeAllInt(Short2IntMap m, IntIntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceInts(ShortIntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceInts(Short2IntMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Short2IntMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Short2IntMap.Entry>
	{
		ObjectOrderedSet<Short2IntMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Short2IntMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Short2IntMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Short2IntMap.Entry first() { return set.first(); }
		@Override
		public Short2IntMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Short2IntMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Short2IntNavigableMap {
		...
		@Override
		public Short2IntMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Short2IntNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Short2IntNavigableMap subMap(Short fromKey, boolean fromInclusive, Short toKey, boolean toInclusive) { synchronized(mutex) { return Short2IntMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Short2IntSortedMap {
		...
		public int lastIntValue() { synchronized(mutex) { return map.lastIntValue(); } }
		@Override
		public Short2IntSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractShort2IntMap implements Short2IntMap {
		...
		@Override
		public int supplyIntIfAbsent(short key, IntSupplier valueProvider) { synchronized(mutex) { return map.supplyIntIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Short2IntMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ShortSet keySet() {
			if(keys == null) keys = ShortSets.synchronize(map.keySet(), mutex);
			return keys;
