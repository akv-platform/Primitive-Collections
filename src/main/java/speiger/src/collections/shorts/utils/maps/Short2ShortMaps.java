...
public class Short2ShortMaps
{
	 ...
	 */
	public static Short2ShortMap.Entry unmodifiable(Short2ShortMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Short2ShortMap.Entry unmodifiable(Map.Entry<Short, Short> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class EmptyMap extends AbstractShort2ShortMap {
		...
		@Override
		public short getOrDefault(short key, short defaultValue) { return defaultValue; }
		@Override
		public short computeShort(short key, ShortShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public short computeShortIfAbsent(short key, Short2ShortFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Short2ShortNavigableMap {
		...
		@Override
		public Short2ShortNavigableMap descendingMap() { return Short2ShortMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Short2ShortNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Short2ShortOrderedMap {
		...
		@Override
		public Short2ShortOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.short2ShortEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Short2ShortSortedMap {
		...
		public short lastShortValue() { return map.lastShortValue(); }
		@Override
		public Short2ShortSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractShort2ShortMap implements Short2ShortMap {
		...
		public void mergeAllShort(Short2ShortMap m, ShortShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(ShortShortUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceShorts(Short2ShortMap m) { throw new UnsupportedOperationException(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Short2ShortMap.Entry>
	{
		ObjectOrderedSet<Short2ShortMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Short2ShortMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Short2ShortMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Short2ShortMap.Entry first() { return set.first(); }
		@Override
		public Short2ShortMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Short2ShortMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Short2ShortNavigableMap {
		...
		@Override
		public Short2ShortNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
		public Short2ShortNavigableMap subMap(Short fromKey, boolean fromInclusive, Short toKey, boolean toInclusive) { synchronized(mutex) { return Short2ShortMaps.synchronize(map.subMap(fromKey, fromInclusive, toKey, toInclusive), mutex); } }
		@Override
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Short2ShortOrderedMap {
		...
		@Override
		public Short2ShortOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ShortOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Short2ShortSortedMap {
		...
		public short lastShortValue() { synchronized(mutex) { return map.lastShortValue(); } }
		@Override
		public Short2ShortSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractShort2ShortMap implements Short2ShortMap {
		...
		@Override
		public short supplyShortIfAbsent(short key, ShortSupplier valueProvider) { synchronized(mutex) { return map.supplyShortIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Short2ShortMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public ShortSet keySet() {
			if(keys == null) keys = ShortSets.synchronize(map.keySet(), mutex);
			return keys;
