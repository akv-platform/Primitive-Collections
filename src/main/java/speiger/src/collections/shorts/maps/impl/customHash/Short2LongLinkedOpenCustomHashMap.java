 ...
 */
public class Short2LongLinkedOpenCustomHashMap extends Short2LongOpenCustomHashMap implements Short2LongOrderedMap
{
	 ...
	 */
	public Short2LongLinkedOpenCustomHashMap(ShortStrategy strategy) {
	 ...
	 */
	public Short2LongLinkedOpenCustomHashMap(int minCapacity, ShortStrategy strategy) {
	 ...
	 */
	public Short2LongLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ShortStrategy strategy) {
	 ...
	 */
	public Short2LongLinkedOpenCustomHashMap(Short[] keys, Long[] values, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2LongLinkedOpenCustomHashMap(Short[] keys, Long[] values, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Short2LongLinkedOpenCustomHashMap(Map<? extends Short, ? extends Long> map, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2LongLinkedOpenCustomHashMap(Map<? extends Short, ? extends Long> map, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Short2LongLinkedOpenCustomHashMap(Short2LongMap map, ShortStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2LongLinkedOpenCustomHashMap(Short2LongMap map, float loadFactor, ShortStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Short2LongLinkedOpenCustomHashMap copy() {
		Short2LongLinkedOpenCustomHashMap map = new Short2LongLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry> implements Short2LongOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2LongMap.Entry o) {
			return Short2LongLinkedOpenCustomHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2LongMap.Entry o) {
			return Short2LongLinkedOpenCustomHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2LongMap.Entry) {
					...
					int index = Short2LongLinkedOpenCustomHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getLongValue() == Short2LongLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Short)) return false;
					int index = Short2LongLinkedOpenCustomHashMap.this.findIndex((Short)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Short2LongLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2LongMap.Entry) {
					Short2LongMap.Entry entry = (Short2LongMap.Entry)o;
					return Short2LongLinkedOpenCustomHashMap.this.remove(entry.getShortKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2LongLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2LongLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2LongLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2LongLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2LongLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2LongLinkedOpenCustomHashMap.this.moveToLast(o);
		}
