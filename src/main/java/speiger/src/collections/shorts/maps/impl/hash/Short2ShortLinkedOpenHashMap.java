 ...
 */
public class Short2ShortLinkedOpenHashMap extends Short2ShortOpenHashMap implements Short2ShortOrderedMap
{
	 ...
	 */
	public Short2ShortLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2ShortLinkedOpenHashMap(Short[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ShortLinkedOpenHashMap(Short[] keys, Short[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ShortLinkedOpenHashMap(Map<? extends Short, ? extends Short> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2ShortLinkedOpenHashMap(Short2ShortMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2ShortLinkedOpenHashMap(Short2ShortMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Short2ShortLinkedOpenHashMap copy() {
		Short2ShortLinkedOpenHashMap map = new Short2ShortLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2ShortMap.Entry o) {
			return Short2ShortLinkedOpenHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2ShortMap.Entry o) {
			return Short2ShortLinkedOpenHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ShortMap.Entry) {
					...
					int index = Short2ShortLinkedOpenHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getShortValue() == Short2ShortLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Short2ShortLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Short2ShortLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ShortMap.Entry) {
					Short2ShortMap.Entry entry = (Short2ShortMap.Entry)o;
					return Short2ShortLinkedOpenHashMap.this.remove(entry.getShortKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2ShortLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2ShortLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2ShortLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2ShortLinkedOpenHashMap.this.moveToLast(o);
		}
