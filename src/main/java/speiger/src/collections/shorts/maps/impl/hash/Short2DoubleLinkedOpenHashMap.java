 ...
 */
public class Short2DoubleLinkedOpenHashMap extends Short2DoubleOpenHashMap implements Short2DoubleOrderedMap
{
	 ...
	 */
	public Short2DoubleLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2DoubleLinkedOpenHashMap(Short[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2DoubleLinkedOpenHashMap(Short[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2DoubleLinkedOpenHashMap(Map<? extends Short, ? extends Double> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2DoubleLinkedOpenHashMap(Short2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2DoubleLinkedOpenHashMap(Short2DoubleMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Short2DoubleLinkedOpenHashMap copy() {
		Short2DoubleLinkedOpenHashMap map = new Short2DoubleLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry> implements Short2DoubleOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2DoubleMap.Entry o) {
			return Short2DoubleLinkedOpenHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2DoubleMap.Entry o) {
			return Short2DoubleLinkedOpenHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2DoubleMap.Entry) {
					...
					int index = Short2DoubleLinkedOpenHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Short2DoubleLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Short2DoubleLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Short2DoubleLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2DoubleMap.Entry) {
					Short2DoubleMap.Entry entry = (Short2DoubleMap.Entry)o;
					return Short2DoubleLinkedOpenHashMap.this.remove(entry.getShortKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2DoubleLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2DoubleLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2DoubleLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2DoubleLinkedOpenHashMap.this.moveToLast(o);
		}
