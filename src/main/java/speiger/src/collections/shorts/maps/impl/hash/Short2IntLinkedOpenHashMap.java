 ...
 */
public class Short2IntLinkedOpenHashMap extends Short2IntOpenHashMap implements Short2IntOrderedMap
{
	 ...
	 */
	public Short2IntLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Short2IntLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2IntLinkedOpenHashMap(Short[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2IntLinkedOpenHashMap(Short[] keys, Integer[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Short2IntLinkedOpenHashMap(short[] keys, int[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2IntLinkedOpenHashMap(short[] keys, int[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2IntLinkedOpenHashMap(Map<? extends Short, ? extends Integer> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2IntLinkedOpenHashMap(Short2IntMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2IntLinkedOpenHashMap(Short2IntMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Short2IntLinkedOpenHashMap copy() {
		Short2IntLinkedOpenHashMap map = new Short2IntLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry> implements Short2IntOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2IntMap.Entry o) {
			return Short2IntLinkedOpenHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2IntMap.Entry o) {
			return Short2IntLinkedOpenHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2IntMap.Entry) {
					...
					int index = Short2IntLinkedOpenHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getIntValue() == Short2IntLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Short2IntLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(Short2IntLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2IntMap.Entry) {
					Short2IntMap.Entry entry = (Short2IntMap.Entry)o;
					return Short2IntLinkedOpenHashMap.this.remove(entry.getShortKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2IntLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2IntLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2IntLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2IntLinkedOpenHashMap.this.moveToLast(o);
		}
