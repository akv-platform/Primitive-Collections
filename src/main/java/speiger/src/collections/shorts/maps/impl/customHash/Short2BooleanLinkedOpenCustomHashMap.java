 ...
 */
public class Short2BooleanLinkedOpenCustomHashMap extends Short2BooleanOpenCustomHashMap implements Short2BooleanOrderedMap
{
	 ...
	 */
	public Short2BooleanLinkedOpenCustomHashMap(ShortStrategy strategy) {
	 ...
	 */
	public Short2BooleanLinkedOpenCustomHashMap(int minCapacity, ShortStrategy strategy) {
	 ...
	 */
	public Short2BooleanLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ShortStrategy strategy) {
	 ...
	 */
	public Short2BooleanLinkedOpenCustomHashMap(Short[] keys, Boolean[] values, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2BooleanLinkedOpenCustomHashMap(Short[] keys, Boolean[] values, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Short2BooleanLinkedOpenCustomHashMap(Map<? extends Short, ? extends Boolean> map, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2BooleanLinkedOpenCustomHashMap(Map<? extends Short, ? extends Boolean> map, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Short2BooleanLinkedOpenCustomHashMap(Short2BooleanMap map, ShortStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2BooleanLinkedOpenCustomHashMap(Short2BooleanMap map, float loadFactor, ShortStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Short2BooleanLinkedOpenCustomHashMap copy() {
		Short2BooleanLinkedOpenCustomHashMap map = new Short2BooleanLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2BooleanMap.Entry o) {
			return Short2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2BooleanMap.Entry o) {
			return Short2BooleanLinkedOpenCustomHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2BooleanMap.Entry) {
					...
					int index = Short2BooleanLinkedOpenCustomHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getBooleanValue() == Short2BooleanLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Short)) return false;
					int index = Short2BooleanLinkedOpenCustomHashMap.this.findIndex((Short)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Short2BooleanLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2BooleanMap.Entry) {
					Short2BooleanMap.Entry entry = (Short2BooleanMap.Entry)o;
					return Short2BooleanLinkedOpenCustomHashMap.this.remove(entry.getShortKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2BooleanLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2BooleanLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2BooleanLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2BooleanLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2BooleanLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Short2BooleanMap.Entry> {
		...
		@Override
		public void set(Short2BooleanMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Short2BooleanMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
