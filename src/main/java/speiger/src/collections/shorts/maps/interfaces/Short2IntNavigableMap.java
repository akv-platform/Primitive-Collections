 ...
 */
public interface Short2IntNavigableMap extends Short2IntSortedMap, NavigableMap<Short, Integer>
{
	@Override
	 ...
	 */
	public default Short2IntNavigableMap synchronize() { return Short2IntMaps.synchronize(this); }
	 ...
	 * @see Short2IntMaps#synchronize
	 */
	public default Short2IntNavigableMap synchronize(Object mutex) { return Short2IntMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Short2IntNavigableMap unmodifiable() { return Short2IntMaps.unmodifiable(this); }
	...
	@Override
	public default Short2IntNavigableMap subMap(short fromKey, short toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Short2IntNavigableMap headMap(short toKey) { return headMap(toKey, false); }
	@Override
	public default Short2IntNavigableMap tailMap(short fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Short2IntMap.Entry lowerEntry(Short key) { return lowerEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2IntMap.Entry floorEntry(Short key) { return floorEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2IntMap.Entry ceilingEntry(Short key) { return ceilingEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2IntMap.Entry higherEntry(Short key) { return higherEntry(key.shortValue()); }
	
	@Override
	@Deprecated
	default Short2IntNavigableMap subMap(Short fromKey, boolean fromInclusive, Short toKey, boolean toInclusive) { return subMap(fromKey.shortValue(), fromInclusive, toKey.shortValue(), toInclusive); }
	@Override
	@Deprecated
	default Short2IntNavigableMap headMap(Short toKey, boolean inclusive) { return headMap(toKey.shortValue(), inclusive); }
	@Override
	@Deprecated
	default Short2IntNavigableMap tailMap(Short fromKey, boolean inclusive) { return tailMap(fromKey.shortValue(), inclusive); }
	@Override
	@Deprecated
	default Short2IntNavigableMap subMap(Short fromKey, Short toKey) { return subMap(fromKey.shortValue(), true, toKey.shortValue(), false); }
	@Override
	@Deprecated
	default Short2IntNavigableMap headMap(Short toKey) { return headMap(toKey.shortValue(), false); }
	@Override
	@Deprecated
	default Short2IntNavigableMap tailMap(Short fromKey) { return tailMap(fromKey.shortValue(), true); }
}