 ...
 */
public class Short2ObjectLinkedOpenHashMap<V> extends Short2ObjectOpenHashMap<V> implements Short2ObjectOrderedMap<V>
{
	 ...
	 */
	public Short2ObjectLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Short2ObjectLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2ObjectLinkedOpenHashMap(Short[] keys, V[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ObjectLinkedOpenHashMap(Short[] keys, V[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ObjectLinkedOpenHashMap(Map<? extends Short, ? extends V> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2ObjectLinkedOpenHashMap(Short2ObjectMap<V> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2ObjectLinkedOpenHashMap(Short2ObjectMap<V> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Short2ObjectLinkedOpenHashMap<V> copy() {
		Short2ObjectLinkedOpenHashMap<V> map = new Short2ObjectLinkedOpenHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectOrderedMap.FastOrderedSet<V> {
		...
		public boolean moveToFirst(Short2ObjectMap.Entry<V> o) {
			return Short2ObjectLinkedOpenHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2ObjectMap.Entry<V> o) {
			return Short2ObjectLinkedOpenHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ObjectMap.Entry) {
					...
					int index = Short2ObjectLinkedOpenHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short2ObjectLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Short2ObjectLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short2ObjectLinkedOpenHashMap.this.values[index]);
				}
			}
			return false;
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ObjectMap.Entry) {
					Short2ObjectMap.Entry<V> entry = (Short2ObjectMap.Entry<V>)o;
					return Short2ObjectLinkedOpenHashMap.this.remove(entry.getShortKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2ObjectLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2ObjectLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2ObjectLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2ObjectLinkedOpenHashMap.this.moveToLast(o);
		}
