 ...
 */
public class Short2CharAVLTreeMap extends AbstractShort2CharMap implements Short2CharNavigableMap
{
	...
	/** EntrySet Cache */
	protected ObjectSet<Short2CharMap.Entry> entrySet;
	 ...
	 */
	public Short2CharAVLTreeMap(ShortComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Short2CharAVLTreeMap(Short[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Short2CharAVLTreeMap(Short[] keys, Character[] values, ShortComparator comp) {
		comparator = comp;
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Short2CharAVLTreeMap(short[] keys, char[] values) {
		this(keys, values, null);
	}
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Short2CharAVLTreeMap(short[] keys, char[] values, ShortComparator comp) {
		comparator = comp;
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Short2CharAVLTreeMap(Map<? extends Short, ? extends Character> map, ShortComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2CharAVLTreeMap(Short2CharMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Short2CharAVLTreeMap(Short2CharMap map, ShortComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Short2CharAVLTreeMap copy() {
		Short2CharAVLTreeMap set = new Short2CharAVLTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	@Override
	public Short2CharNavigableMap headMap(short toKey, boolean inclusive) {
		return new AscendingNaivgableSubMap(this, true, (short)0, true, false, toKey, inclusive);
	}
	
	@Override
	public Short2CharNavigableMap tailMap(short fromKey, boolean inclusive) {
	...
	@Override
	public Short2CharMap.Entry lowerEntry(short key) {
		Node node = findLowerNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Short2CharMap.Entry higherEntry(short key) {
		Node node = findHigherNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Short2CharMap.Entry floorEntry(short key) {
		Node node = findFloorNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Short2CharMap.Entry ceilingEntry(short key) {
	...
	static class KeySet extends AbstractShortSet implements ShortNavigableSet
	{
		...
		public KeySet(Short2CharNavigableMap map) {
			this.map = map;
		}
		...
		public Short lower(Short e) {
			Short2CharMap.Entry node = map.lowerEntry(e.shortValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Short floor(Short e) {
			Short2CharMap.Entry node = map.floorEntry(e.shortValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Short higher(Short e) {
			Short2CharMap.Entry node = map.higherEntry(e.shortValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Short ceiling(Short e) {
			Short2CharMap.Entry node = map.ceilingEntry(e.shortValue());
			return node != null ? node.getKey() : null;
		}
		...
		public ShortBidirectionalIterator iterator(short fromElement) {
			if(map instanceof Short2CharAVLTreeMap) return ((Short2CharAVLTreeMap)map).keyIterator(fromElement);
		...
		public ShortBidirectionalIterator iterator() {
			if(map instanceof Short2CharAVLTreeMap) return ((Short2CharAVLTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public ShortBidirectionalIterator descendingIterator() {
			if(map instanceof Short2CharAVLTreeMap) return ((Short2CharAVLTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Short2CharAVLTreeMap) return ((Short2CharAVLTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Short2CharAVLTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Short2CharAVLTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Short2CharAVLTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Short2CharAVLTreeMap map, boolean fromStart, short lo, boolean loInclusive, boolean toEnd, short hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Short2CharAVLTreeMap map, boolean fromStart, short lo, boolean loInclusive, boolean toEnd, short hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractShort2CharMap implements Short2CharNavigableMap
	{
		final Short2CharAVLTreeMap map;
		final short lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		
		Short2CharNavigableMap inverse;
		ShortNavigableSet keySet;
		ObjectSet<Short2CharMap.Entry> entrySet;
		CharCollection values;
		
		NavigableSubMap(Short2CharAVLTreeMap map, boolean fromStart, short lo, boolean loInclusive, boolean toEnd, short hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
		...
		@Override
		public Short2CharMap.Entry lowerEntry(short key) { return subLower(key); }
		@Override
		public Short2CharMap.Entry floorEntry(short key) { return subFloor(key); }
		@Override
		public Short2CharMap.Entry ceilingEntry(short key) { return subCeiling(key); }
		@Override
		public Short2CharMap.Entry higherEntry(short key) { return subHigher(key); }
		...
		public Short2CharMap.Entry pollFirstEntry() {
			Node entry = subLowest();
			if(entry != null) {
				Short2CharMap.Entry result = entry.export();
				map.removeNode(entry);
				return result;
			}
			return null;
		...
		abstract class SubEntrySet extends AbstractObjectSet<Short2CharMap.Entry> {
			@Override
			public int size() {
				if (fromStart && toEnd) return map.size();
				int size = 0;
				for(ObjectIterator<Short2CharMap.Entry> iter = iterator();iter.hasNext();iter.next(),size++);
				return size;
			}
		...
		class DecsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Short2CharMap.Entry>
		{
		...
		class AcsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Short2CharMap.Entry>
		{
	...
	class Values extends AbstractCharCollection
	{
		...
		@Override
		public int size() {
			return Short2CharAVLTreeMap.this.size;
		}
	...
	class EntrySet extends AbstractObjectSet<Short2CharMap.Entry> {
	...
	class AscendingMapEntryIterator extends MapEntryIterator implements ObjectBidirectionalIterator<Short2CharMap.Entry>
	{
	...
	private static final class Node implements Short2CharMap.Entry
	{
		short key;
		char value;
		int state;
		...
		Node(short key, char value, Node parent) {
			this.key = key;
			this.value = value;
			this.parent = parent;
		}
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				...
				return otherKey instanceof Short && otherValue instanceof Character && key == ((Short)otherKey).shortValue() && value == ((Character)otherValue).charValue();
			}
			return false;
		}
