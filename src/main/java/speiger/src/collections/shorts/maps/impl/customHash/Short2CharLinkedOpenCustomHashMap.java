 ...
 */
public class Short2CharLinkedOpenCustomHashMap extends Short2CharOpenCustomHashMap implements Short2CharOrderedMap
{
	 ...
	 */
	public Short2CharLinkedOpenCustomHashMap(ShortStrategy strategy) {
	 ...
	 */
	public Short2CharLinkedOpenCustomHashMap(int minCapacity, ShortStrategy strategy) {
	 ...
	 */
	public Short2CharLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ShortStrategy strategy) {
	 ...
	 */
	public Short2CharLinkedOpenCustomHashMap(Short[] keys, Character[] values, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2CharLinkedOpenCustomHashMap(Short[] keys, Character[] values, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Short2CharLinkedOpenCustomHashMap(short[] keys, char[] values, ShortStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2CharLinkedOpenCustomHashMap(short[] keys, char[] values, float loadFactor, ShortStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Short2CharLinkedOpenCustomHashMap(Map<? extends Short, ? extends Character> map, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2CharLinkedOpenCustomHashMap(Map<? extends Short, ? extends Character> map, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Short2CharLinkedOpenCustomHashMap(Short2CharMap map, ShortStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2CharLinkedOpenCustomHashMap(Short2CharMap map, float loadFactor, ShortStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Short2CharLinkedOpenCustomHashMap copy() {
		Short2CharLinkedOpenCustomHashMap map = new Short2CharLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2CharMap.Entry o) {
			return Short2CharLinkedOpenCustomHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2CharMap.Entry o) {
			return Short2CharLinkedOpenCustomHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2CharMap.Entry) {
					...
					int index = Short2CharLinkedOpenCustomHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getCharValue() == Short2CharLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Short)) return false;
					int index = Short2CharLinkedOpenCustomHashMap.this.findIndex((Short)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Short2CharLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2CharMap.Entry) {
					Short2CharMap.Entry entry = (Short2CharMap.Entry)o;
					return Short2CharLinkedOpenCustomHashMap.this.remove(entry.getShortKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2CharLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2CharLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2CharLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2CharLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2CharLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2CharLinkedOpenCustomHashMap.this.moveToLast(o);
		}
