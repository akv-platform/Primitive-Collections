...
import speiger.src.collections.shorts.maps.interfaces.Short2LongConcurrentMap;
 ...
 * 
 */
public class Short2LongConcurrentOpenHashMap extends AbstractShort2LongMap implements Short2LongConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Short2LongConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Short2LongConcurrentOpenHashMap() {
	 ...
	 */
	public Short2LongConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Short2LongConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2LongConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2LongConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2LongConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Short2LongConcurrentOpenHashMap(Short[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2LongConcurrentOpenHashMap(Short[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2LongConcurrentOpenHashMap(Short[] keys, Long[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2LongConcurrentOpenHashMap(Short[] keys, Long[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Short2LongConcurrentOpenHashMap(Map<? extends Short, ? extends Long> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2LongConcurrentOpenHashMap(Map<? extends Short, ? extends Long> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2LongConcurrentOpenHashMap(Map<? extends Short, ? extends Long> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2LongConcurrentOpenHashMap(Map<? extends Short, ? extends Long> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2LongConcurrentOpenHashMap(Short2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2LongConcurrentOpenHashMap(Short2LongMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2LongConcurrentOpenHashMap(Short2LongMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2LongConcurrentOpenHashMap(Short2LongMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Short2LongConcurrentOpenHashMap copy() {
		Short2LongConcurrentOpenHashMap copy = new Short2LongConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry> implements Short2LongMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2LongMap.Entry) {
					Short2LongMap.Entry entry = (Short2LongMap.Entry)o;
					return Short2LongConcurrentOpenHashMap.this.remove(entry.getShortKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2LongConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2LongConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2LongConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortSet {
		...
		public boolean remove(short o) {
			int oldSize = size();
			Short2LongConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2LongMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2LongMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Short2LongMap.Entry, Map.Entry<Short, Long> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Short2LongMap.Entry) {
					...
					return getShortKey() == entry.getShortKey() && getLongValue() == entry.getLongValue();
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Short && value instanceof Long && getShortKey() == ((Short)key).shortValue() && getLongValue() == ((Long)value).longValue();
			}
			return false;
		}
		...
		public String toString() {
			return Short.toString(getShortKey()) + "=" + Long.toString(getLongValue());
		}
	}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Short2LongConcurrentOpenHashMap map;
		...
		protected Segment(Short2LongConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Short2LongConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Short2LongConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected long put(int hash, short key, long value) {
		...
		protected long putIfAbsent(int hash, short key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected long addTo(int hash, short key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected long subFrom(int hash, short key, long value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected long get(int hash, short key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected long getOrDefault(int hash, short key, long defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ShortLongConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected long remove(int hash, short key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected long removeOrDefault(int hash, short key, long defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, short key, long value) {
			long stamp = writeLock();
			try {
				if(key == (short)0) {
		...
		protected boolean replace(int hash, short key, long oldValue, long newValue) {
			long stamp = writeLock();
			try {
		...
		protected long replace(int hash, short key, long value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected long compute(int hash, short key, ShortLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long computeIfAbsent(int hash, short key, Short2LongFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long supplyIfAbsent(int hash, short key, LongSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected long computeIfPresent(int hash, short key, ShortLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected long merge(int hash, short key, long value, LongLongUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
