 ...
 */
public class Short2BooleanLinkedOpenHashMap extends Short2BooleanOpenHashMap implements Short2BooleanOrderedMap
{
	 ...
	 */
	public Short2BooleanLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2BooleanLinkedOpenHashMap(Short[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2BooleanLinkedOpenHashMap(Short[] keys, Boolean[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2BooleanLinkedOpenHashMap(Map<? extends Short, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2BooleanLinkedOpenHashMap(Short2BooleanMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2BooleanLinkedOpenHashMap(Short2BooleanMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Short2BooleanLinkedOpenHashMap copy() {
		Short2BooleanLinkedOpenHashMap map = new Short2BooleanLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2BooleanMap.Entry o) {
			return Short2BooleanLinkedOpenHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2BooleanMap.Entry o) {
			return Short2BooleanLinkedOpenHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2BooleanMap.Entry) {
					...
					int index = Short2BooleanLinkedOpenHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getBooleanValue() == Short2BooleanLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Short2BooleanLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Short2BooleanLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2BooleanMap.Entry) {
					Short2BooleanMap.Entry entry = (Short2BooleanMap.Entry)o;
					return Short2BooleanLinkedOpenHashMap.this.remove(entry.getShortKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2BooleanLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2BooleanLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2BooleanLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2BooleanLinkedOpenHashMap.this.moveToLast(o);
		}
