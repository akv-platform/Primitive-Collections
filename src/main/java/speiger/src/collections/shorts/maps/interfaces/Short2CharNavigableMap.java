 ...
 */
public interface Short2CharNavigableMap extends Short2CharSortedMap, NavigableMap<Short, Character>
{
	@Override
	 ...
	 */
	public default Short2CharNavigableMap synchronize() { return Short2CharMaps.synchronize(this); }
	 ...
	 * @see Short2CharMaps#synchronize
	 */
	public default Short2CharNavigableMap synchronize(Object mutex) { return Short2CharMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Short2CharNavigableMap unmodifiable() { return Short2CharMaps.unmodifiable(this); }
	...
	@Override
	public default Short2CharNavigableMap subMap(short fromKey, short toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Short2CharNavigableMap headMap(short toKey) { return headMap(toKey, false); }
	@Override
	public default Short2CharNavigableMap tailMap(short fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Short2CharMap.Entry lowerEntry(Short key) { return lowerEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2CharMap.Entry floorEntry(Short key) { return floorEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2CharMap.Entry ceilingEntry(Short key) { return ceilingEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2CharMap.Entry higherEntry(Short key) { return higherEntry(key.shortValue()); }
	
	@Override
	@Deprecated
	default Short2CharNavigableMap subMap(Short fromKey, boolean fromInclusive, Short toKey, boolean toInclusive) { return subMap(fromKey.shortValue(), fromInclusive, toKey.shortValue(), toInclusive); }
	@Override
	@Deprecated
	default Short2CharNavigableMap headMap(Short toKey, boolean inclusive) { return headMap(toKey.shortValue(), inclusive); }
	@Override
	@Deprecated
	default Short2CharNavigableMap tailMap(Short fromKey, boolean inclusive) { return tailMap(fromKey.shortValue(), inclusive); }
	@Override
	@Deprecated
	default Short2CharNavigableMap subMap(Short fromKey, Short toKey) { return subMap(fromKey.shortValue(), true, toKey.shortValue(), false); }
	@Override
	@Deprecated
	default Short2CharNavigableMap headMap(Short toKey) { return headMap(toKey.shortValue(), false); }
	@Override
	@Deprecated
	default Short2CharNavigableMap tailMap(Short fromKey) { return tailMap(fromKey.shortValue(), true); }
}