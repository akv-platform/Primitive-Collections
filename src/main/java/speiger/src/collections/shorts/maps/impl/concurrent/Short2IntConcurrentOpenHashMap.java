...
import speiger.src.collections.shorts.maps.interfaces.Short2IntConcurrentMap;
 ...
 * 
 */
public class Short2IntConcurrentOpenHashMap extends AbstractShort2IntMap implements Short2IntConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Short2IntConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Short2IntConcurrentOpenHashMap() {
	 ...
	 */
	public Short2IntConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Short2IntConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2IntConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2IntConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2IntConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Short2IntConcurrentOpenHashMap(Short[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2IntConcurrentOpenHashMap(Short[] keys, Integer[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2IntConcurrentOpenHashMap(Short[] keys, Integer[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2IntConcurrentOpenHashMap(Short[] keys, Integer[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Short2IntConcurrentOpenHashMap(short[] keys, int[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2IntConcurrentOpenHashMap(short[] keys, int[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2IntConcurrentOpenHashMap(short[] keys, int[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2IntConcurrentOpenHashMap(short[] keys, int[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Short2IntConcurrentOpenHashMap(Map<? extends Short, ? extends Integer> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2IntConcurrentOpenHashMap(Map<? extends Short, ? extends Integer> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2IntConcurrentOpenHashMap(Map<? extends Short, ? extends Integer> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2IntConcurrentOpenHashMap(Map<? extends Short, ? extends Integer> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2IntConcurrentOpenHashMap(Short2IntMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2IntConcurrentOpenHashMap(Short2IntMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2IntConcurrentOpenHashMap(Short2IntMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2IntConcurrentOpenHashMap(Short2IntMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Short2IntConcurrentOpenHashMap copy() {
		Short2IntConcurrentOpenHashMap copy = new Short2IntConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry> implements Short2IntMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2IntMap.Entry) {
					Short2IntMap.Entry entry = (Short2IntMap.Entry)o;
					return Short2IntConcurrentOpenHashMap.this.remove(entry.getShortKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2IntConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2IntConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2IntConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortSet {
		...
		public boolean remove(short o) {
			int oldSize = size();
			Short2IntConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2IntMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2IntMap.Entry> {
		MapEntry entry;
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Short2IntConcurrentOpenHashMap map;
		...
		protected Segment(Short2IntConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Short2IntConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Short2IntConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected int put(int hash, short key, int value) {
		...
		protected int putIfAbsent(int hash, short key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected int addTo(int hash, short key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected int subFrom(int hash, short key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected int get(int hash, short key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected int getOrDefault(int hash, short key, int defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ShortIntConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected int remove(int hash, short key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected int removeOrDefault(int hash, short key, int defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, short key, int value) {
			long stamp = writeLock();
			try {
				if(key == (short)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				short current = keys[pos];
				if(current == (short)0) return false;
				if(Objects.equals(key, Short.valueOf(current)) && Objects.equals(value, Integer.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (short)0) return false;
					else if(Objects.equals(key, Short.valueOf(current)) && Objects.equals(value, Integer.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, short key, int oldValue, int newValue) {
			long stamp = writeLock();
			try {
		...
		protected int replace(int hash, short key, int value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected int compute(int hash, short key, ShortIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int computeIfAbsent(int hash, short key, Short2IntFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int supplyIfAbsent(int hash, short key, IntSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int computeIfPresent(int hash, short key, ShortIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected int merge(int hash, short key, int value, IntIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
