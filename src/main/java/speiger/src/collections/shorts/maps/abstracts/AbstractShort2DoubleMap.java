...
public abstract class AbstractShort2DoubleMap extends AbstractMap<Short, Double> implements Short2DoubleMap
{
	...
	public void putAll(Short2DoubleMap m) {
		for(ObjectIterator<Short2DoubleMap.Entry> iter = Short2DoubleMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceDoubles(ShortDoubleUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Short2DoubleMap.Entry> iter = Short2DoubleMaps.fastIterator(this);iter.hasNext();) {
			Short2DoubleMap.Entry entry = iter.next();
		...
		return new AbstractShortSet() {
			...
			public ShortIterator iterator() {
				return new ShortIterator() {
					ObjectIterator<Short2DoubleMap.Entry> iter = Short2DoubleMaps.fastIterator(AbstractShort2DoubleMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Short2DoubleMap.Entry> iter = Short2DoubleMaps.fastIterator(this);
