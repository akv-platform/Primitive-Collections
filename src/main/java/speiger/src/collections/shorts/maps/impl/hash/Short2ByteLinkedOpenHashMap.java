 ...
 */
public class Short2ByteLinkedOpenHashMap extends Short2ByteOpenHashMap implements Short2ByteOrderedMap
{
	 ...
	 */
	public Short2ByteLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Short2ByteLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2ByteLinkedOpenHashMap(Short[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ByteLinkedOpenHashMap(Short[] keys, Byte[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ByteLinkedOpenHashMap(Map<? extends Short, ? extends Byte> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2ByteLinkedOpenHashMap(Short2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2ByteLinkedOpenHashMap(Short2ByteMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Short2ByteLinkedOpenHashMap copy() {
		Short2ByteLinkedOpenHashMap map = new Short2ByteLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ByteMap.Entry> implements Short2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2ByteMap.Entry o) {
			return Short2ByteLinkedOpenHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2ByteMap.Entry o) {
			return Short2ByteLinkedOpenHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ByteMap.Entry) {
					...
					int index = Short2ByteLinkedOpenHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getByteValue() == Short2ByteLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Short2ByteLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Short2ByteLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ByteMap.Entry) {
					Short2ByteMap.Entry entry = (Short2ByteMap.Entry)o;
					return Short2ByteLinkedOpenHashMap.this.remove(entry.getShortKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2ByteLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2ByteLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2ByteLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2ByteLinkedOpenHashMap.this.moveToLast(o);
		}
