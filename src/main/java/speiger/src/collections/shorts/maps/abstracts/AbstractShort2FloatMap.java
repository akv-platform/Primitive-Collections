...
public abstract class AbstractShort2FloatMap extends AbstractMap<Short, Float> implements Short2FloatMap
{
	...
	public void putAll(Short2FloatMap m) {
		for(ObjectIterator<Short2FloatMap.Entry> iter = Short2FloatMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceFloats(ShortFloatUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Short2FloatMap.Entry> iter = Short2FloatMaps.fastIterator(this);iter.hasNext();) {
			Short2FloatMap.Entry entry = iter.next();
		...
		return new AbstractShortSet() {
			...
			public ShortIterator iterator() {
				return new ShortIterator() {
					ObjectIterator<Short2FloatMap.Entry> iter = Short2FloatMaps.fastIterator(AbstractShort2FloatMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Short2FloatMap.Entry> iter = Short2FloatMaps.fastIterator(this);
