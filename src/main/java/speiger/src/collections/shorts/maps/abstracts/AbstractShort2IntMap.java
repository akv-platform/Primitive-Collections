...
public abstract class AbstractShort2IntMap extends AbstractMap<Short, Integer> implements Short2IntMap
{
	...
	public void putAll(Short2IntMap m) {
		for(ObjectIterator<Short2IntMap.Entry> iter = Short2IntMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceInts(ShortIntUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Short2IntMap.Entry> iter = Short2IntMaps.fastIterator(this);iter.hasNext();) {
			Short2IntMap.Entry entry = iter.next();
		...
		return new AbstractShortSet() {
			...
			public ShortIterator iterator() {
				return new ShortIterator() {
					ObjectIterator<Short2IntMap.Entry> iter = Short2IntMaps.fastIterator(AbstractShort2IntMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Short2IntMap.Entry> iter = Short2IntMaps.fastIterator(this);
