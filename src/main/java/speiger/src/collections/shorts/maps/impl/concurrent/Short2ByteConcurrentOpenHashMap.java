...
import speiger.src.collections.shorts.maps.interfaces.Short2ByteConcurrentMap;
 ...
 * 
 */
public class Short2ByteConcurrentOpenHashMap extends AbstractShort2ByteMap implements Short2ByteConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Short2ByteConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Short2ByteConcurrentOpenHashMap() {
	 ...
	 */
	public Short2ByteConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Short2ByteConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2ByteConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ByteConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ByteConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Short2ByteConcurrentOpenHashMap(Short[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ByteConcurrentOpenHashMap(Short[] keys, Byte[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ByteConcurrentOpenHashMap(Short[] keys, Byte[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ByteConcurrentOpenHashMap(Short[] keys, Byte[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Short2ByteConcurrentOpenHashMap(Map<? extends Short, ? extends Byte> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ByteConcurrentOpenHashMap(Map<? extends Short, ? extends Byte> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ByteConcurrentOpenHashMap(Map<? extends Short, ? extends Byte> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ByteConcurrentOpenHashMap(Map<? extends Short, ? extends Byte> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2ByteConcurrentOpenHashMap(Short2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2ByteConcurrentOpenHashMap(Short2ByteMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2ByteConcurrentOpenHashMap(Short2ByteMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2ByteConcurrentOpenHashMap(Short2ByteMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Short2ByteConcurrentOpenHashMap copy() {
		Short2ByteConcurrentOpenHashMap copy = new Short2ByteConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ByteMap.Entry> implements Short2ByteMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ByteMap.Entry) {
					Short2ByteMap.Entry entry = (Short2ByteMap.Entry)o;
					return Short2ByteConcurrentOpenHashMap.this.remove(entry.getShortKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2ByteConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2ByteConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2ByteConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortSet {
		...
		public boolean remove(short o) {
			int oldSize = size();
			Short2ByteConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2ByteMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2ByteMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Short2ByteMap.Entry, Map.Entry<Short, Byte> {
		...
		@Override
		public int hashCode() {
			return Short.hashCode(getShortKey()) ^ Byte.hashCode(getByteValue());
		}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Short2ByteConcurrentOpenHashMap map;
		...
		protected Segment(Short2ByteConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Short2ByteConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Short2ByteConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected byte put(int hash, short key, byte value) {
		...
		protected byte putIfAbsent(int hash, short key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected byte addTo(int hash, short key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected byte subFrom(int hash, short key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected byte get(int hash, short key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected byte getOrDefault(int hash, short key, byte defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ShortByteConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected byte remove(int hash, short key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected byte removeOrDefault(int hash, short key, byte defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, short key, byte value) {
			long stamp = writeLock();
			try {
				if(key == (short)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				short current = keys[pos];
				if(current == (short)0) return false;
				if(Objects.equals(key, Short.valueOf(current)) && Objects.equals(value, Byte.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (short)0) return false;
					else if(Objects.equals(key, Short.valueOf(current)) && Objects.equals(value, Byte.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, short key, byte oldValue, byte newValue) {
			long stamp = writeLock();
			try {
		...
		protected byte replace(int hash, short key, byte value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected byte compute(int hash, short key, ShortByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected byte computeIfAbsent(int hash, short key, Short2ByteFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected byte supplyIfAbsent(int hash, short key, ByteSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected byte computeIfPresent(int hash, short key, ShortByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected byte merge(int hash, short key, byte value, ByteByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
