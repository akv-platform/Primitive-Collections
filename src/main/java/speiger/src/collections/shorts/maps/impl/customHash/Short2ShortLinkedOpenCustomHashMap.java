 ...
 */
public class Short2ShortLinkedOpenCustomHashMap extends Short2ShortOpenCustomHashMap implements Short2ShortOrderedMap
{
	 ...
	 */
	public Short2ShortLinkedOpenCustomHashMap(ShortStrategy strategy) {
	 ...
	 */
	public Short2ShortLinkedOpenCustomHashMap(int minCapacity, ShortStrategy strategy) {
	 ...
	 */
	public Short2ShortLinkedOpenCustomHashMap(int minCapacity, float loadFactor, ShortStrategy strategy) {
	 ...
	 */
	public Short2ShortLinkedOpenCustomHashMap(Short[] keys, Short[] values, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ShortLinkedOpenCustomHashMap(Short[] keys, Short[] values, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Short2ShortLinkedOpenCustomHashMap(Map<? extends Short, ? extends Short> map, ShortStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ShortLinkedOpenCustomHashMap(Map<? extends Short, ? extends Short> map, float loadFactor, ShortStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Short2ShortLinkedOpenCustomHashMap(Short2ShortMap map, ShortStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2ShortLinkedOpenCustomHashMap(Short2ShortMap map, float loadFactor, ShortStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Short2ShortLinkedOpenCustomHashMap copy() {
		Short2ShortLinkedOpenCustomHashMap map = new Short2ShortLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	public ObjectOrderedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
		...
		return (ObjectOrderedSet<Short2ShortMap.Entry>)entrySet;
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Short2ShortMap.Entry o) {
			return Short2ShortLinkedOpenCustomHashMap.this.moveToFirst(o.getShortKey());
		}
		
		@Override
		public boolean moveToLast(Short2ShortMap.Entry o) {
			return Short2ShortLinkedOpenCustomHashMap.this.moveToLast(o.getShortKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ShortMap.Entry) {
					...
					int index = Short2ShortLinkedOpenCustomHashMap.this.findIndex(entry.getShortKey());
					if(index >= 0) return entry.getShortValue() == Short2ShortLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Short)) return false;
					int index = Short2ShortLinkedOpenCustomHashMap.this.findIndex((Short)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Short2ShortLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ShortMap.Entry) {
					Short2ShortMap.Entry entry = (Short2ShortMap.Entry)o;
					return Short2ShortLinkedOpenCustomHashMap.this.remove(entry.getShortKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2ShortLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2ShortLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2ShortLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortOrderedSet {
		...
		public boolean remove(short o) {
			int oldSize = size;
			Short2ShortLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(short o) {
			return Short2ShortLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(short o) {
			return Short2ShortLinkedOpenCustomHashMap.this.moveToLast(o);
		}
