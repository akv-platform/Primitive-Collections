 ...
 */
public class Short2LongRBTreeMap extends AbstractShort2LongMap implements Short2LongNavigableMap
{
	...
	/** EntrySet Cache */
	protected ObjectSet<Short2LongMap.Entry> entrySet;
	 ...
	 */
	public Short2LongRBTreeMap(ShortComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Short2LongRBTreeMap(Short[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Short2LongRBTreeMap(Short[] keys, Long[] values, ShortComparator comp) {
		comparator = comp;
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Short2LongRBTreeMap(Map<? extends Short, ? extends Long> map, ShortComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2LongRBTreeMap(Short2LongMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Short2LongRBTreeMap(Short2LongMap map, ShortComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Short2LongRBTreeMap copy() {
		Short2LongRBTreeMap set = new Short2LongRBTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	static class KeySet extends AbstractShortSet implements ShortNavigableSet
	{
		...
		public KeySet(Short2LongNavigableMap map) {
			this.map = map;
		}
		...
		public Short lower(Short e) {
			Short2LongMap.Entry node = map.lowerEntry(e.shortValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Short floor(Short e) {
			Short2LongMap.Entry node = map.floorEntry(e.shortValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Short higher(Short e) {
			Short2LongMap.Entry node = map.higherEntry(e.shortValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Short ceiling(Short e) {
			Short2LongMap.Entry node = map.ceilingEntry(e.shortValue());
			return node != null ? node.getKey() : null;
		}
		...
		public ShortBidirectionalIterator iterator(short fromElement) {
			if(map instanceof Short2LongRBTreeMap) return ((Short2LongRBTreeMap)map).keyIterator(fromElement);
		...
		public ShortBidirectionalIterator iterator() {
			if(map instanceof Short2LongRBTreeMap) return ((Short2LongRBTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public ShortBidirectionalIterator descendingIterator() {
			if(map instanceof Short2LongRBTreeMap) return ((Short2LongRBTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Short2LongRBTreeMap) return ((Short2LongRBTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Short2LongRBTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Short2LongRBTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Short2LongRBTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Short2LongRBTreeMap map, boolean fromStart, short lo, boolean loInclusive, boolean toEnd, short hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Short2LongRBTreeMap map, boolean fromStart, short lo, boolean loInclusive, boolean toEnd, short hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractShort2LongMap implements Short2LongNavigableMap
	{
		final Short2LongRBTreeMap map;
		final short lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		
		Short2LongNavigableMap inverse;
		ShortNavigableSet keySet;
		ObjectSet<Short2LongMap.Entry> entrySet;
		LongCollection values;
		
		NavigableSubMap(Short2LongRBTreeMap map, boolean fromStart, short lo, boolean loInclusive, boolean toEnd, short hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
		...
		@Override
		public Short2LongMap.Entry lowerEntry(short key) { return subLower(key); }
		@Override
		public Short2LongMap.Entry floorEntry(short key) { return subFloor(key); }
		@Override
		public Short2LongMap.Entry ceilingEntry(short key) { return subCeiling(key); }
		@Override
		public Short2LongMap.Entry higherEntry(short key) { return subHigher(key); }
		...
		@Override
		public Short2LongNavigableMap copy() { throw new UnsupportedOperationException(); }
		...
		public Short2LongMap.Entry pollFirstEntry() {
			Node entry = subLowest();
			if(entry != null) {
				Short2LongMap.Entry result = entry.export();
				map.removeNode(entry);
				return result;
			}
			return null;
		...
		abstract class SubEntrySet extends AbstractObjectSet<Short2LongMap.Entry> {
			@Override
			public int size() {
				if (fromStart && toEnd) return map.size();
				int size = 0;
				for(ObjectIterator<Short2LongMap.Entry> iter = iterator();iter.hasNext();iter.next(),size++);
				return size;
			}
		...
		class DecsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Short2LongMap.Entry>
		{
		...
		class AcsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Short2LongMap.Entry>
		{
	...
	class Values extends AbstractLongCollection
	{
		...
		@Override
		public int size() {
			return Short2LongRBTreeMap.this.size;
		}
	...
	class EntrySet extends AbstractObjectSet<Short2LongMap.Entry> {
	...
	class AscendingMapEntryIterator extends MapEntryIterator implements ObjectBidirectionalIterator<Short2LongMap.Entry>
	{
	...
	private static final class Node implements Short2LongMap.Entry
	{
		...
		Node(short key, long value, Node parent) {
			this.key = key;
			this.value = value;
			this.parent = parent;
		}
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				...
				return otherKey instanceof Short && otherValue instanceof Long && key == ((Short)otherKey).shortValue() && value == ((Long)otherValue).longValue();
			}
			return false;
		}
