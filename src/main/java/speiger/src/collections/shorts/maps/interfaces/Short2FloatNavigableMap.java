 ...
 */
public interface Short2FloatNavigableMap extends Short2FloatSortedMap, NavigableMap<Short, Float>
{
	@Override
	 ...
	 */
	public default Short2FloatNavigableMap synchronize() { return Short2FloatMaps.synchronize(this); }
	 ...
	 * @see Short2FloatMaps#synchronize
	 */
	public default Short2FloatNavigableMap synchronize(Object mutex) { return Short2FloatMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Short2FloatNavigableMap unmodifiable() { return Short2FloatMaps.unmodifiable(this); }
	...
	@Override
	public default Short2FloatNavigableMap subMap(short fromKey, short toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Short2FloatNavigableMap headMap(short toKey) { return headMap(toKey, false); }
	@Override
	public default Short2FloatNavigableMap tailMap(short fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Short2FloatMap.Entry lowerEntry(Short key) { return lowerEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2FloatMap.Entry floorEntry(Short key) { return floorEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2FloatMap.Entry ceilingEntry(Short key) { return ceilingEntry(key.shortValue()); }
	@Override
	@Deprecated
	default Short2FloatMap.Entry higherEntry(Short key) { return higherEntry(key.shortValue()); }
	
	@Override
	@Deprecated
	default Short2FloatNavigableMap subMap(Short fromKey, boolean fromInclusive, Short toKey, boolean toInclusive) { return subMap(fromKey.shortValue(), fromInclusive, toKey.shortValue(), toInclusive); }
	@Override
	@Deprecated
	default Short2FloatNavigableMap headMap(Short toKey, boolean inclusive) { return headMap(toKey.shortValue(), inclusive); }
	@Override
	@Deprecated
	default Short2FloatNavigableMap tailMap(Short fromKey, boolean inclusive) { return tailMap(fromKey.shortValue(), inclusive); }
	@Override
	@Deprecated
	default Short2FloatNavigableMap subMap(Short fromKey, Short toKey) { return subMap(fromKey.shortValue(), true, toKey.shortValue(), false); }
	@Override
	@Deprecated
	default Short2FloatNavigableMap headMap(Short toKey) { return headMap(toKey.shortValue(), false); }
	@Override
	@Deprecated
	default Short2FloatNavigableMap tailMap(Short fromKey) { return tailMap(fromKey.shortValue(), true); }
}