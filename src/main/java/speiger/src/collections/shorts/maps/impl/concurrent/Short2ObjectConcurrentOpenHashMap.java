...
import speiger.src.collections.shorts.maps.interfaces.Short2ObjectConcurrentMap;
 ...
 */
public class Short2ObjectConcurrentOpenHashMap<V> extends AbstractShort2ObjectMap<V> implements Short2ObjectConcurrentMap<V>, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Short2ObjectConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Short2ObjectConcurrentOpenHashMap() {
	 ...
	 */
	public Short2ObjectConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Short2ObjectConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Short2ObjectConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ObjectConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ObjectConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Short2ObjectConcurrentOpenHashMap(Short[] keys, V[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ObjectConcurrentOpenHashMap(Short[] keys, V[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ObjectConcurrentOpenHashMap(Short[] keys, V[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ObjectConcurrentOpenHashMap(Short[] keys, V[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Short2ObjectConcurrentOpenHashMap(Map<? extends Short, ? extends V> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Short2ObjectConcurrentOpenHashMap(Map<? extends Short, ? extends V> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ObjectConcurrentOpenHashMap(Map<? extends Short, ? extends V> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Short2ObjectConcurrentOpenHashMap(Map<? extends Short, ? extends V> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Short2ObjectConcurrentOpenHashMap(Short2ObjectMap<V> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Short2ObjectConcurrentOpenHashMap(Short2ObjectMap<V> map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2ObjectConcurrentOpenHashMap(Short2ObjectMap<V> map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Short2ObjectConcurrentOpenHashMap(Short2ObjectMap<V> map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Short2ObjectConcurrentOpenHashMap<V> copy() {
		Short2ObjectConcurrentOpenHashMap<V> copy = new Short2ObjectConcurrentOpenHashMap<>(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectMap.FastEntrySet<V> {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Short2ObjectMap.Entry) {
					Short2ObjectMap.Entry<V> entry = (Short2ObjectMap.Entry<V>)o;
					return Short2ObjectConcurrentOpenHashMap.this.remove(entry.getShortKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Short2ObjectConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Short2ObjectConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Short2ObjectConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractShortSet implements ShortSet {
		...
		public boolean remove(short o) {
			int oldSize = size();
			Short2ObjectConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> {
		MapEntry entry;
	...
	protected class MapEntry implements Short2ObjectMap.Entry<V>, Map.Entry<Short, V> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Short2ObjectMap.Entry) {
					...
					return getShortKey() == entry.getShortKey() && Objects.equals(getValue(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Short && getShortKey() == ((Short)key).shortValue() && Objects.equals(getValue(), value);
			}
			return false;
		}
		...
		public String toString() {
			return Short.toString(getShortKey()) + "=" + Objects.toString(getValue());
		}
	}
	...
	protected static class Segment<V> extends StampedLock
	{
		...
		protected final Short2ObjectConcurrentOpenHashMap<V> map;
		...
		protected Segment(Short2ObjectConcurrentOpenHashMap<V> map) {
			this.map = map;
		}
		
		protected Segment(Short2ObjectConcurrentOpenHashMap<V> map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment<V> copy(Short2ObjectConcurrentOpenHashMap<V> newMap) {
			long stamp = readLock();
			try
			{
		...
		protected V put(int hash, short key, V value) {
		...
		protected V putIfAbsent(int hash, short key, V value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected V get(int hash, short key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected V getOrDefault(int hash, short key, V defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(ShortObjectConsumer<V> action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected V remove(int hash, short key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected V removeOrDefault(int hash, short key, V defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, short key, V value) {
			long stamp = writeLock();
			try {
				if(key == (short)0) {
		...
		protected boolean replace(int hash, short key, V oldValue, V newValue) {
			long stamp = writeLock();
			try {
		...
		protected V replace(int hash, short key, V value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected V compute(int hash, short key, ShortObjectUnaryOperator<V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected V computeIfAbsent(int hash, short key, Short2ObjectFunction<V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected V supplyIfAbsent(int hash, short key, ObjectSupplier<V> valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected V computeIfPresent(int hash, short key, ShortObjectUnaryOperator<V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected V merge(int hash, short key, V value, ObjectObjectUnaryOperator<V, V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
