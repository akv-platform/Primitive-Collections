...
public abstract class AbstractShort2ShortMap extends AbstractMap<Short, Short> implements Short2ShortMap
{
	...
	public void putAll(Short2ShortMap m) {
		for(ObjectIterator<Short2ShortMap.Entry> iter = Short2ShortMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceShorts(ShortShortUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Short2ShortMap.Entry> iter = Short2ShortMaps.fastIterator(this);iter.hasNext();) {
			Short2ShortMap.Entry entry = iter.next();
		...
		return new AbstractShortSet() {
			...
			public ShortIterator iterator() {
				return new ShortIterator() {
					ObjectIterator<Short2ShortMap.Entry> iter = Short2ShortMaps.fastIterator(AbstractShort2ShortMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Short2ShortMap.Entry> iter = Short2ShortMaps.fastIterator(this);
