...
public abstract class AbstractShort2BooleanMap extends AbstractMap<Short, Boolean> implements Short2BooleanMap
{
	...
	public void putAll(Short2BooleanMap m) {
		for(ObjectIterator<Short2BooleanMap.Entry> iter = Short2BooleanMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBooleans(ShortBooleanUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Short2BooleanMap.Entry> iter = Short2BooleanMaps.fastIterator(this);iter.hasNext();) {
			Short2BooleanMap.Entry entry = iter.next();
		...
		return new AbstractShortSet() {
			...
			public ShortIterator iterator() {
				return new ShortIterator() {
					ObjectIterator<Short2BooleanMap.Entry> iter = Short2BooleanMaps.fastIterator(AbstractShort2BooleanMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Short2BooleanMap.Entry> iter = Short2BooleanMaps.fastIterator(this);
