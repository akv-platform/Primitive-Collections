...
public class DoubleLinkedOpenHashSet extends DoubleOpenHashSet implements DoubleOrderedSet
{
	 ...
	 */
	@Deprecated
	public DoubleLinkedOpenHashSet(Collection<? extends Double> collection, float loadFactor) {
	...
	public boolean addAndMoveToFirst(double o) {
		if(Double.doubleToLongBits(o) == 0) {
			...
			while(Double.doubleToLongBits(keys[pos]) != 0) {
				if(Double.doubleToLongBits(keys[pos]) == Double.doubleToLongBits(o)) {
	...
	public boolean moveToFirst(double o) {
		if(isEmpty() || Double.doubleToLongBits(firstDouble()) == Double.doubleToLongBits(o)) return false;
		if(Double.doubleToLongBits(o) == 0) {
			if(containsNull) {
				moveToFirstIndex(nullIndex);
				return true;
	...
	public boolean moveToLast(double o) {
		if(isEmpty() || Double.doubleToLongBits(lastDouble()) == Double.doubleToLongBits(o)) return false;
		if(Double.doubleToLongBits(o) == 0) {
			if(containsNull) {
				moveToLastIndex(nullIndex);
				return true;
	...
	@Override
	public DoubleLinkedOpenHashSet copy() {
		DoubleLinkedOpenHashSet set = new DoubleLinkedOpenHashSet(0, loadFactor);
