 ...
 */
public class Double2CharRBTreeMap extends AbstractDouble2CharMap implements Double2CharNavigableMap
{
	...
	/** EntrySet Cache */
	protected ObjectSet<Double2CharMap.Entry> entrySet;
	 ...
	 */
	public Double2CharRBTreeMap(DoubleComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Double2CharRBTreeMap(Double[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2CharRBTreeMap(Double[] keys, Character[] values, DoubleComparator comp) {
		comparator = comp;
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2CharRBTreeMap(double[] keys, char[] values) {
		this(keys, values, null);
	}
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2CharRBTreeMap(double[] keys, char[] values, DoubleComparator comp) {
		comparator = comp;
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Double2CharRBTreeMap(Map<? extends Double, ? extends Character> map, DoubleComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2CharRBTreeMap(Double2CharMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Double2CharRBTreeMap(Double2CharMap map, DoubleComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Double2CharRBTreeMap copy() {
		Double2CharRBTreeMap set = new Double2CharRBTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	static class KeySet extends AbstractDoubleSet implements DoubleNavigableSet
	{
		...
		public KeySet(Double2CharNavigableMap map) {
			this.map = map;
		}
		...
		public Double lower(Double e) {
			Double2CharMap.Entry node = map.lowerEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Double floor(Double e) {
			Double2CharMap.Entry node = map.floorEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Double higher(Double e) {
			Double2CharMap.Entry node = map.higherEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Double ceiling(Double e) {
			Double2CharMap.Entry node = map.ceilingEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		...
		public DoubleBidirectionalIterator iterator(double fromElement) {
			if(map instanceof Double2CharRBTreeMap) return ((Double2CharRBTreeMap)map).keyIterator(fromElement);
		...
		public DoubleBidirectionalIterator iterator() {
			if(map instanceof Double2CharRBTreeMap) return ((Double2CharRBTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public DoubleBidirectionalIterator descendingIterator() {
			if(map instanceof Double2CharRBTreeMap) return ((Double2CharRBTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Double2CharRBTreeMap) return ((Double2CharRBTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Double2CharRBTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Double2CharRBTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Double2CharRBTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Double2CharRBTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Double2CharRBTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractDouble2CharMap implements Double2CharNavigableMap
	{
		final Double2CharRBTreeMap map;
		final double lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		
		Double2CharNavigableMap inverse;
		DoubleNavigableSet keySet;
		ObjectSet<Double2CharMap.Entry> entrySet;
		CharCollection values;
		
		NavigableSubMap(Double2CharRBTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
		...
		@Override
		public Double2CharMap.Entry lowerEntry(double key) { return subLower(key); }
		@Override
		public Double2CharMap.Entry floorEntry(double key) { return subFloor(key); }
		@Override
		public Double2CharMap.Entry ceilingEntry(double key) { return subCeiling(key); }
		@Override
		public Double2CharMap.Entry higherEntry(double key) { return subHigher(key); }
		...
		@Override
		public Double2CharNavigableMap copy() { throw new UnsupportedOperationException(); }
		...
		public Double2CharMap.Entry pollFirstEntry() {
			Node entry = subLowest();
			if(entry != null) {
				Double2CharMap.Entry result = entry.export();
				map.removeNode(entry);
				return result;
			}
			return null;
		...
		abstract class SubEntrySet extends AbstractObjectSet<Double2CharMap.Entry> {
			@Override
			public int size() {
				if (fromStart && toEnd) return map.size();
				int size = 0;
				for(ObjectIterator<Double2CharMap.Entry> iter = iterator();iter.hasNext();iter.next(),size++);
				return size;
			}
		...
		class DecsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Double2CharMap.Entry>
		{
		...
		class AcsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Double2CharMap.Entry>
		{
	...
	class Values extends AbstractCharCollection
	{
		...
		@Override
		public int size() {
			return Double2CharRBTreeMap.this.size;
		}
	...
	class EntrySet extends AbstractObjectSet<Double2CharMap.Entry> {
	...
	class AscendingMapEntryIterator extends MapEntryIterator implements ObjectBidirectionalIterator<Double2CharMap.Entry>
	{
	...
	private static final class Node implements Double2CharMap.Entry
	{
		...
		Node(double key, char value, Node parent) {
			this.key = key;
			this.value = value;
			this.parent = parent;
		}
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				...
				return otherKey instanceof Double && otherValue instanceof Character && Double.doubleToLongBits(key) == Double.doubleToLongBits(((Double)otherKey).doubleValue()) && value == ((Character)otherValue).charValue();
			}
			return false;
		}
