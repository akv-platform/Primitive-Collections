...
public class Double2FloatLinkedOpenHashMap extends Double2FloatOpenHashMap implements Double2FloatOrderedMap
{
	 ...
	 */
	public Double2FloatLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2FloatLinkedOpenHashMap(Double[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2FloatLinkedOpenHashMap(Double[] keys, Float[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2FloatLinkedOpenHashMap(Map<? extends Double, ? extends Float> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2FloatLinkedOpenHashMap(Double2FloatMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2FloatLinkedOpenHashMap(Double2FloatMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Double2FloatLinkedOpenHashMap copy() {
		Double2FloatLinkedOpenHashMap map = new Double2FloatLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2FloatMap.Entry> implements Double2FloatOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Double2FloatMap.Entry o) {
			return Double2FloatLinkedOpenHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2FloatMap.Entry o) {
			return Double2FloatLinkedOpenHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2FloatMap.Entry) {
					...
					int index = Double2FloatLinkedOpenHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return Float.floatToIntBits(entry.getFloatValue()) == Float.floatToIntBits(Double2FloatLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Double2FloatLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float.valueOf(Double2FloatLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2FloatMap.Entry) {
					Double2FloatMap.Entry entry = (Double2FloatMap.Entry)o;
					return Double2FloatLinkedOpenHashMap.this.remove(entry.getDoubleKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2FloatLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2FloatLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2FloatLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2FloatLinkedOpenHashMap.this.moveToLast(o);
		}
