...
public abstract class AbstractDouble2BooleanMap extends AbstractMap<Double, Boolean> implements Double2BooleanMap
{
	...
	public void putAll(Double2BooleanMap m) {
		for(ObjectIterator<Double2BooleanMap.Entry> iter = Double2BooleanMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceBooleans(DoubleBooleanUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Double2BooleanMap.Entry> iter = Double2BooleanMaps.fastIterator(this);iter.hasNext();) {
			Double2BooleanMap.Entry entry = iter.next();
		...
		return new AbstractDoubleSet() {
			...
			public DoubleIterator iterator() {
				return new DoubleIterator() {
					ObjectIterator<Double2BooleanMap.Entry> iter = Double2BooleanMaps.fastIterator(AbstractDouble2BooleanMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Double2BooleanMap.Entry> iter = Double2BooleanMaps.fastIterator(this);
