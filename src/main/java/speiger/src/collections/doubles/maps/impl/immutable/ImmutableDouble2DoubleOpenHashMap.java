 ...
 */
public class ImmutableDouble2DoubleOpenHashMap extends AbstractDouble2DoubleMap implements Double2DoubleOrderedMap
{
	 ...
	 */
	protected ImmutableDouble2DoubleOpenHashMap() {}
	 ...
	 */
	public ImmutableDouble2DoubleOpenHashMap(Double[] keys, Double[] values) {
	 ...
	 */
	public ImmutableDouble2DoubleOpenHashMap(Double[] keys, Double[] values, float loadFactor) {
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
		init(DoubleArrays.unwrap(keys), DoubleArrays.unwrap(values), 0, keys.length, loadFactor);
	}
	 ...
	 */
	public ImmutableDouble2DoubleOpenHashMap(Map<? extends Double, ? extends Double> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public ImmutableDouble2DoubleOpenHashMap(Map<? extends Double, ? extends Double> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public ImmutableDouble2DoubleOpenHashMap(Double2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public ImmutableDouble2DoubleOpenHashMap(Double2DoubleMap map, float loadFactor) {
		double[] keys = new double[map.size()];
		double[] values = new double[keys.length];
		int index = 0;
		for(Double2DoubleMap.Entry entry : Double2DoubleMaps.fastIterable(map)) {
	...
	protected void init(double[] a, double[] b, int offset, int length, float loadFactor) {
	...
	@Override
	public ImmutableDouble2DoubleOpenHashMap copy() {
		ImmutableDouble2DoubleOpenHashMap map = new ImmutableDouble2DoubleOpenHashMap();
		map.mask = mask;
	...
	@Override
	public boolean replace(double key, double oldValue, double newValue) { throw new UnsupportedOperationException(); }
	
	@Override
	public double replace(double key, double value) { throw new UnsupportedOperationException(); }
	
	@Override
	public double computeDouble(double key, DoubleDoubleUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
	
	@Override
	public double computeDoubleIfAbsent(double key, Double2DoubleFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	private class MapEntrySet extends AbstractObjectSet<Double2DoubleMap.Entry> implements Double2DoubleOrderedMap.FastOrderedSet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2DoubleMap.Entry) {
					...
					int index = ImmutableDouble2DoubleOpenHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(ImmutableDouble2DoubleOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = ImmutableDouble2DoubleOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(ImmutableDouble2DoubleOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		@Override
		public int size() {
			return ImmutableDouble2DoubleOpenHashMap.this.size();
		}
