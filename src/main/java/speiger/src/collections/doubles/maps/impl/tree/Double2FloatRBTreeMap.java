 ...
 */
public class Double2FloatRBTreeMap extends AbstractDouble2FloatMap implements Double2FloatNavigableMap
{
	...
	/** EntrySet Cache */
	protected ObjectSet<Double2FloatMap.Entry> entrySet;
	 ...
	 */
	public Double2FloatRBTreeMap(DoubleComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Double2FloatRBTreeMap(Double[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2FloatRBTreeMap(Double[] keys, Float[] values, DoubleComparator comp) {
		comparator = comp;
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Double2FloatRBTreeMap(Map<? extends Double, ? extends Float> map, DoubleComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2FloatRBTreeMap(Double2FloatMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Double2FloatRBTreeMap(Double2FloatMap map, DoubleComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Double2FloatRBTreeMap copy() {
		Double2FloatRBTreeMap set = new Double2FloatRBTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	static class KeySet extends AbstractDoubleSet implements DoubleNavigableSet
	{
		...
		public KeySet(Double2FloatNavigableMap map) {
			this.map = map;
		}
		...
		public Double lower(Double e) {
			Double2FloatMap.Entry node = map.lowerEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Double floor(Double e) {
			Double2FloatMap.Entry node = map.floorEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Double higher(Double e) {
			Double2FloatMap.Entry node = map.higherEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Double ceiling(Double e) {
			Double2FloatMap.Entry node = map.ceilingEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		...
		public DoubleBidirectionalIterator iterator(double fromElement) {
			if(map instanceof Double2FloatRBTreeMap) return ((Double2FloatRBTreeMap)map).keyIterator(fromElement);
		...
		public DoubleBidirectionalIterator iterator() {
			if(map instanceof Double2FloatRBTreeMap) return ((Double2FloatRBTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public DoubleBidirectionalIterator descendingIterator() {
			if(map instanceof Double2FloatRBTreeMap) return ((Double2FloatRBTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Double2FloatRBTreeMap) return ((Double2FloatRBTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Double2FloatRBTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Double2FloatRBTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Double2FloatRBTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Double2FloatRBTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Double2FloatRBTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractDouble2FloatMap implements Double2FloatNavigableMap
	{
		final Double2FloatRBTreeMap map;
		final double lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		
		Double2FloatNavigableMap inverse;
		DoubleNavigableSet keySet;
		ObjectSet<Double2FloatMap.Entry> entrySet;
		FloatCollection values;
		
		NavigableSubMap(Double2FloatRBTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
		...
		@Override
		public Double2FloatMap.Entry lowerEntry(double key) { return subLower(key); }
		@Override
		public Double2FloatMap.Entry floorEntry(double key) { return subFloor(key); }
		@Override
		public Double2FloatMap.Entry ceilingEntry(double key) { return subCeiling(key); }
		@Override
		public Double2FloatMap.Entry higherEntry(double key) { return subHigher(key); }
		...
		@Override
		public Double2FloatNavigableMap copy() { throw new UnsupportedOperationException(); }
		...
		public Double2FloatMap.Entry pollFirstEntry() {
			Node entry = subLowest();
			if(entry != null) {
				Double2FloatMap.Entry result = entry.export();
				map.removeNode(entry);
				return result;
			}
			return null;
		...
		abstract class SubEntrySet extends AbstractObjectSet<Double2FloatMap.Entry> {
			@Override
			public int size() {
				if (fromStart && toEnd) return map.size();
				int size = 0;
				for(ObjectIterator<Double2FloatMap.Entry> iter = iterator();iter.hasNext();iter.next(),size++);
				return size;
			}
		...
		class DecsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Double2FloatMap.Entry>
		{
		...
		class AcsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Double2FloatMap.Entry>
		{
	...
	class Values extends AbstractFloatCollection
	{
		...
		@Override
		public int size() {
			return Double2FloatRBTreeMap.this.size;
		}
	...
	class EntrySet extends AbstractObjectSet<Double2FloatMap.Entry> {
	...
	class AscendingMapEntryIterator extends MapEntryIterator implements ObjectBidirectionalIterator<Double2FloatMap.Entry>
	{
	...
	private static final class Node implements Double2FloatMap.Entry
	{
		...
		Node(double key, float value, Node parent) {
			this.key = key;
			this.value = value;
			this.parent = parent;
		}
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				...
				return otherKey instanceof Double && otherValue instanceof Float && Double.doubleToLongBits(key) == Double.doubleToLongBits(((Double)otherKey).doubleValue()) && Float.floatToIntBits(value) == Float.floatToIntBits(((Float)otherValue).floatValue());
			}
			return false;
		}
