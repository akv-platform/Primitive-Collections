...
public abstract class AbstractDouble2LongMap extends AbstractMap<Double, Long> implements Double2LongMap
{
	...
	public void putAll(Double2LongMap m) {
		for(ObjectIterator<Double2LongMap.Entry> iter = Double2LongMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceLongs(DoubleLongUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Double2LongMap.Entry> iter = Double2LongMaps.fastIterator(this);iter.hasNext();) {
			Double2LongMap.Entry entry = iter.next();
		...
		return new AbstractDoubleSet() {
			...
			public DoubleIterator iterator() {
				return new DoubleIterator() {
					ObjectIterator<Double2LongMap.Entry> iter = Double2LongMaps.fastIterator(AbstractDouble2LongMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Double2LongMap.Entry> iter = Double2LongMaps.fastIterator(this);
