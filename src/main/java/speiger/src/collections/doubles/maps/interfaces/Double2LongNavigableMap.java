 ...
 */
public interface Double2LongNavigableMap extends Double2LongSortedMap, NavigableMap<Double, Long>
{
	@Override
	public Double2LongNavigableMap copy();
	 ...
	 */
	public default Double2LongNavigableMap synchronize() { return Double2LongMaps.synchronize(this); }
	 ...
	 * @see Double2LongMaps#synchronize
	 */
	public default Double2LongNavigableMap synchronize(Object mutex) { return Double2LongMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Double2LongNavigableMap unmodifiable() { return Double2LongMaps.unmodifiable(this); }
	...
	@Override
	public default Double2LongNavigableMap subMap(double fromKey, double toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Double2LongNavigableMap headMap(double toKey) { return headMap(toKey, false); }
	@Override
	public default Double2LongNavigableMap tailMap(double fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Double2LongMap.Entry lowerEntry(Double key) { return lowerEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2LongMap.Entry floorEntry(Double key) { return floorEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2LongMap.Entry ceilingEntry(Double key) { return ceilingEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2LongMap.Entry higherEntry(Double key) { return higherEntry(key.doubleValue()); }
	
	@Override
	@Deprecated
	default Double2LongNavigableMap subMap(Double fromKey, boolean fromInclusive, Double toKey, boolean toInclusive) { return subMap(fromKey.doubleValue(), fromInclusive, toKey.doubleValue(), toInclusive); }
	@Override
	@Deprecated
	default Double2LongNavigableMap headMap(Double toKey, boolean inclusive) { return headMap(toKey.doubleValue(), inclusive); }
	@Override
	@Deprecated
	default Double2LongNavigableMap tailMap(Double fromKey, boolean inclusive) { return tailMap(fromKey.doubleValue(), inclusive); }
	@Override
	@Deprecated
	default Double2LongNavigableMap subMap(Double fromKey, Double toKey) { return subMap(fromKey.doubleValue(), true, toKey.doubleValue(), false); }
	@Override
	@Deprecated
	default Double2LongNavigableMap headMap(Double toKey) { return headMap(toKey.doubleValue(), false); }
	@Override
	@Deprecated
	default Double2LongNavigableMap tailMap(Double fromKey) { return tailMap(fromKey.doubleValue(), true); }
}