 ...
 */
public class Double2CharLinkedOpenCustomHashMap extends Double2CharOpenCustomHashMap implements Double2CharOrderedMap
{
	 ...
	 */
	public Double2CharLinkedOpenCustomHashMap(DoubleStrategy strategy) {
	 ...
	 */
	public Double2CharLinkedOpenCustomHashMap(int minCapacity, DoubleStrategy strategy) {
	 ...
	 */
	public Double2CharLinkedOpenCustomHashMap(int minCapacity, float loadFactor, DoubleStrategy strategy) {
	 ...
	 */
	public Double2CharLinkedOpenCustomHashMap(Double[] keys, Character[] values, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2CharLinkedOpenCustomHashMap(Double[] keys, Character[] values, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2CharLinkedOpenCustomHashMap(double[] keys, char[] values, DoubleStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2CharLinkedOpenCustomHashMap(double[] keys, char[] values, float loadFactor, DoubleStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Double2CharLinkedOpenCustomHashMap(Map<? extends Double, ? extends Character> map, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2CharLinkedOpenCustomHashMap(Map<? extends Double, ? extends Character> map, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Double2CharLinkedOpenCustomHashMap(Double2CharMap map, DoubleStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2CharLinkedOpenCustomHashMap(Double2CharMap map, float loadFactor, DoubleStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Double2CharLinkedOpenCustomHashMap copy() {
		Double2CharLinkedOpenCustomHashMap map = new Double2CharLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2CharMap.Entry> implements Double2CharOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Double2CharMap.Entry o) {
			return Double2CharLinkedOpenCustomHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2CharMap.Entry o) {
			return Double2CharLinkedOpenCustomHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2CharMap.Entry) {
					...
					int index = Double2CharLinkedOpenCustomHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return entry.getCharValue() == Double2CharLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Double)) return false;
					int index = Double2CharLinkedOpenCustomHashMap.this.findIndex((Double)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Double2CharLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2CharMap.Entry) {
					Double2CharMap.Entry entry = (Double2CharMap.Entry)o;
					return Double2CharLinkedOpenCustomHashMap.this.remove(entry.getDoubleKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2CharLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Double2CharLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Double2CharLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2CharLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2CharLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2CharLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Double2CharMap.Entry> {
		...
		@Override
		public void set(Double2CharMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Double2CharMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
