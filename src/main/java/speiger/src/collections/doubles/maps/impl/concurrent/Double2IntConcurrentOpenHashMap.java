...
import speiger.src.collections.doubles.maps.interfaces.Double2IntConcurrentMap;
 ...
 * 
 */
public class Double2IntConcurrentOpenHashMap extends AbstractDouble2IntMap implements Double2IntConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Double2IntConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Double2IntConcurrentOpenHashMap() {
	 ...
	 */
	public Double2IntConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Double2IntConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2IntConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2IntConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2IntConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Double2IntConcurrentOpenHashMap(Double[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2IntConcurrentOpenHashMap(Double[] keys, Integer[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2IntConcurrentOpenHashMap(Double[] keys, Integer[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2IntConcurrentOpenHashMap(Double[] keys, Integer[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2IntConcurrentOpenHashMap(double[] keys, int[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2IntConcurrentOpenHashMap(double[] keys, int[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2IntConcurrentOpenHashMap(double[] keys, int[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2IntConcurrentOpenHashMap(double[] keys, int[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Double2IntConcurrentOpenHashMap(Map<? extends Double, ? extends Integer> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2IntConcurrentOpenHashMap(Map<? extends Double, ? extends Integer> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2IntConcurrentOpenHashMap(Map<? extends Double, ? extends Integer> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2IntConcurrentOpenHashMap(Map<? extends Double, ? extends Integer> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2IntConcurrentOpenHashMap(Double2IntMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2IntConcurrentOpenHashMap(Double2IntMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2IntConcurrentOpenHashMap(Double2IntMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2IntConcurrentOpenHashMap(Double2IntMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Double2IntConcurrentOpenHashMap copy() {
		Double2IntConcurrentOpenHashMap copy = new Double2IntConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2IntMap.Entry> implements Double2IntMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2IntMap.Entry) {
					Double2IntMap.Entry entry = (Double2IntMap.Entry)o;
					return Double2IntConcurrentOpenHashMap.this.remove(entry.getDoubleKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2IntConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Double2IntConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Double2IntConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleSet {
		...
		public boolean remove(double o) {
			int oldSize = size();
			Double2IntConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2IntMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2IntMap.Entry> {
		MapEntry entry;
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Double2IntConcurrentOpenHashMap map;
		...
		protected Segment(Double2IntConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Double2IntConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Double2IntConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected int put(int hash, double key, int value) {
		...
		protected int putIfAbsent(int hash, double key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected int addTo(int hash, double key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected int subFrom(int hash, double key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected int get(int hash, double key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected int getOrDefault(int hash, double key, int defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(DoubleIntConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected int remove(int hash, double key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected int removeOrDefault(int hash, double key, int defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, double key, int value) {
			long stamp = writeLock();
			try {
		...
		protected boolean replace(int hash, double key, int oldValue, int newValue) {
			long stamp = writeLock();
			try {
		...
		protected int replace(int hash, double key, int value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected int compute(int hash, double key, DoubleIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int computeIfAbsent(int hash, double key, Double2IntFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int supplyIfAbsent(int hash, double key, IntSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int computeIfPresent(int hash, double key, DoubleIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected int merge(int hash, double key, int value, IntIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
