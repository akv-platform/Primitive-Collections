 ...
 */
public class Double2LongLinkedOpenHashMap extends Double2LongOpenHashMap implements Double2LongOrderedMap
{
	 ...
	 */
	public Double2LongLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Double2LongLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2LongLinkedOpenHashMap(Double[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2LongLinkedOpenHashMap(Double[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2LongLinkedOpenHashMap(Map<? extends Double, ? extends Long> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2LongLinkedOpenHashMap(Double2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2LongLinkedOpenHashMap(Double2LongMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Double2LongLinkedOpenHashMap copy() {
		Double2LongLinkedOpenHashMap map = new Double2LongLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Double2LongMap.Entry o) {
			return Double2LongLinkedOpenHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2LongMap.Entry o) {
			return Double2LongLinkedOpenHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2LongMap.Entry) {
					...
					int index = Double2LongLinkedOpenHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return entry.getLongValue() == Double2LongLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Double2LongLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Double2LongLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2LongMap.Entry) {
					Double2LongMap.Entry entry = (Double2LongMap.Entry)o;
					return Double2LongLinkedOpenHashMap.this.remove(entry.getDoubleKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2LongLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2LongLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2LongLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2LongLinkedOpenHashMap.this.moveToLast(o);
		}
