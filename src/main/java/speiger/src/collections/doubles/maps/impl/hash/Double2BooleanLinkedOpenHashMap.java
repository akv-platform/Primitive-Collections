...
public class Double2BooleanLinkedOpenHashMap extends Double2BooleanOpenHashMap implements Double2BooleanOrderedMap
{
	...
	@Override
	public Double2BooleanLinkedOpenHashMap copy() {
		Double2BooleanLinkedOpenHashMap map = new Double2BooleanLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Double2BooleanMap.Entry o) {
			return Double2BooleanLinkedOpenHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2BooleanMap.Entry o) {
			return Double2BooleanLinkedOpenHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2BooleanMap.Entry) {
					...
					int index = Double2BooleanLinkedOpenHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return entry.getBooleanValue() == Double2BooleanLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Double2BooleanLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Double2BooleanLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2BooleanMap.Entry) {
					Double2BooleanMap.Entry entry = (Double2BooleanMap.Entry)o;
					return Double2BooleanLinkedOpenHashMap.this.remove(entry.getDoubleKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2BooleanLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2BooleanLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2BooleanLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2BooleanLinkedOpenHashMap.this.moveToLast(o);
		}
