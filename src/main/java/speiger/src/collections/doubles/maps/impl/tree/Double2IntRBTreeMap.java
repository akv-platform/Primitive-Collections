 ...
 */
public class Double2IntRBTreeMap extends AbstractDouble2IntMap implements Double2IntNavigableMap
{
	 ...
	 */
	public Double2IntRBTreeMap(DoubleComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Double2IntRBTreeMap(Double[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2IntRBTreeMap(Double[] keys, Integer[] values, DoubleComparator comp) {
		comparator = comp;
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2IntRBTreeMap(double[] keys, int[] values) {
		this(keys, values, null);
	}
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2IntRBTreeMap(double[] keys, int[] values, DoubleComparator comp) {
		comparator = comp;
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Double2IntRBTreeMap(Map<? extends Double, ? extends Integer> map, DoubleComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2IntRBTreeMap(Double2IntMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Double2IntRBTreeMap(Double2IntMap map, DoubleComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Double2IntRBTreeMap copy() {
		Double2IntRBTreeMap set = new Double2IntRBTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	static class KeySet extends AbstractDoubleSet implements DoubleNavigableSet
	{
		...
		public Double lower(Double e) {
			Double2IntMap.Entry node = map.lowerEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Double floor(Double e) {
			Double2IntMap.Entry node = map.floorEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Double higher(Double e) {
			Double2IntMap.Entry node = map.higherEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Double ceiling(Double e) {
			Double2IntMap.Entry node = map.ceilingEntry(e.doubleValue());
			return node != null ? node.getKey() : null;
		}
		...
		public DoubleBidirectionalIterator iterator(double fromElement) {
			if(map instanceof Double2IntRBTreeMap) return ((Double2IntRBTreeMap)map).keyIterator(fromElement);
		...
		public DoubleBidirectionalIterator iterator() {
			if(map instanceof Double2IntRBTreeMap) return ((Double2IntRBTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public DoubleBidirectionalIterator descendingIterator() {
			if(map instanceof Double2IntRBTreeMap) return ((Double2IntRBTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Double2IntRBTreeMap) return ((Double2IntRBTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Double2IntRBTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Double2IntRBTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Double2IntRBTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Double2IntRBTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Double2IntRBTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractDouble2IntMap implements Double2IntNavigableMap
	{
		...
		NavigableSubMap(Double2IntRBTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
	...
	class Values extends AbstractIntCollection
	{
		...
		@Override
		public int size() {
			return Double2IntRBTreeMap.this.size;
		}
