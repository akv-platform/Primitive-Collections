 ...
 */
public class Double2IntLinkedOpenCustomHashMap extends Double2IntOpenCustomHashMap implements Double2IntOrderedMap
{
	 ...
	 */
	public Double2IntLinkedOpenCustomHashMap(DoubleStrategy strategy) {
	 ...
	 */
	public Double2IntLinkedOpenCustomHashMap(int minCapacity, DoubleStrategy strategy) {
	 ...
	 */
	public Double2IntLinkedOpenCustomHashMap(int minCapacity, float loadFactor, DoubleStrategy strategy) {
	 ...
	 */
	public Double2IntLinkedOpenCustomHashMap(Double[] keys, Integer[] values, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2IntLinkedOpenCustomHashMap(Double[] keys, Integer[] values, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2IntLinkedOpenCustomHashMap(double[] keys, int[] values, DoubleStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2IntLinkedOpenCustomHashMap(double[] keys, int[] values, float loadFactor, DoubleStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Double2IntLinkedOpenCustomHashMap(Map<? extends Double, ? extends Integer> map, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2IntLinkedOpenCustomHashMap(Map<? extends Double, ? extends Integer> map, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Double2IntLinkedOpenCustomHashMap(Double2IntMap map, DoubleStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2IntLinkedOpenCustomHashMap(Double2IntMap map, float loadFactor, DoubleStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Double2IntLinkedOpenCustomHashMap copy() {
		Double2IntLinkedOpenCustomHashMap map = new Double2IntLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2IntMap.Entry> implements Double2IntOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Double2IntMap.Entry o) {
			return Double2IntLinkedOpenCustomHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2IntMap.Entry o) {
			return Double2IntLinkedOpenCustomHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2IntMap.Entry) {
					...
					int index = Double2IntLinkedOpenCustomHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return entry.getIntValue() == Double2IntLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Double)) return false;
					int index = Double2IntLinkedOpenCustomHashMap.this.findIndex((Double)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(Double2IntLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2IntMap.Entry) {
					Double2IntMap.Entry entry = (Double2IntMap.Entry)o;
					return Double2IntLinkedOpenCustomHashMap.this.remove(entry.getDoubleKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2IntLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Double2IntLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Double2IntLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2IntLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2IntLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2IntLinkedOpenCustomHashMap.this.moveToLast(o);
		}
