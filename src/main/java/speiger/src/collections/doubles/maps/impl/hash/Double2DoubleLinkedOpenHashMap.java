 ...
 */
public class Double2DoubleLinkedOpenHashMap extends Double2DoubleOpenHashMap implements Double2DoubleOrderedMap
{
	 ...
	 */
	public Double2DoubleLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2DoubleLinkedOpenHashMap(Double[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2DoubleLinkedOpenHashMap(Double[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2DoubleLinkedOpenHashMap(Map<? extends Double, ? extends Double> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2DoubleLinkedOpenHashMap(Double2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2DoubleLinkedOpenHashMap(Double2DoubleMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Double2DoubleLinkedOpenHashMap copy() {
		Double2DoubleLinkedOpenHashMap map = new Double2DoubleLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2DoubleMap.Entry> implements Double2DoubleOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Double2DoubleMap.Entry o) {
			return Double2DoubleLinkedOpenHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2DoubleMap.Entry o) {
			return Double2DoubleLinkedOpenHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2DoubleMap.Entry) {
					...
					int index = Double2DoubleLinkedOpenHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Double2DoubleLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Double2DoubleLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Double2DoubleLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2DoubleMap.Entry) {
					Double2DoubleMap.Entry entry = (Double2DoubleMap.Entry)o;
					return Double2DoubleLinkedOpenHashMap.this.remove(entry.getDoubleKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2DoubleLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2DoubleLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2DoubleLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2DoubleLinkedOpenHashMap.this.moveToLast(o);
		}
