 ...
 */
public class Double2BooleanLinkedOpenCustomHashMap extends Double2BooleanOpenCustomHashMap implements Double2BooleanOrderedMap
{
	 ...
	 */
	public Double2BooleanLinkedOpenCustomHashMap(DoubleStrategy strategy) {
	 ...
	 */
	public Double2BooleanLinkedOpenCustomHashMap(int minCapacity, DoubleStrategy strategy) {
	 ...
	 */
	public Double2BooleanLinkedOpenCustomHashMap(int minCapacity, float loadFactor, DoubleStrategy strategy) {
	 ...
	 */
	public Double2BooleanLinkedOpenCustomHashMap(Double[] keys, Boolean[] values, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2BooleanLinkedOpenCustomHashMap(Double[] keys, Boolean[] values, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Double2BooleanLinkedOpenCustomHashMap(Map<? extends Double, ? extends Boolean> map, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2BooleanLinkedOpenCustomHashMap(Map<? extends Double, ? extends Boolean> map, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Double2BooleanLinkedOpenCustomHashMap(Double2BooleanMap map, DoubleStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2BooleanLinkedOpenCustomHashMap(Double2BooleanMap map, float loadFactor, DoubleStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	
	@Override
	public boolean putAndMoveToFirst(double key, boolean value) {
	...
	@Override
	public Double2BooleanLinkedOpenCustomHashMap copy() {
		Double2BooleanLinkedOpenCustomHashMap map = new Double2BooleanLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Double2BooleanMap.Entry o) {
			return Double2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2BooleanMap.Entry o) {
			return Double2BooleanLinkedOpenCustomHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2BooleanMap.Entry) {
					...
					int index = Double2BooleanLinkedOpenCustomHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return entry.getBooleanValue() == Double2BooleanLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Double)) return false;
					int index = Double2BooleanLinkedOpenCustomHashMap.this.findIndex((Double)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Double2BooleanLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2BooleanMap.Entry) {
					Double2BooleanMap.Entry entry = (Double2BooleanMap.Entry)o;
					return Double2BooleanLinkedOpenCustomHashMap.this.remove(entry.getDoubleKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2BooleanLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Double2BooleanLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Double2BooleanLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2BooleanLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2BooleanLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2BooleanLinkedOpenCustomHashMap.this.moveToLast(o);
		}
