 ...
 */
public class Double2ObjectLinkedOpenHashMap<V> extends Double2ObjectOpenHashMap<V> implements Double2ObjectOrderedMap<V>
{
	 ...
	 */
	public Double2ObjectLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2ObjectLinkedOpenHashMap(Double[] keys, V[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ObjectLinkedOpenHashMap(Double[] keys, V[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ObjectLinkedOpenHashMap(Map<? extends Double, ? extends V> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2ObjectLinkedOpenHashMap(Double2ObjectMap<V> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2ObjectLinkedOpenHashMap(Double2ObjectMap<V> map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Double2ObjectLinkedOpenHashMap<V> copy() {
		Double2ObjectLinkedOpenHashMap<V> map = new Double2ObjectLinkedOpenHashMap<>(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2ObjectMap.Entry<V>> implements Double2ObjectOrderedMap.FastOrderedSet<V> {
		...
		public boolean moveToFirst(Double2ObjectMap.Entry<V> o) {
			return Double2ObjectLinkedOpenHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2ObjectMap.Entry<V> o) {
			return Double2ObjectLinkedOpenHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ObjectMap.Entry) {
					...
					int index = Double2ObjectLinkedOpenHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double2ObjectLinkedOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Double2ObjectLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double2ObjectLinkedOpenHashMap.this.values[index]);
				}
			}
			return false;
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ObjectMap.Entry) {
					Double2ObjectMap.Entry<V> entry = (Double2ObjectMap.Entry<V>)o;
					return Double2ObjectLinkedOpenHashMap.this.remove(entry.getDoubleKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2ObjectLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2ObjectLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2ObjectLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2ObjectLinkedOpenHashMap.this.moveToLast(o);
		}
