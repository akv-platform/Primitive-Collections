...
import speiger.src.collections.doubles.maps.interfaces.Double2DoubleConcurrentMap;
 ...
 * 
 */
public class Double2DoubleConcurrentOpenHashMap extends AbstractDouble2DoubleMap implements Double2DoubleConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Double2DoubleConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Double2DoubleConcurrentOpenHashMap() {
	 ...
	 */
	public Double2DoubleConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Double2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2DoubleConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2DoubleConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Double2DoubleConcurrentOpenHashMap(Double[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2DoubleConcurrentOpenHashMap(Double[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2DoubleConcurrentOpenHashMap(Double[] keys, Double[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2DoubleConcurrentOpenHashMap(Double[] keys, Double[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Double2DoubleConcurrentOpenHashMap(Map<? extends Double, ? extends Double> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2DoubleConcurrentOpenHashMap(Map<? extends Double, ? extends Double> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2DoubleConcurrentOpenHashMap(Map<? extends Double, ? extends Double> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2DoubleConcurrentOpenHashMap(Map<? extends Double, ? extends Double> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2DoubleConcurrentOpenHashMap(Double2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2DoubleConcurrentOpenHashMap(Double2DoubleMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2DoubleConcurrentOpenHashMap(Double2DoubleMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2DoubleConcurrentOpenHashMap(Double2DoubleMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Double2DoubleConcurrentOpenHashMap copy() {
		Double2DoubleConcurrentOpenHashMap copy = new Double2DoubleConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2DoubleMap.Entry> implements Double2DoubleMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2DoubleMap.Entry) {
					Double2DoubleMap.Entry entry = (Double2DoubleMap.Entry)o;
					return Double2DoubleConcurrentOpenHashMap.this.remove(entry.getDoubleKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2DoubleConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Double2DoubleConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Double2DoubleConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleSet {
		...
		public boolean remove(double o) {
			int oldSize = size();
			Double2DoubleConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2DoubleMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2DoubleMap.Entry> {
		MapEntry entry;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Double2DoubleMap.Entry) {
					...
					return Double.doubleToLongBits(getDoubleKey()) == Double.doubleToLongBits(entry.getDoubleKey()) && Double.doubleToLongBits(getDoubleValue()) == Double.doubleToLongBits(entry.getDoubleValue());
				}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Double2DoubleConcurrentOpenHashMap map;
		...
		protected Segment(Double2DoubleConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Double2DoubleConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Double2DoubleConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected double put(int hash, double key, double value) {
		...
		protected double putIfAbsent(int hash, double key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double addTo(int hash, double key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double subFrom(int hash, double key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double get(int hash, double key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double getOrDefault(int hash, double key, double defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(DoubleDoubleConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected double remove(int hash, double key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected double removeOrDefault(int hash, double key, double defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, double key, double value) {
			long stamp = writeLock();
			try {
				...
				if(Double.doubleToLongBits(current) == Double.doubleToLongBits(key) && Double.doubleToLongBits(value) == Double.doubleToLongBits(values[pos])) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if(Double.doubleToLongBits((current = keys[pos = (++pos & mask)])) == 0) return false;
					else if(Double.doubleToLongBits(current) == Double.doubleToLongBits(key) && Double.doubleToLongBits(value) == Double.doubleToLongBits(values[pos])) {
						removeIndex(pos);
						return true;
					}
				}
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				double current = keys[pos];
				if(Double.doubleToLongBits(current) == 0) return false;
				if(Objects.equals(key, Double.valueOf(current)) && Objects.equals(value, Double.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if(Double.doubleToLongBits((current = keys[pos = (++pos & mask)])) == 0) return false;
					else if(Objects.equals(key, Double.valueOf(current)) && Objects.equals(value, Double.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, double key, double oldValue, double newValue) {
			long stamp = writeLock();
			try {
		...
		protected double replace(int hash, double key, double value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected double compute(int hash, double key, DoubleDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected double computeIfAbsent(int hash, double key, Double2DoubleFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected double supplyIfAbsent(int hash, double key, DoubleSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected double computeIfPresent(int hash, double key, DoubleDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected double merge(int hash, double key, double value, DoubleDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
