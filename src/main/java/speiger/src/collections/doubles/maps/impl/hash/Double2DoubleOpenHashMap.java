 ...
 */
public class Double2DoubleOpenHashMap extends AbstractDouble2DoubleMap implements ITrimmable
{
	 ...
	 */
	public Double2DoubleOpenHashMap(int minCapacity) {
	 ...
	 */
	public Double2DoubleOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2DoubleOpenHashMap(Double[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2DoubleOpenHashMap(Double[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2DoubleOpenHashMap(Map<? extends Double, ? extends Double> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2DoubleOpenHashMap(Double2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2DoubleOpenHashMap(Double2DoubleMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	public boolean containsValue(double value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(Double.doubleToLongBits(keys[i]) != 0 && Double.doubleToLongBits(values[i]) == Double.doubleToLongBits(value)) return true;
		return false;
	}
	...
	public boolean containsValue(Object value) {
		...
		for(int i = nullIndex-1;i >= 0;i--)
			if(Double.doubleToLongBits(keys[i]) != 0 && ((value == null && values[i] == getDefaultReturnValue()) || Objects.equals(value, Double.valueOf(values[i])))) return true;
		return false;
	}
	...
	@Override
	public Double2DoubleOpenHashMap copy() {
		Double2DoubleOpenHashMap map = new Double2DoubleOpenHashMap(0, loadFactor);
	...
	protected class MapEntry implements Double2DoubleMap.Entry, Map.Entry<Double, Double> {
		...
		@Override
		public int hashCode() {
			return Double.hashCode(keys[index]) ^ Double.hashCode(values[index]);
		}
	...
	private final class MapEntrySet extends AbstractObjectSet<Double2DoubleMap.Entry> implements Double2DoubleMap.FastEntrySet {
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2DoubleMap.Entry) {
					...
					int index = Double2DoubleOpenHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Double2DoubleOpenHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Double2DoubleOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Double2DoubleOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2DoubleMap.Entry) {
					Double2DoubleMap.Entry entry = (Double2DoubleMap.Entry)o;
					return Double2DoubleOpenHashMap.this.remove(entry.getDoubleKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2DoubleOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2DoubleOpenHashMap.this.remove(o);
			return size != oldSize;
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if(lastReturned == nullIndex) {
				...
				Double2DoubleOpenHashMap.this.remove(wrapped.getDouble(-returnedPos - 1));
				lastReturned = -1;
				return;
			}
			size--;
