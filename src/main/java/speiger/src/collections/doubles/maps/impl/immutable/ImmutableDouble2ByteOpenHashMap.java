...
public class ImmutableDouble2ByteOpenHashMap extends AbstractDouble2ByteMap implements Double2ByteOrderedMap
{
	 ...
	 */
	protected ImmutableDouble2ByteOpenHashMap() {}
	 ...
	 */
	public ImmutableDouble2ByteOpenHashMap(Double[] keys, Byte[] values) {
	 ...
	 */
	public ImmutableDouble2ByteOpenHashMap(Double[] keys, Byte[] values, float loadFactor) {
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
		init(DoubleArrays.unwrap(keys), ByteArrays.unwrap(values), 0, keys.length, loadFactor);
	}
	 ...
	 */
	public ImmutableDouble2ByteOpenHashMap(Map<? extends Double, ? extends Byte> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public ImmutableDouble2ByteOpenHashMap(Map<? extends Double, ? extends Byte> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public ImmutableDouble2ByteOpenHashMap(Double2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public ImmutableDouble2ByteOpenHashMap(Double2ByteMap map, float loadFactor) {
		double[] keys = new double[map.size()];
		byte[] values = new byte[keys.length];
		int index = 0;
		for(Double2ByteMap.Entry entry : Double2ByteMaps.fastIterable(map)) {
	...
	protected void init(double[] a, byte[] b, int offset, int length, float loadFactor) {
	...
	@Override
	public ImmutableDouble2ByteOpenHashMap copy() {
		ImmutableDouble2ByteOpenHashMap map = new ImmutableDouble2ByteOpenHashMap();
		map.mask = mask;
	...
	@Override
	public boolean replace(double key, byte oldValue, byte newValue) { throw new UnsupportedOperationException(); }
	
	@Override
	public byte replace(double key, byte value) { throw new UnsupportedOperationException(); }
	...
	private class MapEntrySet extends AbstractObjectSet<Double2ByteMap.Entry> implements Double2ByteOrderedMap.FastOrderedSet {
		...
		@Override
		public boolean moveToFirst(Double2ByteMap.Entry o) { throw new UnsupportedOperationException(); }
		
		@Override
		public boolean moveToLast(Double2ByteMap.Entry o) { throw new UnsupportedOperationException(); }
		...
		@Override
		public Double2ByteMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		
		@Override
		public Double2ByteMap.Entry pollLast() { throw new UnsupportedOperationException(); }
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ByteMap.Entry) {
					...
					int index = ImmutableDouble2ByteOpenHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return entry.getByteValue() == ImmutableDouble2ByteOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = ImmutableDouble2ByteOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(ImmutableDouble2ByteOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		@Override
		public int size() {
			return ImmutableDouble2ByteOpenHashMap.this.size();
		}
