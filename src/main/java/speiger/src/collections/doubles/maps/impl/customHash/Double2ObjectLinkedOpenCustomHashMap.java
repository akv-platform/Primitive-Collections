...
public class Double2ObjectLinkedOpenCustomHashMap<V> extends Double2ObjectOpenCustomHashMap<V> implements Double2ObjectOrderedMap<V>
{
	 ...
	 */
	public Double2ObjectLinkedOpenCustomHashMap(DoubleStrategy strategy) {
	 ...
	 */
	public Double2ObjectLinkedOpenCustomHashMap(int minCapacity, DoubleStrategy strategy) {
	 ...
	 */
	public Double2ObjectLinkedOpenCustomHashMap(int minCapacity, float loadFactor, DoubleStrategy strategy) {
	 ...
	 */
	public Double2ObjectLinkedOpenCustomHashMap(Double[] keys, V[] values, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ObjectLinkedOpenCustomHashMap(Double[] keys, V[] values, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Double2ObjectLinkedOpenCustomHashMap(Map<? extends Double, ? extends V> map, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ObjectLinkedOpenCustomHashMap(Map<? extends Double, ? extends V> map, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Double2ObjectLinkedOpenCustomHashMap(Double2ObjectMap<V> map, DoubleStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2ObjectLinkedOpenCustomHashMap(Double2ObjectMap<V> map, float loadFactor, DoubleStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	public Double2ObjectLinkedOpenCustomHashMap<V> copy() {
		Double2ObjectLinkedOpenCustomHashMap<V> map = new Double2ObjectLinkedOpenCustomHashMap<>(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2ObjectMap.Entry<V>> implements Double2ObjectOrderedMap.FastOrderedSet<V> {
		...
		public boolean moveToFirst(Double2ObjectMap.Entry<V> o) {
			return Double2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2ObjectMap.Entry<V> o) {
			return Double2ObjectLinkedOpenCustomHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ObjectMap.Entry) {
					...
					int index = Double2ObjectLinkedOpenCustomHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Double)) return false;
					int index = Double2ObjectLinkedOpenCustomHashMap.this.findIndex((Double)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double2ObjectLinkedOpenCustomHashMap.this.values[index]);
				}
			}
			return false;
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ObjectMap.Entry) {
					Double2ObjectMap.Entry<V> entry = (Double2ObjectMap.Entry<V>)o;
					return Double2ObjectLinkedOpenCustomHashMap.this.remove(entry.getDoubleKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2ObjectLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2ObjectLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2ObjectLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2ObjectLinkedOpenCustomHashMap.this.moveToLast(o);
		}
