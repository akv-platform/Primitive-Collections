 ...
 */
public interface Double2ShortNavigableMap extends Double2ShortSortedMap, NavigableMap<Double, Short>
{
	@Override
	 ...
	 */
	public default Double2ShortNavigableMap synchronize() { return Double2ShortMaps.synchronize(this); }
	 ...
	 * @see Double2ShortMaps#synchronize
	 */
	public default Double2ShortNavigableMap synchronize(Object mutex) { return Double2ShortMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Double2ShortNavigableMap unmodifiable() { return Double2ShortMaps.unmodifiable(this); }
	...
	@Override
	public default Double2ShortNavigableMap subMap(double fromKey, double toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Double2ShortNavigableMap headMap(double toKey) { return headMap(toKey, false); }
	@Override
	public default Double2ShortNavigableMap tailMap(double fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Double2ShortMap.Entry lowerEntry(Double key) { return lowerEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2ShortMap.Entry floorEntry(Double key) { return floorEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2ShortMap.Entry ceilingEntry(Double key) { return ceilingEntry(key.doubleValue()); }
	@Override
	@Deprecated
	default Double2ShortMap.Entry higherEntry(Double key) { return higherEntry(key.doubleValue()); }
	
	@Override
	@Deprecated
	default Double2ShortNavigableMap subMap(Double fromKey, boolean fromInclusive, Double toKey, boolean toInclusive) { return subMap(fromKey.doubleValue(), fromInclusive, toKey.doubleValue(), toInclusive); }
	@Override
	@Deprecated
	default Double2ShortNavigableMap headMap(Double toKey, boolean inclusive) { return headMap(toKey.doubleValue(), inclusive); }
	@Override
	@Deprecated
	default Double2ShortNavigableMap tailMap(Double fromKey, boolean inclusive) { return tailMap(fromKey.doubleValue(), inclusive); }
	@Override
	@Deprecated
	default Double2ShortNavigableMap subMap(Double fromKey, Double toKey) { return subMap(fromKey.doubleValue(), true, toKey.doubleValue(), false); }
	@Override
	@Deprecated
	default Double2ShortNavigableMap headMap(Double toKey) { return headMap(toKey.doubleValue(), false); }
	@Override
	@Deprecated
	default Double2ShortNavigableMap tailMap(Double fromKey) { return tailMap(fromKey.doubleValue(), true); }
}