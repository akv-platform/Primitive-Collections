 ...
 */
public class Double2ByteLinkedOpenCustomHashMap extends Double2ByteOpenCustomHashMap implements Double2ByteOrderedMap
{
	 ...
	 */
	public Double2ByteLinkedOpenCustomHashMap(DoubleStrategy strategy) {
	 ...
	 */
	public Double2ByteLinkedOpenCustomHashMap(int minCapacity, DoubleStrategy strategy) {
	 ...
	 */
	public Double2ByteLinkedOpenCustomHashMap(int minCapacity, float loadFactor, DoubleStrategy strategy) {
	 ...
	 */
	public Double2ByteLinkedOpenCustomHashMap(Double[] keys, Byte[] values, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ByteLinkedOpenCustomHashMap(Double[] keys, Byte[] values, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Double2ByteLinkedOpenCustomHashMap(Map<? extends Double, ? extends Byte> map, DoubleStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ByteLinkedOpenCustomHashMap(Map<? extends Double, ? extends Byte> map, float loadFactor, DoubleStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Double2ByteLinkedOpenCustomHashMap(Double2ByteMap map, DoubleStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2ByteLinkedOpenCustomHashMap(Double2ByteMap map, float loadFactor, DoubleStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Double2ByteLinkedOpenCustomHashMap copy() {
		Double2ByteLinkedOpenCustomHashMap map = new Double2ByteLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	public ObjectOrderedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
		...
		return (ObjectOrderedSet<Double2ByteMap.Entry>)entrySet;
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Double2ByteMap.Entry> implements Double2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Double2ByteMap.Entry o) {
			return Double2ByteLinkedOpenCustomHashMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2ByteMap.Entry o) {
			return Double2ByteLinkedOpenCustomHashMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ByteMap.Entry) {
					...
					int index = Double2ByteLinkedOpenCustomHashMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return entry.getByteValue() == Double2ByteLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Double)) return false;
					int index = Double2ByteLinkedOpenCustomHashMap.this.findIndex((Double)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Double2ByteLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ByteMap.Entry) {
					Double2ByteMap.Entry entry = (Double2ByteMap.Entry)o;
					return Double2ByteLinkedOpenCustomHashMap.this.remove(entry.getDoubleKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2ByteLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Double2ByteLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Double2ByteLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2ByteLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(double o) {
			return Double2ByteLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(double o) {
			return Double2ByteLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Double2ByteMap.Entry> {
		...
		@Override
		public void set(Double2ByteMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Double2ByteMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
