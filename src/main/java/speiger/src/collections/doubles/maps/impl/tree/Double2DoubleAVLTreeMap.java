...
public class Double2DoubleAVLTreeMap extends AbstractDouble2DoubleMap implements Double2DoubleNavigableMap
{
	 ...
	 */
	public Double2DoubleAVLTreeMap(Double[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Double2DoubleAVLTreeMap(Double[] keys, Double[] values, DoubleComparator comp) {
		comparator = comp;
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Double2DoubleAVLTreeMap(Map<? extends Double, ? extends Double> map, DoubleComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2DoubleAVLTreeMap(Double2DoubleMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Double2DoubleAVLTreeMap(Double2DoubleMap map, DoubleComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	public Double2DoubleAVLTreeMap copy() {
		Double2DoubleAVLTreeMap set = new Double2DoubleAVLTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	static class KeySet extends AbstractDoubleSet implements DoubleNavigableSet
	{
		...
		public DoubleBidirectionalIterator iterator(double fromElement) {
			if(map instanceof Double2DoubleAVLTreeMap) return ((Double2DoubleAVLTreeMap)map).keyIterator(fromElement);
		...
		public DoubleBidirectionalIterator iterator() {
			if(map instanceof Double2DoubleAVLTreeMap) return ((Double2DoubleAVLTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public DoubleBidirectionalIterator descendingIterator() {
			if(map instanceof Double2DoubleAVLTreeMap) return ((Double2DoubleAVLTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Double2DoubleAVLTreeMap) return ((Double2DoubleAVLTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Double2DoubleAVLTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Double2DoubleAVLTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Double2DoubleAVLTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Double2DoubleAVLTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Double2DoubleAVLTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractDouble2DoubleMap implements Double2DoubleNavigableMap
	{
		...
		NavigableSubMap(Double2DoubleAVLTreeMap map, boolean fromStart, double lo, boolean loInclusive, boolean toEnd, double hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
