...
import speiger.src.collections.doubles.maps.interfaces.Double2ShortConcurrentMap;
 ...
 * 
 */
public class Double2ShortConcurrentOpenHashMap extends AbstractDouble2ShortMap implements Double2ShortConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Double2ShortConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Double2ShortConcurrentOpenHashMap() {
	 ...
	 */
	public Double2ShortConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Double2ShortConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Double2ShortConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2ShortConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2ShortConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Double2ShortConcurrentOpenHashMap(Double[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ShortConcurrentOpenHashMap(Double[] keys, Short[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2ShortConcurrentOpenHashMap(Double[] keys, Short[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2ShortConcurrentOpenHashMap(Double[] keys, Short[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Double2ShortConcurrentOpenHashMap(Map<? extends Double, ? extends Short> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Double2ShortConcurrentOpenHashMap(Map<? extends Double, ? extends Short> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2ShortConcurrentOpenHashMap(Map<? extends Double, ? extends Short> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Double2ShortConcurrentOpenHashMap(Map<? extends Double, ? extends Short> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2ShortConcurrentOpenHashMap(Double2ShortMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Double2ShortConcurrentOpenHashMap(Double2ShortMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2ShortConcurrentOpenHashMap(Double2ShortMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Double2ShortConcurrentOpenHashMap(Double2ShortMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Double2ShortConcurrentOpenHashMap copy() {
		Double2ShortConcurrentOpenHashMap copy = new Double2ShortConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Double2ShortMap.Entry> implements Double2ShortMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2ShortMap.Entry) {
					Double2ShortMap.Entry entry = (Double2ShortMap.Entry)o;
					return Double2ShortConcurrentOpenHashMap.this.remove(entry.getDoubleKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2ShortConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Double2ShortConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Double2ShortConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractDoubleSet implements DoubleSet {
		...
		public boolean remove(double o) {
			int oldSize = size();
			Double2ShortConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2ShortMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Double2ShortMap.Entry> {
		MapEntry entry;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Double2ShortMap.Entry) {
					...
					return Double.doubleToLongBits(getDoubleKey()) == Double.doubleToLongBits(entry.getDoubleKey()) && getShortValue() == entry.getShortValue();
				}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Double2ShortConcurrentOpenHashMap map;
		...
		protected Segment(Double2ShortConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Double2ShortConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Double2ShortConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected short put(int hash, double key, short value) {
		...
		protected short putIfAbsent(int hash, double key, short value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected short addTo(int hash, double key, short value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected short subFrom(int hash, double key, short value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected short get(int hash, double key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected short getOrDefault(int hash, double key, short defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(DoubleShortConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected short remove(int hash, double key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected short removeOrDefault(int hash, double key, short defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, double key, short value) {
			long stamp = writeLock();
			try {
		...
		protected boolean replace(int hash, double key, short oldValue, short newValue) {
			long stamp = writeLock();
			try {
		...
		protected short replace(int hash, double key, short value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected short compute(int hash, double key, DoubleShortUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected short computeIfAbsent(int hash, double key, Double2ShortFunction mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected short supplyIfAbsent(int hash, double key, ShortSupplier valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected short computeIfPresent(int hash, double key, DoubleShortUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected short merge(int hash, double key, short value, ShortShortUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
