 ...
 */
public class Double2BooleanArrayMap extends AbstractDouble2BooleanMap implements Double2BooleanOrderedMap
{
	 ...
	 */
	public Double2BooleanArrayMap(Double[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in length
	 */
	public Double2BooleanArrayMap(Double[] keys, Boolean[] values, int length) {
		this(length);
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Double2BooleanArrayMap(Double2BooleanMap map) {
		this(map.size());
		for(ObjectIterator<Double2BooleanMap.Entry> iter = Double2BooleanMaps.fastIterator(map);iter.hasNext();size++) {
	...
	public Double2BooleanArrayMap copy() {
		Double2BooleanArrayMap map = new Double2BooleanArrayMap();
		map.size = size;
	...
	protected void insertIndex(int index, double key, boolean value) {
		grow(size+1);
		if(index != size) {
	...
	protected int findIndex(double key, boolean value) {
	...
	protected int findIndex(Object key, Object value) {
		for(int i = size-1;i>=0;i--)
			if(Objects.equals(key, Double.valueOf(keys[i])) && Objects.equals(value, Boolean.valueOf(values[i]))) return i;
		return -1;		
	}
	...
	private class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Double2BooleanMap.Entry o) {
			return Double2BooleanArrayMap.this.moveToFirst(o.getDoubleKey());
		}
		
		@Override
		public boolean moveToLast(Double2BooleanMap.Entry o) {
			return Double2BooleanArrayMap.this.moveToLast(o.getDoubleKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2BooleanMap.Entry) {
					...
					int index = Double2BooleanArrayMap.this.findIndex(entry.getDoubleKey());
					if(index >= 0) return entry.getBooleanValue() == Double2BooleanArrayMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Double2BooleanArrayMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Double2BooleanArrayMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Double2BooleanMap.Entry) {
					Double2BooleanMap.Entry entry = (Double2BooleanMap.Entry)o;
					return Double2BooleanArrayMap.this.remove(entry.getDoubleKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Double2BooleanArrayMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private class KeySet extends AbstractDoubleSet implements DoubleOrderedSet {
		...
		public boolean remove(double o) {
			int oldSize = size;
			Double2BooleanArrayMap.this.remove(o);
			return size != oldSize;
		}
		...
		@Override
		public boolean moveToFirst(double o) { return Double2BooleanArrayMap.this.moveToFirst(o); }
		@Override
		public boolean moveToLast(double o) { return Double2BooleanArrayMap.this.moveToLast(o); }
		@Override
		...
		@Override
		public int size() { return Double2BooleanArrayMap.this.size(); }
		@Override
		public void clear() { Double2BooleanArrayMap.this.clear(); }
		@Override
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Double2BooleanMap.Entry> {
		...
		@Override
		public void set(Double2BooleanMap.Entry e) { throw new UnsupportedOperationException(); }
		@Override
		public void add(Double2BooleanMap.Entry e) { throw new UnsupportedOperationException(); }
	}
	...
	private class MapEntry implements Double2BooleanMap.Entry, Map.Entry<Double, Boolean> {
		int index = -1;
