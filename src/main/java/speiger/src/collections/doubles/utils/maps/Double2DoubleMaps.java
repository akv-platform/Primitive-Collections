...
public class Double2DoubleMaps
{
	...
	public static class EmptyMap extends AbstractDouble2DoubleMap {
		...
		@Override
		public double getOrDefault(double key, double defaultValue) { return 0D; }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Double2DoubleNavigableMap {
		...
		@Override
		public Double2DoubleMap.Entry lastEntry() { synchronized(mutex) { return map.firstEntry(); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractDouble2DoubleMap implements Double2DoubleMap {
		...
		@Override
		public double computeDoubleIfAbsent(double key, Double2DoubleFunction mappingFunction) { synchronized(mutex) { return map.computeDoubleIfAbsent(key, mappingFunction); } }
		@Override
