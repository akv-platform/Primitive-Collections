...
public class Char2CharMaps
{
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Char2CharNavigableMap {
		...
		@Override
		public Char2CharMap.Entry lastEntry() { synchronized(mutex) { return map.firstEntry(); } }
		@Override
	...
	public static class SynchronizedMap extends AbstractChar2CharMap implements Char2CharMap {
		...
		@Override
		public char computeCharIfAbsent(char key, Char2CharFunction mappingFunction) { synchronized(mutex) { return map.computeCharIfAbsent(key, mappingFunction); } }
		@Override
