...
public class Char2IntMaps
{
	 ...
	 */
	public static Char2IntMap.Entry unmodifiable(Char2IntMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Char2IntMap.Entry unmodifiable(Map.Entry<Character, Integer> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Char2IntNavigableMap {
		...
		@Override
		public Char2IntNavigableMap descendingMap() { return Char2IntMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Char2IntNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Char2IntOrderedMap {
		...
		public ObjectOrderedSet<Char2IntMap.Entry> char2IntEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.char2IntEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Char2IntSortedMap {
		...
		public int lastIntValue() { return map.lastIntValue(); }
		@Override
		public Char2IntSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractChar2IntMap implements Char2IntMap {
		...
		public void mergeAllInt(Char2IntMap m, IntIntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceInts(CharIntUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceInts(Char2IntMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Char2IntMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Char2IntMap.Entry>
	{
		ObjectOrderedSet<Char2IntMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Char2IntMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public boolean moveToFirst(Char2IntMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public boolean moveToLast(Char2IntMap.Entry o) { throw new UnsupportedOperationException(); }
		@Override
		public ObjectOrderedSet<Char2IntMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Char2IntMap.Entry first() { return set.first(); }
		@Override
		public Char2IntMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Char2IntMap.Entry last() { return set.last(); }
		@Override
		public Char2IntMap.Entry pollLast() { throw new UnsupportedOperationException(); }
	}
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Char2IntNavigableMap {
		...
		@Override
		public Char2IntMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Char2IntNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Char2IntSortedMap {
		...
		public int lastIntValue() { synchronized(mutex) { return map.lastIntValue(); } }
		@Override
		public Char2IntSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractChar2IntMap implements Char2IntMap {
		...
		@Override
		public int supplyIntIfAbsent(char key, IntSupplier valueProvider) { synchronized(mutex) { return map.supplyIntIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Char2IntMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public CharSet keySet() {
			if(keys == null) keys = CharSets.synchronize(map.keySet(), mutex);
			return keys;
