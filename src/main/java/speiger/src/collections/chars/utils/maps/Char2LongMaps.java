...
public class Char2LongMaps
{
	 ...
	 * Empty Map Variable
	 */
	private static final Char2LongMap EMPTY = new EmptyMap();
	 ...
	 */
	public static Char2LongMap.Entry unmodifiable(Char2LongMap.Entry entry) { return entry instanceof UnmodifyableEntry ? entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	/**
	 * A Helper function that creates a Unmodifyable Entry
	 * @param entry the Entry that should be made unmodifiable
	 * @return a Unmodifyable Entry
	 */
	public static Char2LongMap.Entry unmodifiable(Map.Entry<Character, Long> entry) { return entry instanceof UnmodifyableEntry ? (UnmodifyableEntry)entry : (entry == null ? null : new UnmodifyableEntry(entry)); }
	...
	public static class EmptyMap extends AbstractChar2LongMap {
		...
		@Override
		public long getOrDefault(char key, long defaultValue) { return defaultValue; }
		@Override
		public long computeLong(char key, CharLongUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public long computeLongIfAbsent(char key, Char2LongFunction mappingFunction) { throw new UnsupportedOperationException(); }
	...
	public static class UnmodifyableNavigableMap extends UnmodifyableSortedMap implements Char2LongNavigableMap {
		...
		@Override
		public Char2LongNavigableMap descendingMap() { return Char2LongMaps.unmodifiable(map.descendingMap()); }
		@Override
		...
		@Override
		public Char2LongNavigableMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableOrderedMap extends UnmodifyableMap implements Char2LongOrderedMap {
		...
		@Override
		public Char2LongOrderedMap copy() { return map.copy(); }
		@Override
		...
		public ObjectOrderedSet<Char2LongMap.Entry> char2LongEntrySet() {
			if(entrySet == null) entrySet = new UnmodifyableOrderedEntrySet(map.char2LongEntrySet());
	...
	public static class UnmodifyableSortedMap extends UnmodifyableMap implements Char2LongSortedMap {
		...
		public long lastLongValue() { return map.lastLongValue(); }
		@Override
		public Char2LongSortedMap copy() { return map.copy(); }
	}
	...
	public static class UnmodifyableMap extends AbstractChar2LongMap implements Char2LongMap {
		...
		public void mergeAllLong(Char2LongMap m, LongLongUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceLongs(CharLongUnaryOperator mappingFunction) { throw new UnsupportedOperationException(); }
		@Override
		public void replaceLongs(Char2LongMap m) { throw new UnsupportedOperationException(); }
		@Override
		public Char2LongMap copy() { return map.copy(); }
		@Override
	 ...
	 */
	public static class UnmodifyableOrderedEntrySet extends UnmodifyableEntrySet implements ObjectOrderedSet<Char2LongMap.Entry>
	{
		ObjectOrderedSet<Char2LongMap.Entry> set;
		
		UnmodifyableOrderedEntrySet(ObjectOrderedSet<Char2LongMap.Entry> c) {
			super(c);
			set = c;
		}
		...
		@Override
		public ObjectOrderedSet<Char2LongMap.Entry> copy() { return set.copy(); }
		@Override
		public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator() { return ObjectIterators.unmodifiable(set.iterator()); }
		@Override
		public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator(Char2LongMap.Entry fromElement) { return ObjectIterators.unmodifiable(set.iterator(fromElement)); }
		@Override
		public Char2LongMap.Entry first() { return set.first(); }
		@Override
		public Char2LongMap.Entry pollFirst() { throw new UnsupportedOperationException(); }
		@Override
		public Char2LongMap.Entry last() { return set.last(); }
		@Override
	...
	public static class SynchronizedNavigableMap extends SynchronizedSortedMap implements Char2LongNavigableMap {
		...
		@Override
		public Char2LongMap.Entry lastEntry() { synchronized(mutex) { return map.lastEntry(); } }
		@Override
		...
		@Override
		public Char2LongNavigableMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedOrderedMap extends SynchronizedMap implements Char2LongOrderedMap {
		...
		@Override
		public Char2LongOrderedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public CharOrderedSet keySet() {
	...
	public static class SynchronizedSortedMap extends SynchronizedMap implements Char2LongSortedMap {
		...
		public long lastLongValue() { synchronized(mutex) { return map.lastLongValue(); } }
		@Override
		public Char2LongSortedMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		@Deprecated
	...
	public static class SynchronizedMap extends AbstractChar2LongMap implements Char2LongMap {
		...
		@Override
		public long supplyLongIfAbsent(char key, LongSupplier valueProvider) { synchronized(mutex) { return map.supplyLongIfAbsent(key, valueProvider); } }
		@Override
		...
		@Override
		public Char2LongMap copy() { synchronized(mutex) { return map.copy(); } }
		@Override
		public CharSet keySet() {
			if(keys == null) keys = CharSets.synchronize(map.keySet(), mutex);
			return keys;
