...
public class Char2BooleanMaps
{
	...
	public static class EmptyMap extends AbstractChar2BooleanMap {
		...
		@Override
		public boolean getOrDefault(char key, boolean defaultValue) { return false; }
		@Override
	...
	public static class SynchronizedMap extends AbstractChar2BooleanMap implements Char2BooleanMap {
		...
		@Override
		public boolean computeBooleanIfAbsent(char key, Char2BooleanFunction mappingFunction) { synchronized(mutex) { return map.computeBooleanIfAbsent(key, mappingFunction); } }
		@Override
