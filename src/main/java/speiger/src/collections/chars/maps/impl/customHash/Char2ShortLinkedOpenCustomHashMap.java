 ...
 */
public class Char2ShortLinkedOpenCustomHashMap extends Char2ShortOpenCustomHashMap implements Char2ShortOrderedMap
{
	 ...
	 */
	public Char2ShortLinkedOpenCustomHashMap(CharStrategy strategy) {
	 ...
	 */
	public Char2ShortLinkedOpenCustomHashMap(int minCapacity, CharStrategy strategy) {
	 ...
	 */
	public Char2ShortLinkedOpenCustomHashMap(int minCapacity, float loadFactor, CharStrategy strategy) {
	 ...
	 */
	public Char2ShortLinkedOpenCustomHashMap(Character[] keys, Short[] values, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ShortLinkedOpenCustomHashMap(Character[] keys, Short[] values, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2ShortLinkedOpenCustomHashMap(char[] keys, short[] values, CharStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ShortLinkedOpenCustomHashMap(char[] keys, short[] values, float loadFactor, CharStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Char2ShortLinkedOpenCustomHashMap(Map<? extends Character, ? extends Short> map, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ShortLinkedOpenCustomHashMap(Map<? extends Character, ? extends Short> map, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Char2ShortLinkedOpenCustomHashMap(Char2ShortMap map, CharStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2ShortLinkedOpenCustomHashMap(Char2ShortMap map, float loadFactor, CharStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Char2ShortLinkedOpenCustomHashMap copy() {
		Char2ShortLinkedOpenCustomHashMap map = new Char2ShortLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2ShortMap.Entry> implements Char2ShortOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2ShortMap.Entry o) {
			return Char2ShortLinkedOpenCustomHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2ShortMap.Entry o) {
			return Char2ShortLinkedOpenCustomHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2ShortMap.Entry) {
					...
					int index = Char2ShortLinkedOpenCustomHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return entry.getShortValue() == Char2ShortLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Character)) return false;
					int index = Char2ShortLinkedOpenCustomHashMap.this.findIndex((Character)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Short.valueOf(Char2ShortLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2ShortMap.Entry) {
					Char2ShortMap.Entry entry = (Char2ShortMap.Entry)o;
					return Char2ShortLinkedOpenCustomHashMap.this.remove(entry.getCharKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2ShortLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2ShortLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2ShortLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2ShortLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2ShortLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2ShortLinkedOpenCustomHashMap.this.moveToLast(o);
		}
