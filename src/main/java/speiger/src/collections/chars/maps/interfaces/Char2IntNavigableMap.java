 ...
 */
public interface Char2IntNavigableMap extends Char2IntSortedMap, NavigableMap<Character, Integer>
{
	@Override
	public Char2IntNavigableMap copy();
	 ...
	 */
	public default Char2IntNavigableMap synchronize() { return Char2IntMaps.synchronize(this); }
	 ...
	 * @see Char2IntMaps#synchronize
	 */
	public default Char2IntNavigableMap synchronize(Object mutex) { return Char2IntMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Char2IntNavigableMap unmodifiable() { return Char2IntMaps.unmodifiable(this); }
	...
	@Override
	public default Char2IntNavigableMap subMap(char fromKey, char toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Char2IntNavigableMap headMap(char toKey) { return headMap(toKey, false); }
	@Override
	public default Char2IntNavigableMap tailMap(char fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Char2IntMap.Entry lowerEntry(Character key) { return lowerEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2IntMap.Entry floorEntry(Character key) { return floorEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2IntMap.Entry ceilingEntry(Character key) { return ceilingEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2IntMap.Entry higherEntry(Character key) { return higherEntry(key.charValue()); }
	
	@Override
	@Deprecated
	default Char2IntNavigableMap subMap(Character fromKey, boolean fromInclusive, Character toKey, boolean toInclusive) { return subMap(fromKey.charValue(), fromInclusive, toKey.charValue(), toInclusive); }
	@Override
	@Deprecated
	default Char2IntNavigableMap headMap(Character toKey, boolean inclusive) { return headMap(toKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2IntNavigableMap tailMap(Character fromKey, boolean inclusive) { return tailMap(fromKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2IntNavigableMap subMap(Character fromKey, Character toKey) { return subMap(fromKey.charValue(), true, toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2IntNavigableMap headMap(Character toKey) { return headMap(toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2IntNavigableMap tailMap(Character fromKey) { return tailMap(fromKey.charValue(), true); }
}