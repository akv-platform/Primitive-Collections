 ...
 */
public class Char2ByteLinkedOpenHashMap extends Char2ByteOpenHashMap implements Char2ByteOrderedMap
{
	 ...
	 */
	public Char2ByteLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Char2ByteLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2ByteLinkedOpenHashMap(Character[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ByteLinkedOpenHashMap(Character[] keys, Byte[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2ByteLinkedOpenHashMap(char[] keys, byte[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ByteLinkedOpenHashMap(char[] keys, byte[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ByteLinkedOpenHashMap(Map<? extends Character, ? extends Byte> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2ByteLinkedOpenHashMap(Char2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2ByteLinkedOpenHashMap(Char2ByteMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Char2ByteLinkedOpenHashMap copy() {
		Char2ByteLinkedOpenHashMap map = new Char2ByteLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2ByteMap.Entry o) {
			return Char2ByteLinkedOpenHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2ByteMap.Entry o) {
			return Char2ByteLinkedOpenHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2ByteMap.Entry) {
					...
					int index = Char2ByteLinkedOpenHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return entry.getByteValue() == Char2ByteLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Char2ByteLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Char2ByteLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2ByteMap.Entry) {
					Char2ByteMap.Entry entry = (Char2ByteMap.Entry)o;
					return Char2ByteLinkedOpenHashMap.this.remove(entry.getCharKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2ByteLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2ByteLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2ByteLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2ByteLinkedOpenHashMap.this.moveToLast(o);
		}
