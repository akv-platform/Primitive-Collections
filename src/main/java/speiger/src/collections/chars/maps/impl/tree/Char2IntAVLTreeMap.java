 ...
 */
public class Char2IntAVLTreeMap extends AbstractChar2IntMap implements Char2IntNavigableMap
{
	...
	/** EntrySet Cache */
	protected ObjectSet<Char2IntMap.Entry> entrySet;
	 ...
	 */
	public Char2IntAVLTreeMap(CharComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Char2IntAVLTreeMap(Character[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2IntAVLTreeMap(Character[] keys, Integer[] values, CharComparator comp) {
		comparator = comp;
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2IntAVLTreeMap(char[] keys, int[] values) {
		this(keys, values, null);
	}
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2IntAVLTreeMap(char[] keys, int[] values, CharComparator comp) {
		comparator = comp;
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Char2IntAVLTreeMap(Map<? extends Character, ? extends Integer> map, CharComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2IntAVLTreeMap(Char2IntMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Char2IntAVLTreeMap(Char2IntMap map, CharComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Char2IntMap.Entry firstEntry() {
		if(tree == null) return null;
		return first.export();
	}
	
	@Override
	public Char2IntMap.Entry lastEntry() {
		if(tree == null) return null;
		return last.export();
	}
	
	@Override
	public Char2IntMap.Entry pollFirstEntry() {
		if(tree == null) return null;
	...
	@Override
	public Char2IntMap.Entry pollLastEntry() {
		if(tree == null) return null;
	...
	@Override
	public Char2IntAVLTreeMap copy() {
		Char2IntAVLTreeMap set = new Char2IntAVLTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	@Override
	public Char2IntNavigableMap descendingMap() {
	...
	@Override
	public Char2IntNavigableMap headMap(char toKey, boolean inclusive) {
		return new AscendingNaivgableSubMap(this, true, (char)0, true, false, toKey, inclusive);
	}
	
	@Override
	public Char2IntNavigableMap tailMap(char fromKey, boolean inclusive) {
	...
	@Override
	public Char2IntMap.Entry lowerEntry(char key) {
		Node node = findLowerNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Char2IntMap.Entry higherEntry(char key) {
		Node node = findHigherNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Char2IntMap.Entry floorEntry(char key) {
		Node node = findFloorNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Char2IntMap.Entry ceilingEntry(char key) {
	...
	static class KeySet extends AbstractCharSet implements CharNavigableSet
	{
		...
		public KeySet(Char2IntNavigableMap map) {
			this.map = map;
		}
		...
		public Character lower(Character e) {
			Char2IntMap.Entry node = map.lowerEntry(e.charValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Character floor(Character e) {
			Char2IntMap.Entry node = map.floorEntry(e.charValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Character higher(Character e) {
			Char2IntMap.Entry node = map.higherEntry(e.charValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Character ceiling(Character e) {
			Char2IntMap.Entry node = map.ceilingEntry(e.charValue());
			return node != null ? node.getKey() : null;
		}
		...
		public CharBidirectionalIterator iterator(char fromElement) {
			if(map instanceof Char2IntAVLTreeMap) return ((Char2IntAVLTreeMap)map).keyIterator(fromElement);
		...
		public CharBidirectionalIterator iterator() {
			if(map instanceof Char2IntAVLTreeMap) return ((Char2IntAVLTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public CharBidirectionalIterator descendingIterator() {
			if(map instanceof Char2IntAVLTreeMap) return ((Char2IntAVLTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Char2IntAVLTreeMap) return ((Char2IntAVLTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Char2IntAVLTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Char2IntAVLTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Char2IntAVLTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Char2IntAVLTreeMap map, boolean fromStart, char lo, boolean loInclusive, boolean toEnd, char hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Char2IntAVLTreeMap map, boolean fromStart, char lo, boolean loInclusive, boolean toEnd, char hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractChar2IntMap implements Char2IntNavigableMap
	{
		final Char2IntAVLTreeMap map;
		final char lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		
		Char2IntNavigableMap inverse;
		CharNavigableSet keySet;
		ObjectSet<Char2IntMap.Entry> entrySet;
		IntCollection values;
		
		NavigableSubMap(Char2IntAVLTreeMap map, boolean fromStart, char lo, boolean loInclusive, boolean toEnd, char hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
		...
		@Override
		public Char2IntMap.Entry lowerEntry(char key) { return subLower(key); }
		@Override
		public Char2IntMap.Entry floorEntry(char key) { return subFloor(key); }
		@Override
		public Char2IntMap.Entry ceilingEntry(char key) { return subCeiling(key); }
		@Override
		public Char2IntMap.Entry higherEntry(char key) { return subHigher(key); }
		...
		public Char2IntMap.Entry pollFirstEntry() {
			Node entry = subLowest();
			if(entry != null) {
				Char2IntMap.Entry result = entry.export();
				map.removeNode(entry);
				return result;
			}
			return null;
		...
		abstract class SubEntrySet extends AbstractObjectSet<Char2IntMap.Entry> {
			@Override
			public int size() {
				if (fromStart && toEnd) return map.size();
				int size = 0;
				for(ObjectIterator<Char2IntMap.Entry> iter = iterator();iter.hasNext();iter.next(),size++);
				return size;
			}
		...
		class DecsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Char2IntMap.Entry>
		{
		...
		class AcsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Char2IntMap.Entry>
		{
	...
	class Values extends AbstractIntCollection
	{
		...
		@Override
		public int size() {
			return Char2IntAVLTreeMap.this.size;
		}
	...
	class EntrySet extends AbstractObjectSet<Char2IntMap.Entry> {
	...
	class AscendingMapEntryIterator extends MapEntryIterator implements ObjectBidirectionalIterator<Char2IntMap.Entry>
	{
	...
	private static final class Node implements Char2IntMap.Entry
	{
		char key;
		int value;
		int state;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				...
				return otherKey instanceof Character && otherValue instanceof Integer && key == ((Character)otherKey).charValue() && value == ((Integer)otherValue).intValue();
			}
			return false;
		}
