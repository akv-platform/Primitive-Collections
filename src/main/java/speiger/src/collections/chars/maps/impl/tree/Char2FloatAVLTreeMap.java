 ...
 */
public class Char2FloatAVLTreeMap extends AbstractChar2FloatMap implements Char2FloatNavigableMap
{
	...
	/** EntrySet Cache */
	protected ObjectSet<Char2FloatMap.Entry> entrySet;
	 ...
	 */
	public Char2FloatAVLTreeMap(CharComparator comp) {
		comparator = comp;
	}
	 ...
	 */
	public Char2FloatAVLTreeMap(Character[] keys, Float[] values) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2FloatAVLTreeMap(Character[] keys, Float[] values, CharComparator comp) {
		comparator = comp;
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2FloatAVLTreeMap(char[] keys, float[] values) {
		this(keys, values, null);
	}
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2FloatAVLTreeMap(char[] keys, float[] values, CharComparator comp) {
		comparator = comp;
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
	 */
	public Char2FloatAVLTreeMap(Map<? extends Character, ? extends Float> map, CharComparator comp) {
		comparator = comp;
		putAll(map);
	}
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2FloatAVLTreeMap(Char2FloatMap map) {
		this(map, null);
	}
	 ...
	 * @param comp the function that decides how the tree is sorted, can be null
 	 */
	public Char2FloatAVLTreeMap(Char2FloatMap map, CharComparator comp) {
		comparator = comp;
		putAll(map);
	}
	...
	@Override
	public Char2FloatAVLTreeMap copy() {
		Char2FloatAVLTreeMap set = new Char2FloatAVLTreeMap();
		set.size = size;
		if(tree != null) {
			set.tree = tree.copy();
			Node lastFound = null;
	...
	@Override
	public Char2FloatNavigableMap descendingMap() {
	...
	@Override
	public Char2FloatNavigableMap subMap(char fromKey, boolean fromInclusive, char toKey, boolean toInclusive) {
		return new AscendingNaivgableSubMap(this, false, fromKey, fromInclusive, false, toKey, toInclusive);
	}
	
	@Override
	public Char2FloatNavigableMap headMap(char toKey, boolean inclusive) {
		return new AscendingNaivgableSubMap(this, true, (char)0, true, false, toKey, inclusive);
	}
	
	@Override
	public Char2FloatNavigableMap tailMap(char fromKey, boolean inclusive) {
	...
	@Override
	public Char2FloatMap.Entry lowerEntry(char key) {
		Node node = findLowerNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Char2FloatMap.Entry higherEntry(char key) {
		Node node = findHigherNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Char2FloatMap.Entry floorEntry(char key) {
		Node node = findFloorNode(key);
		return node != null ? node.export() : null;
	}
	
	@Override
	public Char2FloatMap.Entry ceilingEntry(char key) {
	...
	static class KeySet extends AbstractCharSet implements CharNavigableSet
	{
		...
		public KeySet(Char2FloatNavigableMap map) {
			this.map = map;
		}
		...
		public Character lower(Character e) {
			Char2FloatMap.Entry node = map.lowerEntry(e.charValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Character floor(Character e) {
			Char2FloatMap.Entry node = map.floorEntry(e.charValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Character higher(Character e) {
			Char2FloatMap.Entry node = map.higherEntry(e.charValue());
			return node != null ? node.getKey() : null;
		}
		
		@Override
		public Character ceiling(Character e) {
			Char2FloatMap.Entry node = map.ceilingEntry(e.charValue());
			return node != null ? node.getKey() : null;
		}
		...
		public CharBidirectionalIterator iterator(char fromElement) {
			if(map instanceof Char2FloatAVLTreeMap) return ((Char2FloatAVLTreeMap)map).keyIterator(fromElement);
		...
		public CharBidirectionalIterator iterator() {
			if(map instanceof Char2FloatAVLTreeMap) return ((Char2FloatAVLTreeMap)map).keyIterator();
			return ((NavigableSubMap)map).keyIterator();
		}
		
		@Override
		public CharBidirectionalIterator descendingIterator() {
			if(map instanceof Char2FloatAVLTreeMap) return ((Char2FloatAVLTreeMap)map).descendingKeyIterator();
			return ((NavigableSubMap)map).descendingKeyIterator();
		}
		
		protected Node start() {
			if(map instanceof Char2FloatAVLTreeMap) return ((Char2FloatAVLTreeMap)map).first;
			return ((NavigableSubMap)map).subLowest();
		}
		
		protected Node end() {
			if(map instanceof Char2FloatAVLTreeMap) return null;
			return ((NavigableSubMap)map).subHighest();
		}
		
		protected Node next(Node entry) {
			if(map instanceof Char2FloatAVLTreeMap) return entry.next();
			return ((NavigableSubMap)map).next(entry);
		}
		
		protected Node previous(Node entry) {
			if(map instanceof Char2FloatAVLTreeMap) return entry.previous();
	...
	{
		AscendingNaivgableSubMap(Char2FloatAVLTreeMap map, boolean fromStart, char lo, boolean loInclusive, boolean toEnd, char hi, boolean hiInclusive) {
	...
	static class DescendingNaivgableSubMap extends NavigableSubMap
	{
		...
		DescendingNaivgableSubMap(Char2FloatAVLTreeMap map, boolean fromStart, char lo, boolean loInclusive, boolean toEnd, char hi, boolean hiInclusive) {
			super(map, fromStart, lo, loInclusive, toEnd, hi, hiInclusive);
	...
	static abstract class NavigableSubMap extends AbstractChar2FloatMap implements Char2FloatNavigableMap
	{
		final Char2FloatAVLTreeMap map;
		final char lo, hi;
		final boolean fromStart, toEnd;
		final boolean loInclusive, hiInclusive;
		
		Char2FloatNavigableMap inverse;
		CharNavigableSet keySet;
		ObjectSet<Char2FloatMap.Entry> entrySet;
		FloatCollection values;
		
		NavigableSubMap(Char2FloatAVLTreeMap map, boolean fromStart, char lo, boolean loInclusive, boolean toEnd, char hi, boolean hiInclusive) {
			if (!fromStart && !toEnd) {
		...
		@Override
		public Char2FloatMap.Entry lowerEntry(char key) { return subLower(key); }
		@Override
		public Char2FloatMap.Entry floorEntry(char key) { return subFloor(key); }
		@Override
		public Char2FloatMap.Entry ceilingEntry(char key) { return subCeiling(key); }
		@Override
		public Char2FloatMap.Entry higherEntry(char key) { return subHigher(key); }
		...
		public Char2FloatMap.Entry pollFirstEntry() {
			Node entry = subLowest();
			if(entry != null) {
				Char2FloatMap.Entry result = entry.export();
				map.removeNode(entry);
				return result;
			}
			return null;
		...
		abstract class SubEntrySet extends AbstractObjectSet<Char2FloatMap.Entry> {
			@Override
			public int size() {
				if (fromStart && toEnd) return map.size();
				int size = 0;
				for(ObjectIterator<Char2FloatMap.Entry> iter = iterator();iter.hasNext();iter.next(),size++);
				return size;
			}
		...
		class DecsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Char2FloatMap.Entry>
		{
		...
		class AcsendingSubEntryIterator extends SubMapEntryIterator implements ObjectBidirectionalIterator<Char2FloatMap.Entry>
		{
	...
	class Values extends AbstractFloatCollection
	{
		...
		@Override
		public int size() {
			return Char2FloatAVLTreeMap.this.size;
		}
	...
	class EntrySet extends AbstractObjectSet<Char2FloatMap.Entry> {
	...
	class AscendingMapEntryIterator extends MapEntryIterator implements ObjectBidirectionalIterator<Char2FloatMap.Entry>
	{
	...
	private static final class Node implements Char2FloatMap.Entry
	{
		char key;
		float value;
		int state;
		...
		Node(char key, float value, Node parent) {
			this.key = key;
			this.value = value;
			this.parent = parent;
		}
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				...
				return otherKey instanceof Character && otherValue instanceof Float && key == ((Character)otherKey).charValue() && Float.floatToIntBits(value) == Float.floatToIntBits(((Float)otherValue).floatValue());
			}
			return false;
		}
