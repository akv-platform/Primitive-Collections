 ...
 */
public class Char2FloatLinkedOpenCustomHashMap extends Char2FloatOpenCustomHashMap implements Char2FloatOrderedMap
{
	 ...
	 */
	public Char2FloatLinkedOpenCustomHashMap(CharStrategy strategy) {
	 ...
	 */
	public Char2FloatLinkedOpenCustomHashMap(int minCapacity, CharStrategy strategy) {
	 ...
	 */
	public Char2FloatLinkedOpenCustomHashMap(int minCapacity, float loadFactor, CharStrategy strategy) {
	 ...
	 */
	public Char2FloatLinkedOpenCustomHashMap(Character[] keys, Float[] values, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2FloatLinkedOpenCustomHashMap(Character[] keys, Float[] values, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2FloatLinkedOpenCustomHashMap(char[] keys, float[] values, CharStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2FloatLinkedOpenCustomHashMap(char[] keys, float[] values, float loadFactor, CharStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Char2FloatLinkedOpenCustomHashMap(Map<? extends Character, ? extends Float> map, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2FloatLinkedOpenCustomHashMap(Map<? extends Character, ? extends Float> map, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Char2FloatLinkedOpenCustomHashMap(Char2FloatMap map, CharStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2FloatLinkedOpenCustomHashMap(Char2FloatMap map, float loadFactor, CharStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Char2FloatLinkedOpenCustomHashMap copy() {
		Char2FloatLinkedOpenCustomHashMap map = new Char2FloatLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2FloatMap.Entry> implements Char2FloatOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2FloatMap.Entry o) {
			return Char2FloatLinkedOpenCustomHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2FloatMap.Entry o) {
			return Char2FloatLinkedOpenCustomHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2FloatMap.Entry) {
					...
					int index = Char2FloatLinkedOpenCustomHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return Float.floatToIntBits(entry.getFloatValue()) == Float.floatToIntBits(Char2FloatLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Character)) return false;
					int index = Char2FloatLinkedOpenCustomHashMap.this.findIndex((Character)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Float.valueOf(Char2FloatLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2FloatMap.Entry) {
					Char2FloatMap.Entry entry = (Char2FloatMap.Entry)o;
					return Char2FloatLinkedOpenCustomHashMap.this.remove(entry.getCharKey(), entry.getFloatValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2FloatLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2FloatLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2FloatLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2FloatLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2FloatLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2FloatLinkedOpenCustomHashMap.this.moveToLast(o);
		}
