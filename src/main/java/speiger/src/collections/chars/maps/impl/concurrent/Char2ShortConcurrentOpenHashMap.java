...
import speiger.src.collections.chars.maps.interfaces.Char2ShortConcurrentMap;
 ...
 * 
 */
public class Char2ShortConcurrentOpenHashMap extends AbstractChar2ShortMap implements Char2ShortConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Char2ShortConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Char2ShortConcurrentOpenHashMap() {
	 ...
	 */
	public Char2ShortConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Char2ShortConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2ShortConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ShortConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ShortConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Char2ShortConcurrentOpenHashMap(Character[] keys, Short[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ShortConcurrentOpenHashMap(Character[] keys, Short[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ShortConcurrentOpenHashMap(Character[] keys, Short[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ShortConcurrentOpenHashMap(Character[] keys, Short[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2ShortConcurrentOpenHashMap(char[] keys, short[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ShortConcurrentOpenHashMap(char[] keys, short[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ShortConcurrentOpenHashMap(char[] keys, short[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ShortConcurrentOpenHashMap(char[] keys, short[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Char2ShortConcurrentOpenHashMap(Map<? extends Character, ? extends Short> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ShortConcurrentOpenHashMap(Map<? extends Character, ? extends Short> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ShortConcurrentOpenHashMap(Map<? extends Character, ? extends Short> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ShortConcurrentOpenHashMap(Map<? extends Character, ? extends Short> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2ShortConcurrentOpenHashMap(Char2ShortMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2ShortConcurrentOpenHashMap(Char2ShortMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2ShortConcurrentOpenHashMap(Char2ShortMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2ShortConcurrentOpenHashMap(Char2ShortMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Char2ShortConcurrentOpenHashMap copy() {
		Char2ShortConcurrentOpenHashMap copy = new Char2ShortConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2ShortMap.Entry> implements Char2ShortMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2ShortMap.Entry) {
					Char2ShortMap.Entry entry = (Char2ShortMap.Entry)o;
					return Char2ShortConcurrentOpenHashMap.this.remove(entry.getCharKey(), entry.getShortValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2ShortConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2ShortConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2ShortConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharSet {
		...
		public boolean remove(char o) {
			int oldSize = size();
			Char2ShortConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2ShortMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2ShortMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Char2ShortMap.Entry, Map.Entry<Character, Short> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Char2ShortMap.Entry) {
					...
					return getCharKey() == entry.getCharKey() && getShortValue() == entry.getShortValue();
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Character && value instanceof Short && getCharKey() == ((Character)key).charValue() && getShortValue() == ((Short)value).shortValue();
			}
			return false;
		}
		...
		@Override
		public int hashCode() {
			return Character.hashCode(getCharKey()) ^ Short.hashCode(getShortValue());
		}
		
		@Override
		public String toString() {
			return Character.toString(getCharKey()) + "=" + Short.toString(getShortValue());
		}
	}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Char2ShortConcurrentOpenHashMap map;
		...
		protected Segment(Char2ShortConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Char2ShortConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Char2ShortConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected short put(int hash, char key, short value) {
		...
		protected short putIfAbsent(int hash, char key, short value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected short addTo(int hash, char key, short value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected short subFrom(int hash, char key, short value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected short get(int hash, char key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected short getOrDefault(int hash, char key, short defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(CharShortConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected short remove(int hash, char key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected short removeOrDefault(int hash, char key, short defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, char key, short value) {
			long stamp = writeLock();
			try {
				if(key == (char)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				char current = keys[pos];
				if(current == (char)0) return false;
				if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, Short.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (char)0) return false;
					else if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, Short.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, char key, short oldValue, short newValue) {
			long stamp = writeLock();
			try {
		...
		protected short replace(int hash, char key, short value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected short compute(int hash, char key, CharShortUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected short merge(int hash, char key, short value, ShortShortUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected void insert(int slot, char key, short value) {
