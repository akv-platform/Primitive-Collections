...
import speiger.src.collections.chars.maps.interfaces.Char2DoubleConcurrentMap;
 ...
 * 
 */
public class Char2DoubleConcurrentOpenHashMap extends AbstractChar2DoubleMap implements Char2DoubleConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Char2DoubleConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Char2DoubleConcurrentOpenHashMap() {
	 ...
	 */
	public Char2DoubleConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Char2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2DoubleConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2DoubleConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2DoubleConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Char2DoubleConcurrentOpenHashMap(Character[] keys, Double[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2DoubleConcurrentOpenHashMap(Character[] keys, Double[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2DoubleConcurrentOpenHashMap(Character[] keys, Double[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2DoubleConcurrentOpenHashMap(Character[] keys, Double[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2DoubleConcurrentOpenHashMap(char[] keys, double[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2DoubleConcurrentOpenHashMap(char[] keys, double[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2DoubleConcurrentOpenHashMap(char[] keys, double[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2DoubleConcurrentOpenHashMap(char[] keys, double[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Char2DoubleConcurrentOpenHashMap(Map<? extends Character, ? extends Double> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2DoubleConcurrentOpenHashMap(Map<? extends Character, ? extends Double> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2DoubleConcurrentOpenHashMap(Map<? extends Character, ? extends Double> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2DoubleConcurrentOpenHashMap(Map<? extends Character, ? extends Double> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2DoubleConcurrentOpenHashMap(Char2DoubleMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2DoubleConcurrentOpenHashMap(Char2DoubleMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2DoubleConcurrentOpenHashMap(Char2DoubleMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2DoubleConcurrentOpenHashMap(Char2DoubleMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Char2DoubleConcurrentOpenHashMap copy() {
		Char2DoubleConcurrentOpenHashMap copy = new Char2DoubleConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements Char2DoubleMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2DoubleMap.Entry) {
					Char2DoubleMap.Entry entry = (Char2DoubleMap.Entry)o;
					return Char2DoubleConcurrentOpenHashMap.this.remove(entry.getCharKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2DoubleConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2DoubleConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2DoubleConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharSet {
		...
		public boolean remove(char o) {
			int oldSize = size();
			Char2DoubleConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2DoubleMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2DoubleMap.Entry> {
		MapEntry entry;
	...
	protected class MapEntry implements Char2DoubleMap.Entry, Map.Entry<Character, Double> {
		...
		@Override
		public int hashCode() {
			return Character.hashCode(getCharKey()) ^ Double.hashCode(getDoubleValue());
		}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Char2DoubleConcurrentOpenHashMap map;
		...
		protected Segment(Char2DoubleConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Char2DoubleConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Char2DoubleConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected double put(int hash, char key, double value) {
		...
		protected double putIfAbsent(int hash, char key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double addTo(int hash, char key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected double subFrom(int hash, char key, double value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double get(int hash, char key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected double getOrDefault(int hash, char key, double defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(CharDoubleConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected double remove(int hash, char key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected double removeOrDefault(int hash, char key, double defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, char key, double value) {
			long stamp = writeLock();
			try {
				if(key == (char)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				char current = keys[pos];
				if(current == (char)0) return false;
				if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, Double.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (char)0) return false;
					else if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, Double.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, char key, double oldValue, double newValue) {
			long stamp = writeLock();
			try {
		...
		protected double replace(int hash, char key, double value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected double compute(int hash, char key, CharDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected double merge(int hash, char key, double value, DoubleDoubleUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
