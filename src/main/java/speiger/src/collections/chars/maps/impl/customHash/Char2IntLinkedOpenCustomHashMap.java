 ...
 */
public class Char2IntLinkedOpenCustomHashMap extends Char2IntOpenCustomHashMap implements Char2IntOrderedMap
{
	 ...
	 */
	public Char2IntLinkedOpenCustomHashMap(CharStrategy strategy) {
	 ...
	 */
	public Char2IntLinkedOpenCustomHashMap(int minCapacity, CharStrategy strategy) {
	 ...
	 */
	public Char2IntLinkedOpenCustomHashMap(int minCapacity, float loadFactor, CharStrategy strategy) {
	 ...
	 */
	public Char2IntLinkedOpenCustomHashMap(Character[] keys, Integer[] values, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2IntLinkedOpenCustomHashMap(Character[] keys, Integer[] values, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2IntLinkedOpenCustomHashMap(char[] keys, int[] values, CharStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2IntLinkedOpenCustomHashMap(char[] keys, int[] values, float loadFactor, CharStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Char2IntLinkedOpenCustomHashMap(Map<? extends Character, ? extends Integer> map, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2IntLinkedOpenCustomHashMap(Map<? extends Character, ? extends Integer> map, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Char2IntLinkedOpenCustomHashMap(Char2IntMap map, CharStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2IntLinkedOpenCustomHashMap(Char2IntMap map, float loadFactor, CharStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Char2IntLinkedOpenCustomHashMap copy() {
		Char2IntLinkedOpenCustomHashMap map = new Char2IntLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2IntMap.Entry o) {
			return Char2IntLinkedOpenCustomHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2IntMap.Entry o) {
			return Char2IntLinkedOpenCustomHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2IntMap.Entry) {
					...
					int index = Char2IntLinkedOpenCustomHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return entry.getIntValue() == Char2IntLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Character)) return false;
					int index = Char2IntLinkedOpenCustomHashMap.this.findIndex((Character)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Integer.valueOf(Char2IntLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2IntMap.Entry) {
					Char2IntMap.Entry entry = (Char2IntMap.Entry)o;
					return Char2IntLinkedOpenCustomHashMap.this.remove(entry.getCharKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2IntLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2IntLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2IntLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2IntLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2IntLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2IntLinkedOpenCustomHashMap.this.moveToLast(o);
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Char2IntMap.Entry> {
		...
		@Override
		public void set(Char2IntMap.Entry entry) { throw new UnsupportedOperationException(); }

		@Override
		public void add(Char2IntMap.Entry entry) { throw new UnsupportedOperationException(); }
	}
