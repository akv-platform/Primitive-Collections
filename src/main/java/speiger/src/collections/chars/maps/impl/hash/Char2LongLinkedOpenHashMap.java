 ...
 */
public class Char2LongLinkedOpenHashMap extends Char2LongOpenHashMap implements Char2LongOrderedMap
{
	 ...
	 */
	public Char2LongLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Char2LongLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2LongLinkedOpenHashMap(Character[] keys, Long[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2LongLinkedOpenHashMap(Character[] keys, Long[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2LongLinkedOpenHashMap(char[] keys, long[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2LongLinkedOpenHashMap(char[] keys, long[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2LongLinkedOpenHashMap(Map<? extends Character, ? extends Long> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2LongLinkedOpenHashMap(Char2LongMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2LongLinkedOpenHashMap(Char2LongMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Char2LongLinkedOpenHashMap copy() {
		Char2LongLinkedOpenHashMap map = new Char2LongLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2LongMap.Entry> implements Char2LongOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2LongMap.Entry o) {
			return Char2LongLinkedOpenHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2LongMap.Entry o) {
			return Char2LongLinkedOpenHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2LongMap.Entry) {
					...
					int index = Char2LongLinkedOpenHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return entry.getLongValue() == Char2LongLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Char2LongLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Long.valueOf(Char2LongLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2LongMap.Entry) {
					Char2LongMap.Entry entry = (Char2LongMap.Entry)o;
					return Char2LongLinkedOpenHashMap.this.remove(entry.getCharKey(), entry.getLongValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2LongLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2LongLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2LongLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2LongLinkedOpenHashMap.this.moveToLast(o);
		}
