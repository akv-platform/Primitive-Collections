 ...
 */
public class Char2CharLinkedOpenHashMap extends Char2CharOpenHashMap implements Char2CharOrderedMap
{
	 ...
	 */
	public Char2CharLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Char2CharLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2CharLinkedOpenHashMap(Character[] keys, Character[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2CharLinkedOpenHashMap(Character[] keys, Character[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2CharLinkedOpenHashMap(char[] keys, char[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2CharLinkedOpenHashMap(char[] keys, char[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2CharLinkedOpenHashMap(Map<? extends Character, ? extends Character> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2CharLinkedOpenHashMap(Char2CharMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2CharLinkedOpenHashMap(Char2CharMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Char2CharLinkedOpenHashMap copy() {
		Char2CharLinkedOpenHashMap map = new Char2CharLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2CharMap.Entry> implements Char2CharOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2CharMap.Entry o) {
			return Char2CharLinkedOpenHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2CharMap.Entry o) {
			return Char2CharLinkedOpenHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2CharMap.Entry) {
					...
					int index = Char2CharLinkedOpenHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return entry.getCharValue() == Char2CharLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Char2CharLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Char2CharLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2CharMap.Entry) {
					Char2CharMap.Entry entry = (Char2CharMap.Entry)o;
					return Char2CharLinkedOpenHashMap.this.remove(entry.getCharKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2CharLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2CharLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2CharLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2CharLinkedOpenHashMap.this.moveToLast(o);
		}
