...
public abstract class AbstractChar2CharMap extends AbstractMap<Character, Character> implements Char2CharMap
{
	...
	public void putAll(Char2CharMap m) {
		for(ObjectIterator<Char2CharMap.Entry> iter = Char2CharMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceChars(CharCharUnaryOperator mappingFunction) {
		...
		for(ObjectIterator<Char2CharMap.Entry> iter = Char2CharMaps.fastIterator(this);iter.hasNext();) {
			Char2CharMap.Entry entry = iter.next();
		...
		return new AbstractCharSet() {
			...
			public CharIterator iterator() {
				return new CharIterator() {
					ObjectIterator<Char2CharMap.Entry> iter = Char2CharMaps.fastIterator(AbstractChar2CharMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Char2CharMap.Entry> iter = Char2CharMaps.fastIterator(this);
