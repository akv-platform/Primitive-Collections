...
import speiger.src.collections.chars.maps.interfaces.Char2ByteConcurrentMap;
 ...
 * 
 */
public class Char2ByteConcurrentOpenHashMap extends AbstractChar2ByteMap implements Char2ByteConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Char2ByteConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Char2ByteConcurrentOpenHashMap() {
	 ...
	 */
	public Char2ByteConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Char2ByteConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2ByteConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ByteConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ByteConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Char2ByteConcurrentOpenHashMap(Character[] keys, Byte[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ByteConcurrentOpenHashMap(Character[] keys, Byte[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ByteConcurrentOpenHashMap(Character[] keys, Byte[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ByteConcurrentOpenHashMap(Character[] keys, Byte[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2ByteConcurrentOpenHashMap(char[] keys, byte[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ByteConcurrentOpenHashMap(char[] keys, byte[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ByteConcurrentOpenHashMap(char[] keys, byte[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ByteConcurrentOpenHashMap(char[] keys, byte[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Char2ByteConcurrentOpenHashMap(Map<? extends Character, ? extends Byte> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ByteConcurrentOpenHashMap(Map<? extends Character, ? extends Byte> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ByteConcurrentOpenHashMap(Map<? extends Character, ? extends Byte> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ByteConcurrentOpenHashMap(Map<? extends Character, ? extends Byte> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2ByteConcurrentOpenHashMap(Char2ByteMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2ByteConcurrentOpenHashMap(Char2ByteMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2ByteConcurrentOpenHashMap(Char2ByteMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2ByteConcurrentOpenHashMap(Char2ByteMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Char2ByteConcurrentOpenHashMap copy() {
		Char2ByteConcurrentOpenHashMap copy = new Char2ByteConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2ByteMap.Entry) {
					Char2ByteMap.Entry entry = (Char2ByteMap.Entry)o;
					return Char2ByteConcurrentOpenHashMap.this.remove(entry.getCharKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2ByteConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2ByteConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2ByteConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharSet {
		...
		public boolean remove(char o) {
			int oldSize = size();
			Char2ByteConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2ByteMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2ByteMap.Entry> {
		MapEntry entry;
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Char2ByteMap.Entry) {
					...
					return getCharKey() == entry.getCharKey() && getByteValue() == entry.getByteValue();
				}
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Char2ByteConcurrentOpenHashMap map;
		...
		protected Segment(Char2ByteConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Char2ByteConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Char2ByteConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected byte put(int hash, char key, byte value) {
		...
		protected byte putIfAbsent(int hash, char key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected byte addTo(int hash, char key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected byte subFrom(int hash, char key, byte value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected byte get(int hash, char key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected byte getOrDefault(int hash, char key, byte defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(CharByteConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected byte remove(int hash, char key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected byte removeOrDefault(int hash, char key, byte defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, char key, byte value) {
			long stamp = writeLock();
			try {
				if(key == (char)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				char current = keys[pos];
				if(current == (char)0) return false;
				if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, Byte.valueOf(values[pos]))) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (char)0) return false;
					else if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, Byte.valueOf(values[pos]))){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, char key, byte oldValue, byte newValue) {
			long stamp = writeLock();
			try {
		...
		protected byte replace(int hash, char key, byte value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected byte compute(int hash, char key, CharByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected byte merge(int hash, char key, byte value, ByteByteUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected void insert(int slot, char key, byte value) {
