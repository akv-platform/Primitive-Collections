...
import speiger.src.collections.chars.maps.interfaces.Char2IntConcurrentMap;
 ...
 * 
 */
public class Char2IntConcurrentOpenHashMap extends AbstractChar2IntMap implements Char2IntConcurrentMap, ITrimmable
{
	/** Segment Limit */
	 ...
	 */
	protected Char2IntConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Char2IntConcurrentOpenHashMap() {
	 ...
	 */
	public Char2IntConcurrentOpenHashMap(int minCapacity) {
	 ...
	 */
	public Char2IntConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2IntConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2IntConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2IntConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Char2IntConcurrentOpenHashMap(Character[] keys, Integer[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2IntConcurrentOpenHashMap(Character[] keys, Integer[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2IntConcurrentOpenHashMap(Character[] keys, Integer[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2IntConcurrentOpenHashMap(Character[] keys, Integer[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2IntConcurrentOpenHashMap(char[] keys, int[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2IntConcurrentOpenHashMap(char[] keys, int[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2IntConcurrentOpenHashMap(char[] keys, int[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2IntConcurrentOpenHashMap(char[] keys, int[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Char2IntConcurrentOpenHashMap(Map<? extends Character, ? extends Integer> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2IntConcurrentOpenHashMap(Map<? extends Character, ? extends Integer> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2IntConcurrentOpenHashMap(Map<? extends Character, ? extends Integer> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2IntConcurrentOpenHashMap(Map<? extends Character, ? extends Integer> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2IntConcurrentOpenHashMap(Char2IntMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2IntConcurrentOpenHashMap(Char2IntMap map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2IntConcurrentOpenHashMap(Char2IntMap map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2IntConcurrentOpenHashMap(Char2IntMap map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Char2IntConcurrentOpenHashMap copy() {
		Char2IntConcurrentOpenHashMap copy = new Char2IntConcurrentOpenHashMap(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntMap.FastEntrySet {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2IntMap.Entry) {
					Char2IntMap.Entry entry = (Char2IntMap.Entry)o;
					return Char2IntConcurrentOpenHashMap.this.remove(entry.getCharKey(), entry.getIntValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2IntConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2IntConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2IntConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharSet {
		...
		public boolean remove(char o) {
			int oldSize = size();
			Char2IntConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2IntMap.Entry> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2IntMap.Entry> {
		MapEntry entry;
	...
	protected static class Segment extends StampedLock
	{
		...
		protected final Char2IntConcurrentOpenHashMap map;
		...
		protected Segment(Char2IntConcurrentOpenHashMap map) {
			this.map = map;
		}
		
		protected Segment(Char2IntConcurrentOpenHashMap map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment copy(Char2IntConcurrentOpenHashMap newMap) {
			long stamp = readLock();
			try
			{
		...
		protected int put(int hash, char key, int value) {
		...
		protected int putIfAbsent(int hash, char key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected int addTo(int hash, char key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected int subFrom(int hash, char key, int value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected int get(int hash, char key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected int getOrDefault(int hash, char key, int defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(CharIntConsumer action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected int remove(int hash, char key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) return getDefaultReturnValue();
		...
		protected int removeOrDefault(int hash, char key, int defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, char key, int value) {
			long stamp = writeLock();
			try {
				if(key == (char)0) {
		...
		protected boolean replace(int hash, char key, int oldValue, int newValue) {
			long stamp = writeLock();
			try {
		...
		protected int replace(int hash, char key, int value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected int compute(int hash, char key, CharIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected int merge(int hash, char key, int value, IntIntUnaryOperator mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
