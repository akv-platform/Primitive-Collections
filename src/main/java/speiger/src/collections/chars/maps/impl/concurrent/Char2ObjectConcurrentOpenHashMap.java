...
import speiger.src.collections.chars.maps.interfaces.Char2ObjectConcurrentMap;
...
public class Char2ObjectConcurrentOpenHashMap<V> extends AbstractChar2ObjectMap<V> implements Char2ObjectConcurrentMap<V>
{
	 ...
	 */
	protected Char2ObjectConcurrentOpenHashMap(boolean unused) {}
	
	/**
	 * Default Constructor
	 */
	public Char2ObjectConcurrentOpenHashMap() {
	 ...
	 */
	public Char2ObjectConcurrentOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2ObjectConcurrentOpenHashMap(int minCapacity, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ObjectConcurrentOpenHashMap(float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ObjectConcurrentOpenHashMap(int minCapacity, float loadFactor, int concurrencyLevel) {
	 ...
	 */
	public Char2ObjectConcurrentOpenHashMap(Character[] keys, V[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ObjectConcurrentOpenHashMap(Character[] keys, V[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ObjectConcurrentOpenHashMap(Character[] keys, V[] values, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ObjectConcurrentOpenHashMap(Character[] keys, V[] values, float loadFactor, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2ObjectConcurrentOpenHashMap(char[] keys, V[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ObjectConcurrentOpenHashMap(char[] keys, V[] values, float loadFactor) {
		this(keys, values, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ObjectConcurrentOpenHashMap(char[] keys, V[] values, int concurrencyLevel) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ObjectConcurrentOpenHashMap(char[] keys, V[] values, float loadFactor, int concurrencyLevel) {
		this(keys.length, loadFactor, concurrencyLevel);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 */
	public Char2ObjectConcurrentOpenHashMap(Map<? extends Character, ? extends V> map) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ObjectConcurrentOpenHashMap(Map<? extends Character, ? extends V> map, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ObjectConcurrentOpenHashMap(Map<? extends Character, ? extends V> map, int concurrencyLevel) {
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
	 */
	public Char2ObjectConcurrentOpenHashMap(Map<? extends Character, ? extends V> map, float loadFactor, int concurrencyLevel) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2ObjectConcurrentOpenHashMap(Char2ObjectMap<V> map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2ObjectConcurrentOpenHashMap(Char2ObjectMap<V> map, float loadFactor) {
		this(map, loadFactor, HashUtil.DEFAULT_MIN_CONCURRENCY);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2ObjectConcurrentOpenHashMap(Char2ObjectMap<V> map, int concurrencyLevel) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, concurrencyLevel);
	}
	 ...
	 * @throws IllegalStateException if the concurrencyLevel is either below/equal to 0 or above/equal to 65535
 	 */
	public Char2ObjectConcurrentOpenHashMap(Char2ObjectMap<V> map, float loadFactor, int concurrencyLevel) {
		this(map.size(), loadFactor, concurrencyLevel);
		putAll(map);
	}
	...
	@Override
	public Char2ObjectConcurrentOpenHashMap<V> copy() {
		Char2ObjectConcurrentOpenHashMap<V> copy = new Char2ObjectConcurrentOpenHashMap<>(false);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements Char2ObjectMap.FastEntrySet<V> {
		@Override
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2ObjectMap.Entry) {
					Char2ObjectMap.Entry<V> entry = (Char2ObjectMap.Entry<V>)o;
					return Char2ObjectConcurrentOpenHashMap.this.remove(entry.getCharKey(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2ObjectConcurrentOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2ObjectConcurrentOpenHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2ObjectConcurrentOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharSet {
		...
		public boolean remove(char o) {
			int oldSize = size();
			Char2ObjectConcurrentOpenHashMap.this.remove(o);
			return size() != oldSize;
		}
	...
	private class FastEntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> {
	...
	private class EntryIterator extends MapIterator implements ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> {
		MapEntry entry;
	...
	protected class MapEntry implements Char2ObjectMap.Entry<V>, Map.Entry<Character, V> {
		...
		public boolean equals(Object obj) {
			if(obj instanceof Map.Entry) {
				if(obj instanceof Char2ObjectMap.Entry) {
					...
					return getCharKey() == entry.getCharKey() && Objects.equals(getValue(), entry.getValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)obj;
				Object key = entry.getKey();
				Object value = entry.getValue();
				return key instanceof Character && getCharKey() == ((Character)key).charValue() && Objects.equals(getValue(), value);
			}
			return false;
		}
		...
		public String toString() {
			return Character.toString(getCharKey()) + "=" + Objects.toString(getValue());
		}
	}
	...
	protected static class Segment<V> extends StampedLock
	{
		...
		protected final Char2ObjectConcurrentOpenHashMap<V> map;
		...
		protected Segment(Char2ObjectConcurrentOpenHashMap<V> map) {
			this.map = map;
		}
		
		protected Segment(Char2ObjectConcurrentOpenHashMap<V> map, int minCapacity, float loadFactor, boolean isNullContainer) {
			this.map = map;
		...
		protected Segment<V> copy(Char2ObjectConcurrentOpenHashMap<V> newMap) {
			long stamp = readLock();
			try
			{
		...
		protected V put(int hash, char key, V value) {
		...
		protected V putIfAbsent(int hash, char key, V value) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
				if(slot < 0) {
		...
		protected V get(int hash, char key) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected V getOrDefault(int hash, char key, V defaultValue) {
			long stamp = readLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected void forEach(CharObjectConsumer<V> action) {
			long stamp = readLock();
			try {
				int index = firstIndex;
				while(index != -1) {
		...
		protected V remove(int hash, char key) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected V removeOrDefault(int hash, char key, V defaultValue) {
			long stamp = writeLock();
			try {
				int slot = findIndex(hash, key);
		...
		protected boolean remove(int hash, char key, V value) {
			long stamp = writeLock();
			try {
				if(key == (char)0) {
		...
		protected boolean remove(int hash, Object key, Object value) {
			...
			try
			{
				...
				char current = keys[pos];
				if(current == (char)0) return false;
				if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, values[pos])) {
					removeIndex(pos);
					return true;
				}
				while(true) {
					if((current = keys[pos = (++pos & mask)]) == (char)0) return false;
					else if(Objects.equals(key, Character.valueOf(current)) && Objects.equals(value, values[pos])){
						removeIndex(pos);
						return true;
					}
				}				
		...
		protected boolean replace(int hash, char key, V oldValue, V newValue) {
			long stamp = writeLock();
			try {
		...
		protected V replace(int hash, char key, V value) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected V compute(int hash, char key, CharObjectUnaryOperator<V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected V computeIfAbsent(int hash, char key, Char2ObjectFunction<V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected V supplyIfAbsent(int hash, char key, ObjectSupplier<V> valueProvider) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
				if(index < 0) {
		...
		protected V computeIfPresent(int hash, char key, CharObjectUnaryOperator<V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
		...
		protected V merge(int hash, char key, V value, ObjectObjectUnaryOperator<V, V> mappingFunction) {
			long stamp = writeLock();
			try {
				int index = findIndex(hash, key);
