...
public abstract class AbstractChar2ObjectMap<V> extends AbstractMap<Character, V> implements Char2ObjectMap<V>
{
	...
	public void putAll(Char2ObjectMap<V> m) {
		for(ObjectIterator<Char2ObjectMap.Entry<V>> iter = Char2ObjectMaps.fastIterator(m);iter.hasNext();) {
	...
	public void replaceObjects(CharObjectUnaryOperator<V> mappingFunction) {
		...
		for(ObjectIterator<Char2ObjectMap.Entry<V>> iter = Char2ObjectMaps.fastIterator(this);iter.hasNext();) {
			Char2ObjectMap.Entry<V> entry = iter.next();
		...
		return new AbstractCharSet() {
			...
			public CharIterator iterator() {
				return new CharIterator() {
					ObjectIterator<Char2ObjectMap.Entry<V>> iter = Char2ObjectMaps.fastIterator(AbstractChar2ObjectMap.this);
					@Override
	...
	public int hashCode() {
		int hash = 0;
		ObjectIterator<Char2ObjectMap.Entry<V>> iter = Char2ObjectMaps.fastIterator(this);
