 ...
 */
public class Char2ByteLinkedOpenCustomHashMap extends Char2ByteOpenCustomHashMap implements Char2ByteOrderedMap
{
	 ...
	 */
	public Char2ByteLinkedOpenCustomHashMap(CharStrategy strategy) {
	 ...
	 */
	public Char2ByteLinkedOpenCustomHashMap(int minCapacity, CharStrategy strategy) {
	 ...
	 */
	public Char2ByteLinkedOpenCustomHashMap(int minCapacity, float loadFactor, CharStrategy strategy) {
	 ...
	 */
	public Char2ByteLinkedOpenCustomHashMap(Character[] keys, Byte[] values, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ByteLinkedOpenCustomHashMap(Character[] keys, Byte[] values, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2ByteLinkedOpenCustomHashMap(char[] keys, byte[] values, CharStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ByteLinkedOpenCustomHashMap(char[] keys, byte[] values, float loadFactor, CharStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Char2ByteLinkedOpenCustomHashMap(Map<? extends Character, ? extends Byte> map, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2ByteLinkedOpenCustomHashMap(Map<? extends Character, ? extends Byte> map, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Char2ByteLinkedOpenCustomHashMap(Char2ByteMap map, CharStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2ByteLinkedOpenCustomHashMap(Char2ByteMap map, float loadFactor, CharStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Char2ByteLinkedOpenCustomHashMap copy() {
		Char2ByteLinkedOpenCustomHashMap map = new Char2ByteLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2ByteMap.Entry o) {
			return Char2ByteLinkedOpenCustomHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2ByteMap.Entry o) {
			return Char2ByteLinkedOpenCustomHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2ByteMap.Entry) {
					...
					int index = Char2ByteLinkedOpenCustomHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return entry.getByteValue() == Char2ByteLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Character)) return false;
					int index = Char2ByteLinkedOpenCustomHashMap.this.findIndex((Character)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Byte.valueOf(Char2ByteLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2ByteMap.Entry) {
					Char2ByteMap.Entry entry = (Char2ByteMap.Entry)o;
					return Char2ByteLinkedOpenCustomHashMap.this.remove(entry.getCharKey(), entry.getByteValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2ByteLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2ByteLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2ByteLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2ByteLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2ByteLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2ByteLinkedOpenCustomHashMap.this.moveToLast(o);
		}
