 ...
 */
public interface Char2ShortNavigableMap extends Char2ShortSortedMap, NavigableMap<Character, Short>
{
	@Override
	public Char2ShortNavigableMap copy();
	 ...
	 */
	public default Char2ShortNavigableMap synchronize() { return Char2ShortMaps.synchronize(this); }
	 ...
	 * @see Char2ShortMaps#synchronize
	 */
	public default Char2ShortNavigableMap synchronize(Object mutex) { return Char2ShortMaps.synchronize(this, mutex); }
	 ...
	 */
	public default Char2ShortNavigableMap unmodifiable() { return Char2ShortMaps.unmodifiable(this); }
	...
	@Override
	public default Char2ShortNavigableMap subMap(char fromKey, char toKey) { return subMap(fromKey, true, toKey, false); }
	@Override
	public default Char2ShortNavigableMap headMap(char toKey) { return headMap(toKey, false); }
	@Override
	public default Char2ShortNavigableMap tailMap(char fromKey) { return tailMap(fromKey, true); }
	...
	@Override
	@Deprecated
	default Char2ShortMap.Entry lowerEntry(Character key) { return lowerEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2ShortMap.Entry floorEntry(Character key) { return floorEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2ShortMap.Entry ceilingEntry(Character key) { return ceilingEntry(key.charValue()); }
	@Override
	@Deprecated
	default Char2ShortMap.Entry higherEntry(Character key) { return higherEntry(key.charValue()); }
	
	@Override
	@Deprecated
	default Char2ShortNavigableMap subMap(Character fromKey, boolean fromInclusive, Character toKey, boolean toInclusive) { return subMap(fromKey.charValue(), fromInclusive, toKey.charValue(), toInclusive); }
	@Override
	@Deprecated
	default Char2ShortNavigableMap headMap(Character toKey, boolean inclusive) { return headMap(toKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2ShortNavigableMap tailMap(Character fromKey, boolean inclusive) { return tailMap(fromKey.charValue(), inclusive); }
	@Override
	@Deprecated
	default Char2ShortNavigableMap subMap(Character fromKey, Character toKey) { return subMap(fromKey.charValue(), true, toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2ShortNavigableMap headMap(Character toKey) { return headMap(toKey.charValue(), false); }
	@Override
	@Deprecated
	default Char2ShortNavigableMap tailMap(Character fromKey) { return tailMap(fromKey.charValue(), true); }
}