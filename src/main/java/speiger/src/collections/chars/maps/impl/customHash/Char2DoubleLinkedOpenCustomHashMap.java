...
public class Char2DoubleLinkedOpenCustomHashMap extends Char2DoubleOpenCustomHashMap implements Char2DoubleOrderedMap
{
	 ...
	 */
	public Char2DoubleLinkedOpenCustomHashMap(CharStrategy strategy) {
	 ...
	 */
	public Char2DoubleLinkedOpenCustomHashMap(int minCapacity, CharStrategy strategy) {
	 ...
	 */
	public Char2DoubleLinkedOpenCustomHashMap(int minCapacity, float loadFactor, CharStrategy strategy) {
	 ...
	 */
	public Char2DoubleLinkedOpenCustomHashMap(Character[] keys, Double[] values, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2DoubleLinkedOpenCustomHashMap(Character[] keys, Double[] values, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2DoubleLinkedOpenCustomHashMap(char[] keys, double[] values, CharStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2DoubleLinkedOpenCustomHashMap(char[] keys, double[] values, float loadFactor, CharStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Char2DoubleLinkedOpenCustomHashMap(Map<? extends Character, ? extends Double> map, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2DoubleLinkedOpenCustomHashMap(Map<? extends Character, ? extends Double> map, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Char2DoubleLinkedOpenCustomHashMap(Char2DoubleMap map, CharStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2DoubleLinkedOpenCustomHashMap(Char2DoubleMap map, float loadFactor, CharStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Char2DoubleLinkedOpenCustomHashMap copy() {
		Char2DoubleLinkedOpenCustomHashMap map = new Char2DoubleLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements Char2DoubleOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2DoubleMap.Entry o) {
			return Char2DoubleLinkedOpenCustomHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2DoubleMap.Entry o) {
			return Char2DoubleLinkedOpenCustomHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2DoubleMap.Entry) {
					...
					int index = Char2DoubleLinkedOpenCustomHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return Double.doubleToLongBits(entry.getDoubleValue()) == Double.doubleToLongBits(Char2DoubleLinkedOpenCustomHashMap.this.values[index]);
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Character)) return false;
					int index = Char2DoubleLinkedOpenCustomHashMap.this.findIndex((Character)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Double.valueOf(Char2DoubleLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2DoubleMap.Entry) {
					Char2DoubleMap.Entry entry = (Char2DoubleMap.Entry)o;
					return Char2DoubleLinkedOpenCustomHashMap.this.remove(entry.getCharKey(), entry.getDoubleValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2DoubleLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2DoubleLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2DoubleLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2DoubleLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2DoubleLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2DoubleLinkedOpenCustomHashMap.this.moveToLast(o);
		}
