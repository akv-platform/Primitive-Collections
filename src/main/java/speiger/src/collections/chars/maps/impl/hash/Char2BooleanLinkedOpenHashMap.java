 ...
 */
public class Char2BooleanLinkedOpenHashMap extends Char2BooleanOpenHashMap implements Char2BooleanOrderedMap
{
	 ...
	 */
	public Char2BooleanLinkedOpenHashMap(int minCapacity) {
	 ...
	 */
	public Char2BooleanLinkedOpenHashMap(int minCapacity, float loadFactor) {
	 ...
	 */
	public Char2BooleanLinkedOpenHashMap(Character[] keys, Boolean[] values) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2BooleanLinkedOpenHashMap(Character[] keys, Boolean[] values, float loadFactor) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2BooleanLinkedOpenHashMap(char[] keys, boolean[] values) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2BooleanLinkedOpenHashMap(char[] keys, boolean[] values, float loadFactor) {
		this(keys.length, loadFactor);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2BooleanLinkedOpenHashMap(Map<? extends Character, ? extends Boolean> map, float loadFactor) {
	 ...
	 * @param map the values that should be present in the map
 	 */
	public Char2BooleanLinkedOpenHashMap(Char2BooleanMap map) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2BooleanLinkedOpenHashMap(Char2BooleanMap map, float loadFactor) {
		this(map.size(), loadFactor);
		putAll(map);
	}
	...
	@Override
	public Char2BooleanLinkedOpenHashMap copy() {
		Char2BooleanLinkedOpenHashMap map = new Char2BooleanLinkedOpenHashMap(0, loadFactor);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2BooleanMap.Entry> implements Char2BooleanOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2BooleanMap.Entry o) {
			return Char2BooleanLinkedOpenHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2BooleanMap.Entry o) {
			return Char2BooleanLinkedOpenHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2BooleanMap.Entry) {
					...
					int index = Char2BooleanLinkedOpenHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return entry.getBooleanValue() == Char2BooleanLinkedOpenHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					int index = Char2BooleanLinkedOpenHashMap.this.findIndex(entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Boolean.valueOf(Char2BooleanLinkedOpenHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2BooleanMap.Entry) {
					Char2BooleanMap.Entry entry = (Char2BooleanMap.Entry)o;
					return Char2BooleanLinkedOpenHashMap.this.remove(entry.getCharKey(), entry.getBooleanValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2BooleanLinkedOpenHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2BooleanLinkedOpenHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2BooleanLinkedOpenHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2BooleanLinkedOpenHashMap.this.moveToLast(o);
		}
