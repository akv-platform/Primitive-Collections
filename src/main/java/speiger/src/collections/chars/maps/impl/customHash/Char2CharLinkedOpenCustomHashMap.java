 ...
 */
public class Char2CharLinkedOpenCustomHashMap extends Char2CharOpenCustomHashMap implements Char2CharOrderedMap
{
	 ...
	 */
	public Char2CharLinkedOpenCustomHashMap(CharStrategy strategy) {
	 ...
	 */
	public Char2CharLinkedOpenCustomHashMap(int minCapacity, CharStrategy strategy) {
	 ...
	 */
	public Char2CharLinkedOpenCustomHashMap(int minCapacity, float loadFactor, CharStrategy strategy) {
	 ...
	 */
	public Char2CharLinkedOpenCustomHashMap(Character[] keys, Character[] values, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2CharLinkedOpenCustomHashMap(Character[] keys, Character[] values, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the keys and values do not match in lenght
	 */
	public Char2CharLinkedOpenCustomHashMap(char[] keys, char[] values, CharStrategy strategy) {
		this(keys, values, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2CharLinkedOpenCustomHashMap(char[] keys, char[] values, float loadFactor, CharStrategy strategy) {
		this(keys.length, loadFactor, strategy);
		if(keys.length != values.length) throw new IllegalStateException("Input Arrays are not equal size");
	 ...
	 * @throws NullPointerException if Strategy is null
	 */
	public Char2CharLinkedOpenCustomHashMap(Map<? extends Character, ? extends Character> map, CharStrategy strategy) {
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
	 */
	public Char2CharLinkedOpenCustomHashMap(Map<? extends Character, ? extends Character> map, float loadFactor, CharStrategy strategy) {
	 ...
	 * @throws NullPointerException if Strategy is null
 	 */
	public Char2CharLinkedOpenCustomHashMap(Char2CharMap map, CharStrategy strategy) {
		this(map, HashUtil.DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @throws IllegalStateException if the loadfactor is either below/equal to 0 or above/equal to 1
 	 */
	public Char2CharLinkedOpenCustomHashMap(Char2CharMap map, float loadFactor, CharStrategy strategy) {
		this(map.size(), loadFactor, strategy);
		putAll(map);
	}
	...
	@Override
	public Char2CharLinkedOpenCustomHashMap copy() {
		Char2CharLinkedOpenCustomHashMap map = new Char2CharLinkedOpenCustomHashMap(0, loadFactor, strategy);
	...
	private class MapEntrySet extends AbstractObjectSet<Char2CharMap.Entry> implements Char2CharOrderedMap.FastOrderedSet {
		...
		public boolean moveToFirst(Char2CharMap.Entry o) {
			return Char2CharLinkedOpenCustomHashMap.this.moveToFirst(o.getCharKey());
		}
		
		@Override
		public boolean moveToLast(Char2CharMap.Entry o) {
			return Char2CharLinkedOpenCustomHashMap.this.moveToLast(o.getCharKey());
		}
		...
		public boolean contains(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2CharMap.Entry) {
					...
					int index = Char2CharLinkedOpenCustomHashMap.this.findIndex(entry.getCharKey());
					if(index >= 0) return entry.getCharValue() == Char2CharLinkedOpenCustomHashMap.this.values[index];
				}
				else {
					Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
					if(!(entry.getKey() instanceof Character)) return false;
					int index = Char2CharLinkedOpenCustomHashMap.this.findIndex((Character)entry.getKey());
					if(index >= 0) return Objects.equals(entry.getValue(), Character.valueOf(Char2CharLinkedOpenCustomHashMap.this.values[index]));
				}
			}
			return false;
		}
		...
		public boolean remove(Object o) {
			if(o instanceof Map.Entry) {
				if(o instanceof Char2CharMap.Entry) {
					Char2CharMap.Entry entry = (Char2CharMap.Entry)o;
					return Char2CharLinkedOpenCustomHashMap.this.remove(entry.getCharKey(), entry.getCharValue());
				}
				Map.Entry<?, ?> entry = (Map.Entry<?, ?>)o;
				return Char2CharLinkedOpenCustomHashMap.this.remove(entry.getKey(), entry.getValue());
			}
			return false;
		}
		...
		@Override
		public int size() {
			return Char2CharLinkedOpenCustomHashMap.this.size();
		}
		
		@Override
		public void clear() {
			Char2CharLinkedOpenCustomHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractCharSet implements CharOrderedSet {
		...
		public boolean remove(char o) {
			int oldSize = size;
			Char2CharLinkedOpenCustomHashMap.this.remove(o);
			return size != oldSize;
		}
		...
		public boolean moveToFirst(char o) {
			return Char2CharLinkedOpenCustomHashMap.this.moveToFirst(o);
		}

		@Override
		public boolean moveToLast(char o) {
			return Char2CharLinkedOpenCustomHashMap.this.moveToLast(o);
		}
