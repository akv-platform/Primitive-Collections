...
public class Object2LongMapTests extends TestCase
{
	...
	public static void suite(TestSuite suite) {
		...
		suite.addTest(mapSuite("Object2LongOpenCustomHashMap", (K, V) -> new Object2LongOpenCustomHashMap<>(K, V, HashStrategy.INSTANCE)));
		suite.addTest(mapSuite("Object2LongLinkedOpenCustomHashMap", (K, V) -> new Object2LongLinkedOpenCustomHashMap<>(K, V, HashStrategy.INSTANCE)));
