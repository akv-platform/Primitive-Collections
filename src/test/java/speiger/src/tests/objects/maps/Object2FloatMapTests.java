...
public class Object2FloatMapTests extends TestCase
{
	...
	public static void suite(TestSuite suite) {
		...
		suite.addTest(mapSuite("Object2FloatOpenCustomHashMap", (K, V) -> new Object2FloatOpenCustomHashMap<>(K, V, HashStrategy.INSTANCE)));
		suite.addTest(mapSuite("Object2FloatLinkedOpenCustomHashMap", (K, V) -> new Object2FloatLinkedOpenCustomHashMap<>(K, V, HashStrategy.INSTANCE)));
