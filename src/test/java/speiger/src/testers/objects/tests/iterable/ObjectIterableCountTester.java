...
public class ObjectIterableCountTester<T> extends AbstractObjectCollectionTester<T>
{
	...
	{
		assertEquals("First element should be found", 1, collection.count(T -> Objects.equals(T, e0())));		
	}
	
	@CollectionSize.Require(CollectionSize.SEVERAL)
	public void testIterableCount_FindLast() {
		assertEquals("Last element should be found", 1, collection.count(T -> Objects.equals(T, e2())));
	}
}