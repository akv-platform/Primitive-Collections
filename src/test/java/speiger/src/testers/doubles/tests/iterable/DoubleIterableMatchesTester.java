...
public class DoubleIterableMatchesTester extends AbstractDoubleCollectionTester
{
	...
	public void testIterableMatch_AnyFoundFirstElement() {
		assertTrue("Element ["+e0()+"] should be found", collection.matchesAny(T -> Double.doubleToLongBits(T) == Double.doubleToLongBits(e0())));
	}
	
	@CollectionSize.Require(CollectionSize.SEVERAL)
	public void testIterableMatch_AnyFoundLastElement() {
		assertTrue("Element ["+e2()+"] should be found", collection.matchesAny(T -> Double.doubleToLongBits(T) == Double.doubleToLongBits(e2())));
	}
	
	public void testIterableMatch_AnyFoundNoElement() {
		assertFalse("Element ["+e4()+"] should not be found", collection.matchesAny(T -> Double.doubleToLongBits(T) == Double.doubleToLongBits(e4())));
	}
	...
	public void testIterableMatch_NoneFoundFirstElement() {
		assertFalse("Element ["+e0()+"] should not be found", collection.matchesNone(T -> Double.doubleToLongBits(T) == Double.doubleToLongBits(e0())));
	}
	
	@CollectionSize.Require(CollectionSize.SEVERAL)
	public void testIterableMatch_NoneFoundLastElement() {
		assertFalse("Element ["+e2()+"] should not be found", collection.matchesNone(T -> Double.doubleToLongBits(T) == Double.doubleToLongBits(e2())));
	}
	
	public void testIterableMatch_NoneFoundNoElement() {
		assertTrue("Element ["+e4()+"] should not be found", collection.matchesNone(T -> Double.doubleToLongBits(T) == Double.doubleToLongBits(e4())));
	}
	...
	public void testIterableMatch_AllFoundAllElements() {
		DoubleSet set = new DoubleOpenHashSet(collection);
	...
	public void testIterableMatches_AllPartical() {
		assertFalse("Even if some elements were found, it should return false", collection.matchesAll(T -> Double.doubleToLongBits(T) == Double.doubleToLongBits(e0())));
	}
}