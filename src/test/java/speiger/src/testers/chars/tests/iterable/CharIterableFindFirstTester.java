...
public class CharIterableFindFirstTester extends AbstractCharCollectionTester
{
	...
	public void testIterableFindFirst_FindNothing() {
		assertEquals("No element should be found", (char)0, container.findFirst(T -> T == e4()));
	}
